...
export const generateLlmsTxt = (pages) => {
    ...
    const sectionTitleOverrides: Record<string, string> = {
        ...
        'docs-llm-observability': 'LLM Observability',
...
- **LLM Observability**: Track LLM API calls, token usage, and costs. Integrations for OpenAI, Anthropic, LangChain, and more. See the [LLM Observability docs](https://posthog.com/docs/llm-observability.md).
