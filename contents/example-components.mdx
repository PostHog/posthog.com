...
<Hero
    ...
    subtitle="PostHog’s self-hosted developer platform equips engineers with the dev tools they need to build successful products. Unlike Google Analytics, PostHog is open-source and can be deployed on your existing infrastructure."
    ctas={[
