...
<section class="my-24 px-5">
  <div class="max-w-screen-2xl mx-auto">
    <h3 class="text-2xl lg:text-3xl m-0 text-center mb-6 sm:mb-16 lg:mb-8">Trusted by the world's most successful startups and accelerators</h3>
    <div class="flex justify-center">
      <ul class="m-0 p-0 list-none inline-grid sm:grid-cols-3 lg:grid-cols-3 justify-evenly relative text-center sm:text-left">
        <li class="relative md:max-w-md py-4 md:py-8 pl-4 pr-2 md:px-12 lg:px-8">
          ...
          <p class="m-0 text-[15px]">The world's leading startup accelerator relies on PostHog. A/B experiments have helped improve engagement by +40%, while gathering +30% more data than other tools. <a href="/customers/ycombinator">Read more.</a></p>
        </li>
        <li class="relative md:max-w-md py-4 md:py-8 pl-4 pr-2 md:px-12 lg:px-8">
          ...
          <p class="m-0 text-[15px]">AssemblyAI tried Mixpanel, but had to limit ingestion to avoid exorbitant bills. They switched to PostHog and now track much more data, without any throttling. <a href="/customers/assemblyai">Read more.</a></p>
        </li>
        <li class="relative md:max-w-md py-4 md:py-8 pl-4 pr-2 md:px-12 lg:px-8">
          ...
          <p class="m-0 text-[15px]">Golioth has put PostHog at the heart of it's product development cycle since joining the startup program. Dashboards and insights help them build better products, faster. <a href="/spotlight/startup-golioth">Read more.</a></p>
        </li>
      </ul>
    </div>
  </div>
