...
<FeatureSnapshot
        ...
        features={[
            <>
                <strong>30 million events</strong>. Analyze data, create funnels, build dashboards and more. All in one platform.
            </>,
            <>
            ...
            <>
                <strong>A frankly ridiculous number of surveys</strong>. We charge from $0.01 per response, so send as many surveys as you want. 
            </>,
        ]}
    />
</Section>
