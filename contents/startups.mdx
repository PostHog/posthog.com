...
<li class="w-full bg-accent dark:bg-accent-dark p-6 rounded">
  ...
  <p class="!text-xl font-bold m-0 !leading-tight !mb-2">Backed by <a href="/customers/y-combinator">Y Combinator</a>, acquired by Brex</p>
...
<li class="w-full bg-accent dark:bg-accent-dark p-6 rounded">
  ...
  <p class="!text-xl font-bold m-0 !leading-tight !mb-2">Backed by Boldstart, the partner for devtool founders</p>
  <p class="text-sm">"Boldstart recommended PostHog to us. There’s  so many things that are possible for us right now — but <span class="bg-highlight p-0.5">PostHog is definitely helping us find a path."</span></p>
...
<li class="w-full bg-accent dark:bg-accent-dark p-6 rounded">
  ...
  <p class="!text-xl font-bold m-0 !leading-tight !mb-2">Backed by Concept, the UK's largest pre-seed fund</p>
