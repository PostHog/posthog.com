...
<div class="w-[calc(100%_+_4rem)] relative -mx-4 px-8 md:-mx-16 pt-32 pb-72 -mt-32 md:-mt-44">
  ...
  <CallToAction href="/startups/apply">Apply now</CallToAction>
    ...
    <CallToAction href="/questions">Ask a question</CallToAction>
</div>
...
<section class="my-24 px-5">
  <div class="max-w-screen-2xl mx-auto">
    ...
    <div class="flex justify-center">
      <ul class="m-0 p-0 list-none inline-grid sm:grid-cols-2 lg:grid-cols-3 justify-evenly relative text-center sm:text-left">
