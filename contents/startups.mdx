...
<li class="w-full bg-accent dark:bg-accent-dark p-6 rounded">
  ...
  <p class="text-lg font-semibold m-0 leading-tight mb-1">Backed by Y Combinator. <a href="/customers/y-combinator">And they use PostHog too!</a></p>
  <p class="text-sm"><span class="bg-highlight p-0.5">"PostHog isn’t just about making decisions, it's about having ideas. There are things you don’t even think of until you see the data."</span></p>
...
<li class="w-full bg-accent dark:bg-accent-dark p-6 rounded">
  ...
  <p class="text-lg font-semibold m-0 leading-tight mb-1">Backed by Boldstart, the partner for devtool founders.</p>
  <p class="text-sm"><span class="bg-highlight p-0.5">"Boldstart recommended PostHog to us. There’s  so many things that are possible for us right now — but PostHog is definitely helping us find a path."</span></p>
...
<li class="w-full bg-accent dark:bg-accent-dark p-6 rounded">
  ...
  <p class="text-lg font-semibold m-0 leading-tight mb-1">Backed by Concept, the UK's largest pre-seed fund.</p>
  <p class="text-sm"><span class="bg-highlight p-0.5">"We used to have dozens of tools and dashboards. PostHog is amazing because it reins in the chaos so we have everything in one place."</span></p>
