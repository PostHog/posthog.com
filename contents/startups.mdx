...
<Section>
<h2 className="text-3xl lg:text-5xl text-center">"Can $50k really get me to product-market fit?"</h2>
...
<FeatureSnapshot
        image={'./images/startup-refer.png'}
        features={[
            <>
...
<Section title="Unlock even more benefits for your team" titleSize="sm" cols={2}>
    <div>
