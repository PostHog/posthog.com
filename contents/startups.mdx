...
<section class="my-24 px-5">
  <div class="max-w-screen-md mx-auto">
    ...
    <ul class="p-0">
      ...
      <li class="list-none px-4 py-2 font-semibold"><a href="/blog/early-stage-analytics">The 80/20 of early-stage startup analytics</a></li>
      <li class="list-none px-4 py-2 font-semibold"><a href="/blog/posthog-first-five">What we learned about hiring from our first five employees</a></li>
      <li class="list-none px-4 py-2 font-semibold"><a href="/blog/how-to-run-a-transparent-company">How to run a transparent startup</a></li>
      <li class="list-none px-4 py-2 font-semibold"><a href="/blog/making-something-people-want">How we made something people want</a></li>
      <li class="list-none px-4 py-2 font-semibold"><a href="/blog/startup-ops-toolkit">The ops toolkit for early-stage startups</a></li>
      <li class="list-none px-4 py-2 font-semibold"><a href="/blog/startup-finance-without-finance">How to run finance at your startup without hiring a finance person</a></li>
      <li class="list-none px-4 py-2 font-semibold"><a href="/blog/dev-marketing-for-startups">Developer marketing for early-stage startups – what we’ve learned</a></li>
    </ul>
  </div>
</section>
