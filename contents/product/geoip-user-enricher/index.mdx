...
featuredImage: ../images/product/geoip.png
...
>
    ...
    <div>
        <h5>Correlate with geographic data</h5>
    ...
    <div>
        ...
        <p>Don’t want to pry? Combine the GeoIP User Enricher with other plugins to filter out the details you don’t need.</p>
    </div>
</Section>
