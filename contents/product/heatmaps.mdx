...
<Section
    divider={false}
    title="See what captures users' attention by visualizing click-counts as a product overlay."
    size="full"
    cols={2}
>
    <div>
        <h5>Get more granular than pageviews</h5>
        <p>See which specific links users are clicking, and how often. Identify the most popular links on every page.</p>
    </div>
    <div>
