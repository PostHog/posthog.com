...
- [LLM analytics](/docs/llm-analytics) to monitor, debug, and optimize AI features with trace inspection and cost tracking
...
3. Check our [status page](https://www.posthogstatus.com/) to see if there are any issues.
