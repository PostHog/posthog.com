...
A [data warehouse](/data-stack) and [CDP](/cdp) tie it all together, unifying that context into one source agents can read across. You can steer it all from [Slack](/slack), [the web app](/ai), the desktop ([PostHog Code](/code)), or your own editor via [the MCP](/mcp).
...
You can work with all of it through four products: the [Slack app](/slack) (mention @PostHog in any channel), the [web app](/ai), [PostHog Code](/code) (a desktop app for driving parallel agents on top of your product data), and [the MCP](/mcp), which brings PostHog into Claude Code, Cursor, or whatever agent you already use.
