...
- [Frontend and backend SDKs](/docs/libraries)
...
- A simplified [web analytics](/docs/web-analytics) dashboard with session duration, bounce rates, and channel analysis
