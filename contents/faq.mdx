...
A [data warehouse](/data-stack) and [CDP](/cdp) tie it all together, unifying that context into one source agents can read across. You can steer it all from [Slack](/slack), [the web app](/ai), [PostHog Desktop](/desktop), or your own editor via [the MCP](/mcp).
