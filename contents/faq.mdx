...
PostHog is an all-in-one suite of product and data tools including product analytics, web analytics, session replay, heatmaps, feature flags, A/B testing, surveys, and more. Our mission is to equip every developer to build successful products. 
...
- A/B testing with multivariate testing
...
Yes. PostHog has SDKs for iOS, Android, React Native, Flutter, and more. All of them support event capture, feature flags, and A/B testing. Some also support autocapture and session replay.
...
No. You can [signup](/signup), install the snippet, and capture your first event in less than 5 minutes.
...
If you are a firefighter, probably not.
