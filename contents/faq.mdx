...
Alternatively, the [AI wizard](/docs/ai-platform/ai-wizard) can handle the entire installation process for you with a single command. It automatically authenticates your account, installs the relevant SDKs, scans your codebase, and configures everything.
