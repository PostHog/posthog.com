...
PostHog is a [well-funded](/handbook/strategy/investors) project with [thousands of stars](https://github.com/PostHog/posthog/stargazers) on GitHub, and dozens of PRs being worked on weekly, by both our [core team](/team) and our active community.
...
Active and growing! We have thousands of stars on GitHub (<span className="relative top-2"><StarRepoButton /></span> to be exact). There is a [Slack group](/slack) with daily conversations, and our repos have [issues](https://github.com/PostHog/posthog/issues) raised every day.
