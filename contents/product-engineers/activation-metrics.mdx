...
> **New to SQL?** Check our guide to [the basics of SQL for analytics](/product-engineers/sql-for-analytics) and our [SQL docs](/docs/data-warehouse/sql) for more.
...
-   Connect activation to sales or revenue data with our [data warehouse](/blog/data-warehouse-at-posthog)
