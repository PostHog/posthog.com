...
And, while we can't help you with #6, we do have strong opinions on why [product engineers are awesome](/product-engineer-handbook/what-is-a-product-engineer) for startups, and how product engineers and [product managers](/newsletter/what-does-a-product-manager-do) can work together.
