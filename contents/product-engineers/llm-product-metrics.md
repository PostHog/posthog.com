...
> **💡 PostHog tip**: We recently launched our own built-in [LLM Observability feature](/docs/llm-analytics). It can automatically capture many of the metrics detailed in this post.
