...
> **💡 PostHog tip**: We recently launched our own built-in [AI Observability feature](/docs/ai-observability). It can automatically capture many of the metrics detailed in this post.
