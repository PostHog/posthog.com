  ...
  [
    {
      ...
      content: "<p className=\"mb-2\">\"The user seemed frustrated. Oh, there was a 5 second API request. That's interesting...\"</p><p className=\"m-0\"><i>- An actual PostHog engineer</i></p>"
    },
    {
      image: ./images/products/session-recording.png
    }
