...
There are free tiers everywhere – [PostHog gives you 100K LLM events/mo free](/ai-observability), Langfuse is free to self-host, [Datadog](/compare/posthog-vs-datadog) includes 40K LLM spans/mo on its free tier... use one of them instead.
