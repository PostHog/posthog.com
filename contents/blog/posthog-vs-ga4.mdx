...
**PostHog** uses transparent, usage-based [pricing](/pricing). It's free to get started – no credit card required. Every month you get 1 million analytics events, 5,000 web and 2,500 mobile session replays, 1 million feature flag requests, 1,500 survey responses, and more for free. 
