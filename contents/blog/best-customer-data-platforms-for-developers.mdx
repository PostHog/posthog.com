...
<ProductComparisonTable
    ...
    rows={[
        ...
        'cdp.features.no_code_setup',
        {
            ...
            values: [true, 'Add-on', 'Paid plans only', true, 'Add-on', true],
        },
        {
        ...
        },
        {
            ...
            values: [true, true, true, true, 'Add-on', true],
        },
        {
...
If you want to go deeper on how CDPs fit into a modern data stack, check out our [guide on CDP vs data warehouse: which should you use and why](/blog/cdp-vs-data-warehouse).
