...
Lifecycle analysis digs deeper into your events and shows you a breakdown of the event volume into new, returning, and ressurecting occurences. In addition, it also shows you the churn on that event for the specified time period. 
