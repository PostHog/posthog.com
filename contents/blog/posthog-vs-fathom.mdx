...
- Fathom requires a credit card for the trial.
- PostHog is free to 1M data points. Fathom starts at $15/month for the lowest tier (100K data points). Or $60/month for 1M data points.
- Both services are privacy minded.
- "Switch to a better Google Analytics alternative"
- links
  https://posthog.com/blog/best-fathom-alternatives

## How is PostHog different?

### 1. PostHog offers many tools beyond web analytics
...
### 2. PostHog is free forever

PostHog's ["ridiculously cheap" tier](/pricing) includes all of the features of PostHog for free with an allowance of 1M events per month. For Fathom, the pricing for up to 1M data points is $60 monthly.
...
> 💡 **Good to know:** Many of Fathom's product analytics features, like custom properties and [funnels](/docs/product-analytics/funnels), are on its more expensive "Business" plan. It's roughly twice the price of the Growth plan and includes up to 10 team members and priority support.
