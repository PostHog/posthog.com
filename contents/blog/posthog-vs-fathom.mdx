...
PostHog and Fathom Analtyics both provide alternatives to Google Analytics. In fact, both explicitly mention it with marketing copy like "Switch to a better Google Analytics alternative."

Both products feature web analytics dashboards with an emphasis on simplicity and privacy. They're ideal choices for customers that want to analyze and understand web traffic but find Google Analytics to be needlessly complicated.
...
PostHog's ["ridiculously cheap" tier](/pricing) includes all of the features of PostHog for free with an allowance of 1M events per month. For Fathom, the pricing for up to 1M data points is $60 per month or 100K data points for $15 per month.
...
### Is Fathom simpler than PostHog?

Although PostHog has more features than Fathom, it isn't necessarily more complicated.

If you look at the web analytics dashboard for both products, they're pretty similar in appearance and the data provided:
...
Teams rely on [product analytics](/product-analytics) when they need more customization in both capturing and analyzing date. Although not a focus of Fathom, it does have offer some basic product analytics features with event tracking.
...
<ComparisonTable column1="PostHog" column2="Fathom">
  ...
  <ComparisonRow column1="Invite teammates to collaborate for all features" column2="Share web analytics with or without a password" feature="Collaboration" description="Share your projects and sites with teammates" />
...
<ComparisonTable column1="PostHog" column2="Fathom">
  ...
  <ComparisonRow column1={true} column2={true} feature="WordPress" description="Send and receive error data with Sentry" />
</ComparisonTable>
...
Fathom is a monthly subscription based on usage. Plans start at $15 per month for 100k data points. The pricing for up to 1M data points is $60 per month.
