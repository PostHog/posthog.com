...
Teams rely on [product analytics](/product-analytics) when they need more customization in both capturing and analyzing data. Although not a focus of Fathom, it does have offer some basic product analytics features with event tracking.
...
<ComparisonTable column1="PostHog" column2="Fathom">
  ...
  <ComparisonRow column1="Events, reports" column2={false} feature="Slack" description="Send events, reports, and anomalies to Slack" />
