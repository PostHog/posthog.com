---
title: The most popular LogRocket alternatives & competitors, compared
date: 2023-11-09
author: ["ian-vanagas"]
rootpage: /blog
...
The most popular LogRocket alternatives in 2023 are:
...
![PostHog](../images/blog/best-logrocket-alternatives/posthog.png)
...
According to [BuiltWith](https://trends.builtwith.com/analytics/PostHog), PostHog is much more popular than LogRocket. As of November 2023, 4,037 (0.4%) of the top 1 million websites deploy PostHog, over triple LogRocket's 1,245 (0.12%).
...
As of October 2023, just 389 of the top 1 million websites deploy Glassbox. This is a quarter of LogRocket's 1,245.
...
According to data from [BuiltWith](https://trends.builtwith.com/javascript/Sentry), as of November 2023, 64,445 of the top 1 million sites use Sentry, much more than LogRocket's 1,245.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/Smartlook), as of November 2023, 3,343 of the top 1 million websites use Smartlook. This is more than LogRocket's 1,245.
...
According to data from [BuiltWith](https://trends.builtwith.com/analytics/FullStory), as of November 2023, 8,367 of the top 1 million websites in the world deploy FullStory. This is much more than LogRocket's 1,245.
...
According to [data from BuiltWith](https://trends.builtwith.com/analytics/Pendo), as of November 2023, 3,809 of the top 1 million websites used Pendo. This is triple LogRocket's 1,245.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/Hotjar), as of November 2023, Hotjar is much more popular than LogRocket. A massive 75,000 of the top 1 million sites use Hotjar. LogRocket is only used on 1,245.
