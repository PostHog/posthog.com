...
Traces are ingested into [AI Observability](/docs/ai-observability) as normal PostHog events. They have their own loose schema around special [`$ai_*` properties](/docs/ai-observability/basics) – covering everything from [generations](/docs/ai-observability/generations) and [spans](/docs/ai-observability/spans) to [sessions](/docs/ai-observability/sessions) – but also the flexibility of general PostHog events, which means they generally work with any other PostHog feature out of the box.
...
<iframe
    ...
    title="AI Observability clusters demo"
    frameborder="0"
...
The noise cluster (labeled "Outliers") often contains the most interesting one-off traces – edge cases, unusual workflows, or bugs that don't fit any pattern. Pair this with [evaluations](/docs/ai-evals) (our LLM-as-a-judge feature) to automatically score the quality of generations within each cluster.
