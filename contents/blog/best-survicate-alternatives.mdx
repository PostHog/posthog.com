...
When it comes to surveys, Lucky Orange does many of the same things that Survicate. However, it's designed specifically for optimizing conversion on e-commerce websites, so doesn't support any of the other plaforms that Survicate does. 
