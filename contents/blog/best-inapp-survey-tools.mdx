...
[Surveys](/docs/surveys) in PostHog support web and mobile apps, can be triggered by events or feature flags, and include [templates for NPS, PMF, CSAT, and more](/templates). The free tier includes 1,500 responses per month with no credit card required.
