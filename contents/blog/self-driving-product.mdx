...
Stitch those five things together, and you get a loop we like to call product autonomy: *Collect data → cluster signals → check memory → notify workers → do work → evaluate → write back to memory.*
