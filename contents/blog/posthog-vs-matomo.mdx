...
- **PostHog** – SQL access, an [MCP server](/docs/model-context-protocol) for AI coding tools, [SDKs](/docs/libraries) for every major platform, error tracking, LLM Observability, and tight integration between analytics, feature flags, and experiments. Built by engineers, for engineers.
...
- Building an AI product and need [LLM observability](/llm-observability) tied to real user behavior
