...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Free team members', description: 'Number of users you can invite to your instance', customValue: 'Unlimited' },
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Warehouse exports', description: 'Export data to warehouses like S3 and BigQuery for storage and analysis', customValue: true },
        'platform.integrations.warehouse_import',
        'platform.integrations.slack',
        'platform.integrations.email_reports',
        { label: 'Google Search Console', description: 'See search queries that sent traffic to your site', customValue: false },
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Audit log', description: 'Get a report of all activities happening in your instance', customValue: 'Enterprise' },
    ]}
/>
