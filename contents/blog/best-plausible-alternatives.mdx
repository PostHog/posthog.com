...
- PostHog includes [session replay](/session-replay), [A/B testing](/experiments), [feature flags](/feature-flags), [surveys](/surveys), [error tracking](/error-tracking), [LLM observability](/llm-observability), and more; Plausible focuses exclusively on web analytics.
