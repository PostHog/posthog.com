...
<ComparisonTable column1="PostHog" column2="Plausible">
    ...
    <ComparisonRow
        ...
        column2={true}
        feature="Conversions"
        description="Track conversions towards a goal metric with funnels"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        ...
        description="Option to track without using cookies"
    />
    <ComparisonRow
        column1={true}
        column2={false}
        feature="Product analytics"
        description="Create custom dashboards, trends, funnels, paths, and retention"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        ...
        description="Capture and analyze data at the user-level"
    />
    <ComparisonRow
        column1={true}
        column2={false}
    ...
    <ComparisonRow
        ...
        description="Official instructions to capture more accurate data by avoiding tracking blockers"
    />
</ComparisonTable>
