...
- PostHog includes [session replay](/session-replay), [A/B testing](/experiments), [feature flags](/feature-flags), [surveys](/surveys), [error tracking](/error-tracking), [LLM observability](/llm-analytics), and more; Plausible focuses exclusively on web analytics.
