...
[Plausible](https://plausible.io/) does simple, privacy-friendly website analytics really well. No cookies, no complex setup, no overwhelming dashboards.
...
- Fathom starts at $15/month for 100k pageviews; Plausible starts at $9/month for 10k pageviews, making it cheaper at low volumes but potentially more expensive as traffic grows.
...
- Neither offers session replay, A/B testing, feature flags, or product analytics.
...
- Matomo includes session recordings, heatmaps, and A/B testing (as paid plugins); Plausible focuses exclusively on web analytics.
