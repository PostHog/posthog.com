...
Feature-wise, Plausible and Fathom are nearly identical. Looking closer, however, Fathom is missing some of the compliance features Plausible offers, like [open source](/blog/best-open-source-analytics-tools) code and EU hosting.
