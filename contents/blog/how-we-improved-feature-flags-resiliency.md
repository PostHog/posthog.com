...
This is why the <SmallTeam slug="feature-flags" /> has spent the last few months making PostHog's feature flags fast and resilient. Our goal was to ensure that:
...
You can see a similar story on [our status page](https://www.posthogstatus.com/uptime/1t4b8gf5psbc?page=3), where feature flags related incidents went down.
