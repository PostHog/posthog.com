...
hideAnchor: true
featuredImage: >-
  https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-vs-hotjar/posthog-vs-hotjar.jpg
...
<ComparisonTable column1="PostHog" column2="Hotjar">
  ...
  <ComparisonRow column1={true} column2={false} feature="In-app prompts and messages" description="Send messages to users in your app." />
  ...
  <ComparisonRow column1={false} column2={true} feature="User interview recordings and transcriptions" />
...
<ComparisonTable column1="PostHog" column2="Hotjar">
  <ComparisonRow column1="5,000/mo" column2="~1k per month (max 35 per day) on Basic plan" feature="Free replay allowance" />
  <ComparisonRow column1="$175/mo" column2="~$200 per month (max 1.5k sessions per day)" feature="Price for first 50k sessions" />
  <ComparisonRow column1={true} column2={true} feature="Browser app replays" description="Watch real users use your product." />
  <ComparisonRow column1={true} column2={false} feature="Connected to product analytics" description="View replays for specific users and events." />
  <ComparisonRow column1={true} column2="Only in Scale plan" feature="Console logs" description="Debug user problems and app errors." />
  <ComparisonRow column1={true} column2={false} feature="Performance monitoring" description="Monitor network activity and performance" />
  <ComparisonRow column1="Alpha" column2={false} feature="iOS app replays" description="Record user sessions in iOS apps." />
  <ComparisonRow column1="Planned Q1 2024" column2={false} feature="Android app replays" description="Record user sessions in Android apps." />
...
> **Further reading:** [All the best Hotjar alternatives and competitors](/blog/best-hotjar-alternatives)
...
<ComparisonTable column1="PostHog" column2="Hotjar">
  ...
  <ComparisonRow column1={true} column2={false} feature="Custom user targeting" description="Define who should see your widgets with your own data." />
  <ComparisonRow column1={true} column2={true} feature="Surveys" description="Capture user feedback with surveys." />
  <ComparisonRow column1={false} column2={true} feature="User interview recordings and transcriptions" />
  <ComparisonRow column1={true} column2={false} feature="Notification bar" description="Display a customized banner on your site." />
  <ComparisonRow column1={true} column2={false} feature="In-app popups" description="Highlight features in your app." />
</ComparisonTable>
...
<ComparisonTable column1="PostHog" column2="Hotjar">
  ...
  <ComparisonRow column1={false} column2={true} feature="HIPAA-ready" description="Business Associate Agreement available." />
