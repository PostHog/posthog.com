...
Worth knowing if you're picking a free tier to build on: Dynatrace announced an agreement to acquire Arize in August 2026, so the AX free tier's future terms are now an enterprise vendor's call. Self-hosted Phoenix is unaffected.
