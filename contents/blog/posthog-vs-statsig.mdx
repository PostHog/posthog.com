...
- **PostHog** is an all-in-one platform built to help engineers understand users and create better products. Beyond [A/B testing](/ab-testing) and [feature flags](/feature-flags), it offers advanced [product analytics](/docs/product-analytics), [session replays](/docs/session-replay), [surveys](/docs/surveys), and more.
