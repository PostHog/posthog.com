...
<ComparisonTable column1="PostHog" column2="Statsig">
  ...
  <ComparisonRow column1={true} column2={true} feature="Dynamic config" description="Replace hard-coded values in your app with config values" />
  <ComparisonRow column1={true} column2={true} feature="Web session replays" description="Watch real users use your web app; debug behavior" />
  <ComparisonRow column1={true} column2={false} feature="Mobile session replays" description="Watch real users use your native mobile app" />
  ...
  <ComparisonRow column1="Beta" column2={true} feature="Data warehouse experiments" description="Run A/B tests natively on data in your existing warehouse" />
</ComparisonTable>
