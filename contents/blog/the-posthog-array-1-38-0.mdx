...
- Export any dashboard or insight as a nicely rendered image, to share anywhere you need
- Setup email subcriptions to have insight and dashboard updates sent to you and your team regularly
- Setup Slack subscriptions to get scheduled updates (with image previes) into any channel you choose
...
After previously [deprecating the Sessions page](/blog/sessions-removal), we've now bought it back in a new and improved form. As of 1.38.0, we've added support for tracking and analyzing sessions within the insights feature.

Session analysis is a powerful way to get answers to questions such as:
