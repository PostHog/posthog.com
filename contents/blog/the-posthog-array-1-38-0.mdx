...
- New: Async migration 0005(#asyn-migration-0005)
...
`properties` column takes up most of the space in any PostHog ClickHouse setup. This release changes out the default compression scheme for ZSTD(3). This reduces space usage by around 2.4x and can speed up uncached queries up to 2.4x.
...
-   **Actions have been renamed to Calculated Events**: Actions are now called calculated events and can be found and created from the Data Management Events tab.
