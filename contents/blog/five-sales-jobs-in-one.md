...
If you opened the internet or even looked at billboards in major cities in the last year, you may have gotten the impression that AI will take over all (sales) jobs. Attention grabbing yes, but it is not really new.

Every few decades, a new technology comes along, and everyone claims that "sales is dead". It started with the telephone, then the internet, and now AI. So while the statement is overblown, the changes to the job are very real.
...
- With the services glasses on, I not only advise on the ideal set up but can literally help them through MCP prompts, or fix their implementation with PRs against their code directly (as shared above). And I can measure the impact of my deployment consulting by the actual usage numbers going up.
