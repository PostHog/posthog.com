...
export const sessionsummariesdark = "https://res.cloudinary.com/sortafreel/video/upload/v1764510391/minivied-v2_onrxvy.mov"
export const sessionsummarieslight = "https://res.cloudinary.com/sortafreel/video/upload/v1764510391/minivied-v2_onrxvy.mov"
...
<ProductVideo 
    videoLight={sessionsummarieslight}
    videoDark={sessionsummariesdark}
    alt="Session summaries demo" 
    classes="rounded"
/>
