...
It was a mixed start, but belief remained. We ran regular traces hours, where we looked at LLM calls (hey, you should try [PostHog's LLM Observability](/llm-observability)!) and worked out what went wrong when our users had a poor experience. We kept iterating.
