...
This is the deep dive. If you just want the short version, the [docs](/docs/start-here) walk the whole [autonomy loop](/docs/start-here/autonomy-loop) — scouts, signals, reports, and the inbox — at a glance. And if you just want to see scouts in action, skip to [two scouts, end to end](#two-scouts-end-to-end).
