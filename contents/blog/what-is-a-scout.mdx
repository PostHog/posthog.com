...
This post walks through how scouts work in PostHog, with two real scouts we run on our own project — one that watches agent-driven MCP feedback, and one that watches what the internet says about us 😱.
...
As your scout runs over time of course you can easily add a list of dos and don'ts or anything else you want to steer it in ways that are valuable to you.
...
Scouts are still rolling out gradually and are invite-only for now while we shake out the rough edges — wider access is coming soon.

Once they're available to you, the home base is [PostHog Code](/code), our desktop coding agent — download it, sign in, and the PostHog MCP is wired up for you. From there you can navigate to the Agents section and explore the set of canonical scouts PostHog ships with as well as make your own custom scouts.
