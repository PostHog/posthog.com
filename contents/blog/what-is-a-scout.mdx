...
A scout is a small agent (don't overthink that word) that looks at, wrangles, and makes sense of any data available in PostHog. It's a core component of [Self-driving](/docs/self-driving) in PostHog (now in open beta), an autonomous loop that monitors your product for patterns and drafts fixes. 
