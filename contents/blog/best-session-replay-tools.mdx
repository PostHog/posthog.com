...
**PostHog** and **LogRocket** both support iOS and Android with native SDKs. **UXCam** is another strong option built specifically for mobile. Avoid web-only tools like **Microsoft Clarity** if mobile is your primary platform.
