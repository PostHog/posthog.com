...
tags:
    ...
    - AI
seo:
    metaTitle: "6-7 loops we use every day to make PostHog self-driving"
...
What makes this a loop is that the scout **checks back on things that it thinks got fixed**. It does this by keeping notes in its scratchpad about what was reported, what shipped, and validates that the fix held before considering a theme closed.
