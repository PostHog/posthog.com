...
Everyone wants high product engagement. It's one of those things that sounds obviously good, like "growth" or "trction." But what does it actually mean, and how do you measure it? 
...
First off, there’s no need to track a dozen engagement metrics from the start. Until you've solidly found product-market fit, you and your team should still be focused on one number: your [North Star metric](/founders/north-star-metrics). 

North Star metrics are numbers that are simple to communicate and easy to measure. They're typically one of the raw behavioral metrics from above, like rides booked on Uber, for example. A great North Star metric lets someone quickly grasp your business's goals because it's an [obvious precursor to revenue](/docs/new-to-posthog/getting-hogpilled).
