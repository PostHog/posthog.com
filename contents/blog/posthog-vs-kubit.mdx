...
<ComparisonTable column1="Kubit" column2="PostHog">
  ...
  <ComparisonRow column1={false} column2={true} feature="Heatmaps" description="Track where users click" />
  <ComparisonRow column1={false} column2={true} feature="Event pipelines" description="Push and pull data to enrich customer profiles" />
...
<ComparisonTable column1="Kubit" column2="PostHog">
  ...
  <ComparisonRow column1={false} column2={true} feature="Lifecycle analysis" description="Understand who is dormant, churning, and thriving" />
  <ComparisonRow column1={false} column2={true} feature="Correlation analysis" description="Identify predictors and shared commonalities" />
  ...
  <ComparisonRow column1={false} column2={true} feature="SQL access" description="Use code to directly query the data" />
  <ComparisonRow column1={false} column2={true} feature="Group analytics" description="Gather individual users into larger organizations" />
  <ComparisonRow column1={true} column2={false} feature="Predictive analytics" description="Extrapolate from now, into the future" />
</ComparisonTable>
...
<ComparisonTable column1="Kubit" column2="PostHog">
  ...
  <ComparisonRow column1={false} column2={true} feature="Slack integration" description="Receive notifications about new data" />
  <ComparisonRow column1={false} column2={true} feature="Discord integration" description="Receive notifications about new data" />
  <ComparisonRow column1={false} column2={true} feature="MS Teams integration" description="Receive notifications about new data" />
...
<ComparisonTable column1="Kubit" column2="PostHog">
  <ComparisonRow column1={false} column2={true} feature="JavaScript" />
  <ComparisonRow column1={false} column2={true} feature="React Native" />
  <ComparisonRow column1={false} column2={true} feature="React" />
  <ComparisonRow column1={false} column2={true} feature="Flutter" />
  <ComparisonRow column1={false} column2={true} feature="iOS" />
  <ComparisonRow column1={false} column2={true} feature="Android" />
...
<ComparisonTable column1="Kubit" column2="PostHog">
  ...
  <ComparisonRow column1={false} column2={true} feature="Data anonymization" />
  ...
  <ComparisonRow column1={false} column2={true} feature="2FA available" />
</ComparisonTable>
