...
We used [html-to-image](https://github.com/bubkoo/html-to-image) to render the final product. When a team member clicks the _download_ button, the image is generated, uploaded to our Cloudinary instance, then downloaded to the client.
...
<ProductScreenshot
    imageLight = "https://res.cloudinary.com/dmukukwp6/image/upload/changelog_post_e3ba3d6d52.png" 
    classes="rounded"
