...
PostHog is much more popular than Split. According to [BuiltWith](https://trends.builtwith.com/analytics/PostHog), 4732 of the top 1 million sites use PostHog, compared to 177 using Split (as of April 2024).
...
> #### Bottom line
> PostHog makes for a great alternative to Split as it includes all the key feature flag and experimentation features along with being free, self-serve, and open source. For product-led startups and scaleups, it is an especially good choice thanks to its full suite of tools built for them.
...
[LaunchDarkly](/blog/posthog-vs-launchdarkly) is an enterprise feature flag and A/B testing platform. It helps developers de-risk releases, target experiences, and optimize their products. They provide automation and governance features to ensure teams are following [engineering best practices](/product-engineers/feature-flag-best-practices).

According to [BuiltWith](https://trends.builtwith.com/analytics/LaunchDarkly), as of April 2024, 1072 of the top 1 million websites use LaunchDarkly, significantly more than the 177 who use Split.
...
> #### Bottom line
> Although LaunchDarkly has nearly an identical feature set to Split, it isn't self-serve. For teams needing strong governance and automation tools, LaunchDarkly makes a good choice. For smaller teams, there are likely better options.
...
VWO is a digital experience optimization platform that aims to maximize conversion with tools like A/B testing, personalization, funnels, heatmaps, session replay, and customer analytics. Although it isn't a focus for them, they also have feature flags.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/Visual-Website-Optimizer), as of April 2024, 9,183 of the top million sites use VWO. This is significantly more than Split's 177.
...
Although VWO has analytics, it is behavioral analytics (like session replays and heatmaps) rather than product analytics.
...
1. **Support:** VWO's support staff are knowledgeable, helpful, and responsive. This helps reviewers get the most out of the platform from onboarding onwards.
...
- 🔌 **Integrations:** Connects with data warehouses and analytics tools, but offers limited integrations beyond that.

### How does GrowthBook compare to Split?

GrowthBook's highlight is that it is open source and warehouse native. It does miss some of the depth in features of Split though.
...
1. **Warehouse native:** GrowthBook's integrations with the warehouses reviewers are already using is a standout feature for them. It enables them to extract and make use of the data they already have.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/AB-Tasty), as of April 2024, 2351 of the top 1 million sites deploy AB Tasty, while 177 use Split.
...
Harness has a much different feature set than Split does. It focuses on DevOps, whereas Split focuses on product and engineering. The key difference is Harness' lack of A/B testing. 
...
2. **Developer-focused:** Harness is a tool built for developers. They appreciate the experience it provides them.

3. **Simplicity:** Although it is a developer tool, reviewers do mention they appreciate how easy it makes many tasks, like feature flags or deployments. 

> #### Bottom line
> For companies wanting to follow engineering best practice and not needing A/B testing, Harness can be a good choice. It is more likely to be an option for companies looking for DevOps tools though.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/Kameleoon), as of April 2024, 816 of the top 1 million websites deploy Kameleoon. This is the closest of the alternatives to Split's 177.
...
3. **Integrations:** Reviews like how Kameleoon integrates with all the tools they already use like Google Analytics, Adobe Analytics, and Mixpanel.

> #### Bottom line
> For companies looking for a developer-focused optimization platform, Kameleoon is a good alternative. The fact that it isn't self-serve hurts this recommendation significantly, however.
