...
<ComparisonTable column1="PostHog" column2="Matomo">
    ...
    <ComparisonRow
        ...
        description="Pre-built dashboard of aggregate traffic, sources, campaigns, and session metrics"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        ...
        column2={false}
        feature="Autocapture"
        description="Capture clicks and pageviews without manual instrumentation"
    />
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Cohort analysis"
        description="Combine users into cohorts for analysis"
    />
    <ComparisonRow
        column1={false}
        column2={true}
    ...
    <ComparisonRow
        ...
        column2={true}
        feature="A/B testing"
        description="Run multivariate tests and see the impact of changes with custom goals and reports"
    />
    <ComparisonRow
        column1={true}
        column2={true}
