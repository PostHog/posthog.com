...
![Always has been meme](https://res.cloudinary.com/dmukukwp6/image/upload/w_500,c_limit,q_auto,f_auto/pasted_image_2025_12_02_T22_12_46_779_Z_b1454b5a68.png)
...
Here's what usually doesn't make it into the tiger team retro: the people left behind.

While they gets the shiny title, the exec attention, and the mandate to "move fast and break things," everyone else is still stuck in the slow(er) lane. Often, they're the ones who identified the problem in the first place, but instead of getting the green light to fix it, they get to watch someone else parachute in and take it from here.

The implicit message is: you're not trusted to handle the important stuff. 

Tiger teams create a two-tier system, the "elite squad" and everyone else. And everyone else notices. 

Great for morale, as you can imagine.

![Spongebob meme](https://res.cloudinary.com/dmukukwp6/image/upload/w_500,c_limit,q_auto,f_auto/pasted_image_2025_12_02_T22_09_32_293_Z_3418de753c.png)
...
![Small team vs tiger team diagram](https://res.cloudinary.com/dmukukwp6/image/upload/w_500,c_limit,q_auto,f_auto/pasted_image_2025_12_02_T22_14_20_151_Z_45e4671c7b.png)
...
A tiger team might ship a quick fix that technically solves the problem but creates technical debt. Why wouldn't they? They won't be around to pay it off. Worse, they can have an incentive to *not* fix things too permanently. Why make themselves obsolete? It's a self-reinforcing loop of misaligned incentives: the people with the most power to fix the system are the same people who benefit from it staying broken.
