...
When an agent sets out to write code, it has many viable paths to both solve the problem and [introduce mistakes](/newsletter/ai-coding-mistakes). Mistakes are especially common for newer, upstart projects.
