...
The project also shows how you can implement PostHog in your CLI products, gathering all sorts of useful data. We know how many runs are successful, and how many are cancelled, and this information is reported alongside the rest of our PostHog data. You can do this too!
