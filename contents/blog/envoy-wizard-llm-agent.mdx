...
The second problem? **It's super expensive**.
...
Build an **envoy**: software you control that developers can inject into their agent sessions with just a prompt.
...
Naturally, we're building our own envoy already. It's a beta, but it's already very cool and the feedback has been promising.
...
[Fork the wizard](https://github.com/PostHog/wizard/tree/main) – it's MIT licensed – and you can use it as your own starting place for an envoy. You just don't have to spend a lot of money to get into the coding agent mix.