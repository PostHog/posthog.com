...
The project also shows how you can implement PostHog in your CLI surfaces, which gets us all sort of useful data, like which libraries and frameworks are most popular. You can do this too!
