...
The PostHog [wizard](https://github.com/PostHog/wizard) is an interactive command line tool that automates the basics of a PostHog integration. It grabs an API key from a user’s account and uses it to populate a .env file.
...
[Fork the wizard](https://github.com/PostHog/wizard) – it's MIT licensed – and you can use it as your own starting place for an envoy. You just don't have to spend a lot of money to get into the coding agent mix.