...
The most popular FullStory alternatives in 2023 are:
...
![PostHog](../images/blog/best-fullstory-alternatives/posthog.png)
...
According to [BuiltWith](https://trends.builtwith.com/analytics/PostHog), PostHog is half as popular as FullStory. As of November 2023, 4,037 (0.4%) of the top 1 million websites deploy PostHog, while 8,367 (0.8%) use FullStory.

### Why do companies use PostHog?

According to [reviews on G2](https://www.g2.com/products/posthog/reviews), companies use PostHog because:

1. **It replaces multiple tools:** PostHog can replace FullStory (session replay and analytics), LaunchDarkly (feature flags and A/B testing), and Hotjar (feedback and surveys). This simplifies workflows and ensures all product is in one place.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/Smartlook), as of November 2023, 3,343 of the top 1 million websites use Smartlook. This is less than half of FullStory's 8,367.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/Amplitude), Amplitude bests FullStory with 10,247 of the top million sites using them as of November 2023. FullStory is close behind at 8,367.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/Heap), Heap is about half as popular as FullStory with 4,312 sites using them as of November 2023. FullStory has 8,367.
...
As of November 2023, just 398 of the top 1 million websites deploy Glassbox (according to [BuiltWith](https://trends.builtwith.com/analytics/GlassBox)). Their focus on mobile apps isn't reflected in these numbers, but this is nearly twenty times less than FullStory's 8,367.
...
According to [BuiltWith](https://trends.builtwith.com/widgets/LogRocket), 1,245 of the top million sites use LogRocket (as of November 2023). This is much less FullStory's 8,367. 
...
According to [data from BuiltWith](https://trends.builtwith.com/analytics/Pendo), as of November 2023, 3,809 of the top million websites used Pendo. This is under half of FullStory's 8,367.
