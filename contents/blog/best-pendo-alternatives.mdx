...
The most popular Pendo alternatives in 2023 are:

1. **PostHog:** An all-in-one platform combining comprehensive analytics with session replay, user surveys, A/B testing, and feature flags. Ideal for B2B SaaS apps.
...
Both PostHog and Pendo are multi-product companies covering many use cases. Pendo focuses on in-app guides and internal tools. PostHog focuses on tools engineering and growth teams need like feature flags and A/B testing.
...
According to [BuiltWith](https://trends.builtwith.com/widgets/WalkMe), as of January 2024, 1,006 of the top million sites used WalkMe. This is roughly a quarter of Pendo's 3,711 but doesn't reflect WalkMe's focus on internal apps. Ahrefs has WalkMe's organic traffic at 85.9k, which is nearly double Pendo's 35.9k.
...
Appcues is a product adoption platform helping teams build better onboarding. It provides no-code component builder, announcements, and personalization to help improve activation, conversion, and stickiness. Also includes analytics to help track your progress improving onboarding flows.
...
Appcues focuses on features helping improve the product onboarding experience. They miss out on features of Pendo that capture the broader user experience like product analytics and session replay.
