...
<ComparisonTable column1="PostHog" column2="Pendo">
    <ComparisonRow
        ...
        description="Filter and visualize data with trends, funnels, paths, and retention analysis"
    />
    <ComparisonRow
        column1={true}
        column2={false}
        feature="Web analytics"
        description="Simple dashboard of aggregated traffic, sources, campaigns, and session metrics"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        column1={false}
        column2={true}
        feature="In-app guides"
        description="Communicate with users through product tours, tooltips, and popups"
    />
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Feedback"
        description="Get qualitative feedback from your users via feedback and surveys"
    />
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Segmenting"
        description="Analyze and filter based on user properties and behaviors"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Self-serve with free tier"
        description="Free to use, no mandatory sales calls"
    />
    <ComparisonRow
        column1={true}
        column2={false}
        feature="Transparent pricing"
        description="Get pricing immediately without talking to sales"
    />
    <ComparisonRow
        column1={true}
        column2={'Enterprise'}
        feature="EU hosting"
        description="Store your data in the EU to comply with privacy regulations"
    />
    <ComparisonRow
        column1={true}
        column2={false}
        feature="Open source"
        description="Audit code, contribute to the roadmap, and build integrations"
    />
</ComparisonTable>
