...
The goal of the team was to create an AI bot that could answer support questions, easing the load on our support heros and making it easier for the community to find answers to their questions.
