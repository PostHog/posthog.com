...
While [Hotjar](/blog/posthog-vs-hotjar) is an excellent tool for viewing session replays and understanding user behavior, it doesn't support mobile apps. 

In this post, we compare the best alternatives for mobile so that you can find the best replay tool for your needs.
