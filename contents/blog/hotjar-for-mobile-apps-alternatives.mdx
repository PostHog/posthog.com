---
title: 'Hotjar alternatives for mobile apps (iOS & Android)'
date: 2024-12-10
author:
  - lior-neu-ner
rootpage: /blog
...
This guide compares replay tools that support mobile apps, so you can find the best replay tool for your needs. If you don't need a "Hotjar for mobile", see our guide to [Hotjar alternatives for web apps](https://posthog.com/blog/best-hotjar-alternatives).
...
<ComparisonTable column1="PostHog">
  <ComparisonRow column1="Android, iOS" feature="Supported platforms" description="Mobile platforms where session replay is available" />
  <ComparisonRow column1={true} feature="Debug logs" description="View console logs, network logs" />
  <ComparisonRow column1={true} feature="Filters" description="View specific replays based on user segments, screens visited, events" />
