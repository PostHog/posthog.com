...
<ProductComparisonTable
    products={[posthog, contentsquare]}
    rows={[
        'session_replay',
...
<ProductComparisonTable
    products={[fullstory, contentsquare]}
    rows={[
        'session_replay',
        'session_replay.platform_support.mobile_app_recordings',
        'session_replay.ai.ai_summaries',
...
<ProductComparisonTable
    products={[microsoft_clarity, contentsquare]}
    rows={[
        'session_replay',
        'session_replay.platform_support.mobile_app_recordings',
        'session_replay.ai.ai_summaries',
...
<ProductComparisonTable
    products={[glassbox, contentsquare]}
    rows={[
        'session_replay',
        'session_replay.platform_support.mobile_app_recordings',
        'session_replay.ai.ai_summaries',
...
<ProductComparisonTable
    products={[quantum_metric, contentsquare]}
    rows={[
        'session_replay',
        'session_replay.platform_support.mobile_app_recordings',
        'session_replay.ai.ai_summaries',
