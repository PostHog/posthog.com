...
export const AndOrFilteringImage = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/blog/array/1-36-0-and-or-filtering.png"
export const UniversalSearchImage = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/blog/array/1-36-0-universal-search.png"
export const InsightOnMultipleDashboardsImage = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/blog/array/1-36-0-insight-on-multiple-dashboards.png"
export const DataColorsImage = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/blog/array/1-36-0-data-colors.png"
export const NewFunnelVizImage = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/blog/array/1-36-0-new-funnel-viz.png"
export const NewFunnelVizDashboardImage = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/blog/array/1-36-0-new-funnel-viz-dashboard.png"
export const TimezoneImage = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/blog/array/1-36-0-timezone.png"
export const PreflightImage = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/blog/array/1-36-0-preflight.png"
export const MultiPointPersonsModalImage = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/blog/array/1-36-0-multi-point-persons-modal.gif"
...
<iframe
    width="560"
    height="315"
    src="https://www.youtube-nocookie.com/embed/clVpovL0vxI"
...
-   **For ~~plugin~~ app developers:** `onEvent`, `onShapshot` and `onAction` event payloads have been cleaned up a bit. Specifically, `timestamp`, `$set`, and `$set_once` are always provided now, while `now`, `sent_at`, `site_url`, `offset`, as well as `kafka_offset` are no longer included. All apps available in our [App Store](https://posthog.com/pipeline) are compatible with this change. `processEvent` is unaffected.
