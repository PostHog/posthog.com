...
Speaking of design, you may have noticed we've updated the color palette in most Insights (specifically: [Trends](/docs/user-guides/funnels), [Funnels](/docs/user-guides/funnels), [Retention](/docs/user-guides/Retention), and [Stickiness](/docs/user-guides/stickiness)). 
