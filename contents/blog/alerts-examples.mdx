...
To show you how you can use alerts, we'll start by creating an alert and then dive into practical examples and use cases.
...
In this case, you can set up another trend insight to graph the number of pageviews for your 404 page. You can examine the graph to establish a baseline for a standard amount of traffic to the 404 page. You can click the graph where you see a spike and it will display a list of all the users effected. If you have [session replay](/session-replay) enabled, you can even watch the session where the 404 occurred and figure out exactly which link is broken.
