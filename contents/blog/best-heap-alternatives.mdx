...
<ComparisonTable column1="PostHog" column2="Heap">
    ...
    <ComparisonRow
        ...
        description="Custom trends, funnels, and retention analysis"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Visual labeling"
        description="Create and tag custom events without using code"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        column1={true}
        column2={false}
        feature="User surveys"
        description="Ask users for qualitative feedback and gather responses"
    />
...
As of January 2024, it's deployed on just 386 of the top 1 million websites, compared to Heap's 4,221.
