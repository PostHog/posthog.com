...
According to [data from BuiltWith](https://trends.builtwith.com/analytics/Pendo), Pendo is about as popular as Heap. As of October 2023, Pendo is used by 3,711 of the top 1 million websites, compared to 4,221 that use Heap.
