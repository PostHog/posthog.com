...
This policy is organizational insurance against the sort of committee thinking and filibustering that derails bold decisions. Instead, PostHog explicitly empowers the prime mover of a new direction to take action regardless of opinion.
