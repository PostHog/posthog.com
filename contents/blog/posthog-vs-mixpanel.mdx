...
2. Mixpanel relies on data warehouse connectors to combine customer and product data. This means you don't import data directly from third-party tools, but get them into a third-party warehouse and then import that data into Mixpanel for analysis.
