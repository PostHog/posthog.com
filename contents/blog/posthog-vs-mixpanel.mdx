...
Every PostHog user gets a generous amount of free usage each month: 1 million events for product analytics, 1 million synced rows for the data warehouse, 5,000 web and 2,500 mobile session recordings, 1 million API requests each for feature flags and A/B testing, and 1,500 survey responses.
