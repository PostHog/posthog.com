...
PostHog's AB testing features are free when you enter card details. You get a generous 1 million API requests every month, so you'll pay nothing if you remain below this limit.
