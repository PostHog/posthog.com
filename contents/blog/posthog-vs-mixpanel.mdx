...
2. PostHog has a [SQL-based query builder](/docs/product-analytics/sql) for power users, which enables you to generate custom data analyses using PostHog event data. In future, our query builder will let you analyze data as you would in a business intelligence tool, like Metabase, inside PostHog.
