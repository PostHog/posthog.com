...
> 💡**Good to know:** You can evaluate the results of experiments using events tracked using PostHog, or [event tables stored in our data warehouse](/docs/experiments/data-warehouse). We support [data warehouse imports](/docs/cdp/sources) from numerous sources, including Stripe, MySQL and Postgres databases, Snowflake, Amazon S3, and more. This means you can include all kinds of business event data as primary or seconday metrics in your experiments.
