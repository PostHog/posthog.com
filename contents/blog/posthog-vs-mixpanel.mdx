...
<ProductComparisonTable
    ...
    rows={[
        ...
        {
            path: 'product_analytics.features.correlation_analysis',
...
<ProductComparisonTable
    ...
    rows={[
        {
            path: 'session_replay.features.canvas_recording',
            label: 'Canvas recording',
            description: 'Capture canvas elements in your app',
        },
        {
            path: 'session_replay.features.chat_with_recordings',
            label: 'Chat with your recordings',
        ...
        {
            path: 'session_replay.features.event_timeline',
            label: 'Event timeline',
            description: 'See events triggered during recordings',
        },
        {
            path: 'session_replay.features.iframe_recording',
            label: 'Iframe recording',
            description: 'Record embedded iframes',
        },
        'session_replay.identity.identity_detection',
        {
            path: 'session_replay.features.minimum_duration',
...
<ProductComparisonTable
    ...
    rows={[
        ...
        'feature_flags.advanced.features.early_access_widget',
        {
...
<ProductComparisonTable
    ...
    rows={[
        {
            path: 'experiments.features.ab_testing',
