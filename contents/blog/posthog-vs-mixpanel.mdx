...
- **Mixpanel** charges the same for all events generated by identified users as anonymous users. 
- **PostHog** charges up to 80% less for events generated by anonymous users. 

We do this because they're cheaper to ingest and process than events by identified users, so we pass that cost saving onto our customers – see our [anonymous vs identified events explainer](/docs/data/anonymous-vs-identified-events) for more on this.
...
We recommend tracking your marketing website and product in a single project, and you can track all events on your website anonymously to save hundreds or thousands of dollars every month.
