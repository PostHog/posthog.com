...
I'm sure you've felt like this working with [AI agents](/newsletter/building-ai-agents). Your agent is doing what you ask, it feels like black box magic, and you're too busy adding "AI engineer" to your LinkedIn bio to stop and interrogate _how_ it's doing what you ask.
...
$6.67 USD. That's how much we spend on inference for every Wizard user (according to [AI Observability](/docs/ai-observability).
...
Nepotism and token corruption go hand-in-hand. Subagents [don't share a cache prefix](/newsletter/this-post-will-save-you-tokens#4-learn-what-caching-is-and-why-it-matters) and don't terminate reliably as of today. Many sources claim that subagents can increase efficiency by parallelizing tasks, but the current implementation is just not reliable enough.
