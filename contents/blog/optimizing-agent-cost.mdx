...
Another common way to clear the context is to use [subagent](https://platform.claude.com/docs/en/agent-sdk/subagents). I tried instructing the main agent to run the `conclude` step instructions in its own subagent. This approach also has a few issues.
