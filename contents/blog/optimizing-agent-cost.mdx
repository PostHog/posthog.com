...
The [PostHog Wizard](/docs/ai-platform/ai-wizard) is an AI agent that integrates PostHog into your code base. It understands your business logic, captures high quality data, and correctly configures PostHog products in a single command.
