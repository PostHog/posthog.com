...
- Query traces and ship fixes [from Slack](/slack), your editor ([via MCP](/mcp) or [CLI](/docs/cli)), [PostHog Code](/code), or [PostHog AI](/ai) in the app.
