...
There are also frameworks which can be used to translate information between the two. [NPS scores](/apps/nps-score-collector), for example, are often used to translate a user sentiment into a measurable data point.
