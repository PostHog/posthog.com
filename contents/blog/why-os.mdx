...
-   A reference customer database
    -   I’ve created a single customer record [in code](https://github.com/PostHog/posthog.com/blob/windows-n-such/src/hooks/useCustomers.tsx) that contains: a) which products they use, b) quotes from specific people about individual products c) SVG logos that work in light and dark mode
