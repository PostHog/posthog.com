...
Most onboarding drop-off is friction, not rejection.
</details>
...
- **Product analytics** to build funnels and see where users drop off  
- **Session replay** to understand what users were doing before they left  
