...
<details>
  <summary><strong>👨‍🍳 Chef's tip</strong></summary>
  Export your <a href="/docs/data/cohorts">cohort</a> of dropped-off users — they can be useful for more than just replays. You can use it to target them with win-back marketing campaigns or <a href="/docs/surveys/creating-surveys">surveys</a> later.
</details>
