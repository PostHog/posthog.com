...
---
<details>
<summary><strong>Quick reference checklist</strong></summary>

<h3>Ingredients</h3>
<ul style="list-style: none; padding-left: 0;">
  <li><input type="checkbox" /> Product analytics tool</li>
  <li><input type="checkbox" /> Session replay tool</li>
  <li><input type="checkbox" /> Surveys (optional)</li>
  <li><input type="checkbox" /> Feature flags (optional)</li>
  <li><input type="checkbox" /> Experiments (optional)</li>
</ul>

<h3>Steps</h3>
<ul style="list-style: none; padding-left: 0;">
  <li><input type="checkbox" /> <strong>1.</strong> Define your activation event</li>
  <li><input type="checkbox" /> <strong>2.</strong> Build a 3–5 step funnel</li>
  <li><input type="checkbox" /> <strong>3.</strong> Let data collect for ~1 week</li>
  <li><input type="checkbox" /> <strong>4.</strong> Find the biggest drop-off</li>
  <li><input type="checkbox" /> <strong>5.</strong> Watch 10–15 session replays</li>
  <li><input type="checkbox" /> <strong>6.</strong> Fold in survey data</li>
  <li><input type="checkbox" /> <strong>7.</strong> Form hypothesis, ship one fix</li>
  <li><input type="checkbox" /> <strong>8.</strong> Roll out with feature flags</li>
  <li><input type="checkbox" /> <strong>9.</strong> Measure and iterate</li>
</ul>

<h3>You've nailed it when...</h3>
<ul style="list-style: none; padding-left: 0;">
  <li><input type="checkbox" /> You know your activation event</li>
  <li><input type="checkbox" /> You can see where users drop off</li>
  <li><input type="checkbox" /> You understand why they're dropping off</li>
  <li><input type="checkbox" /> You've shipped a fix</li>
  <li><input type="checkbox" /> You've measured whether it worked</li>
  <li><input type="checkbox" /> You have your next hypothesis ready</li>
</ul>
