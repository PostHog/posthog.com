...
Becoming "technical" in sales, account management, or success doesn't require attending a course or a bootcamp. It requires habits. When a customer asks something technical, try to answer it yourself before forwarding it to an engineer. This isn’t the norm in most customer success roles, because it’s riskier and takes longer, but it’s the habit that turned me into a genuinely technical CSM. That’s the TL;DR, for the long version, keep reading.

## Work on a technical product first

This was the most impactful move I made. If you're coming from a non-technical background, walking straight into a technical CS role is hard, especially from sales. What worked for me was working on a technical product in a non-technical role. This gives you a much better start towards a deeper technical understanding.
...
## A lean team makes you figure it out
...
## AI is a major unlock

So, not exactly a hot take, but important to call out, because 1) it's true and 2) most people are doing it wrong. I'm vibe coding, not hand-writing React, but being willing to vibe code at all already puts you a few steps ahead of most people in this job.
...
## You're a jack of all trades, not a master

People assume technical CSM means you need to be a data whiz, have hand-coded an app in React, and understand distributed systems. You don't. You're a jack of all trades, not a master.
...
1. A solid base
2. The ability to adapt when a customer throws something unfamiliar at you
3. Enough curiosity to keep learning and to care what your customers are doing
