...
2. **It might need human input** – usually because it's [a product decision the agent shouldn't be making on its own](/newsletter/software-factories#what-software-factories-are-missing). Those land in an inbox for you to look at in the morning.
...
That's what we're pointing PostHog at: the data you already collect turning into [shipped code](/desktop).
