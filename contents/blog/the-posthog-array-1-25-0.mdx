...
excerpt: PostHog 1.25.0 is here! Read about our new features, why we're giving 1M events for free to everyone, and find out who are the 6 new team members we've onboarded.
---
...
This features isn't new to all of you, because we've been testing it out with a [feature flag](/docs/tutorials/feature-flags). However, legends for charts in 'Trends' are now enabled for everyone!
