...
There are plenty of [session replay tools](/blog/best-session-replay-tools) out there, but not all of them supports mobile, and those that do vary significantly in depth, platform support, and what they capture alongside replays.
...
[PostHog](/) (that's us 👋) is an all-in-one developer platform built to enable engineers to create better products. It includes [session replays](/session-replay) and a whole bunch more, such as [product analytics](/product-analytics), [LLM analytics](/llm-analytics), [error tracking](/error-tracking), [experiments](/experiments), [feature flags](/feature-flags), and more.
...
**[Microsoft Clarity](/blog/best-microsoft-clarity-alternatives)** xis completely free with no session limits. 
