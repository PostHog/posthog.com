...
Their **Team** plan starts at $199/month for up to 10k sessions and includes most session replay features, but excludes other features such as product analytics and some error tracking features.

Their **Professional** plan starts at $420/month for up to 10k sessions and includes all their features, but requires an annual commitment.
...
<ComparisonTable column1="PostHog">
  <ComparisonRow column1="iOS and Android only" feature="Session replay" description="Watch real users on your mobile apps; discover friction points" />
  <ComparisonRow column1={true} feature="Debug logs" description="View console logs, network logs, performance data" />
  <ComparisonRow column1={true} feature="Filters" description="View specific replays based on user segments, screens visited, events" />
  <ComparisonRow column1={true} feature="Heatmaps" description="See where users tap and interact" />
...
PostHog has [transparent pricing](/pricing?product=session-replay) based on usage. It’s free to get started and completely free for the first 5,000 recordings. After this free monthly allowance, pricing starts at $0.0050/recording (or $50 for 10k recordings), and recordings cost progressively less the more you use. This makes PostHog significantly cheaper than all the other companies on this list (apart from [Microsoft Clarity](#2-microsoft-clarity)).
...
[UXCam](/blog/best-uxcam-alternatives) is a platform built solely for mobile apps. It includes a full-suite of analytics features as well as session replays, heatmaps, and crash analytics.
...
Smartlook's free plan records up to 3k sessions and includes most of their replay features. Their pro plan includes all of their replay features and starts at $69/month for 5k sessions or $99 for 10k sessions. Their pricing becomes progressively cheaper with more monthly sessions.
...
Since Contentsquare caters mostly to enterprise companies, their pricing is not available publicly and you need to speak to their sales team to get a quote. According to [Capterra](https://www.capterra.co.uk/software/161591/contentsquare), pricing starts at $10,000/month, but no further information is given
