...
What’s cooler than having your [own query language](/docs/sql)? Having your own general purpose programming language, of course! That’s literally what we built: PostHog’s first ever programming language, [Hog](/docs/hog). (Earlier versions of this name included Hög and Höge, but turns out we're anti-umlaut.)
