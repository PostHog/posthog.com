...
Heap is mainly focused on product analytics. This means you need to adopt additional tools for things like feature management, experiments, and surveys. This is all built-in to PostHog – we even have a built-in data warehouse that integrates with Stripe and Hubspot. 
...
> 💡 **Good to know:** SOMETHING SOMETHING SOMETHING
