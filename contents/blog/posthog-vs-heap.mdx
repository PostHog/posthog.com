...
Minutes. Just [include the tracking snippet](/docs/integrate?tab=snippet) in your product or website and autocapture starts collecting events immediately. Enable session replays, feature flags, and other features from your project settings. See the guide to [getting started on PostHog Cloud](/docs/getting-started/cloud) for more.
