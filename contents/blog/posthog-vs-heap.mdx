...
Minutes. Use the [onboarding wizard](/docs/ai-engineering/ai-wizard) to connect your app, or just [add the tracking snippet](/docs/getting-started/start-here) directly and autocapture starts collecting events immediately. Enable session replays, feature flags, and other features from your project settings.
