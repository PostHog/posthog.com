...
<ComparisonTable column1="PostHog" column2="Heap">
  <ComparisonRow column1="1 million API requests" column2="b/a" feature="Free usage" description="How much free usage do you get each month?" />
  ...
  <ComparisonRow column1="Bayesian" column2="b/a" feature="Statistics engine" description="How the results of an experiment are calculated" />
</ComparisonTable>
...
We don't currently offer a business associate agreement (BAA) for HIPAA, but it's on our roadmap. [Get in touch](/contact-sales) to register your interest.
