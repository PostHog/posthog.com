...
Could the intro points be:

We're built by engineers for engineers
Engineers choose what to build, iterate with customers, do support
SDKs, APIs, SQL querying, and warehouse
All-in-one
We're transparent
Pricing
No need to hop on a call, self-serve
Open source

## How is PostHog different?

### 1. We're build for engineers
...
- It means we support all popular (and many unpopular) [SDKs](/docs/libraries) for client-side, backend, and mobile tracking.
