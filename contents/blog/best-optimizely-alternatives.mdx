...
<ComparisonTable column1="PostHog" column2="Optimizely">
    ...
    <ComparisonRow
        ...
        description="Deploy features safely with targeting and percentage rollouts"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Visual experiment editor"
        description="Easily create experiments that make changes to your site or app"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        ...
        description="Target flags and A/B tests on segments and non-users"
    />
    <ComparisonRow
        column1={false}
        column2={true}
        feature="Personalization"
        description="Deliver targeted content and products to users"
    />
    <ComparisonRow
        column1={false}
        column2={true}
    ...
    <ComparisonRow
        ...
        description="First-party analytics with custom events, pageviews, and more"
    />
    <ComparisonRow
        column1={true}
        column2={true}
