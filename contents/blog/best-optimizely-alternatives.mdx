...
[PostHog](/) (that's us 👋) is an open-source platform combining A/B testing, feature flags, product analytics, session replay, and user surveys into one product. This means it's not only an alternative to [Optimizely](/blog/posthog-vs-optimizely) but also tools like [Mixpanel](/blog/posthog-vs-mixpanel) and [Hotjar](/blog/posthog-vs-hotjar).

Typical PostHog users are engineers and product managers at startups and mid-size companies, particularly B2B companies. Customers include [AssemblyAI](/customers/assemblyai), [ElevenLabs](/customers/elevenlabs), [Hasura](/customers/hasura), and Airbus.
...
> **Bottom line**
> Being free, self-serve, and sharing many of the same features, PostHog is a great alternative to Optimizely. This is especially true for startups and scale-ups looking for product and data tools rather than enterprise project management ones.
...
> #### Bottom line
> If you're a massive enterprise looking for optimization tools and don't need CMS functionality, VWO is a solid alternative. If you are smaller or product-focused, there are likely less complex and cheaper options.
...
- 🧑‍⚖️ **Governance:** Audit flag changes. Get visibility into flag state across platforms.
...
### How popular is LaunchDarkly?

According to [BuiltWith](https://trends.builtwith.com/analytics/LaunchDarkly), 1,019 of the top 1 million sites use LaunchDarkly. This is nearly 5x less than Optimizely's 5,353 but may undercount mobile and backend usage. 
...
AB Tasty shares many similarities to Optimizely when it comes to digital experience optimization. It misses a little depth, lacking funnel tests and API evaluation. Like many of the other alternatives listed here, it also doesn't include the content or project management tools. 
...
As of January 2024, 2,351 of the top million sites use AB Tasty according to [BuiltWith](https://trends.builtwith.com/analytics/AB-Tasty). This is just under half of Optimizely's 5,353.
...
![Kameleoon](https://res.cloudinary.com/dmukukwp6/image/upload/v1712355573/posthog.com/contents/images/blog/best-optimizely-alternatives/dynamic-yield.png)
...
- 🍽️ **Multi-platform:** Personalize experiences across websites, apps, email, or any other medium with the API.
...
- 🕸️ **Web experimentation:** Use their smart graphic editor and widget library to run flicker-free A/B tests on your website.
...
Kameleoon focuses on experimentation and engineering best practices more than Optimizely, but it still includes the no-code experiment editor that product managers would use. It doesn't include the CMS and project management tools that Optimizely has.
