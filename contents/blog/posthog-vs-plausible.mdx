...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Script size', description: 'Size of the script that runs on your site', customValue: '56.8 kb' },
    ]}
/>
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Free collaboration', description: 'Add unlimited teammates to your project', customValue: false },
        'heatmaps',
        'session_replay',
        'experiments',
        'surveys',
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Warehouse exports', description: 'Export data to warehouses like S3 and BigQuery for storage and analysis', customValue: false },
        { label: 'Data warehouse', description: 'Query customer and product data together', customValue: false },
        'platform.integrations.warehouse_import',
        'platform.integrations.slack',
        'platform.integrations.email_reports',
        { label: 'Google Search Console', description: 'See search queries that sent traffic to your site', customValue: true },
...
<ProductComparisonTable
    competitors={['posthog', 'plausible']}
    rows={[
        { label: 'Data retention', description: 'The length of time event data is retained', customValue: '7 years' },
