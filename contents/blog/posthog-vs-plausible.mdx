...
Beyond PostHog's free tier, we try to be as cheap as possible and transparent. We can do this because we're efficient. We don't splurge on massive sales teams, or D-list comedians to host an annual convention you'll never attend.

Want to know how much we'll charge? See our [pricing calculator](/pricing).

### 2. We're more than just web analytics

Although [web analytics](/web-analytics) is a big part of PostHog, it's just a part of our overall platform. We have many more tools to help you analyze, test, observe, and deploy your site and app.

These include [product analytics](/product-analytics), [session replay](/session-replay), [surveys](/surveys), [A/B testing](/experiments),  [feature flags](/feature-flags), a [data warehouse](/data-warehouse), and more 

### 3. We're multi-platform

Plausible is entirely focused on the web. PostHog has a major focus on the web, but also other platforms like mobile, backend, and [API](/docs/api).
...
Both Plausible and PostHog are [Google Analytics alternatives](/blog/ga4-alternatives). This means a big focus on tracking and analyzing your website. 
...
For more customization, both in capturing data and analyzing it, teams rely on [product analytics](/product-analytics). Although not a focus of Plausible, it does have some product analytics features, but not nearly as many as PostHog's full suite. 

Many of Plausible's product analytics features, like custom properties and [funnels](/docs/product-analytics/funnels), are on their more expensive "Business" plan. 
...
Plausible is a monthly subscription based on usage. Plans start at $9/m for 10k events. Their "Business" plan unlocks more team members, custom properties, funnels, and more for a minimum of $10/m more.
