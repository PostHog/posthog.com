...
For a start, how about [integrating PostHog with Sentry](https://posthog.com/docs/integrate/third-party/sentry) and watching all recordings with an `$exception` event in them?
