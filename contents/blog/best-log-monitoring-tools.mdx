...
**Free to use (managed):** **PostHog** includes 50 GB of logs free every month, **Grafana Cloud** also offers 50 GB free, and **Better Stack** and **Elastic Cloud** both have free tiers. Datadog and Splunk offer trials rather than permanent free tiers.
...
PostHog is the only tool on this list on both lists: open source under MIT *and* 50 GB free on the managed cloud, no credit card required.
