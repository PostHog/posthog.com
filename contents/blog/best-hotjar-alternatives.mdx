...
[PostHog](/) (that's us 👋) is an all-in-one platform for [session replay](/session-replay), [heatmaps](/heatmaps), [product](/product-analytics) and [web analytics](/web-analytics), [feature flags](/feature-flags), [A/B testing](/experiments), [error tracking](/error-tracking), [user surveys](/surveys), and more – everything you need to understand your users. This means it's not just an [alternative to Hotjar](/blog/posthog-vs-hotjar), but also tools like [Mixpanel](/blog/best-mixpanel-alternatives), [Sentry](/blog/best-sentry-alternatives), and [LaunchDarkly](/blog/best-launchdarkly-alternatives).

Typical PostHog users are engineers and product managers at startups, scaleups, and mid-size companies, such as [ElevenLabs](/customers/elevenlabs), Supabase, and Lovable.
