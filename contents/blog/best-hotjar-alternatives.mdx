...
<ComparisonTable column1="PostHog" column2="Hotjar">
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Web session replay"
        description="View real sessions on websites and web apps"
    />
    <ComparisonRow
        column1={true}
        column2={false}
        feature="Mobile session replay"
        description="View real sessions on iOS, Android, React Native, and Flutter apps"
    />
    <ComparisonRow
        column1={'5k/mo'}
        column2={'35/day'}
        feature="Free replays"
    ...
    <ComparisonRow
        ...
        column2={true}
        feature="Rage clicks"
        description="Detect when users click rapidly in the same place"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        ...
        description="Pre-built widgets for NPS, CSAT, and more"
    />
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Web surveys"
        description="Run targeted surveys to gather open-ended feedback"
    />
    <ComparisonRow
        column1={'No Android'}
        column2={false}
        feature="Mobile surveys"
        description="Run surveys and capture feedback on iOS, Android, React Native, and Flutter"
    />
    <ComparisonRow
        column1={true}
        column2={false}
    ...
    <ComparisonRow
        ...
        description="Control feature access and phase rollouts"
    />
    <ComparisonRow
        column1={true}
        column2={false}
