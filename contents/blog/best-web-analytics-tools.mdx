...
Every pageview can be tied to events, users, recordings, flag variants, errors, and more. You can see which channels bring high-value users, combine analytics and replays to understand drop-offs, and run experiments to optimize conversion – all without switching tools.

The web analytics dashboard also includes [real-time activity](/docs/web-analytics/dashboard), [conversion goals](/docs/web-analytics/conversion-goals), and the flexibility to open any chart as a [product analytics insight](/docs/product-analytics/insights) or query it directly with [SQL](/docs/data-warehouse/sql).
