...
<ProductComparisonTable
    ...
    rows={[
        ...
        {
            label: 'Reverse proxy available',
            description: 'Send events from your own domain to capture more data',
            values: ['', ''],
        },
        { label: 'Cross-domain tracking', description: 'Track users across domains and sub-domains', values: ['', ''] },
