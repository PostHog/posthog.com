...
* **Completed an event frequently:** Find your power users. For example, "Give me users who bought an item in 5 out of the last 7 weeks".
...
Within data management, a new dedicated detail page exists for all events and properties. These pages allow you to dig into the details. For example, on the event page, you can now see:
...
Loading insights and recordings just got a little bit faster. We realized that some data payloads were quite big, which resulted in the network slowing things down. To improve this, we added compression to a few of the endpoints in the app, and now see at least 50% smaller responses sent to clients.  
