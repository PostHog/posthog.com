...
Loading insights and recordings just got a little bit faster. We realized that some data payloads were quite big. As a result, the network was slowing things down. To improve this, we added compression to a few of the endpoints in the app. 
...
-   **Fixed**: PostHog-js was logging an unnecesary warning [#10375](https://github.com/PostHog/posthog/pull/10375)
