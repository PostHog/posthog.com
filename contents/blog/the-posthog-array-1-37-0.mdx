...
On the live events page, you can now save the custom event columns that you want to see. The columns selected can be saved at the team level, so your colleagues can benefit too.
