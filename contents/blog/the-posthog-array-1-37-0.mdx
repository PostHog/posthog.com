...
<b>IMPORTANT!</b> This version will not run until async migration `0004_replicated_schema` is completed. Before upgrading, please make sure this migration is completed. Check out the <a href="/docs/self-host/configure/async-migrations/overview" target="_blank">async migrations</a> docs for details.
</blockquote>
