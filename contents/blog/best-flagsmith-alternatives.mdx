...
<ComparisonTable column1="PostHog" column2="Flagsmith">
    ...
    <ComparisonRow
        ...
        description="Use local, cached flag values to increase speed"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        ...
        description="Easily change feature properties without deploying new code."
    />
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Scheduling"
        description="Schedule flag updates and rollouts"
    />
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Cohorts"
        description="Gradually release features to specific groups"
    />
    <ComparisonRow
        column1={true}
        column2="Requires 3rd-party analytics"
...
<ComparisonTable column1="Unleash" column2="Flagsmith">
    ...
    />
    <ComparisonRow
        column1="Requires 3rd-party analytics"
        column2="Requires 3rd-party analytics"
        feature="Multivariate (A/B/n) testing"
        description="Test multiple variants of a change"
    />
