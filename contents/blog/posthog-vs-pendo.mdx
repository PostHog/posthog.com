...
<ComparisonTable column1="PostHog" column2="Pendo">
  ...
  <ComparisonRow column1={true} column2={true} feature="Session replays" description="Watch real users use your product; diagnose bugs" />
...
### Can I migrate from Pendo?

Yes. See our [Pendo to PostHog migration guide](/docs/migrate/pendo) for more.