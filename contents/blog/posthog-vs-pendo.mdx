...
<ComparisonTable column1="Pendo" column2="PostHog">
  ...
  <ComparisonRow column1={false} column2={true} feature="SQL access" description="Write your own queries in SQL" />
</ComparisonTable>
...
<ComparisonTable column1="Pendo" column2="PostHog">
  ...
  <ComparisonRow column1={false} column2={true} feature="Shopify" description="Sync customer and order data" />
...
<ComparisonTable column1="Pendo" column2="PostHog">
  ...
  <ComparisonRow column1={false} column2={true} feature="Combined events (actions)" description="Track related events as a single trackable action or behavior" />
