...
<ProductComparisonTable
    ...
    rows={[
        ...
        'feature_flags',
        'experiments',
        { label: 'In-app prompts and messages', description: 'Send messages to users in your app', customValue: true },
        { label: 'Apps/integrations', description: 'Push and pull data to other destinations', customValue: true },
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'UTM tracking', description: 'Track marketing campaigns with UTM tags', customValue: true },
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Airbyte', description: 'Extract and load data to external platforms', customValue: true },
    ]}
/>
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Shopify', description: 'Sync customer and order data', customValue: false },
        'platform.integrations.stripe',
        'platform.integrations.slack',
        { label: 'Discord', description: 'Receive notifications about new data', customValue: false },
...
<ProductComparisonTable
    competitors={['posthog', 'pendo']}
    rows={[
        { label: 'Event tracking', description: 'Track manually instrumented events', customValue: true },
        { label: 'Autocapture', description: 'Automatically track events without instrumentation', customValue: true },
        { label: 'Combined events (actions)', description: 'Track related events as a single trackable action or behavior', customValue: false },
        { label: 'Send events from your own domain', description: 'Ensure ad blockers don\'t block data capture', customValue: true },
        { label: 'Cross-domain tracking', description: 'Track users across domains and subdomains', customValue: true },
        { label: 'Server-side tracking', description: 'Send events from your server', customValue: true },
        { label: 'Capture API', description: 'Send events through an API', customValue: true },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'pendo']}
    rows={[
        { label: 'JavaScript', customValue: true },
        { label: 'React Native', customValue: true },
        { label: 'React', customValue: true },
        { label: 'Flutter', customValue: true },
        { label: 'iOS', customValue: true },
        { label: 'Android', customValue: true },
        { label: 'Ruby', customValue: false },
    ]}
/>
