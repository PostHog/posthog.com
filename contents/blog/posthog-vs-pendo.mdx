...
We built PostHog to support technically-savvy product managers and engineers — especially [engineers with a product focus in their role](/product-engineer-handbook/what-is-a-product-engineer). As such, PostHog includes many powerful features that aren’t available in tools like Pendo, which are built for more general audiences.
