...
<ProductComparisonTable
    ...
    rows={[
        ...
        'feature_flags',
        'experiments',
        { label: 'In-app prompts and messages', description: 'Send messages to users in your app', values: ['', ''] },
        { label: 'Apps/integrations', description: 'Push and pull data to other destinations', values: ['', ''] },
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'UTM tracking', description: 'Track marketing campaigns with UTM tags', values: ['', ''] },
...
<h4 className="mb-4">
    Discover what's possible with <span className="text-blue">PostHog apps</span>
</h4>
<TutorialsSlider
    slugs={[
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Airbyte', description: 'Extract and load data to external platforms', values: ['', ''] },
    ]}
/>
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Shopify', description: 'Sync customer and order data', values: ['', ''] },
        'platform.integrations.stripe',
        'platform.integrations.slack',
        { label: 'Discord', description: 'Receive notifications about new data', values: ['', ''] },
...
<ProductComparisonTable
    competitors={['posthog', 'pendo']}
    rows={[
        { label: 'Event tracking', description: 'Track manually instrumented events', values: ['', ''] },
        { label: 'Autocapture', description: 'Automatically track events without instrumentation', values: ['', ''] },
        {
            label: 'Combined events (actions)',
            description: 'Track related events as a single trackable action or behavior',
            values: ['', ''],
        },
        {
            label: 'Send events from your own domain',
            description: "Ensure ad blockers don't block data capture",
            values: ['', ''],
        },
        { label: 'Cross-domain tracking', description: 'Track users across domains and subdomains', values: ['', ''] },
        { label: 'Server-side tracking', description: 'Send events from your server', values: ['', ''] },
        { label: 'Capture API', description: 'Send events through an API', values: ['', ''] },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'pendo']}
    rows={[
        { label: 'JavaScript', values: ['', ''] },
        { label: 'React Native', values: ['', ''] },
        { label: 'React', values: ['', ''] },
        { label: 'Flutter', values: ['', ''] },
        { label: 'iOS', values: ['', ''] },
        { label: 'Android', values: ['', ''] },
        { label: 'Ruby', values: ['', ''] },
    ]}
/>
