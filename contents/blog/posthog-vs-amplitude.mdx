...
- **Free tier:** PostHog offers 1M events, 5,000 replays, 1,500 survey responses free; Amplitude offers 10K MTUs (2M events), 1,000 replays, and 1 survey
...
It depends on your usage pattern. PostHog uses usage-based pricing where you pay per event, replay, or survey response, with generous free tiers (1M events, 5,000 replays, 1,500 survey responses monthly). Amplitude charges per Monthly Tracked User (MTU) with 10K MTUs (2M events) free. PostHog's pricing is fully transparent and published publicly; Amplitude's Growth and Enterprise pricing requires contacting sales.
