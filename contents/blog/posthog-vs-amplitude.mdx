...
-   [LLM observability](/docs/llm-analytics) for gathering data on AI and LLM product usage and performance
...
No. Amplitude does not offer LLM observability or analytics. PostHog includes [LLM observability](/docs/llm-analytics) for tracking AI product usage, monitoring model performance, and analyzing costs—all connected to your existing user data.
