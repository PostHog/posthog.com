...
<ProductComparisonTable
    ...
    rows={[
        ...
        'product_analytics.insights.sql_mode',
        //'dashboards.available',
        'dashboards',
        'dashboards.features',
        'dashboards.features.annotations',
        'product_analytics.summary',
        // Insights
        'product_analytics.insights',
        // Specific insight capabilities
        'product_analytics.insights.formula_mode',
        // Funnels
        'product_analytics.funnels',
        // Paths
        'product_analytics.paths',
        // Dashboards
        // Web analytics (product-level)
        'web_analytics.summary',
    ]}
/>
