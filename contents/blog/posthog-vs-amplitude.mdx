...
The main exception is warehouse-native analytics: Amplitude can run queries directly on your data warehouse (Snowflake, BigQuery), while we mostly sync data into PostHog and run queries there. Find out more about ([how we do warehouse-native](/warehouse-native) in the docs).
