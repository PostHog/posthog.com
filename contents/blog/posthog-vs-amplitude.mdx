...
### 3. Transparent and low prices, generous free tiers
...
In 2024, we [cut prices for session [replay]](/blog/session-replay-pricing) and [analytics events](/blog/analytics-pricing). In 2025, we've [cut prices for data pipelines surveys](/blog/data-pipeline-pricing) and surveys. If we can cut pass a saving onto our customers, we always will. 
...
The rest of this page includes detailed feature comparisons between PostHog and Amplitude for things like [product analytics](#product-analytics), [session replay](#session-replay), and more, but here's a quick summary: 
