...
- Want an [all-in-one platform](/products) built for engineers, with [product analytics](/product-analytics), [web analytics](/web-analytics), [error tracking](/error-tracking), [LLM observability](/llm-analytics), [surveys](/surveys), and more, with transparent usage-based [pricing](/pricing)? Go with **PostHog**.
...
- **Free tier:** PostHog offers 1M events, 5,000 replays, 1,500 survey responses free; Amplitude offers 2M events, 1,000 replays, and 1 survey
