...
But, deep down, Amplitude is an analytics tool with some extra bits grafted on. In contrast, PostHog is built from the ground up as an all-in-one platform for building successful products. Here's how they compare.
...
- It means they do support – all product teams have a [weekly support hero](/handbook/engineering/support-hero).
...
- It means start using PostHog without ever jumping on a quick call – see [how we do sales](/sales).
