...
**Amplitude** if you need queries to run directly on your Snowflake/BigQuery. **PostHog** is a better solution if you're using our integrated data warehouse or want to avoid [warehouse-native workflows](/warehouse-native).
