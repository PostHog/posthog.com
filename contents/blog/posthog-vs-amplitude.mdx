...
The main exception is warehouse-native analytics: Amplitude can run queries directly on your data warehouse (Snowflake, BigQuery), while PostHog offers an integrated data warehouse approach. If you use PostHog as your warehouse, data stays in PostHog and is accessible across many PostHog tools. If you use an external warehouse, you can sync tables and fields from Snowflake/BigQuery into PostHog via our CDP; queries then run on PostHog compute.
