...
**Amplitude charges based on event volume**. Its free plan includes 2 million events per month, and paid plans scale with the number of events you send, with higher tiers unlocking more advanced analytics, experimentation, and enterprise features.
