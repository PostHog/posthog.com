...
1. Not all free tiers are created equal. PostHog includes 1M events, 5,000 session recordings, and 1,500 surveys each month. Amplitude's Starter plan covers 10k tracked users (which can work out to more total events, depending on usage), but only up to 1,000 recordings and no free surveys.  
