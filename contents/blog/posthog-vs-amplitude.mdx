...
This means engineers make product decisions. It means they do support – all product teams have a [weekly support hero](/handbook/engineering/support-hero) dedicated to solving user issues. It means [we ship fast](/changelog) and iterate based on user feedback. It means we work in the open – [our roadmap](/roadmap) is public, as is [our company handbook](/handbook). It means our pricing is 100% transparent. It means you can sign up and start using PostHog without ever jumping on a quick call – see [how we do sales](/sales).
