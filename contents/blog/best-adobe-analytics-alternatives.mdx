...
> 💡 **Good to know:** 
> - Matomo's session replay, heatmaps, and A/B testing are all paid add-ons costing hundreds of dollars monthly.
> - Although Matomo offers a script install, it's not simple. It's 12 lines long with several confusing configuration options. 
