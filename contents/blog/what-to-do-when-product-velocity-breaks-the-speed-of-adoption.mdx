...
Slowing down is what companies do when they run out of ideas (and clearly that's the not problem). Fortunately, the Theory of Constraints is quite explicit about what _not_ to do here:
...
So the real question is:  how do you elevate adoption without killing velocity? (and without [losing your edge](/newsletter/how-startups-lose-their-edge)).

That means that the real question isn’t whether to slow down. It’s this:
...
- Marketing on the same exhausted channels as everyone else (https://andrewchen.substack.com/p/every-marketing-channel-sucks-right)
...
- Existing users with [feature fatigue](https://www.linkedin.com/pulse/feature-fatigue-love-focus-derek-francis-mezxc/), and new users with release whiplash 
...
### Instead
- Publish deep thinking, [learnings](/8-learnings-from-1-year-of-agents-posthog-ai), works-in-progress, and durable mental models that are useful with, or without your product
- Give space for all seniority levels and roles to [author content](/blog) that matters to them
- Publish uncomfortable things like [postmortems](/blog/nov-24-shai-hulud-attack-post-mortem) for incidents 
- Turn internal knowledge into [public artifacts](/handbook)
- Be a good citizen, create space for [others to thrive](/handbook/people/hogpatch), help developers (or whichever community you market to) without asking for anything in return
...
- Turn internal knowledge into [public artifacts](/handbook) and give space for all every role to author content that matters to them
