...
A huge mistake startups make is using titles to establish and reinforce hierarchy. This is dangerous for three reasons:
...
2. In the beginning, most startups face the default route of financial death - especially if you're bootstrapping. As such, it's a lot more important to _prevent_ and _fix_ issues quickly, no matter who's in charge of that specific problem. Companies that insist on rigidly-defined roles, titles, and hierarchies often put themselves at risk of performance and profit leaks from their product or personnel.

3. Titles can make it harder to [give and receive feedback](https://posthog.com/handbook/people/feedback) in a hierarchy even though feedback - from both colleagues and customers - is crucial to a fledgling company with high growth ambitions.

At PostHog, we started off completely flat, with everyone reporting to James or Tim - and everyone getting individual contributor titles such as “Software Engineer” or “Designer.” If we’d had “Senior Engineer” and “Junior Engineer” titles, for example, that would've indicated that we care about hierarchy, thus discouraging peer-to-peer feedback and capping individual performance at the level of whoever was designated as 'Senior.'

But we hit a snag.

When we initially found product market fit, we had to step up our game in certain areas. This meant being more thoughtful about the product, design, and user experience - tasks that demanded creativity and which were easier through collaboration.

We also found that we were struggling to develop people’s skills properly with too many direct reports. Towards the end of 2020, we were shipping lots of code but nothing moved the needle for our growth.
...
Ex-founders or early employees make for brilliant generalists. They’re less likely to be as deeply skilled in any given area, but if you need a quick uplift in a certain area, they’ll get you there faster and more flexibly. As your company grows and your requirements change, you can specialize your roles and titles. For example, as of writing, we're hiring for a Technical Blogger and Developer Educator to bolster our content and developer relations efforts. (Check out our [Career](https://posthog.com/careers) page for more open roles.)
...
On the design side, it involves thinking about how the company and our business model should work - including our [product](https://posthog.com/handbook/strategy/roadmap), financing, [deployment](https://posthog.com/docs/self-host), [team structure](https://posthog.com/handbook/people/team-structure/team-structure), and [pricing](https://posthog.com/pricing) strategies.

Lastly, many people focus on being a manager, but that’s an output. It's better to focus on being brilliant at your job and developing your skills over time. Get more opinionated and connect your work to the company’s overall strategy, and management will happen to you if you want it.
