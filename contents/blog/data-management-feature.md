...
The Data Management (pictured below) is the hub for Events, Event Properties and Actions in PostHog - a one stop shop for viewing, editing and managing all the data coming into your instance. 
