...
If you're an existing customer, nothing is breaking tomorrow, and Mintlify has said it will support migrations. But if you're evaluating tools for a new project, Helicone is no longer on the menu – you can't create an account. 

And even for current users, "no new features, ever" is a significant limitation in a space that reinvents itself every six months. Agent tracing, evals, OTel support: whatever the next must-have is, Helicone won't have it.
