...
Nothing is breaking tomorrow, but "no new features, ever" is a significant limitation. The [AI observability](/ai-observability) space is still maturing. Tools and best practices are being reinvented every six months. Whether the next must-have is agent tracing, evals, OTel support or something else, Helicone won't have it.
