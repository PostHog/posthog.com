...
While nothing is “wrong” with our product's UI, we also know the user experience hasn't won any awards. It gets the job done, but it hasn't been particulary delightful.
...
This is a given, and will happen soon! (For now, check out the command pallete with `Cmd` + `Shift` + `K`!)
