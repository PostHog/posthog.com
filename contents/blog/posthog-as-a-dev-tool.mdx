...
rootpage: /blog
featuredImage: >-
  https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/blog/posthog-as-a-dev-tool/preview-3000.jpg
...
While nothing is “wrong” with our product's UI, we also know the user experience hasn't won any awards. It gets the job done, but it hasn't been particularly delightful.

But our ICP ([ideal customer profile](/newsletter/ideal-customer-profile-framework)) is _product engineers,_ an audience with a high expectation for quality, and for generalist tools that “just work” the way they expect them to.

This means a shift in our design approach: **PostHog should feel less like a generic SaaS app and more like a dev tool.** (I’m using the term “dev tool” to include any product built with power users in mind, not just tools where users write code.)

## SaaS app vs. dev tool

So what’s the difference between a SaaS app and a dev tool? In large part, it's  the experience.

| Typical SaaS app 	| Dev tool 	|
|---	|---	|
| White space 	| Data density 	|
...
Dev tools are also flexible in how users can accomplish a task, allowing different workflows rather than forcing users into a single path. Interfaces become less about fluff, more about getting out of the way. Power users are a lot faster and more efficient in a dev tool. 
...
In essence, we want PostHog to release as much dopamine as these other tools.
...
It’s the first set of visual changes in [a broader experience roadmap](/roadmap) that will take us a year (or more?) to fully realize. When you get access to PostHog 3000 over the next month, here’s what you’ll notice:
...
![PostHog 3000 in dark mode](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-as-a-dev-tool/dark-mode.png)
...
Excitingly, the buttons now match the website! (They're really fun to click on – don't take our word for it.) This was tricky to do, as buttons serve different purposes between a website and a product, but I'm very happy with the results.
...
![PostHog 3000 nav menu](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-as-a-dev-tool/nav.png)

</div>

The nav menu has now been organized into two main sections: **project & data** and **products**.

**Project & data** includes your dashboards and notebooks, along with the data you've sent to PostHog (like events, people, and properties), and metadata you've added on top (like actions, cohorts, and annotations) – and a live feed of incoming events.
...
![PostHog 3000 side panel](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-as-a-dev-tool/side-panel.gif)
...
![Command palette](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-as-a-dev-tool/command-bar.png)

### 2. Data exploration/synthesis

[Notebooks](/docs/notebooks) lets you drag almost anything from the main workspace into a Notion-like document. You can add multiple types of insights or learnings, along with commentary, then share it with your team.
...
![Notebooks in side panel](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-as-a-dev-tool/notebooks-sidebar.gif)
...
![Toolbar](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-as-a-dev-tool/toolbar.jpg)

#### Search

Search is being drastically improved. We may soon have insight previews within search results.

You can `Tab` between result categories.

![Search 3000](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-as-a-dev-tool/search-3000.jpg)

## Our UX roadmap

PostHog 3000 is far from complete. You might find a few things in the UI that don't feel quite perfect... and that's because we're not done yet!
...
![Taxonomy filters](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-as-a-dev-tool/filters.png)
...
![Query pane](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-as-a-dev-tool/query-pane.gif)
...
![Query pane](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-as-a-dev-tool/explorer.gif)
...
![PostHog 3000](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-as-a-dev-tool/3000-ui.png)
...
- **Info:** Metadata like the event name, description, and tags appear here. The same concept would be used in insights as well.
