...
tags:
    - Comparisons
seo: { metaDescription: 'Comparing session replay tools that support iOS, Android, React Native, and Flutter SDKs.' }
---
...
<ComparisonTable column1="LogRocket">
    <ComparisonRow
        column1="Android, iOS, React Native"
    ...
    <ComparisonRow
        column1={true}
        feature="Filters"
        description="View specific replays based on user segments, screens visited, events"
    />
...
<ComparisonTable column1="UXCam">
    <ComparisonRow
        column1="Android, iOS, React Native, Flutter"
        feature="Supported platforms"
        description="Mobile platforms where session replay is available"
    />
    <ComparisonRow column1={true} feature="Debug logs" description="View console logs, network logs" />
