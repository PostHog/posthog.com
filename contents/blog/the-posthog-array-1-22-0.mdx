...
Our latest release is marked by significant improvements to our core insights, as well as the typical squashing of hundreds of bugs and the multitude of performance improvements.

Here's the TL;DR:

- **New:** Support for bar charts by value
- **New:** UTM tags now get automatically set as use properties
- **New:** Equality filters now allow the selection of multiple values
- **New:** Two more plugins!
...
Our special shoutout this week goes to [oshura3](https://github.com/oshura3), who helped us with a [thorough review of the content on our website](https://github.com/PostHog/posthog.com/pull/1045), correcting typos and standardizing our writing!
...
- Make PLUGIN\_SERVER\_INGESTION True by default [\#3485](https://github.com/PostHog/posthog/pull/3485) ([Twixes](https://github.com/Twixes))
...
- Fix "passowrd" on invite page [\#3473](https://github.com/PostHog/posthog/pull/3473) ([Twixes](https://github.com/Twixes))
...
- Fix find\_key\_with\_source \(2231571657\) [\#3429](https://github.com/PostHog/posthog/pull/3429) ([paolodamico](https://github.com/paolodamico))
...
- Support POSTHOG\_REDIS\_\* vars in bin/plugin-server [\#3426](https://github.com/PostHog/posthog/pull/3426) ([Twixes](https://github.com/Twixes))
...
- Add some missing team\_id filters [\#3372](https://github.com/PostHog/posthog/pull/3372) ([macobo](https://github.com/macobo))
