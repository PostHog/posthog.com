...
<h3><strong className="text-red dark:text-yellow">1. Identified events</strong> <em class="text-sm font-normal text-primary/75 dark:text-primary-dark/75">- previously the only event type</em></h3>
