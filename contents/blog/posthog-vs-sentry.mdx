...
<ProductComparisonTable
    ...
    rows={[
        ...
        'product_analytics',
        'web_analytics',
        { label: 'LLM analytics', description: 'Monitor and debug your LLM-powered features', values: ['', ''] },
        'feature_flags',
        'experiments',
        'heatmaps',
    ]}
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Alerting', description: 'Alert when types of events happen', values: ['', ''] },
        'platform.developer.sdks',
        { label: 'Free team members', description: 'Invite your team to your project for free', values: ['', ''] },
    ]}
/>
    ...
    rows={[
        {
            ...
            description: 'Capture errors and exceptions including stack traces',
            values: ['', ''],
        },
        { label: 'Free errors', description: 'Free errors you can capture per month', values: ['100k', '5k'] },
        { label: 'Issue management', description: 'Monitor and manage issues', values: ['', ''] },
        { label: 'Code context', description: 'See the code related to the issue', values: ['', ''] },
        { label: 'Tracing', description: 'Track the path of a request across your system', values: ['', ''] },
        { label: 'Profiling', description: 'Monitor and visualize code performance', values: ['', ''] },
        { label: 'Network performance', description: 'Track network performance of sessions', values: ['', ''] },
        { label: 'Cron monitoring', description: 'Track scheduled job health', values: ['', ''] },
        {
            label: 'Release tracking',
            description: 'Track the performance of each release of your software',
            values: ['', ''],
        },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'sentry']}
    rows={[
        { label: 'Web', description: 'Record sessions from web apps', values: ['', ''] },
        { label: 'iOS', description: 'Record sessions from iOS apps', values: ['', ''] },
        { label: 'Android', description: 'Record sessions from Android apps', values: ['', ''] },
        { label: 'React Native', description: 'Record sessions from React Native apps', values: ['', ''] },
        { label: 'Flutter', description: 'Record sessions from Flutter apps', values: ['', ''] },
        { label: 'Sampling', description: 'Choose what sessions you record', values: ['', ''] },
        { label: 'Privacy', description: 'Censor private or personal information', values: ['', ''] },
        { label: 'Console', description: 'Capture console logs, errors', values: ['', ''] },
        { label: 'Canvas', description: 'Record canvas elements', values: ['', ''] },
        { label: 'Free allowance', description: 'Free replays per month', values: ['5,000', '50'] },
        { label: '50k replays cost', description: 'Cost per month of 50,000 replays', values: ['173', ''] },
        { label: '100k replays cost', description: 'Cost per month of 100,000 replays', values: ['$273', ''] },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'sentry']}
    rows={[
        { label: 'Text input', description: 'Capture what users want to tell you', values: ['', ''] },
        { label: 'Rating and selects', description: 'Let users pick preset options', values: ['', ''] },
        { label: 'Multi-part surveys', description: 'Ask multiple questions', values: ['', ''] },
        { label: 'Templates', description: 'For NPS, CSAT, interviews, and more', values: ['', ''] },
        { label: 'Triggers', description: 'Trigger surveys on events and actions', values: ['', ''] },
        { label: 'User targeting', description: 'Target specific users or cohorts', values: ['', ''] },
        { label: 'API', description: 'Implement your own UI', values: ['', ''] },
        { label: 'Customization', description: 'Color, position, branding, delay', values: ['', ''] },
        { label: 'Free allowance', description: 'Free responses per month', values: ['1,500', ''] },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'sentry']}
    rows={[
        { label: 'Audit logs', description: 'Manage and view edits and related users', values: ['', ''] },
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Postgres', description: 'Sync and query data from your database', values: ['', ''] },
        { label: 'Stripe', description: 'Sync and query data from Stripe', values: ['', ''] },
        { label: 'Zendesk', description: 'Sync and query data from Zendesk', values: ['', ''] },
        { label: 'Hubspot', description: 'Sync and query data from Hubspot', values: ['', ''] },
        {
