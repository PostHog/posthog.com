...
<ProductComparisonTable
    ...
    rows={[
        'error_tracking',
        { label: 'Performance monitoring', description: 'Trace requests or queries and profile functions', customValue: 'Partial' },
        'session_replay',
        'surveys',
        'product_analytics',
        'web_analytics',
        { label: 'LLM analytics', description: 'Monitor and debug your LLM-powered features', customValue: false },
        'feature_flags',
        'experiments',
        'heatmaps',
    ]}
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Alerting', description: 'Alert when types of events happen', customValue: true },
        'platform.developer.sdks',
        { label: 'Free team members', description: 'Invite your team to your project for free', customValue: false },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'sentry']}
    rows={[
        { label: 'Exception capture', description: 'Capture errors and exceptions including stack traces', customValue: true },
        { label: 'Free errors', description: 'Free errors you can capture per month', customValue: '100k' },
        { label: 'Issue management', description: 'Monitor and manage issues', customValue: true },
        { label: 'Code context', description: 'See the code related to the issue', customValue: true },
        { label: 'Tracing', description: 'Track the path of a request across your system', customValue: false },
        { label: 'Profiling', description: 'Monitor and visualize code performance', customValue: false },
        { label: 'Network performance', description: 'Track network performance of sessions', customValue: true },
        { label: 'Cron monitoring', description: 'Track scheduled job health', customValue: false },
        { label: 'Release tracking', description: 'Track the performance of each release of your software', customValue: false },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'sentry']}
    rows={[
        { label: 'Web', description: 'Record sessions from web apps', customValue: true },
        { label: 'iOS', description: 'Record sessions from iOS apps', customValue: true },
        { label: 'Android', description: 'Record sessions from Android apps', customValue: true },
        { label: 'React Native', description: 'Record sessions from React Native apps', customValue: true },
        { label: 'Flutter', description: 'Record sessions from Flutter apps', customValue: true },
        { label: 'Sampling', description: 'Choose what sessions you record', customValue: true },
        { label: 'Privacy', description: 'Censor private or personal information', customValue: true },
        { label: 'Console', description: 'Capture console logs, errors', customValue: true },
        { label: 'Canvas', description: 'Record canvas elements', customValue: true },
        { label: 'Free allowance', description: 'Free replays per month', customValue: '5,000' },
        { label: '50k replays cost', description: 'Cost per month of 50,000 replays', customValue: '$173' },
        { label: '100k replays cost', description: 'Cost per month of 100,000 replays', customValue: '$273' },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'sentry']}
    rows={[
        { label: 'Text input', description: 'Capture what users want to tell you', customValue: true },
        { label: 'Rating and selects', description: 'Let users pick preset options', customValue: false },
        { label: 'Multi-part surveys', description: 'Ask multiple questions', customValue: false },
        { label: 'Templates', description: 'For NPS, CSAT, interviews, and more', customValue: false },
        { label: 'Triggers', description: 'Trigger surveys on events and actions', customValue: false },
        { label: 'User targeting', description: 'Target specific users or cohorts', customValue: false },
        { label: 'API', description: 'Implement your own UI', customValue: true },
        { label: 'Customization', description: 'Color, position, branding, delay', customValue: false },
        { label: 'Free allowance', description: 'Free responses per month', customValue: '1500' },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'sentry']}
    rows={[
        { label: 'Audit logs', description: 'Manage and view edits and related users', customValue: true },
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Postgres', description: 'Sync and query data from your database', customValue: false },
        { label: 'Stripe', description: 'Sync and query data from Stripe', customValue: false },
        { label: 'Zendesk', description: 'Sync and query data from Zendesk', customValue: false },
        { label: 'Hubspot', description: 'Sync and query data from Hubspot', customValue: false },
        { label: 'Project management', description: 'Add issues to tools like Jira, Linear, and GitHub', customValue: true },
    ]}
/>
