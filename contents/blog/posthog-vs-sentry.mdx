...
Error and performance monitoring is the main focus of Sentry. PostHog has a full error tracking product as well as [network performance recording](/docs/session-replay/network-recording), [distributed tracing](/tracing) (in beta), and [metrics](/docs/metrics) (in alpha), though Sentry's tracing and monitoring features are more mature.
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Free allowance', description: 'Free recordings per month', values: ['5,000 web + 2,500 mobile', '50'] },
...
Many tools like **Sentry** offer both. **PostHog** has both too – error tracking next to [distributed tracing](/tracing) (beta) and [metrics](/docs/metrics) (alpha) – and adds the product analytics context that shows you who the slowdown affected.
