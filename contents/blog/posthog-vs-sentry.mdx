...
Given PostHog already tracks context about your users, it is possible to understand the impact of exceptions more accurately. For example, you can filter issues affecting VIP user cohorts or find those affecting the most amount of sessions.
