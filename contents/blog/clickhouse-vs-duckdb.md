...
![DuckDB query interface](https://res.cloudinary.com/dmukukwp6/image/upload/Duck_DB_q_788d1a16d7.png)
...
![ClickHouse horizontal scaling diagram](https://res.cloudinary.com/dmukukwp6/image/upload/Click_House_903586b66d.png)
...
![DuckDB single-node scaling diagram](https://res.cloudinary.com/dmukukwp6/image/upload/image_7ba45d685f.png)
...
PostHog uses three databases. For PostHog's application state, we use Postgres in all of the ways you'd expect. In fact, at our start, we exclusively used Postgres until [our analytical queries were frying it alive](/blog/clickhouse-vs-postgres). We then added ClickHouse, a real-time analytical engine that powers our funnels, trends, retention, and paths over billions of events.
...
![Duckgres connection diagram](https://res.cloudinary.com/dmukukwp6/image/upload/Duckgres_connect_b7694cb18a.png)
