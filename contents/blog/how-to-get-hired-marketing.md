---
title: How to get hired to PostHog's marketing teams
date: 2026-07-30
author:
  - joe-martin
rootPage: /blog
...
> **What good looks like:** Hiring our first event marketer, we spoke to dozens of candidates whose strategy was essentially just "do hackathons". <TeamMember name="Daniel Zaltsman" showOnlyFirstName photo /> said PostHog is "a 1 to N tool, not a 0 to 1 tool" and that hackathons were a bad idea. He then created an event strategy so unique that PostHog engineers actually _want_ to host events without being asked – and so successful it led to a whole new events team.
...
Let's say you tick all these boxes. How do you make sure you communicate that and get an interview?

The conventional wisdom on LinkedIn seems to be that you should message the hiring manager directly and ask for 10 minutes to "just chat about the role".

That is a bad idea and it often actively works against you. It's ok to reach out if you have a specific question about the role, but as a hiring manager, I want to follow our existing hiring process. It isn't fair to other candidates and, in my experience, it's often the lowest-effort candidates that ask for it anyway.

This is not what most people want to hear, but these are the things that actually work and help you stand out...

**Get a referral.** If you know someone here, ask whether they'd refer you. They get a bonus if you're hired and you turn up with someone's name behind you. It's a win-win and can lead to us fast-tracking candidates at times.

**Write a cover letter.** Yes, they can be tiresome to write, but real humans do read them. Our own application form says a couple of sentences will put you ahead of 90% of applicants, and it isn't exaggerating. Casual is fine. Short is fine. Telling us a story is fine. AI generating one is not.
...
- [Finding a job as a product engineer](/newsletter/finding-a-job-product-engineer)
