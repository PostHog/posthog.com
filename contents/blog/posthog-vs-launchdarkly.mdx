...
PostHog is built for startups and their engineers. The people who find it most useful are founders, [product engineers](/product-engineer-handbook/what-is-a-product-engineer), and growth engineers. Companies that use PostHog feature flags and experiments include [Y Combinator](/customers/ycombinator), [ElevenLabs](/customers/elevenlabs), and [ResearchGate](/customers/researchgate).
