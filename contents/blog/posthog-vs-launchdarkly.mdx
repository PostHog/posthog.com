...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Self-service', description: 'No need to talk to sales', values: ['', ''] },
        'platform.developer.sdks',
        'platform.developer.proxies',
        'platform.developer.api',
        'platform.developer.local_evaluation',
        { label: 'Bootstrapping', description: 'Flags available on frontend application load', values: ['', ''] },
        'platform.developer.sql',
        'session_replay',
        'surveys',
        'cdp',
        'data_warehouse',
        { label: 'Notebooks', description: 'Ad-hoc analysis and collaboration', values: ['', ''] },
        { label: 'Dark mode', description: 'Choose between light and dark UI', values: ['', ''] },
    ]}
/>
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Lifecycle management', description: 'Display new and old flags', values: ['', ''] },
        { label: 'Triggers', description: 'Trigger changes based on metrics', values: ['', ''] },
        { label: 'Unlimited targeting size', description: 'Target contexts of any size', values: ['', ''] },
...
<ProductComparisonTable
    ...
    rows={[
        {
            label: 'Free usage',
            description: 'How many experiments can you run for free?',
            values: ['1M requests per month', ''],
        },
...
<ProductComparisonTable
    competitors={['posthog', 'launchdarkly']}
    rows={[
        { label: 'Analytics', description: 'Capture usage and calls related to flags', values: ['', ''] },
        'product_analytics.trends',
        'product_analytics.funnels',
        'product_analytics.retention',
        { label: 'Breakdowns', description: 'Breakdown analytics by properties', values: ['', ''] },
        'dashboards',
        { label: 'Non-flag data', description: 'Combine flag data with other product data', values: ['', ''] },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'launchdarkly']}
    rows={[
        { label: 'Free integrations', description: 'Use integrations on the free plan', values: ['', ''] },
        ...
        { label: 'Edge tools', description: 'Use edge networks', values: ['', ''] },
    ]}
/>
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Approvals', description: 'Require approvals to change flags', values: ['', ''] },
        { label: 'Permissioning', description: 'Control who can edit and modify flags', values: ['Enterprise?', ''] },
    ]}
/>
