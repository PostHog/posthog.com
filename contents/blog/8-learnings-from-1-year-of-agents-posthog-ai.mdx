...
Even in an agentic loop, it's tempting to organize task execution into [specialized subagents](/blog/10k-prs-in-a-month#more-prs-means-more-review-but-humans-dont-need-to-do-them-all). Doesn't it feel so clever to come up with these architectures? "The Widget CEO will delegate work to the Widget Engineer, and then the work will be verified by the Widget Tester, with input from the Widget Product Manager".
