...
<ComparisonTable column1="PostHog" column2="LaunchDarkly">
    ...
    />
    <ComparisonRow
        column1={'Bayesian, Frequentist'}
        column2={'Bayesian, Frequentist'}
        feature="Statistical approach"
        description="The models available for statistical analysis of experiments"
    />
    <ComparisonRow
        column1={true}
        column2={false}
    ...
    <ComparisonRow
        ...
        column2={true}
        feature="Major SDKs"
        description="Pre-built SDKs for JavaScript, Python, iOS, Android, Go, and more"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Imports and exports"
        description="Import and export data to and from other popular tools"
    />
    <ComparisonRow
        column1={true}
        column2={true}
