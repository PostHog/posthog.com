...
The most popular LaunchDarkly alternatives in 2023 are:
...
Also, for LaunchDarkly, features like integrations, API controls, and reusable segments are only available on their Pro plan. Much of their automation and governance functionality is only available on their Enterprise plans.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/PostHog), as of November 2023, 4,037 (0.4%) of the top 1 million websites deploy PostHog. This is much more popular than LaunchDarkly's 876, but this doesn't count mobile installs.
...
It also includes a warehouse-native mode to connect directly and utilize your current data warehouse like Snowflake.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/Statsig), 564 of the top million sites use Statsig. This is just under LaunchDarkly's 876.
...
[Optimizely](/blog/posthog-vs-optimizely) is an all-in-one set of tools for marketing. It helps businesses create the best possible digital experiences. They provide this through a combination of content management, marketing, web and feature experiments, and ecommerce optimization tools.
...
According to BuiltWith, 5,197 of the top million sites use [Optimizely](https://trends.builtwith.com/analytics/Optimizely) as of November 2023. This is much more than LaunchDarkly's 876. 
...
Split is a feature management platform combining feature flags with testing and observability to ship features safely and effectively. They care much more about preventing issues with monitoring than other alternatives.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/Split), 236 of the top million sites use Split as of November 2023. This is roughly 1/3 of LaunchDarkly's 876.
...
According to [BuiltWith](https://trends.builtwith.com/analytics/Visual-Website-Optimizer), 7,828 of the top million sites use VWO as of November 2023. This is nearly ten times more than LaunchDarkly's 876.
...
As of November 2023, 2,201 of the top million sites use AB Tasty according to [BuiltWith](https://trends.builtwith.com/analytics/AB-Tasty). This is nearly three times more than LaunchDarkly's 876. 
...
BuiltWith doesn't have data on DevCycle's usage, but we can use organic traffic as a proxy. Ahrefs estimates its organic traffic to be 3.5k per month, while it estimates LaunchDarkly at 46.3k per month, nearly 15x more popular.
