...
In the coming weeks and months, we'll be sharing far more of what we've learned about building effective AI agents. Subscribe to our engineering blog, and stay tuned.
...
**PostHog AI is [live in your PostHog project](https://app.posthog.com/#panel=max).** For builders, from builders.
