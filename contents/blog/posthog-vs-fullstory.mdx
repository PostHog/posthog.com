...
hideAnchor: true
featuredImage: >-
  https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/blog/posthog-vs-fullstory/posthog-vs-fullstory.jpg
...
<ComparisonTable column1="PostHog" column2="FullStory">
  <ComparisonRow column1="In beta" column2={true} feature="iOS app replays" description="Record user sessions in iOS apps." />
  <ComparisonRow column1="On the roadmap" column2={true} feature="Android app replays" description="Record user sessions in Android apps" />
...
<ComparisonTable column1="PostHog" column2="FullStory">
  ...
  <ComparisonRow column1={false} column2={true} feature="Movement maps" description="Visualize mouse movements" />
