...
You can also do this in reverse by filtering for session replays where particular events occur, and creating dynamic saved filters. We cover these session replay features in greater depth below. 
