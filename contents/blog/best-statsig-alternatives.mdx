...
Run [evals with LLM-as-a-Judge](/blog/stop-ai-slop) to catch quality regressions, [manage prompts](/docs/llm-analytics/prompts) directly in PostHog with versioning and fetch them at runtime (no redeploys), and use the prompt playground to compare models side-by-side. 
