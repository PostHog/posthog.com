...
[This is where feature flags come in](/blog/decouple-deployment-from-release): you ship the code when it's ready, and you control who sees it separately.
...
The trade-off is cost. Their pricing is based on client-side MAUs, and can scale quickly. It also doesn't include product analytics, session replay, or error tracking, so you'll need separate tools for those.
