...
This means other tools which rely on Google Analytics, such as the experimentation platform [Google Optimize](/blog/optimize-to-posthog), are also not HIPAA-compliant. Read our guide to [HIPAA-compliant split testing tools](/compare/best-hipaa-compliant-ab-testing-tools) if you need an alternative to Optimize as well.
