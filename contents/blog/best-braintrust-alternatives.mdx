...
You can also [manage and version prompts](/docs/prompt-management) without redeploying code, and query trace data with SQL or through the [MCP server](/mcp) directly from your editor.
...
In August 2026, Dynatrace announced an agreement to acquire Arize. The open standards mean your traces stay portable either way, but AX's roadmap and pricing now belong to a large enterprise observability vendor.
