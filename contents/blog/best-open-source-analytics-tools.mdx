...
- **Active development:** PostHog Cloud gets continuous updates and new features as soon as they ship. The self-hosted release is a snapshot, so you'll always be running slightly behind and responsible for keeping it up to date yourself.
...
Yes. PostHog offers both a self-hostable open source release (MIT license) and a cloud-hosted free tier. The cloud free tier includes 1 million events, 5,000 session recordings, and 1 million feature flag requests every month. Around 90% of PostHog users pay nothing. See [PostHog's pricing page](/pricing) for full details.
...
- **Open source:** MIT-licensed and [actively maintained](https://github.com/PostHog/posthog) with 24k+ GitHub stars
