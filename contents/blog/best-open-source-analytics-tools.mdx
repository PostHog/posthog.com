...
It was first released in Feb 2020. It's maintained by PostHog with contributions from its community and customers. PostHog currently has 80 employees, 90% of whom are engineers actively developing the product.
...
[PostHog Open Source](https://github.com/PostHog/posthog) is distributed under an MIT license for hobby deploys via a Docker Compose deployment. It includes most features, but is limited to one project.

#### What are the hosting requirements?

The minimum requirements are something equivalent to a Hetzner VM with 4 vCPU, 16GB RAM, and more than 30GB storage.

#### Is there a hosted option?

Yes. PostHog offers a managed cloud option with a [generous free tier](/pricing) of 1 million events, 5,000 recordings, and 1 million flag API requests every month, and option of US or EU-based hosting.
...
It also offers several additional features, such as session replay, heatmaps, funnels, and A/B testing, but these aren't available in the free open-source release.
...
- **Languages:** Clojure (49%), TypeScript (33%), JavaScript (15%)
...
[Plausible Analytics](/blog/posthog-vs-plausible) is focused on providing [GDPR-compliant website analytics](/blog/best-gdpr-compliant-analytics-tools) that doesn't infringe on user privacy. That means Plausible doesn't rely on cookies and is compliant with regulations like GDPR out of the box. 
...
#### License and self-hosting
Plausible Analytics is available under a AGPLv3 license and can be self-hosted via Docker Compose. Plausible recommends at least 2GB of RAM and it requires a CPU that supports SSE 4.2 or NEON instruction set or higher. Pricing for its hosted version starts at €9 per month for 10,000 monthly pageviews.
