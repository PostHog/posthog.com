...
<details>
  ...
  - **Feb 17, 2025:** Complete guide overhaul. Added OpenPanel and Swetrix
...
Yes. Matomo's cloud offereing inludes all features and charges by "hits per month". The hosted version unlocks some features, like A/B testing and heatmaps, that are paid add-ons for the on-premise release.
...
Not directly, though third-parties to offer managed instances.
