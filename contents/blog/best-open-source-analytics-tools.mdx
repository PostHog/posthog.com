...
[PostHog Open Source](https://github.com/PostHog/posthog) is distributed under an MIT license for hobbyists and proof of concepts via a Docker Compose deployment. It includes most features, but is limited to one project per instance and is provided without guarantee.
...
[Matomo](https://github.com/matomo-org/matomo) is an open-source platform for website analytics. The user experience is closely modelled on the previous version of Google Analytics, known as Universal Analytics, which many people prefer to Google's current offering.
...
| Used by many large orgs (United Nations & EU)               | More complex to selfhost than lightweight analytics tools                    |
...
<details>
    <summary>hat's included in open source?</summary>
...
[OpenReplay](https://openreplay.com/) is a session replay suite built for developers to find and eliminate problems. 
