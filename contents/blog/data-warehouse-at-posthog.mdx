...
<CalloutBox icon="IconInfo" title="Modifying queries to your data" type="fyi">
  Because our data structure is unique, the SQL queries included here likely won't work out-of-the-box for you. Luckily, <a href="/max">PostHog AI</a> makes modifying SQL easy. Just paste these queries in as context and ask it to use your data instead.
</CalloutBox>
