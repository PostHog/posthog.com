...
<CalloutBox icon="IconInfo" title="Modifying queries to your data" type="fyi">
  Because our data structure is unique, the SQL queries included here likely won't work out-of-the-box for you. Luckily, [Max AI](/max) makes modifying SQL easy. Just paste these queries in as context and ask him to use your data instead.
</CalloutBox>
