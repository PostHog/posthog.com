...
We've also created **over 1600** SQL insights using our data warehouse. Each is a combination of an SQL query and a visualization. It's our second most popular type of insight behind trends (which was around long before we had the data warehouse).
