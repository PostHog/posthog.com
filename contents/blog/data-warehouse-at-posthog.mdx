...
WITH daily_exceptions AS (
    ...
    WHERE event = 'organization usage report'
        ...
        AND &lbrace;filters&rbrace;  -- Same filters as daily customers query
...
before_escalated_breaches_in_time_range as(
    ...
    where 
        ...
        and ztme.time >= &lbrace;filters.dateRange.from&rbrace;
        and ztme.time <= &lbrace;filters.dateRange.to&rbrace;
