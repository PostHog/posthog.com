...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Self-service', description: 'Start without talking to sales', values: ['', ''] },
        'experiments',
        'feature_flags',
        'product_analytics',
        'web_analytics',
        'session_replay',
        'surveys',
        { label: 'CMS', description: 'Manage content', values: ['', ''] },
        { label: 'Cart optimization', description: 'Optimize ecommerce checkouts', values: ['', ''] },
        { label: 'Project management', description: 'Manage projects related to experiments', values: ['', ''] },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'optimizely']}
    rows={[
        { label: 'A/B/n tests', description: 'Do tests with multiple variants', values: ['', ''] },
        'experiments.features.custom_targeting',
        'experiments.features.custom_goals',
        { label: 'Single-page app support', description: 'Use app frameworks like React and Vue', values: ['', ''] },
        ...
        { label: 'Native analytics', description: 'Track experiments without third-party tools', values: ['', ''] },
        { label: 'Scheduling', description: 'Schedule experiments to run at specific times', values: ['', ''] },
        { label: 'Use external data', description: 'Use data from other platforms in experiments', values: ['', ''] },
    ]}
/>
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Logging', description: 'Log flag usage', values: ['', ''] },
        { label: 'Audience builder', description: 'Known as cohorts in PostHog', values: ['', ''] },
        { label: 'Custom attributes', description: 'Known as properties in PostHog', values: ['', ''] },
        { label: 'UI controls', description: 'Configure experiments with UI', values: ['', ''] },
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Per-product pricing', description: 'Separate pricing for each product', values: ['', ''] },
    ]}
/>
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Results', description: 'View experiment results', values: ['', ''] },
        { label: 'Segment results', description: 'Break results down for segments', values: ['', ''] },
        'experiments.features.secondary_metrics',
        { label: 'Winner', description: 'Calculate the winning experiment variant', values: ['', ''] },
        { label: 'Custom insights', description: 'Query and customize analytics', values: ['', ''] },
        'product_analytics.trends',
        'product_analytics.funnels',
        { label: 'Confidence interval', description: 'Show confidence in results', values: ['', ''] },
        'session_replay',
    ]}
/>
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Client', description: 'JavaScript, React', values: ['', ''] },
        { label: 'Server', description: 'Node, Python, Go, PHP', values: ['', ''] },
        { label: 'Mobile', description: 'Android, iOS', values: ['', ''] },
        { label: 'OTT', description: 'Over-the-top TV applications', values: ['', ''] },
...
<ProductComparisonTable
    competitors={['posthog', 'optimizely']}
    rows={[
        { label: 'Change history', description: 'Trail of changes to data', values: ['', ''] },
        'platform.security.saml_sso',
        'platform.security.two_factor_auth',
        { label: 'Roles and permissions', description: 'Control who can do what', values: ['', ''] },
        'platform.security.gdpr_ready',
        { label: 'Cookieless', description: 'Use product without cookies', values: ['', ''] },
        { label: 'DPA available', description: 'Enter into Data Processing Agreements', values: ['', ''] },
    ]}
/>
