...
<ComparisonTable column1="PostHog" column2="Optimizely">
    ...
    <ComparisonRow
        ...
        description="Manage and rollout features remotely"
    />
    ...
    <ComparisonRow
        ...
        column2={false}
        feature="Surveys"
        description="Ask users questions and track responses"
    />
    ...
    <ComparisonRow
        ...
        description="Optimize ecommerce checkouts"
    />
    <ComparisonRow
        column1={false}
        column2={true}
        feature="Project management"
        description="Manage projects related to experiments"
    />
</ComparisonTable>
...
<ComparisonTable column1="PostHog" column2="Optimizely">
    ...
    <ComparisonRow
        ...
        description="Target users with custom attributes"
    />
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Custom goals"
        description="Set experiment goals to any metric"
    />
    <ComparisonRow
        column1={true}
        column2={true}
    ...
    <ComparisonRow
        ...
        description="Implement experiments without code"
    />
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Low-code experiments"
    ...
    <ComparisonRow
        column1={true}
        column2={false}
        feature="Native analytics"
        description="Track experiments without third-party tools"
    />
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Scheduling"
        description="Schedule experiments to run at specific times"
    />
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Use external data"
...
<ComparisonTable column1="PostHog" column2="Optimizely">
    ...
    <ComparisonRow
        ...
        column2={true}
        feature="Rollouts"
        description="Control rollout of features remotely"
    />
    ...
    <ComparisonRow
        ...
        description="Calculate the statistical significance of experiments"
    />
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Remote configuration"
        description="Configure your experiments without changing code"
    />
    <ComparisonRow
        column1="Partial"
        column2={true}
...
<ComparisonTable column1="PostHog" column2="Optimizely">
    <ComparisonRow
        ...
        column2={false}
        feature="Transparent"
        description="See pricing without talking to sales"
    />
    ...
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Per-product pricing"
        description="Separate pricing for each product"
    />
</ComparisonTable>
...
<ComparisonTable column1="PostHog" column2="Optimizely">
    ...
    <ComparisonRow
        column1={true}
        column2={true}
        feature="Segment results"
        description="Break results down for segments"
    />
    ...
    <ComparisonRow
        ...
        column2={true}
        feature="Winner"
        description="Calculate the winning experiment variant"
    />
    <ComparisonRow
        column1={true}
        column2={false}
        feature="Custom insights"
        description="Query and customize analytics"
    />
    ...
    <ComparisonRow
        ...
        description="View user sessions related to the experiments"
    />
</ComparisonTable>
...
<ComparisonTable column1="PostHog" column2="Optimizely">
    ...
    <ComparisonRow
        column1={true}
        column2={true}
        feature="DPA available"
        description="Enter into Data Processing Agreements"
    />
</ComparisonTable>
