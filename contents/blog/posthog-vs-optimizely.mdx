...
seo:
  ...
  metaDescription: Looking for the best experimentation and feature flag tool? Compare PostHog vs Optimizely on feature flags, A/B testing, analytics, and pricing to find the right fit.
---
...
<ComparisonTable column1="PostHog" column2="Optimizely">
  ...
  <ComparisonRow column1={true} column2={true} feature="Experiments" description="Run A/B tests" />
