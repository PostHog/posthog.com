...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Self-service', description: 'Start without talking to sales', customValue: true },
        'experiments',
        'feature_flags',
        'product_analytics',
        'web_analytics',
        'session_replay',
        'surveys',
        { label: 'CMS', description: 'Manage content', customValue: false },
        { label: 'Cart optimization', description: 'Optimize ecommerce checkouts', customValue: false },
        { label: 'Project management', description: 'Manage projects related to experiments', customValue: false },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'optimizely']}
    rows={[
        { label: 'A/B/n tests', description: 'Do tests with multiple variants', customValue: true },
        'experiments.features.custom_targeting',
        'experiments.features.custom_goals',
        { label: 'Single-page app support', description: 'Use app frameworks like React and Vue', customValue: true },
        'experiments.features.no_code_experiments',
        { label: 'Low-code experiments', description: 'Implement experiments with a small amount of code', customValue: true },
        'experiments.features.funnel_metrics',
        { label: 'Native analytics', description: 'Track experiments without third-party tools', customValue: true },
        { label: 'Scheduling', description: 'Schedule experiments to run at specific times', customValue: true },
        { label: 'Use external data', description: 'Use data from other platforms in experiments', customValue: true },
    ]}
/>
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Logging', description: 'Log flag usage', customValue: true },
        { label: 'Audience builder', description: 'Known as cohorts in PostHog', customValue: true },
        { label: 'Custom attributes', description: 'Known as properties in PostHog', customValue: true },
        { label: 'UI controls', description: 'Configure experiments with UI', customValue: true },
        'experiments.features.statistical_significance',
        { label: 'Remote configuration', description: 'Configure your experiments without changing code', customValue: true },
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Per-product pricing', description: 'Separate pricing for each product', customValue: true },
    ]}
/>
...
<ProductComparisonTable
    competitors={['posthog', 'optimizely']}
    rows={[
        { label: 'Native analytics', description: 'Track experiments without the use of third parties', customValue: true },
        { label: 'Results', description: 'View experiment results', customValue: true },
        { label: 'Segment results', description: 'Break results down for segments', customValue: true },
        'experiments.features.secondary_metrics',
        { label: 'Winner', description: 'Calculate the winning experiment variant', customValue: true },
        { label: 'Custom insights', description: 'Query and customize analytics', customValue: true },
        'product_analytics.trends',
        'product_analytics.funnels',
        { label: 'Confidence interval', description: 'Show confidence in results', customValue: true },
        'session_replay',
    ]}
/>
...
<ProductComparisonTable
    ...
    rows={[
        ...
        { label: 'Client', description: 'JavaScript, React', customValue: true },
        { label: 'Server', description: 'Node, Python, Go, PHP', customValue: true },
        { label: 'Mobile', description: 'Android, iOS', customValue: true },
        { label: 'OTT', description: 'Over-the-top TV applications', customValue: false },
...
<ProductComparisonTable
    competitors={['posthog', 'optimizely']}
    rows={[
        { label: 'Google Analytics', customValue: false },
...
<ProductComparisonTable
    competitors={['posthog', 'optimizely']}
    rows={[
        { label: 'Change history', description: 'Trail of changes to data', customValue: true },
        'platform.security.saml_sso',
        'platform.security.two_factor_auth',
        { label: 'Roles and permissions', description: 'Control who can do what', customValue: true },
        'platform.security.gdpr_ready',
        { label: 'Cookieless', description: 'Use product without cookies', customValue: true },
        { label: 'DPA available', description: 'Enter into Data Processing Agreements', customValue: true },
    ]}
/>
