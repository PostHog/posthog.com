...
- **[LLM observability](/docs/llm-observability):** Track token usage, latency, costs, and user feedback across your AI pipelines.
...
- **You're building an AI product** – PostHog has first-class support for [LLM observability](/llm-observability), error tracking for AI pipelines, and an MCP server that connects your product data to your AI coding tools.
