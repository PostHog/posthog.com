...
It also includes [evals](/docs/ai-evals/evaluations) (so you can score model outputs and catch regressions when you tweak a prompt) and [prompt management](/docs/prompt-management/prompts) (versioning, A/B testing, and rollback for production prompts).
