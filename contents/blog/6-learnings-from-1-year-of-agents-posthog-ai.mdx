...
Here's what we've learned building productive agents so far.
...
It remains hard to estimate what impact a model upgrade will really have! [A great post on this by Sean Goedecke](https://www.seangoedecke.com/are-new-models-good/). Still, while the progress isn't so obvious as GPT-2 vs. GPT-3, it's relentless.
...
[Some](https://x.com/gdb/status/1733553161884127435) say evals can be all you need. For foundation models: certainly, your datasets are… foundational. For agents: evals are a great tool to have, but things get nuanced.
