...
A year later, I'm reporting back from the AEO trenches with some good news: it works. It's the fastest-growing, highest-converting channel at PostHog – and it's not close either.
...
As of today, **6,618** of them to be exact (and we've only been doing this for 3 months).
...
We've watched hundreds of signups walk in asking for "an alternative to Google Analytics," dozens more for Sentry, Hotjar, Amplitude, Mixpanel. These reports have surfaced new content niches for us to focus on, specific framings of problems we hadn't thought to write about, adjacent tools and use cases to surface in our articles...
