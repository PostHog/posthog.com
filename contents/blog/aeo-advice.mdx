...
*Of course I can*, I replied, with the confidence of someone already opening 17 tabs.
...
Anyone who's watched SEO mature over the last few years has already seen how high the upside can be when you take it seriously, and AEO is an amplifier of it (a big one at that). 
...
It's an amazing feedback loop. The best part? It cost roughly zero dollars to set up, and it's become one of the most (if not the most) valuable strategic inputs in my entire reporting stack.
...
*Honorable mention to the user who told us they found out about PostHog in Fortnite voice chat, specifically talking to a Darth Vader NPC about analyzing the Fortnite economy. I think about him often.*
...
My honest answer is that when I first started I took 100+ AI-generated suggestions from my AEO tool (based on our brand profile and target SEO keywords), tracked all of them, and hoped for the best (see section #5 for how that ended.)

Now I have a framework, or at least a more confident shape of one. It comes down to three circles:

![Prompt framework](https://res.cloudinary.com/dmukukwp6/image/upload/LLM_conversion_rates_v2_1a9b794f4e.jpg)
...
We tested one of the most popular and fancy ($$$) end-to-end AI content automation tools out there with the hopes we would be able to offload some of the AEO content creation burden; you'd think throwing money at the problem would solve it, but ultimately after weeks of iteration, nothing it produced met our standards (or came close enough to make it worth the reputational risk and level of investment).
...
Am I a savant? Probably not. Am in the right place, at the right company, at the right moment in the technology cycle? Maybe. Some of both? Most likely.
