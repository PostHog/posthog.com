...
- **Error tracking:** Monitor crashes, exceptions, and stack traces – connected directly to session replays and user behavior.

- **Surveys:** Collect in-app feedback with NPS, CSAT, and custom surveys. Target users by properties, behavior, or feature flag.
