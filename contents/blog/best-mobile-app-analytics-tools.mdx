...
AppsFlyer has three pricing tiers based on attributed conversions (non-organic installs and re-engagements). The Zero and Growth plans both include 12,000 free conversions for the first year:
...
- **Growth plan:** $0.07 per conversion after the 12,000. Includes attribution for all major ad networks.
