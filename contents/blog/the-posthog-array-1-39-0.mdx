...
We'll share more about this update once it's fully released to all users - keep and eye on [the PostHog blog](/blog) for updates. For more information on how we've implemented this change behind the scenes, check out our [overview of the ingestion pipeline](/docs/architecture/ingestion-pipeline).
