...
- Beta: [Person properties on events](#beta-person-properties-have-moved-on-to-events)
...
### Beta: Person properties on events
...
### New: Number chart type for insights

Sure, line charts are nice and bar charts have their place, but sometimes you just need a big, bold number. 

This new and much-requested chart type only works on a single series at a time, but is really handy for those occasions where you need to boil things down to a single figure. 
...
If your event properties are sent as milliseconds or seconds you can now mark your insight as showing durations and get human readable durations

![formatting an insight as a duration](../images/blog/array-1.39.0/duration-formatting.gif)

### New: Big Bold Number Insight Type

You can combine that with the new (and very exciting) big bold number insight type. For those times you need to track one big number.
