...
- [New and Improved: Expo compatible React Native library](#expo-compatible-react-native-library)
...
> Want to upgrade your library? The minimum version requirement is [PostHog 1.38.0](/blog/the-posthog-array-1-38-0)
...
## Expo compatible React Native library

We've rewritten the React Native library, bringing it up to a 2.0. Super exciteingly it is now [expo-compatible](https://expo.dev/). 

The integration is fully converted to TypeScript and now supports autocapture as well as feature flags and group analytics! 💯.
