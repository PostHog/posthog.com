...
<ComparisonTable column1="PostHog" column2="Fathom">
  ...
  <ComparisonRow column1={true} column2={"Events only"} feature="Custom events" description="Manually capture custom events and properties wherever they happen" />
...
> 💡 **Good to know:** Fathom has slightly different approach to complying with EU privacy regulation. They do so by:
...
Google Analytics is still masively popular. According to [BuiltWith](https://trends.builtwith.com/analytics/Google-Analytics), as of October 2024, 489,524 of the top 1 million websites deploy Google Analytics and a comparitively tiny 1,832 use Fathom.
...
> #### Bottom line
> You would probably not consider Fathom without knowing about Google Analytics. It's the go-to choice for a signifcant portion of sites, especially ones tied to the Google ecosystem.
