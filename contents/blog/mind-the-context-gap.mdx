...
A [context warehouse](/context-warehouse) wraps ingestion, modeling, storage, and querying in one tool instead of four you wire together with pipelines between them. Using PostHog's context warehouse means you don't have to set up multiple pipelines between your data sources, warehouse, modeling, and BI tools, creating dependancies that take too much time to keep up with. Here's how it works in PostHog:
