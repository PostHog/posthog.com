...
- **External sources sync in.** Connect [Stripe](https://posthog.com/docs/data-warehouse/sources/stripe), [HubSpot](https://posthog.com/docs/data-warehouse/sources/hubspot), [Salesforce](https://posthog.com/docs/data-warehouse/sources/salesforce), [Postgres](https://posthog.com/docs/data-warehouse/sources/postgres), and the other 102 sources of data you have, and it lands in the same warehouse. The pipelines are maintained automatically with scheduled, by default syncs.
