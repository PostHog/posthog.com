...
- <Link to="https://github.com/posthog/posthog" state={{ newWindow: true}} external>Open source products</Link>
- <Link to="/pricing" state={{ newWindow: true}}>Generous free tiers</Link>
- <Link to="/sales" state={{ newWindow: true}}>No outbound sales</Link>
- <Link to="/blog/analytics-pricing" state={{ newWindow: true}}>Price cuts</Link> instead of increases
- <Link to="/side-project-insurance" state={{ newWindow: true}}>Protection</Link> against viral usage spikes
...
In addition to the nice summary from the _TLDR newsletter_ (above):
...
- <Link to="/teams" state={{ newWindow: true}}>See who's working on which product</Link> and what their goals are
