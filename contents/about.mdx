...
<CloudinaryImage
    ...
    width={420}
    height={433}
    className="float-right ml-2 max-w-40 @xl:max-w-2xs"
/>
...
<div className="flex justify-center @lg:float-right @2xl/reader-content-container:-mr-4 @3xl/reader-content-container:-mr-8">
