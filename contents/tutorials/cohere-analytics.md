...
We'll build a basic Next.js app, implement the Cohere API via the Vercel AI SDK, and capture these events automatically using PostHog's AI Observability.
...
<ProductScreenshot
  ...
  alt="PostHog AI Observability dashboard"
  classes="rounded"
/>
...
<ProductScreenshot
  ...
  alt="PostHog AI Observability generations tab"
  classes="rounded"
/>
