...
import filterSessionLight from '../images/tutorials/filter-session-recordings/filter-events-session-recording-light-mode.png'
import filterSessionDark from '../images/tutorials/filter-session-recordings/filter-events-session-recording-dark-mode.png'
import filterOffLight from '../images/tutorials/filter-session-recordings/recording-filter-off-light-mode.png'
import filterOffDark from '../images/tutorials/filter-session-recordings/recording-filter-off-dark-mode.png'
import filterOnLight from '../images/tutorials/filter-session-recordings/recording-filter-on-light-mode.png'
import filterOnDark from '../images/tutorials/filter-session-recordings/recording-filter-on-dark-mode.png'
import searchRecordingFlagLight from '../images/tutorials/filter-session-recordings/search-recording-flag-light-mode.mp4'
import searchRecordingFlagDark from '../images/tutorials/filter-session-recordings/search-recording-flag-dark-mode.mp4'
import filterPersonsRecordingsLight from '../images/tutorials/filter-session-recordings/filter-persons-recordings-light-mode.png'
import filterPersonsRecordingsDark from '../images/tutorials/filter-session-recordings/filter-persons-recordings-dark-mode.png'
import quickFilterLight from '../images/tutorials/filter-session-recordings/quick-filter-recordings-light-mode.png'
import quickFilterDark from '../images/tutorials/filter-session-recordings/quick-filter-recordings-dark-mode.png'
import filterRecordingsLight from '../images/tutorials/filter-session-recordings/filter-recordings-time-light-mode.png'
import filterRecordingsDark from '../images/tutorials/filter-session-recordings/filter-recordings-time-dark-mode.png'
import timePickerLight from '../images/tutorials/filter-session-recordings/time-picker-light-mode.mp4'
import timePickerDark from '../images/tutorials/filter-session-recordings/time-picker-dark-mode.mp4'
