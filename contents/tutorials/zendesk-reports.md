...
To start, you need both Zendesk and PostHog accounts. Once you have those, head to PostHog's [data pipeline sources tab](https://app.posthog.com/data-management/sources) and:
...
Once done, PostHog will automatically pull and format your Zendesk data for querying. You can adjust the sync frequency, see the last successful run, and more in [data pipeline sources tab](https://app.posthog.com/data-management/sources).
