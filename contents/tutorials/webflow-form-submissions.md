...
With this, you can set up alerts in Slack for email submissions with a [destination](/docs/cdp/destinations/slack), [identify users](/docs/product-analytics/identify) with the email they submit, and export [cohorts of users](/docs/data/cohorts) who submit emails.
