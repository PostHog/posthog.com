...
PostHog can capture a lot of data about your users. For data it can't capture, you can leverage the [data warehouse](/context-warehouse) to manually upload any data you'd like as a CSV
