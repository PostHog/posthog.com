...
tags:
  ...
  - product analytics
---
export const retentionChartLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/churn-rate/retention-chart-light-mode.png"
export const retentionChartDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/churn-rate/retention-chart-dark-mode.png"
export const lifeCycleLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/churn-rate/lifecycle-chart-light-mode.png"
export const lifeCycleDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/churn-rate/lifecycle-chart-dark-mode.png"
export const churnRiskCohortLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/churn-rate/churn-risk-cohort-light-mode.png"
export const churnRiskCohortDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/churn-rate/churn-risk-cohort-dark-mode.png"
...
<ProductScreenshot
    imageLight = {retentionChartLight} 
    imageDark = {retentionChartDark}
    classes="rounded"
    alt="Retention chart"
/>
...
Now that we calculated and visualized the churn rate in our product, we can figure out ways to lower it. Being an all-in-one developer platform, PostHog has tools to help you with this, and they connect to your data and the work you’ve already done.
...
<ProductScreenshot
    imageLight = {churnRiskCohortLight} 
    imageDark = {churnRiskCohortDark}
    classes="rounded"
    alt="Churn risk cohort"
/>
...
<ProductScreenshot
    imageLight = {churnRiskActionLight} 
    imageDark = {churnRiskActionDark}
    classes="rounded"
    alt="Churn risk action"
/>
