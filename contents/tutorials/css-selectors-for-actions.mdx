...
export const setupLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/tutorials/toolbar/setup-toolbar-light-mode.mp4"
export const setupDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/tutorials/toolbar/setup-toolbar-dark-mode.mp4"
...
export const toolbarNewActionLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/products/product-analytics/toolbar-create-new-action-light-mode.mp4"
export const toolbarNewActionDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/products/product-analytics/toolbar-create-new-action-dark-mode.mp4"
export const dataManagementLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/features/data-management/data-management-light-mode.png"
export const dataManagementDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/features/data-management/data-management-dark-mode.png"
export const matchGroupsLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/css-selectors-for-actions/match-groups-light-mode.png"
export const matchGroupsDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/css-selectors-for-actions/match-groups-dark-mode.png"
export const toolbarLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1711136223/posthog.com/contents/images/tutorials/css-selectors-for-actions/toolbar-light-mode.png"
export const toolbarDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1711136223/posthog.com/contents/images/tutorials/css-selectors-for-actions/toolbar-dark-mode.png"


_Estimated reading time: 7 minutes_ ☕

PostHog supports different methods for creating [actions](/docs/data/actions): autocapturing, using the [toolbar](/docs/user-guides/toolbar) and via CSS selectors. 

As the name suggests, [autocapture](/docs/product-analytics/autocapture) is the easiest option, because users don't have to do anything - actions are identified and captured automatically. While this is really nice, the amount of events generated this way can sometimes be overwhelming for a targeted analysis.
...
Then, press the `Open with Toolbar` button, which will take you to your website. You can read more about working with the toolbar in the [toolbar manual](/manual/toolbar).

After your website is open, you should see a PostHog toolbar:

<ProductScreenshot
    imageLight = {toolbarLight}
    imageDark = {toolbarDark}
    alt="Toolbar in action" 
    classes = {"rounded"}
/>
...
<ProductVideo
    videoLight = {toolbarNewActionLight}
    videoDark = {toolbarNewActionDark}
...
<ProductScreenshot
    ...
    alt= "Create new action modal with two buttons: 'Inspect element on your site' and 'From event or pageview'"
    classes="rounded"
/>
...
<ProductScreenshot
    imageLight = {matchGroupsLight} 
    imageDark = {matchGroupsDark}
    alt= "Data management: match groups" 
    classes="rounded"
/>
