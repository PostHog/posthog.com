...
import selectReplayControlDark from '../images/tutorials/limit-session-recordings/select-replay-control-flag-dark-mode.png'
import selectReplayControlLight from '../images/tutorials/limit-session-recordings/select-replay-control-flag-light-mode.png'
import flagDark from '../images/tutorials/limit-session-recordings/feature-flag-to-control-sessions-dark-mode.png'
import flagLight from '../images/tutorials/limit-session-recordings/feature-flag-to-control-sessions-light-mode.png'
