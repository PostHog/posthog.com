...
export const selectReplayControlDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/limit-session-recordings/select-replay-control-flag-dark-mode.png"
export const selectReplayControlLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/limit-session-recordings/select-replay-control-flag-light-mode.png"
export const flagDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/limit-session-recordings/feature-flag-to-control-sessions-dark-mode.png"
export const flagLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/limit-session-recordings/feature-flag-to-control-sessions-light-mode.png"
