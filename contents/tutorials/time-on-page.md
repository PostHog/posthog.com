...
To calculate the average time on page, we must create a SQL insight. To do this, [create a new insight](https://app.posthog.com/insights/new) and select the SQL tab. Here we write a [HogQL expression](/docs/hogql/expressions) to: 
