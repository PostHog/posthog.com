...
If you build something in one project that you want in another, you can copy it instead of recreating it. You can copy [dashboards](/docs/product-analytics/dashboards#copying-dashboards-and-templates-between-projects), [insights](/docs/product-analytics/insights#copying-insights-to-another-project), [experiments](/docs/experiments/managing-lifecycle#to-another-project), [feature flags](/docs/feature-flags/multi-project-feature-flags), [actions](/docs/data/actions#copying-an-action-to-another-project), [cohorts](/docs/data/cohorts#copying-a-cohort-to-another-project), [surveys](/docs/surveys/creating-surveys#copying-a-survey-to-another-project), and [early access features](/docs/feature-flags/early-access-feature-management#copying-a-feature-to-another-project) to another project in the same organization. Open the resource and click **Copy to another project**. Feature flags use the **Projects** tab instead, as described below.
