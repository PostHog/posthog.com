...
To fetch the active surveys, we use [`posthog.getActiveMatchingSurveys()`](/docs/libraries/js/usage#surveys). This returns an array of survey objects that looks like this:
