---
title: How to set up analytics in Python and Flask
date: 2024-02-22
author: ["lior-neu-ner"]
...
Run `python3 app.py` and navigate to `http://localhost:5000` to see our app in action. Enter anything on the login page to save some session details.
