...
>
> When calling `posthog.capture()`, you can provide a `distinct_id` argument. This is a unique identifier for your user and enables you to correctly attribute events to them. You can pass the distinct_id directly, or use contexts to manage it across a request/response cycle.
>
