...
## Capturing LLM Observability events

It's also possible to capture LLM Observability events using the API. If you're using a language without [SDK support for LLM Observability](/docs/llm-observability/installation), you can use the API to capture events.

To capture LLM Observability, you need to capture 4 types of events:

| Event type   | Event name         | Documentation                          |
|--------------|-------------------|---------------------------------------------|
| Generations  | `$ai_generation`  | [What are generations?](/docs/llm-observability/generations) |
| Spans        | `$ai_span`        | [What are spans?](/docs/llm-observability/spans)             |
| Traces       | `$ai_trace`       | [What are traces?](/docs/llm-observability/traces)            |
| Embeddings   | `$ai_embedding`   | [What are embeddings?](/docs/llm-observability/embeddings)    |

You can find more information in our [manual capture guide](/docs/llm-observability/installation/manual-capture).
...
- [Manual LLM Observability capture](/docs/llm-observability/installation/manual-capture)
