...
---
import apiEventsLight from '../images/tutorials/api-capture-events/api-events-light-mode.png'
import apiEventsDark from '../images/tutorials/api-capture-events/api-events-dark-mode.png'
