...
It's also possible to capture LLM analytics events using the API. If you're using a language without [SDK support for LLM analytics](/docs/ai-observability/installation), you can use the API to capture events.
...
- [Manual LLM analytics capture](/docs/ai-observability/installation/manual-capture)
