...
It's also possible to capture LLM Observability events using the API. If you're using a language without [SDK support for LLM Observability](/docs/llm-analytics/installation), you can use the API to capture events.
...
- [Manual LLM Observability capture](/docs/llm-analytics/installation/manual-capture)
