...
Next we [connect Langfuse to PostHog](/docs/llm-observability/integrations/langfuse-posthog) so that you can combine your LLM trace data with your PostHog analytics. This enables you to answer product questions such as:
...
Langfuse will now begin sending your LLM Observability to PostHog once a day.
...
- [How to set up LLM Observability for Anthropic's Claude](/tutorials/anthropic-analytics)
