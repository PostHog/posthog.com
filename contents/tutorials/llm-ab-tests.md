...
Lastly, when a user log outs we call [`posthog.reset()`](/docs/libraries/js/usage#resetting-a-user) to unlink any future events. Update the `handleLogout` function in `recipe-builder/page.js` to do this:
