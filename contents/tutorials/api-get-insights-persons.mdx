...
tags:
  ...
  - product os
---
export const profileLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/api-get-insights-persons/profile-light-mode.png"
export const profileDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/api-get-insights-persons/profile-dark-mode.png"
export const inspectLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/api-get-insights-persons/inspect-light-mode.png"
export const inspectDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/api-get-insights-persons/inspect-dark-mode.png"
...
<ProductScreenshot
    imageLight = {profileLight} 
    imageDark = {profileDark}
    classes="rounded"
    alt="Profile"
/>
...
<ProductScreenshot
    imageLight = {inspectLight} 
    imageDark = {inspectDark}
    classes="rounded"
    alt="Inspect requests"
/>
