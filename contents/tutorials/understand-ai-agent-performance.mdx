...
export const socialImage =
    "https://res.cloudinary.com/dmukukwp6/image/upload/f_jpg,w_1200,h_630,c_fill,g_auto,q_auto/pasted_image_2026_08_17_T08_50_29_648_Z_c98944d6bd"
...
![The seven-step AI product improvement loop, from capturing the right data through tracking whether the agent improved](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/pasted_image_2026_08_17_T08_50_29_648_Z_c98944d6bd.png)
...
![Clusters in PostHog showing themes across AI traces and generations](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/pasted_image_2026_08_17_T08_50_34_731_Z_53dc59d5c6.jpeg)
...
![A PostHog cluster detail page with its summary, metrics, visualization, and example traces](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/pasted_image_2026_08_17_T08_50_33_753_Z_c36b0d6006.png)
...
_"How much money do I have in my bank account?"_

Another person might ask:

_"I want to understand how much money I have in my account today."_

Someone else might ask:

_"Help me understand how much money I have across my different accounts."_
...
![A PostHog AI trace linked to a session replay](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/pasted_image_2026_08_17_T08_51_33_151_Z_241c3c2a76.png)
...
![The Sentiment tab in PostHog AI Observability](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/pasted_image_2026_08_17_T08_51_30_033_Z_a99eef47e2.png)
...
_"Did the agent successfully answer the user's question? True or false."_

![Creating a boolean evaluation in PostHog](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/pasted_image_2026_08_17_T08_50_36_709_Z_9c9d1606d1.png)
...
_"Did the agent return the correct bank balance using the customer's live account data? True or false."_
...
![A trend insight showing AI evaluation results over time](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/pasted_image_2026_08_17_T08_50_35_720_Z_6f651c4c0a.png)
...
![An AI Observability dashboard in PostHog](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/pasted_image_2026_08_17_T08_49_49_601_Z_f26a16c467.png)
...
![Creating a workflow for failed AI evaluations in PostHog](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/pasted_image_2026_08_17_T08_51_38_974_Z_4be0a339ef.png)
...
_"What's my bank account balance today?"_

For whatever reason, the agent hallucinates and says:

_"You're really wealthy. You have $100 million."_
...
_"Chatbot failed because the user wanted to know how much money was in their bank account and the agent returned the wrong balance."_
...
![A workflow alert with links to the failed trace and person](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/pasted_image_2026_08_17_T08_51_35_314_Z_fd6f857751.png)
...
![Testing a failed AI generation in the PostHog Playground](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/pasted_image_2026_08_17_T08_51_27_430_Z_989da41d0c.png)
