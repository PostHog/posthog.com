...
In this tutorial, we show you how to do this and monitor important metrics such as:
...
For this tutorial we create a simple RAG chat app that answers questions about how to care for hedgehogs. We vectorize a [pdf on how to care for hedgehogs](https://www.pro-igel.de/downloads/merkblaetter_engl/wildtier_engl.pdf) using [Mistral's 8x22B model](https://docs.mistral.ai/getting-started/models/). 

First, install all the necessary dependencies for the app:
...
Next, paste the following code into `app.py` to set up the app:
...
All steps of the LLM chain are now tracked in Langfuse. You can view your traces in xyz to see what steps your LLM performaed

<!-- https://res.cloudinary.com/dmukukwp6/image/upload/Screenshot_2024_12_06_at_1_29_21_PM_80ce94fb98.png -->
<!-- dark https://res.cloudinary.com/dmukukwp6/image/upload/Screenshot_2024_12_06_at_1_30_43_PM_fc294d1faf.png -->

## 4. Integrate Langfuse with PostHog

The final step is connect Langfuse to PostHog so that you can combine your LLM trace data with your PostHog analytics. This enables to answer product questions such as:

- XYZ. maybe something else
...
1. In your [Langfuse dashboard](https://cloud.langfuse.com/), click on **Settings** and scroll down to the **Integrations** section to find the PostHog integration.
2. Click **Configure** and paste in your PostHog host and project API key (you can find these in your [PostHog project settings](https://us.posthog.com/settings/project)).
