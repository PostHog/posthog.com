...
In this tutorial, we'll build a basic Next.js app, implement the Claude API, and capture these events automatically using PostHog LLM Observability.
...
Once you generate a few responses, go to PostHog's [LLM Observability tab](https://app.posthog.com/llm-observability) to get an overview of traces, users, costs, and more.
...
- [How to set up LLM Observability for Cohere](/tutorials/cohere-analytics)
