...
Once you generate a few responses, go to PostHog's [LLM Observability tab](https://app.posthog.com/llm-analytics) to get an overview of traces, users, costs, and more.
