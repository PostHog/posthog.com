...
PostHog offers a variety of tools which are useful for [real user monitoring](/blog/real-user-monitoring) and debugging errors, such as [Session Recording](/docs/user-guides/recordings), Paths and Trends — yet it is not a bespoke error monitoring tool. 
...
> **Interested in capturing errors in PostHog?** Our new error tracking product is live. Learn more about it in [our docs](/docs/error-tracking).
