...
export const InitialDark = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/tutorials/first-last-touch-attribution/initial-dark.png"
export const InitialLight = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/tutorials/first-last-touch-attribution/initial-light.png"
export const ReferrerDark = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/tutorials/first-last-touch-attribution/referrer-dark.png"
export const ReferrerLight = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/tutorials/first-last-touch-attribution/referrer-light.png"
export const PathDark = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/tutorials/first-last-touch-attribution/path-dark.png"
export const PathLight = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/tutorials/first-last-touch-attribution/path-light.png"
...
<ProductScreenshot
  imageLight={InitialLight} 
  imageDark={InitialDark} 
  alt="Initial properties"
  classes="rounded"
/>

### First pageview

We can also calculate the first touch as the first page a user lands on. To do this, we can [create an insight](https://app.posthog.com/insights/new), go to the SQL tab, and use [SQL](/docs/sql). Here we query for the first `$pageview` event for a user, then get the `$current_url` of this event. This looks like this:
...
<ProductScreenshot
  imageLight={ReferrerLight} 
  imageDark={ReferrerDark} 
  alt="Referrer property"
  classes="rounded"
/>

### Last pageview event

We can look at the last pageview event before signing up. Like first touch attribution, we can do this by [creating an insight](https://app.posthog.com/insights/new), going to the SQL tab, and using [SQL](/docs/sql). 
