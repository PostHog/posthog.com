...
export const InitialDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/first-last-touch-attribution/initial-dark.png"
export const InitialLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/first-last-touch-attribution/initial-light.png"
export const ReferrerDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/first-last-touch-attribution/referrer-dark.png"
export const ReferrerLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/first-last-touch-attribution/referrer-light.png"
export const PathDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/first-last-touch-attribution/path-dark.png"
export const PathLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/first-last-touch-attribution/path-light.png"
