...
Back in your app, add PostHog to your component in `app/page.js`, call the [`get_session_replay_url()`](/docs/libraries/js/usage#session-replay) method, and add the link as `recent_replay` in your `boot` call like this:
