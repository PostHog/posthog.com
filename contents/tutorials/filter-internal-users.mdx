...
date: 2022-02-14
---
import step1Light from '../images/tutorials/filter-internal-users/step1-light-mode.png'
import step1Dark from '../images/tutorials/filter-internal-users/step1-dark-mode.png'
import step2Light from '../images/tutorials/filter-internal-users/step2-light-mode.png'
import step2Dark from '../images/tutorials/filter-internal-users/step2-dark-mode.png'
import step3Light from '../images/tutorials/filter-internal-users/step3-light-mode.png'
import step3Dark from '../images/tutorials/filter-internal-users/step3-dark-mode.png'
