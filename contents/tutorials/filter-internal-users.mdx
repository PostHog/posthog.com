...
> **Update:** When filtering out internal users by person properties, like email, 
> instead of the instructions below, we recommend [creating a Cohort](https://posthog.com/docs/data/cohorts#method-2-create-a-new-cohort-from-the-cohorts-page)
