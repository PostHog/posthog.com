...
---
export const step1Light = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/filter-internal-users/step1-light-mode.png"
export const step1Dark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/filter-internal-users/step1-dark-mode.png"
export const step2Light = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/filter-internal-users/step2-light-mode.png"
export const step2Dark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/filter-internal-users/step2-dark-mode.png"
export const step3Light = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/filter-internal-users/step3-light-mode.png"
export const step3Dark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/filter-internal-users/step3-dark-mode.png"
...
## Automatic filtering for new teams

New PostHog teams automatically have internal user filtering set up. When you create a new team, PostHog:

1. Creates a cohort called **"Internal / Test users"** that contains users with the `$internal_or_test_user` person property set to `true`.
2. Configures your test account filters to exclude this cohort by default.

To mark someone as an internal or test user, set the `$internal_or_test_user` property to `true` on their person profile. They'll automatically be added to the cohort and filtered out of your analytics.

The steps below are for teams that:

- Were created before this automatic setup was available
- Want to customize filtering beyond the default cohort
- Need to add additional filters on top of the automatic cohort
...
> **Update 18 Sept, 2024:** When filtering out internal users by person properties, like email, 
> instead of the instructions below, we now recommend [creating a Cohort](/docs/data/cohorts#method-2-create-a-new-cohort-from-the-cohorts-page)
> with those properties, and then adding that cohort with a "not in" operator in your ‘_Filter out internal and test users_’ settings.
