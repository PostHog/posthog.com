...
tags:
  - surveys
---
export const enableLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/feedback-interviews-site-apps/enable-light-mode.png"
export const enableDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/tutorials/feedback-interviews-site-apps/enable-dark-mode.png"
export const feedbackLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/tutorials/feedback-interviews-site-apps/feedback-light-mode.mp4"
export const feedbackDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/tutorials/feedback-interviews-site-apps/feedback-dark-mode.mp4"
export const interviewLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/tutorials/feedback-interviews-site-apps/interview-light-mode.mp4"
export const interviewDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/tutorials/feedback-interviews-site-apps/interview-dark-mode.mp4"
...
<ProductScreenshot
    imageLight = {enableLight} 
    imageDark = {enableDark}
    classes="rounded"
    alt="Enable surveys"
/>
...
<ProductVideo
    ...
    videoDark = {feedbackDark}
    classes="rounded"
    alt="Creating the feedback survey"
/>
...
<ProductVideo
    ...
    videoDark = {interviewDark}
    classes="rounded"
    alt="Interview survey"
/>
