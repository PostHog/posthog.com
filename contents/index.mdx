...
<span class="text-base font-medium mb-0">PostHog helps you debug your code, ship features faster, and keep all your usage and customer data in one stack.</span>
