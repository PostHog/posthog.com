...
<table className="w-400 mt-4" style="max-width: 1100px; font-size: 15px;">
    <thead>
        <tr class="border-b border-primary">
            ...
            <td className="w-2/12 text-center"><a href="/compare/posthog-vs-pendo">Pendo</a></td>
            <td className="w-2/12 text-center"><a href="/compare/posthog-vs-logrocket">LogRocket</a></td>
