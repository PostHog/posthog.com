...
<div class="w-[calc(100%_+_4rem)] relative -mx-4 px-8 md:-mx-16 pt-32 pb-72 -mt-32 md:-mt-44">
  ...
  <h2 className="text-[18px] md:text-[20px] leading-[1.4] font-semibold mb-8 !mt-5">Clerky users can claim $55,000 in PostHog credit,<br className="hidden lg:block" />plus other benefits to help them build better products</h2>
    ...
    <div class="flex justify-center">
      <ul class="m-0 p-0 list-none inline-grid sm:grid-cols-2 lg:grid-cols-5 justify-evenly relative text-center sm:text-left">
        ...
        <li class="relative md:max-w-md py-4 md:py-8 pl-4 pr-2 md:px-12 lg:px-8">
          ...
          <p class="m-0 text-[15px]">We're part of DigitalOcean's Hatch program. You'll get $25,000 of infra credit.</p>
        </li>
        <li class="relative md:max-w-md py-4 md:py-8 pl-4 pr-2 md:px-12 lg:px-8">
