...
featuredImage: 
documentation: /docs/apps/timestamp-parser
thumbnail: ../thumbnails/timestamp-parser.png
filters: {
...
>
    ...
    <div>
        ...
        <p>How does the day of the week affect user behavious? What about time of day? Find out with timestamps!</p>
    </div>
    <div>
