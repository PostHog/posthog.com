...
featuredImage: ../images/apps/salesforce.png
...
>
    ...
    <div>
        <h5>Leverage product data</h5>
        <p>Combining product data from PostHog with Salesforce makes it easier to spot trends and trivial to maximize sales activities.</p>
    </div>
</Section>
