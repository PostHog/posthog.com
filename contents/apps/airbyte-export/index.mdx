...
>
    <div>
        ...
        <p>Export event data from PostHog to Airbyte, then use any of over 300 connectors to send it anywhere else you need - from Azure to Kafka, MongoDB to Oracle.</p>
    </div>
    <div>
