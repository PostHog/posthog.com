...
featuredImage: 
documentation: /docs/apps/semver-flattener
thumbnail: ../thumbnails/semver-flattener.png
filters: {
    type: ["data-in"],
    maintainer: official
}
...
<Section
    divider={false}
    title="Sometimes you want to compare versions when filtering in PostHog insights. This app adds a valid SemVer string, to make that easier."
    size="full"
    cols={2}
>
    <div>
