...
Some will be better at talking to users than others. Some will be stronger at data analysis. Some will be stronger on the front-end than the back-end.
...
A product engineer needs a high-level understanding of how software businesses work, so you can properly understand the context in which you're building, and ultimately make good decisions about what to build.

This starts with understanding basic concepts like product-market fit, and the difference between an ideal customer profile and a user persona. It also includes the business metrics that imply or predict the success of a product, like net revenue retention.

Product engineers don't need to be experts in these things or, god forbid, have an MBA, but they do need to understand them at a high level, and actively care about them.

## 2. How to write well

The role of product engineer isn't just about writing code. Writing skills outside of code are often just as important.

A product engineer should be able to write persuasive RFCs to help guide decisions, coherent goals and plans, actionable feedback, and helpful documentation.

Honing your writing skills means you can work more asynchronously, so you can spend less time in meetings and more time building.
...
Product engineers need to be comfortable using the full gamut of tools available, such as error tracking, logging, performance monitoring, help desks, and more to diagnose root causes and find solutions.
...
* Are familiar with analytics tools, like PostHog  
...
* Writing custom SQL queries to [track activation for their product](https://posthog.com/newsletter/wtf-is-activation)

Product engineers don't need to be data-led per se – overrelying on data for decisions is a bit of a red flag, actually – but you do need to be comfortable using data tools, and digging into product usage data when it makes sense to do so.

Product managers can and should support this work, but product engineers shouldn't be wholly reliant on them to gather actionable insights. See chapter 4, The product engineer's role in the product team, for more on how product engineers and product managers can work together.
...
Product engineers also need to be practical about choosing the best tool for the job, rather than the one you're interested in trying because it's cool and new, or the one you evangelize.

Being a product engineer means avoiding dogmatic arguments and, sometimes, choosing the most expedient and boring technology that allows you to ship something quickly. 

## 6. Coding with AI

Semantic arguments about what constitutes vibe coding and "real engineering" are a distraction. Ultimately, we're careening toward a future where the majority of software code is AI assisted in some form, and anything that helps a product engineer iterate faster is something you should embrace.

This doesn't invalidate engineering skills and knowledge because not understanding, or reviewing, the code an LLM writes is an anti-pattern. A bad one. Understanding the proper architecture of a software project protects you against the decision-making of the robot. This skill is more essential than ever.
...
The whole point of being a product engineer is the ability to ship and iterate quickly independently. It's impossible to do so without some design sensibility, and an understanding of [basic UX principles](https://posthog.com/newsletter/good-taste-great-products).

## 8. How to safely test in production

The ability to safely test changes in production is a fundamental part of being a product engineer.
...
And, of course, it requires a familiarity with feature flags tools like PostHog – and [feature flag best practices](https://posthog.com/docs/feature-flags/best-practices) – to make this all happen.
...
This means being familiar with product experiment tools and core concepts, such as how to write a good hypothesis, best practices, and when it's useful (or not) to run an experiment in the first place.
...
You could argue this is important for anyone in any role, and you'd be right, but it becomes acutely critical when you remove processes and rely on trust and feedback to guide people.

Whether it's code reviews, UX feedback, or feedback on plans and goals, a huge part of being a product engineer is understanding when feedback is useful, and delivering it in a way that it's heard.
