...
<p>
    We started work at 09:00 UTC, May 16 and expect it to take up to four hours. If it takes longer, we'll keep this page updated with the latest information. We'll remove the in-app banner once work is finished.
</p>
</details>
...
<details>
  ...
  <p>
    We first tried to complete this migration on April 28, and notified users at the time. Our team ran into issues however, and we had to rollback. We're now trying to complete the work and finish the migration. We'd originally scheduled to do this on May 12, but decided to delay until May 16 so we could further limit risk and downtime. Thank you for your patience! 
</p>
</details>
