...
rootPage: /compare
featuredImage: >-
    https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/compare/posthog-vs-hotjar/posthog-vs-hotjar.jpg
...
For years, [Hotjar](/compare/posthog-vs-hotjar) was synonymous with session replay. It was the tool that made watching real users interact with your site accessible to everyone – engineers, designers, marketers, and founders alike.
...
This means it's not just an [alternative to Hotjar](/compare/posthog-vs-hotjar), but also tools like [Mixpanel](/compare/best-mixpanel-alternatives), [Sentry](/blog/best-sentry-alternatives), and [LaunchDarkly](/compare/best-launchdarkly-alternatives).
...
Hotjar (now part of [Contentsquare](/compare/best-contentsquare-alternatives)) is great for web session replays, heatmaps, and surveys, but users often rely on other tools for analytics and more. PostHog can replace them all and has a [generous free tier](/pricing) of 5,000 web sessions, 2,500 mobile sessions, and 1 million analytics events per month.

PostHog also provides session replays and surveys for mobile apps – with native SDKs for iOS, Android, React Native, and Flutter – making it a great option if you need a [Hotjar-style tool for mobile apps](/compare/hotjar-for-mobile-ios-android-react-native-flutter). Contentsquare's mobile replay, by comparison, is limited to Enterprise plans.
...
1. **It replaces multiple tools:** PostHog can replace [Hotjar](/compare/posthog-vs-hotjar) (session replay & surveys), [Google Analytics](/blog/posthog-vs-ga4), [GrowthBook](/compare/posthog-vs-growthbook) (feature flags and A/B testing), and more. This simplifies workflows and ensures all their data is in one place.
...
>
> It also has a [generous free tier](/pricing) for each of its products including 5,000 web and 2,500 mobile replays, 1 million events, and 1,500 survey responses per month.
...
[Mouseflow](/compare/best-mouseflow-alternatives) is a behavioral analytics tool that offers session replays, heatmaps, and basic funnel analysis. It's designed mainly for marketing and e-commerce websites. It's very similar to Hotjar, making it a direct rip and replace solution.
...
[Pendo](/compare/posthog-vs-pendo) describes itself as a product experience platform. In addition to session replay and user feedback tools, it offers product analytics, in-app guides, user feedback, and product validation tools. It's mainly used by product managers and customer success teams.
...
> #### Bottom line
>
> [Pendo](/compare/best-pendo-alternatives) isn't a complete replacement for Hotjar due its lack of heatmaps, but the combination of analytics, session replay, and survey tools makes it useful for product managers, especially those who also need in-app product guides.
>
...
- Hotjar/Contentsquare has a product analytics add-on (via [Heap](/compare/posthog-vs-heap)) and zone-based heatmaps; Clarity has basic heatmaps only.
...
**[Hotjar](/compare/posthog-vs-hotjar)** (now Contentsquare) focuses on qualitative behavior analytics – session replays, heatmaps, surveys, and user interviews. PostHog is built for engineering and product teams who want everything in one place; Hotjar is designed for non-technical UX and marketing teams who want simple visual insights.
...
See our [PostHog vs Hotjar comparison](/compare/posthog-vs-hotjar) for a detailed pricing breakdown.
...
If you want more of the functionality of Hotjar, **PostHog** has a generous free tier: 1 million analytics events, 5,000 web and 2,500 mobile session replays, 1,500 survey responses, 1 million feature flag requests, and 100,000 error tracking events per month.
...
For a detailed comparison, see our guide to the [best session replay tools](/compare/best-session-replay-tools).
