...
| **Pricing** | Free: 100 GB/mo ingest + 1 full platform user. Then ~$0.40/GB ingested and per-seat for full users (~$99–$349/mo) |
| **License** | Proprietary |
...
**Alternatives to consider:** **Datadog** for another broad suite; **Dynatrace** for automated root-cause at enterprise scale; **PostHog** if the questions you debug start with "which users?" more often than "which service?"
...
| **Pricing** | Self-hosted is free; SigNoz Cloud is usage-based – $0.30/GB for logs and traces, $0.10 per million metric samples, from $49/mo |
| **License** | Open source (MIT) |
