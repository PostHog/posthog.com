...
| **Pricing** | Free: 100 GB/mo ingest + 1 full platform user. Then ~$0.40/GB ingested plus full-platform seats – Standard is $10 for the first user and $99 each after (max 5 users); Pro is $349/user on an annual commitment |
| **License** | Proprietary |
