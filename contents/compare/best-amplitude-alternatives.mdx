...
Yes. Amplitude offers warehouse-native analytics that can query data directly from Snowflake, BigQuery, and Databricks. **Statsig** and **Mixpanel** also offer strong data warehouse integrations. 
