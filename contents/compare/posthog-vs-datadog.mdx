...
hideAnchor: true
featuredImage: >-
 https://res.cloudinary.com/dmukukwp6/image/upload/comparisons_blog_post_template_2_4ffbb8fec0.png
...
Datadog is organized around services and hosts. PostHog is organized around [events](/docs/data/events), [people](/docs/data/persons), and services.
...
This doesn't mean both aren't used by other types of users though. They have overlapped more and more. Datadog acquired Eppo for experiments and launched a feature flags product. PostHog launched [logs](/logs) and is filling out its APM suite with [tracing](/docs/distributed-tracing) in beta and [metrics](/docs/metrics/installation) in open alpha.
...
- You're already emitting OpenTelemetry and want to [repoint an exporter](/docs/logs/installation) or want quick setup using standard OpenTelemetry instrumentation, without requiring a proprietary agent.
