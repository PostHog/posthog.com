...
Yes. **PostHog**'s free tier covers 5,000 web session replays and 2,500 mobile session replays per month. [Microsoft Clarity](/blog/best-microsoft-clarity-alternatives) is completely free with unlimited sessions (though it has no product analytics or error tracking). **Hotjar** has a free tier for basic heatmaps and recordings. **Sentry** has a free tier for error tracking with 50 session replays/month.
