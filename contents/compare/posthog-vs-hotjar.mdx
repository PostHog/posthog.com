...
- **PostHog** – A single platform that scales from MVP to growth stage. The generous free tier includes 1 million analytics events, 5,000 replays, and 1,500 survey responses per month. [Startups can also qualify for $50k in free credits](/startups).
