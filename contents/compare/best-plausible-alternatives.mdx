...
- PostHog offers [SQL access](/docs/data-warehouse/sql) for custom queries and a built-in [data warehouse](/data-warehouse) for importing external data; Plausible offers CSV exports and a Stats API.
