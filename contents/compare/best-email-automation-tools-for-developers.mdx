...
It triggers messages from the [events](/docs/data/events), [cohorts](/docs/data/cohorts), [feature flags](/feature-flags), and [experiment](/experiments) results already recorded in PostHog, so you can email everyone who finished onboarding, entered a behavioral cohort, or hit a specific flag without exporting anyone to a marketing database first. And because automation lives next to your analytics, you can check what recipients did before and after the send without reconciling two datasets.
