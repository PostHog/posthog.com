...
-   **Channels:** Any dispatch step – email, Slack, push (iOS/Android), webhook, or any CDP destination; a webhook step can call out to anything else you run, so email is just one of them
