...
- PostHog has 100K free events/month, Langfuse has 50K free units/month
...
**Arize** built Phoenix, a popular open source AI observability project with no limits on traces, retention, or users when self-hosted. Arize was acquired by Dynatrace in August 2026.
...
- SOC 2 Type 2 and multi-factor authentication (MFA) on the free tier
...
[Datadog](/compare/best-datadog-alternatives) bolts LLM tracing onto its established APM and infrastructure platform. 
...
- **PostHog** for [CDP](/cdp), [data warehouse](/context-warehouse), and AI observability under one vendor, with self-host and EU hosting for data residency
...
You only need a card when you upgrade past free limits or start a **paid trial** like **[Datadog](/compare/best-datadog-alternatives)**.
