...
**PostHog**: You can pair your experimentation efforts with [PostHog Code](/desktop), a desktop coding agent that runs on top of your product data. PostHog Code turns signals from your PostHog stack – recurring errors, frustration in session replays, survey responses, experiment results, etc. – into a prioritized task list, then creates PRs with the fixes.
