...
- **[PR babysitter](/newsletter/stop-being-the-code-review-bottleneck#2-delegate-pr-babysitting-to-loops).** The goal is to get a pull request to pass tests and "get CI green." The context is the changes (diff) as well as the testing suite, and the evaluation is done by the CI.
