...
Thanks to LLMs, [figuring out what to build](/newsletter/when-ai-writes-all-code#2-setting-direction) is now a greater bottleneck than how to build it, and it's forcing engineers to think more like [product managers](/newsletter/product-management-is-broken) (PMs).
