...
3. **Steady improvements:** Standard product development that doesn't require coordination beyond the product team. For example, LLM Observability adding [time to first token](/changelog?id=2558).
