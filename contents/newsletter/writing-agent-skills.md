...
We’re officially skill-pilled. PostHog teams have published 226 skills to our internal [skill store](/docs/self-driving/skills), and we have 187 `SKILL.md` files across 28 different products in our codebase. Everyone uses skills to both improve PostHog and their own workflows.
