...
- Every product should be priced separately. This means separate free tiers for each product. [AI Observability](/ai-observability) is separate from product analytics, even though they both use “events.”
