...
A clear hypothesis about why your change will achieve your goal
...
Test as small of a change as reasonably possible
...
Read more about these traits in A software engineer's guide to A/B testing on the PostHog blog.
...
How YC's biggest startups run A/B tests (with examples) – Ian Vanagas

How we experiment at Monzo – Monzo blog

5. Understanding significance 📊
There are two moments when you should analyze your goal, secondary, and counter metrics:

At launch, to make sure the test is working as expected.

At the recommended run time, to check for significance and make a decision.
...
8 annoying A/B testing mistakes engineers should know – Lior Neu-ner
...
Enjoying this post? We send new ones every two weeks… and they’re free.
...
But, as Airbnb found out, peeking too early isn’t the only way to get false positives. They found a pattern of hitting significance, and then converging back to insignificant, neutral results in their experiments.
...
Experiment with everything. Say “I don’t know” and find out. Jeff Bezos once said, “Our success at Amazon is a function of how many experiments we do per year, per month, per week, per day.”

Let everyone experiment. Good ideas can come from everywhere. ~75% of Booking.com’s 1,800 tech and product team members actively use the company’s experimentation platform.
...
Learn more in A software engineer's guide to A/B testing on the PostHog blog.
...
Multivariate or A/B/n tests, which compare multiple (n > 2) changes and their impact on the same goal.

Holdout tests, where you leave a small percentage (~10%) of users on the old variant after you choose a winner to test the long-term impact on the goal.

A/A tests, where you compare the same change to see if the impact on the goal is not statistically significant. This is to test your A/B test service, functionality, and implementation work as expected.
...
Targeting your A/B test can go beyond just users. GitHub and GitLab instead use the concept of “actors”, which can include organizations, teams, pages, projects, and more.
...
Read more about targeting in When and how to run group-targeted A/B tests.

Thanks for reading Product for Engineers. Subscribe (it’s free)


Subscribed

Good reads 🤔
PostHog's recommended reading for startup teams – PostHog blog
...
How a startup loses its spark – John Qian
...
Stop Making People Make Up Their Mind – Stay SaaSy
...
Beware of Price Cliffs – Good Better Best
A quick and useful lesson on how mental barriers can impact user behavior.

Words by Ian Vanagas, who is A/B testing whether pineapple belongs on pizza.