...
Right now, we split our responsibilities around the products we care most about, and are uniquely qualified to help progress:
  ...
  * Tim is focused on platform teams, our [data warehouse](/docs/data-warehouse) and [customer data platform](/docs/cdp), and new products like [LLM analytics](/docs/ai-observability). He’s great at execution and understands the ins and outs of these products better than I.
