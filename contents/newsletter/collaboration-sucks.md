...
In return, we ask for extraordinarily high ownership and the ability to get a lot done by *yourself.* Marketers ship code, salespeople answer technical questions without backup, and [product engineers](/product-engineer-handbook/what-is-a-product-engineer) work across the stack.
