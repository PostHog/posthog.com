...
As humans shifted from writing code to [orchestrating agents that write code for them](/newsletter/when-ai-writes-all-code#4-evaluating-the-work-of-your-agents), code review has become the new bottleneck.
