...
6. Borrow a familiar concept to explain a new one. For example, one hackathon team explored building our own take on [Claude Cowork](/blog/making-claude-cowork-actually-useful) inside [PostHog Desktop](/desktop), so they creatively named their project PostHog Work.
...
24. Do more weird. No one asked for clips of [Dylan](https://www.linkedin.com/in/dmarticus) sipping piña coladas in the background, but the [PostHog Desktop](/desktop) mobile app team did it anyway. It's also the demo I remember most. 🍹
