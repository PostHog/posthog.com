...
Many engineers place shipping code above all else. Anything that gets in the way of this is, apparently, a waste of time. This reflects in common metrics for measuring engineering success like lead time or deployment frequency.
...
You might already think you know what users want. Someone spoke to users, turned those insights into tickets, and you to build them. The problem with this is there has been a lot of information lost in the process of going from interviews to tickets.
...
As an engineer, you miss out on the context and depth of information users can provide. The person talking to the user likely doesn't know the options and constraints as well as you do. You miss out on being able to dive deeper on those areas and use that information to close in on a good solution

Think of user interviews like automated tests. Not doing them saves you time, but also leads to pain over the long term. Both enable you to iterate faster by providing rapid feedback on if what you've built is working, even if they aren't code you ship.

## 3. Preparing to talk to users

To make the most out of talking to users, you should know: 

1. **Who are your users.** Read "[Defining our ICP is the most important thing we ever did](https://newsletter.posthog.com/p/defining-our-icp-is-the-most-important)" if you don't know.
...
If this process is going too slow, an incentive like a merch code or gift card, can help speed it up.
...
Our experience talking to users has revealed two main discussion areas. The first is **problem exploration**. This guides future product decisions, like [what to build next](https://newsletter.posthog.com/p/how-we-decide-what-to-build). Focus on concrete, past situations by asking questions like:
...
The first thing you should do after the interview is clean up and [share the notes with your team](https://posthog.com/product-engineers/interview-snapshot-guide). This helps you get more from the work you've done talking to them. We keep all of our user interview notes in a single user interview file (it is currently 378 pages long).
...
The second thing to do after the interview is to use it to take action. The great part about being an engineer is that you can just ship small changes yourself. For example, our team often immediately makes small UX changes to clarify a user confusion.
...
Your users are still your users after you talk with them. This means you should still try to build valuable things and get feedback from them after you talk with them.
...
By getting more feedback from users, we are better able to ship features users actually want. In the long run, this is a repeatable method to build the best possible product.
