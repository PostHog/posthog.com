...
<section class="my-24 px-5">
  <div class="max-w-screen-2xl mx-auto">
    ...
    <p class="text-2xl lg:text-3xl m-0 text-center mb-6 sm:mb-16 lg:mb-8">Teams must be less than 2 years old and have less than $5 million in funding 
    <br />(but we can be a bit flexible)</p>
