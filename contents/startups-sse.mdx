---
title: PostHog x SSE Business Lab
showTitle: false
showSidebar: true
width: lg
images:
...
<div className="max-w-[849px] mx-auto text-center">
  ...
  <h2 className="text-[18px] md:text-[20px] leading-[1.4] font-semibold mb-8 !mt-5">
    Teams in the SSE Business Lab can claim $50k in credit <br className="hidden lg:block" />
    and other perks to help get to product-market fit
  </h2>
...
<section class="my-24 px-5">
  <div class="max-w-screen-2xl mx-auto">
    ...
    <p class="text-2xl lg:text-3xl m-0 text-center mb-6 sm:mb-16 lg:mb-8">Teams must be less than 2 years old and have less than $5 million in funding </br>(but we can be a bit flexible)</p>
    <div class="flex justify-center">
      <ul class="m-0 p-0 list-none inline-grid sm:grid-cols-2 lg:grid-cols-4 justify-evenly relative text-center sm:text-left">
        ...
        <li class="relative md:max-w-md py-4 md:py-8 pl-4 pr-2 md:px-12 lg:px-8">
          ...
          <p class="m-0 text-[15px]">Refer an accelerator to 2x your credits, or split $10k when you refer a friend.</p>
        </li>
      </ul>
    </div>
  </div>
