---
title: PostHog x Scaling DevTool 
showTitle: false
showSidebar: true
width: lg
images:
...
<section class="my-24 px-5">
  <div class="max-w-screen-2xl mx-auto">
    ...
    <p class="text-2xl lg:text-3xl m-0 text-center mb-6 sm:mb-16 lg:mb-8">We're extending our startup program to all teams in the Scaling Devtools hackathon, offering you these benefits</p>
