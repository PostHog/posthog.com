...
<div class="w-[calc(100%_+_4rem)] relative -mx-4 px-8 md:-mx-16 pt-32 pb-72 -mt-32 md:-mt-44">
  ...
  <h2 className="text-[18px] md:text-[20px] leading-[1.4] font-semibold mb-8 !mt-5">Claim $50,000 in PostHog credit<br className="hidden lg:block" />to power you hackathon project for a year</h2>
