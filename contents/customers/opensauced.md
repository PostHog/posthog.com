...
<Quote
    ...
    quote={`“PostHog is ideal for startups as it is a really solid analytics tool, but also has a bunch of features like feature flags and experiments that will become even more useful as the company grows. That will save founders like Brian time, as they have the right tools for the job from day 1.”`}
/>
</BorderWrapper>
