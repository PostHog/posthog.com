...
Mention Me’s Product Stack
Logos for: AppCues, PostHog, Intercom
...
PostHog’s all-in-one nature has also enabled Mention Me to reduce the number of different platforms they use, dropping tools such as HotJar. Session recording and heatmaps are now both achieved with PostHog, so teams can see the qualitative and quantitative impact of changes they make all in one intertwined platform.
