...
As a fast-growing startup, Saga recognised the importance of product analytics from the very beginning, using [Amplitude](/blog/posthog-vs-amplitude) to track users in its earliest versions. However the team soon ran into issues with data integrity. 
