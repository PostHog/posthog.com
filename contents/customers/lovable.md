...
“We started using PostHog very early on,” Viktor says. “We [use feature flags to roll out releases gradually](/tutorials/phased-rollout), experiments to test new ideas, and [AI Observability](/ai-observability) too. It’s a crucial part of how we debug traces and ask ourselves questions like, ‘Why is the LLM doing that?’”
