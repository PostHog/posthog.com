---
title: How Lovable builds better agents with AI Observability and experimentation
customer: Lovable
featuredImage: >-
...
“We started using PostHog very early on,” Viktor says. “We [use feature flags to roll out releases gradually](/tutorials/phased-rollout), experiments to test new ideas, and [AI Observability](/llm-analytics) too. It’s a crucial part of how we debug traces and ask ourselves questions like, ‘Why is the LLM doing that?’”
...
This kind of debugging isn’t limited to new releases however. For Viktor, it’s a daily practice — honing efficiency, investigating odd behaviors, and pushing Lovable’s agents forward. It’s this drive which has led him to become one of the heaviest users of AI Observability across the team, often comparing PostHog directly with other AI Observability tools in their stack...
...
## How _does_ PostHog stack up against other AI Observability tools?
