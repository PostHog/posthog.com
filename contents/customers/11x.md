...
“It was a real hodgepodge of tools,” says Keith Fearon, Head of Growth at 11x. “We used [HotJar](/compare/posthog-vs-hotjar) for session recordings, [FullStory](/compare/posthog-vs-fullstory) for analytics, and we were building our own in-house feature flags.”

Eventually, after two years, the team decided to optimize things. They soon discovered that PostHog offered all of these tools in one platform, complete with its own [dedicated AI analytics suite](/docs/ai-observability)
