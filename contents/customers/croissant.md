...
Croissant’s team was already using PostHog for analytics, web insights, and surveys. But as they built out their B2B motion, they wanted a way to act on that data, not just analyze it.
...
<OSQuote
  customer="getcroissant"
  author="jorge_lopez_sarry"
  product="workflows"
 />
