...
1. The number of rows exported via [batch exports](/docs/cdp/batch-exports)
2. The number of events triggered under [realtime destinations](/docs/cdp/destinations)

Like other products, there is a generous free tier for both categories which can be seen on the [pricing](/pricing) page. 

## Estimating your monthly bill

Once you've figured your projected event usage and flag requests, you can either:

1. Use the pricing calculator on our [pricing](/pricing?calculator) page and calculate your estimated costs for adopting PostHog. 
...
- For Product Analytics, read [how to capture fewer events](/docs/product-analytics/cutting-costs)
...
- For Feature Flags, read [how to reduce flag requests](/docs/feature-flags/cutting-costs)
- For Error Tracking, read [how to capture fewer exceptions](/docs/error-tracking/pricing#tips-to-reduce-your-bill)
- For Logs, read [how to reduce the volume you ingest](/docs/logs/pricing)
- For Data Warehouse, read [how to sync less data](/docs/data-warehouse/cutting-costs)
