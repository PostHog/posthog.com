...
Your data pipelines are billed on two things: the number of rows exported via [Batch exports](/docs/cdp/batch-exports), and the number of events triggered under [Realtime destinations](/docs/cdp/destinations). 
