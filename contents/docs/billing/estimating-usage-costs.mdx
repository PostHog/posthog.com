...
- For Session replay, read [how to only record the sessions you want](/tutorials/limit-session-recordings)
- For Feature flags, read [how to make fewer API requests](/docs/feature-flags/common-questions#how-can-i-reduce-the-cost-of-feature-flags)
