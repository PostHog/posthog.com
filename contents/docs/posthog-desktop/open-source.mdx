...
PostHog Desktop is open source under the MIT license. The full source for the desktop app, the agent framework, and the bundled PostHog skills lives at [github.com/PostHog/code](https://github.com/PostHog/code).
...
PostHog Desktop is released under the [MIT license](https://github.com/PostHog/code/blob/main/LICENSE).
