...
To run several tasks in a grid (mixing these modes), use [Command Center](/docs/posthog-desktop/command-center).
...
For setup details and configuration options, see [Worktrees](/docs/posthog-desktop/worktrees).
...
See [Cloud runs](/docs/posthog-desktop/cloud-runs) for the full story, including how to move tasks between cloud and local.
