...
Use the report's chat to choose what happens next. The conversation includes the report and its evidence as context.

You can use a suggested action or tell the agent what you need. Depending on the report, the agent can investigate further, start or continue a fix, defer the report until more evidence arrives, or archive it with a reason.
