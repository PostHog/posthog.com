...
export const RunningTimeLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/w_400,c_limit,q_auto,f_auto/pasted_image_2025_12_16_T16_38_32_989_Z_361d910bf8.png";
export const RunningTimeDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/w_400,c_limit,q_auto,f_auto/Screenshot_2025_12_16_at_17_43_43_a8f08f51f6.png";
export const ConfigModalLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/h_1000,c_limit,q_auto,f_auto/us_posthog_com_project_2_experiments_182150_b288872be7.png";
export const ConfigModalDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/h_1000,c_limit,q_auto,f_auto/us_posthog_com_project_2_experiments_182150_3_9ac460a093.png";
export const ManualModeLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/h_1000,c_limit,q_auto,f_auto/us_posthog_com_project_2_experiments_182150_2_9907deabe4.png";
export const ManualModeDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/h_1000,c_limit,q_auto,f_auto/us_posthog_com_project_2_experiments_182150_4_a6ce94be6c.png";
...
- Automatic is the default mode for _launched_ experiments and provides more accurate results.
- Manual mode is default for _draft_ experiments, and _optional_ for launched experiments.
...
<CalloutBox icon="IconInfo" title="Automatic mode requires real data">
...
The default is **30%**, which is a reasonable starting point for most experiments. You can change the default MDE for all new experiments in your project by going to [**Settings** > **Experiments**](https://app.posthog.com/settings/environment-experiments#environment-experiment-mde). This requires admin access. Individual experiments can still override the project default.
