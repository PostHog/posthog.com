...
- Automatic is the default mode for *launched* experiments and provides more accurate results. 
- Manual mode is default for *draft* experiments, and *optional* for launched experiments.
...
### Setting a project-level default

To set the default MDE for all new experiments, go to **Experiments > Settings**. This is useful if your team runs many experiments and wants a consistent MDE across the project.

You can override this default for any experiment in the running time configuration modal.
