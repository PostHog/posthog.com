...
The calculator offers two modes: **Automatic** and **Manual**. Automatic mode is the default for launched experiments and provides more accurate results using real data. Manual mode is available for both draft and launched experiments.
...
> **Note:** Automatic mode is only available after launching your experiment since it requires real data. For draft experiments, use Manual mode to estimate running time before launch.
...
Manual mode lets you estimate running time **before** launching your experiment. It's the default mode for draft experiments, enabling you to plan your test duration in advance. Use it when you know your approximate traffic numbers and baseline metrics.
