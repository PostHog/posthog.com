...
1. Ensure your feature flag has at least 2 variants.
2. Make sure one variant has the key `control`.
3. If using an existing feature flag, check that it meets both requirements before linking it to an experiment.
