...
- [Log-normal model with a Normal-Inverse-Gamma prior for trends metrics with property values](/docs/experiments/trends-property-value-statistics) like revenue.
