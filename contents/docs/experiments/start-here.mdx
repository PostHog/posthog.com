...
<OSButton variant="primary" asLink={true} to="/docs/experiments/installation">
  Install PostHog SDK
</OSButton>
...
<OSButton variant="primary" asLink={true} to="/docs/experiments/creating-an-experiment">
...
<OSButton variant="primary" asLink={true} to="/docs/experiments/adding-experiment-code">
...
<OSButton variant="primary" asLink={true} to="/docs/experiments/metrics">
