...
See exactly what users experienced in each variant with [session recordings](/docs/session-replay) tied to your experiment results. Filter recordings by experiment variant to understand why users behaved differently – click **View recordings** on any variant in your results to see recordings for users in that group.
