...
Metrics define how you measure the experiment's impact. You can add them in step 3 of the creation wizard, after saving the experiment, or even after launching – but you won't see results without them. Go to your experiment and click **Add metric** in the Primary metrics section.
