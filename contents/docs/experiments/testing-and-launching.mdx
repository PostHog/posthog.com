...
Before you can launch your experiment, you need to define at least one metric to measure its success. Metrics determine what you're measuring and how you'll know if your experiment is successful.

To add a metric, go to your experiment's **Primary metrics** section and click **Add metric**. You can choose from funnel metrics (for conversion rates), mean metrics (for averages and sums like revenue), or ratio metrics (for custom calculations). 

[Learn more about experiment metrics](/docs/experiments/metrics) and how to choose the right metric type for your hypothesis.
