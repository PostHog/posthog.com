...
> To run an experiment using our API (without any SDK), see our docs on [how to run experiments without feature flags](/docs/experiments/running-experiments-without-feature-flags).