...
After saving an experiment, you can access the **Settings** tab to configure additional options.

### Statistics

Change the statistical method used for your experiment's analysis. You can choose between **Bayesian** and **Frequentist** and adjust the confidence level.

### Notifications

Set up notifications to get alerted when a metric reaches statistical significance. This saves you from having to manually check your experiment results.

Available notification destinations:

- **Slack** – Post a message to a Slack channel
- **HTTP Webhook** – Send a webhook to a custom URL