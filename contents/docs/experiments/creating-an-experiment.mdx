...
If your project has **Flag persistence default** enabled in [project settings](/docs/feature-flags/project-wide-settings#flag-persistence-default), the experiment's feature flag will automatically have persistence enabled. You can override this in the experiment creation form.
