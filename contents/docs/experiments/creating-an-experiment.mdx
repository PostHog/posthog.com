...
To create a new experiment, go to the [A/B testing tab](https://app.posthog.com/experiments) in the PostHog app, and click on the "Create experiment" button in the centre of the page.
...
<ProductVideo
    ...
    vidoDark={ImprovementCalculatorDark}
