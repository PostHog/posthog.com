...
By default, your experiment will target 100% of participants. If you'd like to target a more specific set of participants, or change the rollout percentage, you'll need to do this by changing the [release conditions](docs/feature-flags/creating-feature-flags#release-conditions) for the feature flag used by your experiment.
