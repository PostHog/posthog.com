...
- They evaluate the flag both before and after calling `identify` and you don't have [flag persistence](/docs/feature-flags/creating-feature-flags#persisting-feature-flags-across-authentication-steps) enabled
