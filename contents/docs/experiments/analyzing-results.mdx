...
The **AI analysis** tab uses [PostHog AI](/docs/posthog-ai) to help you understand your experiment results. It contains two features:

- **Summarize results** – Analyzes your experiment's metric results, statistical significance, and variant performance using AI.
- **Summarize session replays** – Compares session recordings across variants to identify differences in user behavior.

To access the AI analysis tab, click the **AI analysis** tab at the top of the experiment view.
