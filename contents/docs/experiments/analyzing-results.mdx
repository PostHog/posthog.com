...
Stopping the experiment will stop counting events in the results. Your feature flag, however, will continue working normally and events will still be tracked. You can restart the experiment later if needed.
