...
You can also click **Summarize session replays** to have PostHog AI analyze recordings across your experiment variants. This uses Max AI to identify behavior patterns, highlighting differences in how users interact with each variant.
