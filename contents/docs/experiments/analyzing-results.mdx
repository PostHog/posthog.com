...
Click on any funnel step bar (except the first "Experiment exposure" step) to inspect the persons at that step. Clicking the filled portion of the bar shows persons who **completed** the step, while clicking the background shows persons who **dropped off**. This opens a modal listing matching persons along with links to their [session recordings](/docs/session-replay).
