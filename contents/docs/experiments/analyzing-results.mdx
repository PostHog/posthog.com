...
<CalloutBox icon="IconInfo" title="Get notified when results are significant" type="fyi">

Instead of checking results manually, you can set up notifications to receive alerts when a metric reaches statistical significance. See [Settings](/docs/experiments/creating-an-experiment#settings) for setup instructions.
