...
You can also click **Summarize session replays** to have [PostHog AI](/docs/posthog-ai/session-summaries) analyze user behavior patterns across your experiment's session recordings. This helps you understand why users in different variants behaved differently by identifying common patterns, issues, and insights from the recordings.
...
After you've analyzed your experiment metrics and determined a winning variant, you can click the **End experiment** button on the experiment page. This lets you choose a variant to keep, roll it out to all users, and end the experiment.
...
## Pausing and resetting experiments
...
Resetting analysis clears the experiment's collected data, returning it to a draft state. This doesn't affect the feature flag or variant rollout – it only resets the analysis data.
...
| **Resetting** | Unchanged | Multiple variants | Resets | Cleared | Yes (relaunch) |