...
| `experiment-metrics-recalculation-latest-retrieve` | Get the current results for an Experiment, including per-variant statistics, confidence intervals, and significance.              |
| `experiment-metrics-recalculation-create`          | Trigger a fresh calculation of all metrics for an Experiment. Use when results look stale.                                        |
...
- `Recalculate the results for my checkout-flow experiment.`
