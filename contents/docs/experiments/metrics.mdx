...
CUPED supports **mean** and **funnel** metrics. It automatically uses 14 days of pre-experiment data as the lookback window.
...
If both are configured, the experiment-level setting takes precedence:
