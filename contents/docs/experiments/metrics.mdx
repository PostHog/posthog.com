...
<CalloutBox icon="IconInfo" title="New feature" type="fyi">
    You can now duplicate shared metrics by clicking the copy icon next to any metric. This action will pre-populate the save form with your metric information, allowing you to change or accept the existing values.
</CalloutBox>
