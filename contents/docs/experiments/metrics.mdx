...
<CalloutBox icon="IconInfo" title="New feature" type="fyi">
    You can now duplicate existing shared metrics by clicking the copy icon next to any metric. This creates a new metric with the same configuration but with "(Duplicate)" appended to the name.
</CalloutBox>
