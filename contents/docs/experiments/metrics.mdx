...
Each metric can be set as either a **primary** or **secondary** metric. You can set up to 10 primary and 10 secondary metrics per experiment. This is just a way of organizing metrics - primary and secondary metrics work the same way.
