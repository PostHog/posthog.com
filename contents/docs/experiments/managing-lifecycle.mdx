...
4. [Archiving the experiment](#archiving-experiments).
...
| **Archiving** | Unchanged | Unchanged | Unchanged | Preserved | Yes (unarchive) |

## Archiving experiments

Archiving moves completed experiments out of your default list view while keeping all data and results intact. Archived experiments don't appear in the main experiments list, so you can focus on active work.

To archive an experiment, open the **More** menu on the experiment page and select **Archive experiment**.

### Unarchiving experiments

You can unarchive an experiment if you need to reference or restore it. This returns the experiment to the default list view without changing its status, dates, or results.

To unarchive:

1. Filter the experiments list to show **Archived** experiments.
2. Find the experiment you want to restore.
3. Open the **More** menu on the experiment row or detail page and select **Unarchive experiment**.
