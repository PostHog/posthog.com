...
To set the default confidence level for all experiments, go to **Settings** > **Experiments**. You can also override this for individual experiments in the **Statistics** section of the experiment.
