...
For ratio metrics, the numerator and denominator are capped independently—each with its own percentile thresholds computed from the pooled experiment population.
