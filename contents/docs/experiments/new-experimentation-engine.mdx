...
Cap metric values at specified quantile thresholds by setting lower and upper bounds. This is especially useful for metrics with skewed distributions, like revenue or total event counts.
