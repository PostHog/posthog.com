...
Read on for a how to enable and a deeper dive into the new features.
...
1. Click on your name in the lower-left corner of the PostHog app to open the menu.
...
The new engine is still in beta, so some features in the old engine is not yet supported in the new. All of these are things we are working on and hope to ship soon.
