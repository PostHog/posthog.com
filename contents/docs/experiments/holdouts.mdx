...
When running A/B tests, you can create lists of users called "holdouts" who won't participate in experiments. You can keep these same users out of either specific experiments or all of your testing entirely.
