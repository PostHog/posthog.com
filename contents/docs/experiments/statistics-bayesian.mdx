...
For example, instead of saying "statistically significant at p < 0.05," you get intuitive statements like "There's a 96% chance that variant B increases conversion rate."
