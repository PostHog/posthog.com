...
* **New** - Users who did the action during interval and were also created during that period (e.g. Created an account and sent a message during today)
...
* **Resurrecting** - This is someone who was not active in the previous interval and became active once again (e.g. did not send any messages 10 days, but sent one today)
