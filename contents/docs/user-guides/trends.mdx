...
### Creating and customizing a trend
...
#### Adding events and filtering

Now that we've created our Trends insight, the next thing we want to do is select the events we would like to see. This can be done by clicking the dropdown next to Series 'A'.
