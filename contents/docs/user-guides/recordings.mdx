...
Recordings are kept indefinitely by default. You can set recordings to delete after a configurable number of days in the [project settings page](/project/settings#recordings).
