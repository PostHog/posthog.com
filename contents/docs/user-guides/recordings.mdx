...
-   The seekbar shows a striped pattern when inactivity ocurred and a solid pattern when activity ocurred. If the pattern is red it means the recording has been buffered and loaded. If it's gray it means it's loading.
