...
Find out how to create an experiment [here](https://docs.google.com/document/d/1DJmSY6ILZFmHhmRLTQ0L2oXGgFZCvGM4DF-zh92DIE8/edit?usp=sharing).
...
**1. Use the PostHog Toolbar** - Once you've pushed your experiment code, you can open the PostHog toolbar, click on the feature flags option, and override the feature flag to whichever variant you want, and see that the changes reflect on your screen.

**Note:** This doesn't work if you're using NextJs

**2. Use the web developer console** - The experiment draft screen also has a snippet for testing your code. Once you've pushed your experiment code, open the console on your browser, and paste the snippet in. This will override the feature flag for you, and you should be able to see the changes you've made on screen.
