...
Experimentation helps you test product changes to your app and find the optimal changes. You can test hypotheses about which product changes will lead to optimal results. You may have heard it before as A/B testing. Examples:
...
With Experimentation, you start with a hypothesis on how to improve your product (e.g. changing the flow, changing copy, changing visual styles, ...) and a goal (e.g. improve conversion, improve sign ups, ...).

-   Once you have those, you can create an Experiment which will have a control group and any number of experimentation variants (at least one).
-   You can select which users will participate in the Experiment (e.g. paid users, users in a given country, or all users).
...
-   [ ] Document conclusions and findings in your PostHog experiment. This will help preseve context for team members who in the future need to understand what happened.
-   [ ] Archive the experiment. This will terminate the Feature Flag so make sure your code no longer depends on the flag.
