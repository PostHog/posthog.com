...
## Recording console log

You can optionally record anything that happens in your console log. To activate, you'll need to add `enable_recording_console_log: true` to the posthog.init call like so:
...
To find the logs, click on a recording and find the 'Console' tab.
