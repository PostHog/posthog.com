...
Definitions are the basic building blocks for how you manage data at PostHog. There's no need to create any definition in order to get started analyzing your data on PostHog. However, your team's experience on PostHog can be greatly enriched when your events are defined with best practices in mind.
...
You can learn about how to best use these attributes by going to our [best practices](/docs/user-guides/data-management/#how-to-use-data-management-as-a-team-best-practices) section.
