...
It's also worth noting that Stickiness measures the number of users who performed an action an **exact** number of times.
...
Now that have the hang of Stickiness, you can tune your insight further by:
