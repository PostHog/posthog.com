...
Feature Flags allow you to safely deploy and roll back new features. It means you can ship the code for new features and then slowly roll them out to your users. If something has gone wrong, you can roll back without having to re-deploy your application. Feature Flags can also help you control access to certain parts in your product (e.g. only show paid features to users with an active subscription).
...
![Create feature flags](../../images/features/feature-flags/feature-flags-page.png)
