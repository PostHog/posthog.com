...
| `--dotenv-file <PATH>`      | Load PostHog credentials from a dotenv-style file when not present in the process environment. Also settable via `POSTHOG_CLI_DOTENV_FILE`.                                                                      |
