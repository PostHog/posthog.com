...
Clusters automatically group similar LLM [traces](/docs/ai-observability/traces) or [generations](/docs/ai-observability/generations) together, helping you discover patterns in how users interact with your LLM features without reading every conversation.
...
Enabled clustering jobs run automatically during the next scheduled cycle — no manual intervention needed beyond having [traces captured](/docs/ai-observability/installation).

## Viewing clusters

Navigate to **AI Observability** > **Clusters** to see the overview.
...
- **Filters** – Narrow which traces or generations to include by event properties, person properties, or cohort membership. Leave empty to include all.
