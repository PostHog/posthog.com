...
Custom properties in LLM analytics enable you to add metadata to your [AI generations](/docs/ai-observability/generations), making it easier to filter, analyze, and understand your LLM usage patterns. 

This guide shows you how to set custom properties using PostHog's LLM analytics SDKs and leverage them for better observability. For specific integration patterns, see our guides on [linking to session replay](/docs/ai-observability/link-session-replay) and [linking to error tracking](/docs/ai-observability/link-error-tracking).
