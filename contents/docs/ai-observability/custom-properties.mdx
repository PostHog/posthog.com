...
Custom properties in AI Observability enable you to add metadata to your [AI generations](/docs/ai-observability/generations), making it easier to filter, analyze, and understand your LLM usage patterns.

This guide shows you how to set custom properties using PostHog's AI Observability SDKs and leverage them for better observability. For specific integration patterns, see our guides on [linking to session replay](/docs/ai-observability/link-session-replay) and [linking to error tracking](/docs/ai-observability/link-error-tracking).

## Why use custom properties?

Custom properties help you:
- **Filter [traces](/docs/ai-observability/traces)** by specific criteria (e.g., subscription tier, feature flags, account settings)
- **Track prompt versions** to measure improvements over time
- **Link backend LLM events** to [session replays](/docs/ai-observability/link-session-replay) and [error tracking](/docs/ai-observability/link-error-tracking)
- **Group related [generations](/docs/ai-observability/generations)** by custom business logic (e.g, sessions, conversations, tenants )
...
Once you've set custom properties, they appear in the PostHog AI Observability dashboard where you can:
