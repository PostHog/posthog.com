...
<CalloutBox icon="IconFlask" title="User feedback is in beta" type="action">
...
3. View user feedback per-trace within AI Observability, or view all feedback within [Surveys](https://app.posthog.com/surveys).
...
On any top-level [trace](/docs/ai-observability/traces) (or pseudo-trace) event, navigate to the **Feedback** tab to create a survey.
...
For the quickest setup in React apps, [use the `useThumbSurvey` hook to wire up your survey](/docs/ai-observability/user-feedback/use-thumb-survey).

If you need more flexibility, or are not building a React app, see [manual feedback event capture](/docs/ai-observability/user-feedback/manual-event-capture).

## Viewing survey responses

You can view survey responses per-trace within AI Observability, or per-survey within Surveys.
...
You can also view all responses in a table, and quickly link to the related trace by clicking the AI Observability icon:
