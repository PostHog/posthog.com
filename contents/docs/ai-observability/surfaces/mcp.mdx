---
title: Use AI Observability over MCP
sidebar: Docs
showTitle: true
---
...
The server also exposes tools for the scoring side of AI Observability – creating and running [evaluations](/docs/ai-evals), managing trace reviews and review queues, and configuring [clustering](/docs/ai-observability/clusters) – so an agent can set up scoring for you as well as read the results.
...
- Score traces automatically with [AI Evals](/docs/ai-evals).
