...
AI Observability gives you x-ray vision into your LLM applications. You can track:
...
>
  ...
  PostHog's AI Observability dashboard provides a comprehensive overview of your LLM performance. Break usage metrics down by model, latency, cost, and more.
...
/>
  ...
  <OSButton variant="primary" asLink to="/docs/ai-observability/dashboard">
