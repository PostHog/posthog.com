...
AI Observability captures every call your product makes to an LLM and turns them into traces you can query, score, and get alerted on. You can:
...
<QuestLogItem 
  title="Track AI traces"
  subtitle="Required"
  icon="IconRecord"
>

  Once you've installed the SDK, every LLM call automatically becomes a [trace](/docs/ai-observability/traces) – a detailed record of what went in and what came out. Each trace captures:
...
<OSButton variant="primary" asLink to="/docs/ai-observability/traces">
  Learn about traces
</OSButton>
...
>
  ...
  PostHog's evaluation suite runs offline and online evals, so you can block regressions before they ship and monitor live performance. Three evaluation types are supported:
...
>
  ...
  Your LLM data is a [signal source](/docs/self-driving/inbox/sources) for [Self-driving](/docs/self-driving). A scout watches it and files an investigation report in your inbox when a regression appears which can become a PR in one-click. Signals include:

  - 💰 Cost spikes
  - ⏱️ Latency regressions
  - ❌ Error rate increases
  - 📈 Volume anomalies
  - ⚖️ Eval performance drops
