...
Click any session to open its detail page. The page displays the conversation – all messages exchanged between users and the LLM across the session's traces.
