...
This 30-day window applies to the large properties of `$ai_` events only. For the period that PostHog keeps all other events, see [events data retention](/docs/data/events-retention).
