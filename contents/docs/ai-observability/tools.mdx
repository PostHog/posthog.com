...
Click on any tool name to drill down into the [Generations](/docs/ai-observability/generations) tab, filtered to show only generations that called that specific tool. This helps you:
...
Tool calls also appear as tags directly in the [Traces](/docs/ai-observability/traces) and [Generations](/docs/ai-observability/generations) views, making it easy to spot which conversations involved tool use at a glance.
