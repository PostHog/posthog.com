...
Reviews are also a practical way to find gaps in your [evaluations](/docs/ai-evals). Manual review helps you spot failure modes you have not encoded yet, so you can turn them into better automated checks later.
...
Trace Reviews and [evaluations](/docs/ai-evals) solve different problems:
