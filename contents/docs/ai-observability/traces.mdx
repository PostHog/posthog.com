...
If you also send OpenTelemetry spans to [Distributed tracing](/docs/distributed-tracing), you can set `$ai_trace_id` to the trace ID of the surrounding span and correlate the two products. See [Link traces to AI Observability](/docs/distributed-tracing/link-ai-observability).
