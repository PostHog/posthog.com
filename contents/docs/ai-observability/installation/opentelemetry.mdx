...
The OTLP path caps each export at **4MB** and each span at **8MB**. Oversize data is dropped without an application error. See [capturing large AI events](/docs/ai-observability/large-events#sending-over-opentelemetry) to avoid silent data loss.
