...
- The full event, including large properties like `$ai_input` and `$ai_output`, is kept for 30 days. After that, only a copy without those properties remains. See [data retention](/docs/ai-observability/data-retention).
