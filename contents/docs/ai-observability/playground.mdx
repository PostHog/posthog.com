...
<<<<<<< HEAD
The playground works out of the box with PostHog-provided trial models — no setup required. To use your own API keys for higher rate limits and access to more models, add them in [**Settings** > **AI Observability**](https://app.posthog.com/settings/project-ai-observability#ai-observability-byok).
||||||| 740056430
...
<<<<<<< HEAD
[Add your own API keys](https://app.posthog.com/settings/project-ai-observability#ai-observability-byok) to remove PostHog rate limits. BYOK models are subject only to the provider's own rate limits.
||||||| 740056430
