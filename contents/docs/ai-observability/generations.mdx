...
PostHog can classify the sentiment of user messages in your generations as negative, neutral, or positive using a local model — no data is sent to third-party services. Sentiment runs as a [sentiment analysis evaluation](/docs/ai-evals#sentiment-analysis-evaluations) that you configure. See [Sentiment classification](/docs/ai-observability/sentiment) for more details.
