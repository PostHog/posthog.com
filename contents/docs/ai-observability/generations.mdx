...
You can automatically assess the quality of your generations using [evaluations](/docs/ai-evals/evaluations). Evaluations use an LLM-as-a-judge approach to score outputs based on criteria like relevance, helpfulness, or safety.
