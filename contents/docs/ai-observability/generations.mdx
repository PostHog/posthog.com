...
These properties are captured automatically when using the [OpenAI](/docs/ai-observability/installation/openai) or [Azure OpenAI](/docs/ai-observability/installation/azure-openai) wrappers.
