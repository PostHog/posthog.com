...
Reports are available for **boolean evaluations** (LLM-as-a-judge and code-based) and **sentiment analysis evaluations** that target generations. Evaluations targeting traces don't support reports.
