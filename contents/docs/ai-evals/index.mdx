...
Reports are available for **boolean evaluations** (LLM-as-a-judge and code-based) on any target – generations, traces, or sessions – and for **sentiment analysis evaluations**, which target generations.
