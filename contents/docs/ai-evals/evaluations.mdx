...
Evaluations automatically assess the quality of your LLM [generations](/docs/ai-observability/generations) and return a pass/fail result with reasoning. PostHog supports two types of evaluations:
...
| ------------------------ | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
<<<<<<< HEAD
| **Trial limit reached**  | The 100 free trial evaluation runs have been exhausted.   | Add your own API key in [**Settings** > **AI Observability**](https://app.posthog.com/settings/project-ai-observability#ai-observability-byok).       |
||||||| 740056430
...
<<<<<<< HEAD
| **Provider key deleted** | The provider API key used by this evaluation was removed. | Add a new provider API key in [**Settings** > **AI Observability**](https://app.posthog.com/settings/project-ai-observability#ai-observability-byok). |
||||||| 740056430
