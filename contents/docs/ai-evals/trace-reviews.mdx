...
Trace Reviews are the manual review workflow in [LLM analytics](/docs/ai-observability). They let your team inspect individual [traces](/docs/ai-observability/traces), apply structured scores, add reasoning, and work through pending traces in queues.
