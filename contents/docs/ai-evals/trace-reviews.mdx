...
Trace Reviews are the manual review workflow in [AI Evals](/docs/ai-evals). They let your team inspect individual [traces](/docs/ai-observability/traces), apply structured scores, add reasoning, and work through pending traces in queues.
...
Reviews are also a practical way to find gaps in your [evaluations](/docs/ai-evals/evaluations). Manual review helps you spot failure modes you have not encoded yet, so you can turn them into better automated checks later.

## How Reviews work

The **Reviews** area in AI Evals has three parts:
...
1. Create a queue in **AI Evals** > **Reviews** > **Queues**
...
1. Open a trace in [Traces](/docs/ai-observability/traces) or from a review queue
2. Click **Review**
...
Trace Reviews and [evaluations](/docs/ai-evals/evaluations) solve different problems:
