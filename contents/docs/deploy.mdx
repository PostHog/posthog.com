...
<div class="flex flex-col items-stretch lg:flex-row lg:items-center justify-between bg-gray-accent-light dark:bg-gray-accent-dark py-4 px-6 rounded-sm mb-4 space-y-3 lg:space-y-0 lg:space-x-3">
    <div>
        <span class="font-bold text-xl block">Get started with PostHog Cloud</span>
        <span class="text-base text-gray block">It's the easiest and quickest way to set-up PostHog.</span>
    </div>
    <CallToAction class="shrink-0" to="https://app.posthog.com/signup">Get started</CallToAction>
</div>

Change your mind later? You can always [migrate to a self-hosted instance later](/docs/runbook/migrate/migrate-between-cloud-and-self-hosted).
