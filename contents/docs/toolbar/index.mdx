...
You can view your existing actions on your page by clicking the "Actions" button on the Toolbar. 

This will highlight any elements that are associated with an action. 

This is a useful way to check that elements are associated with the correct actions.
...
## Overide feature flags using the toolbar
...
Overriding feature flags will only affect *your* browser. 

You may also need to refresh the page to see how your change affect your website. 

It does not affect feature flags evaluation for your backend.
