...
## Viewing heatmaps in PostHog app

You can also view heatmaps directly within the PostHog app. This method is currently in beta and provides almost the same functionality as the toolbar.
