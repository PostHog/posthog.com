...
The heatmap data shows where on the page users are clicking, rageclicking, or moving their mouse. Unlike the clickmap, the user doesn't have to be clicking on a clickable element, so you can see where users are trying to click but can't. There are multiple options to configure your heatmap.
