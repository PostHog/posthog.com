...
To start, ensure you enable the capturing of heatmap data in [your project settings](https://app.posthog.com/settings/environment-heatmaps#heatmaps) or with the `enable_heatmaps` key in the [JavaScript Web SDK initialization config](/docs/libraries/js/config). 
