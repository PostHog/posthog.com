...
Heatmaps support [access control](/docs/settings/access-control), available on Teams and Enterprise plans. You can control who can view and edit heatmaps at the resource level (all heatmaps in a project) or at the object level (individual saved heatmaps). Access can be configured for specific members or roles in your project's access control settings.
