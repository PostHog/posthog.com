...
Because authorized URLs are a security boundary, [PostHog Desktop](/docs/posthog-desktop) handles this one carefully and **never adds a domain unattended**. With health checks enabled as a [signal source](/docs/self-driving/inbox/sources), the agent will:
