...
We don't just sell this loop, we run it. A troop of 35 scouts – built-in and custom – watches the PostHog app, and reports about posthog.com become pull requests on [the public repo that builds it](https://github.com/PostHog/posthog.com/pulls). If self-driving ever stops being worth it, we'll be the first to know.
...
Being set up means giving PostHog three things: **eyes** (signal sources and scouts watching your product), **hands** (a GitHub connection so agents can open pull requests), and **permission** (AI data processing approved for your organization). The wizard handles all three in one command, installing PostHog first if you haven't already. Add the [Slack app](/docs/slack) to bring your whole team in.

Setup takes a few minutes, and your first reports land in your inbox within about 30 minutes.
...
[PostHog Desktop](/docs/posthog-desktop) is a desktop app for driving parallel agents that edit your product. The same inbox, reports, and scouts live there too.
