...
- **[Skills](/docs/self-driving/skills)** – versioned, reusable instructions for agents, stored centrally in PostHog and usable from any MCP-connected agent. Every scout is a skill.
