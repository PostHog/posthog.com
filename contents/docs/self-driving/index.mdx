...
Customers run it too: [Juno](/customers/juno), an AI health assistant, merges roughly 90% of the pull requests self-driving opens for its health tracking app.
...
<QuestLogItem title="Learn the concepts" subtitle="Context, skills, signals, sources, scouts, reports, inbox" icon="IconCode2">
...
- **[Skills](/docs/skills)** – versioned, reusable instructions for agents, stored centrally in PostHog and usable from any MCP-connected agent. Every scout is a skill.
...
<QuestLogItem title="Learn by use case" subtitle="Pocket guides" icon="IconBook">
