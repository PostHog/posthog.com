...
- Head to your [inbox](https://app.posthog.com/inbox/scouts) and on the top right, click **New scout**, then **Chat with an agent**. This starts an agent that checks your project data and builds the scout with you.
