...
This setting is off by default, because the comment is public. Everybody who watches the issue can see that PostHog started work. The comment contains only the link. It does not contain the title of the report or the research, and the report itself stays behind your project's access controls.
