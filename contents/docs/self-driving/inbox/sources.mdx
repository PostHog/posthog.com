...
<List
  ...
  items={[
    ...
    },
    {
      ...
      description: "Findings from eval reports on your LLM traffic.",
      lineClamp: 2,
    },
    {
      ...
      icon: "IconGraph",
      description: "Investigated anomaly alerts on your insights – true positives only.",
      lineClamp: 2,
    },
    {
      label: "Health checks",
