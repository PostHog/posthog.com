...
## Asking the AI about a report

You can use the **Ask AI** button on any report to ask questions or give guidance to the agent. Your message kicks off a discussion task, and the agent responds in context. Use this to clarify requirements or steer the approach before any code is written.

**Ask AI** is available on every report, including resolved and archived ones.
