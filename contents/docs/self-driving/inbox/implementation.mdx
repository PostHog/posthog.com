...
You can use the **Discuss** button on any report to ask questions or give guidance to the agent. Your message kicks off a discussion task, and the agent responds in context. Use this to clarify requirements or steer the approach before any code is written.

Discuss is available on every report, including resolved and archived ones.
