...
- **Record a measurement.** When the job is scoring or classifying rather than surfacing, a scout can record structured, schema-checked measurements as events instead of filing anything to your inbox. See [turn a scout's judgment into a metric](#turn-a-scouts-judgment-into-a-metric).
