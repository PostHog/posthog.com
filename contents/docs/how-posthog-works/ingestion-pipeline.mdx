...
- Validating events against [enforced schemas](/docs/product-analytics/schema-management#enforcing-schemas-at-ingestion) and rejecting those that don't match
