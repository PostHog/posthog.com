...
The following pages in this section cover [Data model](/how-posthog-works/data-model),  [Ingestion pipeline](/how-posthog-works/ingestion-pipeline), [ClickHouse](/how-posthog-works/clickhouse) and [Querying data](/how-posthog-works/querying-data). 
