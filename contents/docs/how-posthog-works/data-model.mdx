...
![PostHog data flow](https://res.cloudinary.com/dmukukwp6/image/upload/posthog_data_flow_7ce769cecd.png)
...
Groups require that you have the [Group analytics add-on](/addons#group-analytics) that you enable person profiles.
