...
Persons are stored in PostgreSQL, but are additionally replicated into Clickhouse for certain queries. For example, when viewing the global list of Perons from the dashboard, this information is retrieved from Clickhouse.
