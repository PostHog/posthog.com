...
1. Some users are counted twice on the trend graph. 
   ...
   > Note: This was never an issue pre PostHog version 1.39 because we'd join the latest person info to get this result. However, this doesn't scale well, and we've decided to not continue going down this route.
