...
> **Note:** If you signed up before June 2024 you can configure in [settings](https://us.posthog.com/settings/project-product-analytics#persons-on-events) to use the faster queries mode instead of joining with the person table for current properties.
