...
In the web app, you can also open a single log record and have [PostHog AI explain it](/docs/logs/explain-logs-ai) – what it means, what probably caused it, and what to do next.
...
- All logs are retained 14 days by default. Set custom retention per service or per source for $0.05/GB per month retained – see [logs pricing](/docs/logs/pricing#retention) for more details
