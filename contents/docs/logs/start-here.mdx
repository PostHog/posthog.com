...
import { IconBell, IconCode, IconSearch, IconSettings } from '@posthog/icons'

<QuestLog firstSpeechBubble="Let's get started!" lastSpeechBubble="You're all set to monitor your logs!">
