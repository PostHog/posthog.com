...
- **trace_id** – filter logs by their OpenTelemetry trace correlation ID. You can paste the hex format you copy from trace URLs — PostHog converts it to base64 automatically.
