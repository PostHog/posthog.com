...
- [Sampling strategies](#sample-strategically)
...
- **Log attributes** are set per event. They describe what happened in that specific request: `posthog_distinct_id`, `order_id`, `payment_method`, `duration_ms`.
