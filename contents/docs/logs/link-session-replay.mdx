...
When you click on a log entry that has a session ID, you can view related errors in the **Related errors** tab. This tab shows [Error Tracking](/docs/error-tracking) issues that occurred within the same session (within ±6 hours of the log timestamp).
