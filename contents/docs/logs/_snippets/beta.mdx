...
Logs is currently in early beta. While in beta, logs is free to use. Right now it is only available in the US region, however we're working on EU region support.
