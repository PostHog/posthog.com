...
If an attribute or resource attribute key contains any of these substrings (case-insensitive), the **entire value** is replaced with `{{REDACTED}}`:
...
See our [logging best practices guide](/docs/logs/best-practices) for more on structured logging patterns that make it easy to keep PII out of your Logs.
