...
- **[Microsoft Teams](/docs/cdp/destinations/microsoft-teams)** – provide a Microsoft Teams webhook URL (from a Power Automate Workflows connector).
...
| **Notifications** | Tags for each configured destination (Slack, Microsoft Teams, or Webhook). A struck-through bell indicates no destinations.                                                                |
