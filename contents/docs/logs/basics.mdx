...
Most logging is bad. Not because people don't log enough – they log too much of the wrong things.
...
**No vendor lock-in** - PostHog uses [OpenTelemetry (OTLP)](/docs/logs/installation) for log ingestion. Use standard OTel libraries in any language – no proprietary SDK required. If you already have OTel instrumentation, point it at PostHog and you're done.
