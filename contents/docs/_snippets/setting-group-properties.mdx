...
> **Note:** You must include at least one group property for a group to be visible in the [Persons & Groups tab](https://app.posthog.com/persons).

<MultiLanguage>

```js-web
// Option 1 (recommended):
// Set properties in posthog.group()
// Note that this has the side-effect that for the rest of the session
// all subsequent events captured will be associated to the group
