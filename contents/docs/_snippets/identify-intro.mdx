...
However, in the frontend of a [web](/docs/libraries/js/usage#capturing-events) or [mobile app](/docs/libraries/ios#capturing-events), a `distinct_id` is not a required argument — PostHog's SDKs will generate an anonymous `distinct_id` for you automatically and you can capture events anonymously, provided you use the appropriate [configuration](/docs/libraries/js/usage#capturing-anonymous-events).
