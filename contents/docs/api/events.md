...
| `date_from` | ISO formatted string/relative date | no | The datetime up until which to get events. Can be in iso format (ie `2020-05-25T14:06:33.584171Z`) or a relative date (ie `-7d` for last 7 days, `mStart` for the start of the month etc).
