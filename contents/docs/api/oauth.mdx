...
If you'd like your app marked as a verified integration, which removes the "unverified application" notice shown on the authorization screen, email **team-growth@posthog.com**. The <SmallTeam slug="growth" /> is building a self-serve flow for this.
