...
With CIMD, you don't pre-register your OAuth client or manage a client secret. Instead:
...
Verification is optional and isn't required to go live. If you'd like your app marked as a verified integration, which removes the **unverified application** notice shown on the authorization screen, email [team-growth@posthog.com](mailto:team-growth@posthog.com). The <SmallTeam slug="growth" /> is building a self-serve flow for this.

Have a question while integrating? [Reach out to us](https://posthog.com/talk-to-a-human).
