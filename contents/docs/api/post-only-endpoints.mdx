...
### Events without person profiles

By default, PostHog captures events with [person profiles](/docs/data/persons). To remove them, add the `$process_person_profile` property to the event and set it to `false`.
