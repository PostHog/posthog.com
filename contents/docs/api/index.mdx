...
- For the `/invites` and `/invites/bulk` endpoints, you can send `50` invites per hour and `100` per day, with up to 20 invites per bulk request. This also applies to invites sent from the PostHog UI.
