...
- When logged in, you can view and download the API schema using the following options:
  - [Download the OpenAPI spec](https://us.posthog.com/api/schema/)
  - [View the API schema with Swagger UI](https://us.posthog.com/api/schema/swagger-ui/)
  - [View the API schema with Redoc](https://us.posthog.com/api/schema/redoc/)
