...
- Transformations like [GeoIP enrichment](/docs/cdp/transformations/template-geoip) and [bot detection](/docs/cdp/transformations/template-bot-detection) can **still use the IP** before it is discarded
