...
- [Hashing PII data](https://posthog.com/docs/cdp/transformations/hash-properties) before it's stored in PostHog
- Disabling default [GeoIP enrichment transformations](https://posthog.com/docs/cdp/transformations/geoip)
- [Dropping events](https://posthog.com/docs/cdp/transformations/drop-events) based on a filter
- [IP anonymization](https://posthog.com/docs/cdp/transformations/ip-anonymization)
...
- Transformations like [GeoIP enrichment](https://posthog.com/docs/cdp/transformations/geoip) and [bot detection](https://posthog.com/docs/cdp/transformations/bot-detection) can **still use the IP** before it is discarded
