...
To delete persons and their events, you can use the single delete endpoint if you have the person UUID or the bulk delete endpoint if you have distinct IDs.
...
#### Deleting anonymous users by distinct ID

If you only have the user's distinct ID, for example, the auto-generated ID assigned to anonymous users by `posthog-js`, you must use the [bulk delete endpoint](/docs/api/persons#post-api-projects-project_id-persons-bulk_delete). This works for deleting a single person too:
