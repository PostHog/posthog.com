...
```bash
curl -X DELETE "https://us.posthog.com/api/projects/:project_id/persons/:person_uuid?delete_events=true" \
     -H "Authorization: Bearer [your personal api key]"
```

```javascript
fetch('https://us.posthog.com/api/projects/:project_id/persons/:person_uuid?delete_events=true', {
  method: 'DELETE',
  headers: {
    'Authorization': 'Bearer [your personal api key]'
  }
...
url = "https://us.posthog.com/api/projects/{}/persons/{}?delete_events=true".format(
...
curl -X POST "https://us.posthog.com/api/projects/:project_id/persons/bulk_delete/" \
     ...
     -d '{"distinct_ids": ["your-distinct-id"], "delete_events": true}'
```
...
url = "https://us.posthog.com/api/projects/{}/persons/bulk_delete/".format(project_id)
headers = {
