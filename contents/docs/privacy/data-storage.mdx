...
| **Projects**      | [Project settings](https://us.posthog.com/settings/project#project-delete)                | All data under the project (including events) are automatically removed. Cannot delete the last project if your organization has an active subscription.                 |
| **Organizations** | [Organization settings](https://us.posthog.com/settings/organization#organization-delete) | All data under the organization's projects (including events) are automatically removed. Cannot delete an organization with an active subscription.                      |
