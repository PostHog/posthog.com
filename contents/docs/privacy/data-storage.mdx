...
```bash
curl -X POST "https://app.posthog.com/api/projects/<project_id>/persons/bulk_delete/" \
     -H "Authorization: Bearer <personal_api_key>" \
     -H "Content-Type: application/json" \
     -d '{"distinct_ids": ["<distinct_id>"], "delete_events": true}'

```javascript
fetch('https://app.posthog.com/api/projects/<project_id>/persons/bulk_delete/', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer <personal_api_key>',
...
url = "https://app.posthog.com/api/projects/{}/persons/bulk_delete/".format(project_id)
headers = {
