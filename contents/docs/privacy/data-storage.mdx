...
The end of a retention period is also not a deletion guarantee. It stops your queries from reading the data, but it does not promise that PostHog deleted the data. If you must show that PostHog deleted specific data, use one of the tools above, because each one gives you an action that you can request, monitor, and record.
