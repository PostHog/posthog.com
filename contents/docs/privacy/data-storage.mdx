...
| [Events data retention](#events-data-retention)                   | How long events stay queryable on each plan                      |
...
How long your events stay queryable depends on your plan: 1 year on Free, 2 years on Pay-as-you-go, and up to 7 years with a platform package. Organizations that were on a paid plan before September 3, 2026 keep 7 years. See [events data retention](/docs/product-analytics/data-retention) for the full policy, what happens when events age out, and how to recover them.
