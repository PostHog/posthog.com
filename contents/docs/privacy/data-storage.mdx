...
{/* TODO: Re-enable this section when engineering adds support for deleting anonymous users by distinct_id.
    Currently the async deletion job uses person_id, so this won't work for truly anonymous users.
