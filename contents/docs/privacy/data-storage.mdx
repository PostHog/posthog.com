...
> **Note:** This does not apply when [cookieless tracking](/tutorials/cookieless-tracking) is enabled. In cookieless mode, the IP is stripped before transformations run, so GeoIP enrichment and bot detection won't enrich your events.
