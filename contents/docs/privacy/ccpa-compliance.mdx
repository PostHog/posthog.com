...
* The right to delete personal information collected from them (with some exceptions). [Learn about deleting personal information](#deleting-personal-information-in-posthog).
...
The right to delete personal information is also covered by CCPA. You have 45 days to respond to a request from a user to delete any personal information stored about them. [Learn more about deleting personal information](#deleting-personal-information-in-posthog).

## How to set PostHog up for CCPA compliance

We recommend using [PostHog Cloud US](/us) for CCPA compliance, but you can self-host your analytics on your own infrastructure and maintain full control of the data – i.e. you decide how and where to host any personal information. It also means you have full control of the underlying database, making it possible for you to easily share any information stored about an individual or delete any personal data. 

### Step 1: Choose a hosting provider

We recommend using [PostHog Cloud US](/us) for CCPA compliance. If self-hosting, the steps will depend on where you're hosting your data. 
