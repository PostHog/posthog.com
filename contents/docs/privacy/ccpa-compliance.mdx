...
If a user request the deletion of their information under the CCPA, you can delete their data programatically or manually. Learn more about [deleting personal information](/docs/privacy/data-storage#data-deletion).
