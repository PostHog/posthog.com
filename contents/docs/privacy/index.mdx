...
## Controlling data collection, storage, and processing

You can control data collection, ingestion, and storage at different levels 

- [Controlling data collection](/docs/privacy/controlling-data-collection/)
- [Controlling data processing](/docs/privacy/controlling-data-processing/)
- [Controlling data storage](/docs/privacy/controlling-data-storage/)
