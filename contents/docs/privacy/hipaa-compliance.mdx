...
PostHog only offers Business Associate Agreements (BAAs) for PostHog Cloud to users on [a Teams or an Enterprise plan](/pricing). To enquire about BAAs, HIPAA compliance, or an Enterprise plan, please [contact us directly](/talk-to-a-human).
