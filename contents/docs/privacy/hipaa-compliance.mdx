...
<CalloutBox type="caution" title="PostHog AI is not covered by BAAs">

[PostHog AI](/docs/posthog-ai) is not HIPAA-compliant and is not intended for processing Protected Health Information (PHI). Any BAA you have with PostHog does not apply to PostHog AI features. If you use PostHog under a BAA and require HIPAA compliance, ensure PostHog AI is disabled in your [organization settings](https://app.posthog.com/settings/organization-details#organization-ai-consent).
