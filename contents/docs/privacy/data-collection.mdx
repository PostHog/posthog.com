...
PostHog can be configured to do cookieless audience measurement.
...
- `cookieless_mode: "on_reject"`
  - Use this if you do want to show a cookie banner and only enable cookies when the user consents
  ...
  - If consent is denied, PostHog will still be able to count those users, using a privacy-preserving hash
