...
6. Update your PostHog snippet or SDK to use the subdomain chosen in step 3 as the `api_host`. Make sure to also update the PostHog SDK's `ui_host` config property to `https://us.posthog.com`.
