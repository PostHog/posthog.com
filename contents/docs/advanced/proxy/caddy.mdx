...
showTitle: true
showStepsToc: true
platformImageUrl: https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/caddylogo_9a7a28e702.png
---
...
Replace `e.yourdomain.com` with your chosen subdomain. Replace `us` with `eu` for EU region.
...
Replace `e.yourdomain.com` with your subdomain and `yourdomain.com` with your application domain. Replace `us` with `eu` for EU region.
