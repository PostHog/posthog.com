...
All PostHog users can create managed proxies. Free accounts include 2 proxy records, and [platform packages](https://posthog.com/platform-packages) include higher limits. You need access to your domain's DNS settings to complete setup.
