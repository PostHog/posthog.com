...
If you're onboarding a web-based product like Web Analytics, Surveys, or LLM Observability, you'll be guided through managed proxy setup as part of the onboarding flow. The steps below are for setting it up manually from the organization settings.
