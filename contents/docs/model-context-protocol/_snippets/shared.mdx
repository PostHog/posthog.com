...
**Prompt:** "Why did our signup conversion rate drop last week?"

The agent will diagnose the metric change by checking for known causes (feature flag changes, experiments, deployments), running breakdowns across segments, and analyzing lifecycle shifts to identify the root cause.
