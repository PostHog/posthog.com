...
Tools let your agent take actions on your behalf in PostHog. Click any category below to see the full list — or browse [example prompts](/docs/model-context-protocol#what-you-can-do-with-it) on the main MCP page to see what's possible.
...
The MCP server acts as a proxy to your PostHog instance. It does not store your analytics data – all queries are executed against your PostHog project and results are returned directly to your AI client. For more information, check [the PostHog privacy policy](/privacy), or [terms and conditions](/terms). 
