...
**Prompt:** "Show me pageviews and button clicks combined as one trend line over the last 30 days"

The agent combines the events into a single series using OR logic, counting both event types together rather than as separate lines.
