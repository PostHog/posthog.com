...
### HogQL insights with chart configuration

**Prompt:** "Create a HogQL insight called 'Daily Active Users' that shows unique users per day as a line chart, with the date on the X-axis"

The agent will create a HogQL insight with your specified chart type (line, bar, or auto) and axis configuration, and return a link to the insight in PostHog.
