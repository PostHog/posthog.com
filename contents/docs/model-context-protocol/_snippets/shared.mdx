...
**Prompt:** "Add a text card to my 'Product Metrics' dashboard explaining what the conversion funnel measures"

The agent uses `dashboard-text-card-create` to add a markdown text card to your dashboard. Text cards let you add context, documentation, or annotations alongside your insights.

**Prompt:** "Update the text card on dashboard ID 123 to include a note about the new onboarding flow changes"

The agent uses `dashboard-get` to retrieve the dashboard, then `dashboard-text-card-update` to modify the content.
