...
The MCP server also exposes **agent skills** as resources. Agent skills are curated instructions and context that help AI agents perform PostHog-specific tasks effectively. Skills are authored alongside product code in the PostHog monorepo and distributed via GitHub releases.
