...
**Prompt:** "Show me the LLM costs for my project broken down by model"

The agent will use the `get-llm-total-costs-for-project` tool to retrieve cost data and display a breakdown table showing total costs and recent spending per model.
