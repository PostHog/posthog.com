...
<summary>Alternative: Manual authentication with API key</summary>

If your MCP client doesn't support OAuth, you can authenticate manually:

1. Get a personal API key from the [user API keys settings page](https://app.posthog.com/settings/user-api-keys?preset=mcp_server)
