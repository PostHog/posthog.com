...
Tools trigger actions on behalf of the user based on the goals and information already in the context of the LLM. The tools are also available in our [agent toolkit](/docs/ai-engineering/agent-toolkit) which can be integrated with AI agent frameworks like Vercel's AI SDK and LangChain.
