...
> Rolling this out across a whole engineering team? See [Cursor Team MCP setup](/docs/model-context-protocol/cursor-team) for the admin dashboard flow that pushes the config to every teammate automatically.
