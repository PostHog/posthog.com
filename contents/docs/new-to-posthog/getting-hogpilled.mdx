...
Pick a [naming convention](/docs/product-analytics/best-practices#3-implement-a-naming-convention) and stick with it! 

There isn't a right choice here, only a wrong choice: different people on your team using different event names, or conventions to describe the same behavior.
...
PostHog enforces some rules use of the identify function to prevent users from being merged incorrectly. 
