...
Below is a simple version of metrics tree where events influence your North Star metric.
...
What does this look for your product?
...
See our docs on [sending events](/docs/getting-started/send-events) and [identifying users](/docs/getting-started/identify-users) for more integration guidance. 
