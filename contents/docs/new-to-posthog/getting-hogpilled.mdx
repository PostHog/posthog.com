...
The ones that win often do it by accident.

We can do better.

This guide will help you **win on purpose**. We start by defining success as a number we can measure, then describe the user behavior that feeds that number.

After that, we're going to:

- Measure if users find the value of your product
- Determine if they come back and how often
- Track the lifeblood of your business: revenue
