...
To get the most out of this, a little planning goes a long way. Here’s what you can do to make the most of a pilot.

## List out the people who care about user behavior, no matter their role
...
For companies sized 25 and up, [we’ve got a team](/talk-to-a-human) who can answer questions and help you make a plan. But only if you want the help! They’re not going to pressure you or do anything corny, but their integration experience can save time for teams who want it. They can also help you map PostHog features to your business goals and otherwise help you develop a mental model for using PostHog.

But we’re not going to get in your way, either, because…

## Jump in and play around

The most important job is getting familiar with PostHog in whatever way makes you most comfortable. We’ve got loads more documentation to support your journey if you want to explore on your own.
...
- Try out a [no-code survey](/docs/surveys/creating-surveys) to see what customers are feeling about your product
- Fire up [web analytics](/docs/web-analytics/getting-started), see if you and your teamprefer it to your existing provider  

After two weeks to explore, check in with your teammates as well. See if there’s anything they want but aren't getting. If you can get them excited with you, you'll have a better chance of making this pilot stick.
...
From here there’s no sneaky stuff. All our [pricing is posted publicly](/pricing), and you can use our interactive calculator to project your monthly bill.

<CalloutBox title="We guarantee your safe pilot" type="action">
