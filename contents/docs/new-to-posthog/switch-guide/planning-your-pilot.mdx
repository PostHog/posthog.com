...
- Fire up [web analytics](/docs/web-analytics/start-here), see if you like it better than your existing provider
...
Want to lower your bill? Check out our guides on cutting costs for [product analytics](/docs/product-analytics/cutting-costs), [session replay](/docs/session-replay/how-to-control-which-sessions-you-record), and [feature flags](/docs/feature-flags/cutting-costs).
