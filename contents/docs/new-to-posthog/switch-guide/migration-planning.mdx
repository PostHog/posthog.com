...
To support this, it can help to make a spreadsheet for people to request their most essential metrics. You want to know what data they need to keep making good decisions, and ensure those metrics are easy to find in PostHog. Capturing these requirements can also help you check that your technical implementation is handling everything necessary.
