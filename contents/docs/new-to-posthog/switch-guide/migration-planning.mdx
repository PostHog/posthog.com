...
To support this, it can help to make a spreadsheet for people to request their most essential metrics. Use it to create insights in PostHog and then add link them in the spreadsheet. You want to know what data they need to keep making good decisions, and ensure those metrics are easy to find in PostHog. Capturing these requirements can also help you check that your technical implementation is handling everything necessary.

While moving historical events over is straightforward, you’ll need to take some time rebuilding the views and dashboards your team relies on.
