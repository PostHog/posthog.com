...
This one is a visual crowd pleaser: launch your site’s PostHog [toolbar](https://app.posthog.com/project/toolbar) to show heatmap overlays and other stats directly on your site. You can even use it to launch [hedgehog mode](/blog/aruba-hackathon#hedgehog-mode--toolbar--awesomeness).
