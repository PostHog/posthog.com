...
- **[Get comprehensive documentation](/docs)** developers love for every every stack, framework, and language.
...
- **PostHog doesn’t require a contract**. You can save a bit of money with one, but it’s not a gate to getting started and trying things out.
