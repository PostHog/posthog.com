...
PostHog's **data warehouse** solves this problem by aggregating multiple data sources. You can then build custom insights that traverse your events and external sources together.
...
With revenue logged, you need a way to see it.
