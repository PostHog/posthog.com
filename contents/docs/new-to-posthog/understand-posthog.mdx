...
<Admonition icon="IconBook" title="Further reading" type="tip">
...
Dig into the [data model](/docs/how-posthog-works/data-model) to learn more about the fields on each data type.