...
To migrate your events, we can use the [PostHog Replicator app](/docs/apps/replicator),
which enables us to stream both incoming and historical events to PostHog Cloud
