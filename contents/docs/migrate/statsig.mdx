...
Learn more about how they compare in our [PostHog vs Statsig comparison](/compare/posthog-vs-statsig).
...
## Getting your Statsig and PostHog keys
...
Once this is done, you can capture the data into PostHog using the [Python SDK](/docs/libraries/python#historical-migrations) or the [event capture API endpoint](/docs/api/capture) with `historical_migration` set to `true`. You can find your project token and host in [your project settings](https://us.posthog.com/settings/project).
