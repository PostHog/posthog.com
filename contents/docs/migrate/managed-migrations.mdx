...
S3 imports can source data from any S3-compatible blob storage by providing an **Endpoint URL**. The endpoint must be publicly accessible (internal or private IPs are not allowed).
