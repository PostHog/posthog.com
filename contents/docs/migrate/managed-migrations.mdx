...
Customers with large datasets or who need custom event transformations/event enrichment, may need to export and preprocess data before it can be ingested. For these use cases, the migration is not fully automated/managed.
