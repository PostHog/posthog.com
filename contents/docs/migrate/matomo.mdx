...
The big difference is that Matomo structures their data around **visits** that contain one or more **actions**. Matomo actions are similar to PostHog's [events](/docs/data/events).
