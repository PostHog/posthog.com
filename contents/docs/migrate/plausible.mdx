...
> 2. Plausible uses **variousisit** to represent a single use of your product or visit to your site. In PostHog, these are called [sessions](/docs/data/sessions).
...
> **🛠️ Work in progress:** The follow import converts and capture visitors and pageviews, but is not comprehensive. For example, it doesn't include:
