...
> Please not that the Migrator 3000 app is no longer maintained, or recommended. To export events to a new PostHog instance, we recommend using the [Replicator](/apps/replicator) app instead.
...
2. Visit the 'Apps' page on the old instance and click on the 'Advanced' tab.
