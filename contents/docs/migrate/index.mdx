...
- [Moving or splitting event data between projects](/docs/migrate/split-or-merge-projects) on the same PostHog instance, for example to consolidate several projects into one, or split events from different sources out of a shared project.
