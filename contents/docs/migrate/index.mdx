...
- Migrating from a different tool or platform like [Mixpanel](/docs/migrate/mixpanel), [Amplitude](/docs/migrate/migrate-from-amplitude), or [Heap](/docs/migrate/heap)
