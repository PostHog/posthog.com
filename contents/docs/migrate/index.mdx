...
Start your migration by formating your data correctly. There is no way to selectively delete event data in PostHog, so getting this right is critical. This means:
