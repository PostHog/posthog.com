...
Use `posthog-node` if PostHog is the only place your spans go. Use OpenTelemetry if you already run it, or if you want auto-instrumentation of the libraries you call.
...
See the [Node.js SDK docs](/docs/libraries/node#configuration) for batching and queue options.
