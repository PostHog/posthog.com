...
> **Note:** Distributed tracing is in beta. Setup details, including the ingestion endpoint, may change before general availability.
...
<CallToAction type="primary" to="/docs/distributed-tracing/installation">
