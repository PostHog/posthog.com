...
| Dashboards             | Created, updated, deleted, sharing enabled, sharing disabled, access token refreshed |
| Insights               | Created, updated, deleted, sharing enabled, sharing disabled, access token refreshed |
