...
You can view the change history for any individual resource. When viewing a feature flag, dashboard, experiment, insight, or other resource, click the **History** tab to see all changes made to that specific item over time.
