...
If you signed up for PostHog before accepting an invite, any pending invites for your email address appear in the project switcher. Open the project switcher from the organization dropdown in the top bar to see and accept them.
