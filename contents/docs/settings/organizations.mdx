...
By default, organization members can see the full member list. Organization admins and owners can restrict this if you invite customers or other external collaborators into separate projects, such as when you set up [embedded analytics](/docs/data/embedded-analytics-projects).
