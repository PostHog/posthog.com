...
Every organization has a unique ID. You can find and copy it in [**Settings** > **Organization** > **General**](https://app.posthog.com/settings/organization-details#organization-id). This ID is required for organization-scoped [API](/docs/api) endpoints and is useful when filing support requests.
...
Sending invites is subject to [rate limits](/docs/api#rate-limiting), which apply across your organization.
...
Organization admins and owners can restrict members from viewing the full list of org members. This is useful if you invite external collaborators into separate projects, like when you set up [embedded analytics](/tutorials/embedded-analytics).

Find this setting under [**Settings** > **Organization** > **Security**](https://app.posthog.com/settings/organization-security), labeled **Members can see the full member list**.

When disabled, members only see themselves and other members in their projects.

> **Note:** This feature requires the [Boost, Scale, or Enterprise plan](/platform-packages).
