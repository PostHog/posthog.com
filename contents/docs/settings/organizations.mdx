...
Organization admins and owners can download a CSV file of all organization members. Navigate to [**Settings** > **Organization** > **Members**](https://app.posthog.com/settings/organization-members) and click **Download members list**.
