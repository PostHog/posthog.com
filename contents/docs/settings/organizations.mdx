...
Organization admins and owners can restrict which members are visible to non-admin members. Find this setting under [**Settings** > **Organization** > **Security**](https://app.posthog.com/settings/organization-security), labeled **Members can see the full member list**.

It's enabled by default. When you disable it, non-admin members only see themselves and members who have access to a project they share. Admins and owners still see everyone.

This only has an effect in private projects. If a project's default access level is "Member" or "Admin", every organization member stays visible.
