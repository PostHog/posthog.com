...
Use the organization dropdown in the top bar to switch between organizations or create a new one. You can also press `g` then `o` to quickly open the organization switcher.
