...
You can customize the new tab behavior when working in the [SQL editor](/docs/data-warehouse/sql). By default, clicking **New tab** while in the SQL editor opens another SQL editor tab. To open the search command instead, go to [**Customization**](https://app.posthog.com/settings/user#sql-editor-tab-preference) and select your preferred option.
