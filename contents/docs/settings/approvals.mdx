...
> **Note**: For **Update feature flag** policies, select the **Release conditions** field to require approval when someone adds, removes, or edits a flag's release conditions. Release conditions are only gated by a policy that selects them.
