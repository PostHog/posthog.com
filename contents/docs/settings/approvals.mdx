...
Approvers receive both email and in-app notifications when a change request is created. In-app notifications appear in the notification popover and link directly to the approval detail page.
