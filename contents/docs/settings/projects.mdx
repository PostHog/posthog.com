...
To switch between projects, navigate to project settings, or create new projects, use the project switcher in the middle of the top bar. You can also press `g` then `p` to quickly open the project switcher. To access the current project's settings, use the sidebar.
