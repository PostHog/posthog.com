...
Keep all tenants in one production project and separate them with [group analytics](/docs/product-analytics/group-analytics) instead. See [multi-tenant and B2B SaaS setup](/docs/product-analytics/multi-tenant-saas) for the full walkthrough.
