...
Organization owners and admins can delete projects from [project settings](https://us.posthog.com/settings/project-danger-zone). Deleting a project is **irreversible** — all data, including events, is permanently removed.

<CalloutBox icon="IconWarning" title="Active subscription restriction" type="caution">

You cannot delete the last project in an organization that has an active subscription. This prevents you from losing access to the billing page. To delete your last project, [cancel your subscription](https://us.posthog.com/organization/billing) first.
