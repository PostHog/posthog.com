...
You can copy dashboards, insights, actions, and cohorts from one project to another.

To copy a resource:

1. Open the resource you want to copy
2. Click the **...** menu
3. Select **Copy to another project**
4. Choose the destination project
5. Click **Copy**

This creates a separate copy in the destination project with the same configuration. Changes to one don't affect the other.

> You need access to both the source and destination projects to copy resources between them.