...
> SCIM is currently in beta and available on request for customers on the Enterprise plan. [Contact us](https://app.posthog.com/#panel=support) to enable it for your organization.

### Prerequisites

Before setting up SCIM, you need:

1. Verified authentication domain in PostHog
