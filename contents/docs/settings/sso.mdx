...
3. Check **Enable API integration** and enter:
   ...
   Set the **Unique identifier field for users** to an attribute that's unique for each provisioned user. This is usually `userName`, mapped to the user's email address.
