...
| Managing members (invites, changing roles, removing, etc.)                            | <span className="text-red text-lg">✖</span>                  | <span className="text-green text-lg">✔</span>          | <span className="text-green text-lg">✔</span>    |
