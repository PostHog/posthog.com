...
- **For object access controls**: You must be the resource creator, a project admin, an organization admin, or have manager-level access to the resource
- **For resource access controls**: You must be an project admin or organization admin
>>>>>>> Stashed changes
