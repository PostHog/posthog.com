...
> **Note:** "Data warehouse tables & views" controls creating, editing, and deleting warehouse tables, views (models), folders, and joins, plus materialization actions. It does not restrict querying the underlying data via SQL.

We do not yet support limiting access to querying data, viewing replays, or accessing person / group profiles. Support for these features is planned for the near future.
