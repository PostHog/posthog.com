...
\*Admins and owners can disable this for members. When disabled, members can't view the invite list. Members can only see invites for roles at or below their own level.
