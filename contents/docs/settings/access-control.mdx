...
| Leaving an organization**                                                             | <span className="text-green text-lg">✔</span>                | <span className="text-green text-lg">✔</span>          | <span className="text-green text-lg">✔</span>    |
...
**Owners can only leave an organization when at least one other active owner exists.
