...
Note: We do not yet support limiting access to querying data, viewing replays, or accessing people data. Support for these features is planned for the near future.
...
The goal of this add-on is to allow teams with stricter access requirements to control who can access their projects and resources.
