...
The default behavior for this SDK is to use the `IDENTIFIED_ONLY` mode of person processing, but this can be changed in the config. The options are:
- `IDENTIFIED_ONLY`
- `NEVER`
- `ALWAYS`

See [person profiles](/docs/data/persons) for more info.
