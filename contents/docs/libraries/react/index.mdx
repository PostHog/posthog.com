...
<List
    ...
    items={[
        ...
        },
        {
            ...
            image: "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/docs/integrate/frameworks/remix.svg"
        },
        {
            label: "React Router",
            url: "/docs/libraries/react-router",
            image: "https://res.cloudinary.com/dmukukwp6/image/upload/rr_logo_light_970950178e.svg"
        }
    ]}
/>
