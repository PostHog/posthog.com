...
By default, this component tracks views and interactions. However, you can disable these if you don't want them like so:

```react
<PostHogFeature flag={given.featureFlag} match={given.matchValue} trackInteraction={false} trackView={false}>
