...
Our Python SDK includes a built-in LLM observability feature. It enables you to capture LLM usage, performance, and more. Check out our [observability docs](/docs/llm-observability) for more details on setting it up.
