...
> These docs cover version `7.x` of the PostHog Python SDK, which requires Python 3.10 or higher. On Python 3.9 or older, see [For Python versions 3.9 and older](#for-python-versions-39-and-older).
