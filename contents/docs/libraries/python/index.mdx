...
See our [Celery docs](/docs/libraries/celery) for how to set up PostHog with Celery background tasks. The Celery integration automatically captures task lifecycle events, exceptions, and propagates context from your web application to workers.
