...
See our [Celery docs](/docs/libraries/celery) to capture task lifecycle events, propagate user context from producers to workers, and track exceptions from failed tasks.
