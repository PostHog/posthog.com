...
You can pass it to your backend by adding your backend hostname to `tracing_headers` in your config. This will automatically add tracing headers to your requests.
