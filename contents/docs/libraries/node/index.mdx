...
By default, calling `isFeatureEnabled()` sends a `$feature_flag_called` event so you can analyze flag usage. You can disable this by passing the `sendFeatureFlagEvents` property:
