...
You can capture errors using the `posthog-node` library. See stracktraces, source code and watch associated session recordings to improve your application stability. Learn more in our [error tracking docs](https://posthog.com/docs/error-tracking/installation?tab=Node).
