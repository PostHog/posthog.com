...
```bash
npm install @posthog/react posthog-js posthog-node
```

- `@posthog/react` - React provider and hooks for client-side usage
- `posthog-js` - PostHog [JS Web SDK](/docs/libraries/js) (peer dependency of `@posthog/react`)
...
Installing the JS Web SDK and Node SDK means all of their functionality is available in your TanStack Start project. To learn more about this, have a look at our [JS Web SDK docs](/docs/libraries/js/features) and [Node SDK docs](/docs/libraries/node/features).