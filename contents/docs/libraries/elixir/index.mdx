...
The library is maintained by the PostHog team since February 2025. Thanks to [nkezhaya](https://github.com/nkezhaya) for contributing v0.1.0. Thanks to [alexmartsinovich](https://github.com/alexmartsinovich) for contributing v2.0.0.
