...
icon: >-
  https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/docs/integrate/dotnet.svg
features:
  eventCapture: true
...
import DotNetInstall from '../../integrate/_snippets/install-java.mdx'
...
import DotNetFeatureFlagsCode from '../../integrate/feature-flags-code/_snippets/feature-flags-code-python.mdx'
...
- ensure that `await posthog.FlushAsync()` is called after processing every request, by adding a middleware to your server: this allows `posthog.CaptureEvent()` to remain asynchronous for better performance.
