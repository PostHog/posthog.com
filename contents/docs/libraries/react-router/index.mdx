...
| [Declarative mode](/docs/libraries/react-router/react-router-v7-declarative-mode) | In declarative mode, you can build SPAs (single-page applications) with basic routing. |
