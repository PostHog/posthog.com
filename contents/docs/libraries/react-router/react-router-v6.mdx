...
tableOfContents: [
    ...
    {
        url: 'additional-usage',
        value: 'Additional usage',
        depth: 1,
    },
]
---
...
Feature flag and experiment setup is the same as React. You can find more details in the [React integration guide](/docs/libraries/react#feature-flags).