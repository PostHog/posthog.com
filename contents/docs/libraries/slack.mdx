...
5. If you have multiple Slack workspaces connected, select which **Slack connection** to use
6. Choose the Slack channel where you want to receive updates
7. Set your desired frequency (daily, weekly, monthly, etc.)
