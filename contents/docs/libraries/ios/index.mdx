...
For more details on how to setup masking for session replay, please refer to our [Privacy Controls](/docs/session-replay/network-recording?tab=iOS) documentation. 
