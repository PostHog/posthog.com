...
| `sessionReplayConfig`<br/><br/>**Type:** Object<br/>**Default:** `null`                                 | Session Replay configuration. https://posthog.com/docs/session-replay/installation for more details.                                                                                                                                                                                                       |
