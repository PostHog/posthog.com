...
Note that this does **not** set the user's properties. This only sets the properties for their events. To store user properties, see the [setting user properties section](#setting-user-properties).
