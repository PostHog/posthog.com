...
|`custom_blocked_useragents`<br/><br/>**Type:**Array<br/>**Default**`[]`| List of custom user agents/bots to block capturing from. This list is added to the default list [here](https://github.com/PostHog/posthog-js/blob/dbdb0f1aba729edf265345edefcf6e1ccacd5457/src/utils/blocked-uas.ts)|
