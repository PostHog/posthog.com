...
## Amending or sampling events before capture
...
> **🚨 Warning:** Amending and rejecting events is advanced functionality and should be done with care. It can cause unexpected results in parts of PostHog.
