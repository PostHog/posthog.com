...
| `autocapture`<br/><br/>**Type:** Boolean | AutocaptureConfig<br/>**Default:** `true`                                                                                                                          | Determines if PostHog should [autocapture](#autocapture) events. This setting does not affect capturing pageview events (see `capture_pageview`).  See below for `AutocaptureConfig`          |
...
`autocapture` config can take an object providing further config to autocapture's behavior.

| Attribute                                                                                                                                                                                 | Description                                                                                                                    |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| `url_allowlist`<br/><br/>**Type:** Array of String or Regexp<br/>**Default:** `undefined`                                                                                                          | List of URLs to allow autocapture on, can be strings to match or regexes e.g. ['https://example.com', 'test.com/.*']. NB an empty list means no URLs are allowed for capture.                                                                                                 |
| `dom_event_allowlist`<br/><br/>**Type:** `'click' or 'change' or 'submit'`<br/>**Default:** `undefined`                                                                                                          | List of DOM events to allow autocapture on.          NB an empty list means no events are allowed for capture.                                                                                            |
| `element_allowlist`<br/><br/>**Type:** `'a' or 'button' or 'form' or 'input' or 'select' or 'textarea' or 'label'`<br/>**Default:** `undefined`                                                                                                          | List of DOM elements to allow autocapture on.          NB an empty list means no elements are allowed for capture.                                                                                            |
| `css_selector_allowlist`<br/><br/>**Type:** `String[]`<br/>**Default:** `undefined`                                                                                                          | List of CSS selectors to allow autocapture on.          NB an empty list means no css selectors are allowed for capture.                                                                                            |
| `element_attribute_ignorelist`<br/><br/>**Type:** `String[]`<br/>**Default:** `undefined`                                                                                                          | List of element attributes that autocapture will not capture.          NB an empty list means no attributes are ignored.                                                                                     |
