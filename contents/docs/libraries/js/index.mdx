...
To control whether you capture identified events and person profiles, update the `person_profiles` config option:
...
| `person_profiles`<br /><br />**Type:** Enum: `always`, `identified_only`<br/>**Default:** `always`                                                                                | Set whether events should have capture identified events and process person profiles |
