...
Autocapture allows you to track the majority of general events on your website right out of the gate. You can learn more about autocapture and how to configure it in our [autocapture docs](/docs/data/autocapture).
