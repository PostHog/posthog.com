...
This does **not** set the user's properties. It only sets the properties for their events. To store user properties, see the [setting user properties docs](/docs/product-analytics/user-properties).
