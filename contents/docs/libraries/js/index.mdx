...
| `person_processing`<br /><br />**Type:** Enum: `always`, `identified_only`, `never` | Set whether events should have person processing enabled (see [Events](/docs/data/events#events-with-person-processing)) |
