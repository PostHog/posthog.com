...
To control whether you capture person profiles, update the `person_profiles` config option with one of the three options:
...
| `person_profiles`<br /><br />**Type:** Enum: `always`, `identified_only`, `never`<br/>**Default:** `always`                                                                                | Set whether events should have person profiles processed |
