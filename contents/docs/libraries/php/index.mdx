...
The PHP SDK captures identified events by default. These create [person profiles](/docs/data/persons). To set [person properties](/docs/product-analytics/person-properties), call `identify` with the user's distinct ID and properties:
