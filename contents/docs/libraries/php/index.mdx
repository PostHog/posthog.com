...
| `verify_batch_events_request`<br/><br/>**Type:** Boolean<br/>**Default:** `true` | Whether to verify succussful delivery of batch events (synchronous), or fire and forget (asynchronous) |
