...
| Option | Type | Default | Description |
|--------|------|---------|-------------|
| `logs_enabled` | Boolean | `false` | Master switch for forwarding `Rails.logger` output to PostHog Logs over OTLP. Requires Ruby 3.3+ and the three OpenTelemetry gems — see the [installation guide](/docs/logs/installation/ruby-on-rails). |
