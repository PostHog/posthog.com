...
import DjangoContextsMiddleware from './python/_snippets/django-contexts-middleware.mdx'

<DjangoContextsMiddleware />

## Error tracking

import PythonDjangoExceptionAutocapture from '../error-tracking/_snippets/python-django-exception-autocapture.mdx'
