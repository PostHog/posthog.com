...
PostHog can automatically capture generations, traces, spans, and more for Vercel's AI SDK. You can find out how to install it in [the LLM Observability docs](/docs/llm-observability/installation/vercel-ai). 
