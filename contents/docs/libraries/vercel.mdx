...
<CalloutBox icon="IconInfo" title="PostHog MCP server for v0" type="fyi">

If you're building with v0, you can connect to the PostHog MCP server to interact with PostHog's products. See the [PostHog MCP server documentation](/docs/model-context-protocol?tab=v0) for more details.
...
PostHog can automatically capture generations, traces, spans, and more for Vercel's AI SDK. You can find out how to install it in [the LLM analytics docs](/docs/ai-observability/installation/vercel-ai). 
