...
<CalloutBox icon="IconBolt" title="Vercel Marketplace Integration" type="info">

Looking for the one-click PostHog integration from Vercel Marketplace with billing handled by Vercel? See the [Vercel Marketplace integration guide](/docs/integrate/vercel-marketplace).
...
- [Vercel Marketplace integration](/docs/integrate/vercel-marketplace) - One-click install with Vercel billing
