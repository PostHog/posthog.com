...
Finally, to ensure all your requests complete you can combine PostHog's `shutdown()` method with Next.js's [`after` function](https://nextjs.org/docs/app/api-reference/functions/after) for Next.js 15.1 and above, or Vercel's [`waitUntil` helper method](https://vercel.com/docs/functions/functions-api-reference/vercel-functions-package#waituntil) for older versions. 
