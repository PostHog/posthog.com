...
> **What about the pages router?** [Vercel recommends](https://vercel.com/docs/functions?framework=nextjs) using route handlers in the app router when using Vercel Functions.
