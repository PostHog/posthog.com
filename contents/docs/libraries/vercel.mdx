...
PostHog can automatically capture generations, traces, spans, and more for Vercel's AI SDK. You can find out how to install it in [the AI Observability docs](/docs/ai-observability/installation/vercel-ai).
