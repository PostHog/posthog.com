...
Joins can also come from the [semantic layer](/docs/semantic-layer) (beta): when a human accepts an AI-proposed [table relationship](/docs/semantic-layer/certifications-and-relationships#relationship-proposals), it's promoted to a regular table join.
