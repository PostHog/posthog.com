...
You can also enable **Transpose results** to flip rows and columns, which is useful when you have many columns but few rows and want to compare values side by side.
