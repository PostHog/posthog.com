...
Tables also include a **Transpose results** toggle that flips rows and columns. This is useful when your query returns many columns but few rows. Enable it in the **Columns** section of the **Visualization** tab.
