...
4. Click the **Save as** button in the header to save your query as an insight, view, or [endpoint](/docs/endpoints).
5. Choose and customize your visualization if saving as an insight.
