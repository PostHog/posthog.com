...
After [linking your source](/docs/data-warehouse/setup), you can use its data in a [trend](/docs/product-analytics/trends) like you would event or person data. 
...
To see available sources, go to the [data warehouse tab](https://us.posthog.com/data-warehouse). This page shows the external and PostHog tables as well as [saved views](/docs/data-warehouse/views) you can visualize with trends or query through [SQL insights](/docs/product-analytics/sql).
