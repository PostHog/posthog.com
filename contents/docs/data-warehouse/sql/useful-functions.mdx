...
To use actions in SQL by using the `matchesAction()` function with the name of your action. For example, to get a count of the action clicked homepage button, you can do:
