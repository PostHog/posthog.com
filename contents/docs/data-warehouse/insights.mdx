...
Extended person properties are supported in [Trends](/docs/product-analytics/trends), [Funnels](/docs/product-analytics/funnels), and [Retention](/docs/product-analytics/retention) insights.
