...
After [linking your source](/docs/cdp/sources), you can use its data in [trend](/docs/product-analytics/trends) and [funnel](/docs/product-analytics/funnels) insights like you would event or person data.
