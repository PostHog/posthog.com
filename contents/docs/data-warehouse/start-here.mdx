...
import { AllSources } from '../_snippets/data-sources'
...
>
  ...
  <OSButton variant="primary" asLink to="/docs/data-warehouse/sources">
...
>
  ...
  <OSButton variant="primary" asLink to="/docs/data-warehouse/query">
...
>
  ...
  <OSButton variant="primary" asLink to="/docs/data-warehouse/join">
    Set up a join
  </OSButton>
...
>
  ...
  <OSButton variant="primary" asLink to="/docs/data-warehouse/views">
    Create a view
  </OSButton>
...
>
  ...
  Sync Stripe to automatically generate a [revenue analytics dashboard](/docs/revenue-analytics/dashboard) in PostHog to track MRR, customer count, ARPU, LTV, growth rate, and more.
