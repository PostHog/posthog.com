...
>
  ...
  Sync Stripe to automatically generate a [revenue analytics](/docs/revenue-analytics/dashboard) dashboard in PostHog to track MRR, customer count, ARPU, LTV, growth rate, and more.
