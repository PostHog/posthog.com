...
>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/data-warehouse/sources">
...
>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/data-warehouse/query">
...
>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/data-warehouse/join">
    Set up a join
  </OSButton>
...
>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/data-warehouse/views">
    Create a view
  </OSButton>
