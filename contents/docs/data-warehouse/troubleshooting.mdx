...
## How can I see why my materialization is failing?

From the [SQL editor](https://app.posthog.com/sql), select your materialized view and scroll to the **Materialization Runs** table. Each run shows its status, row count, duration, and any errors.

Click any row to expand it and view detailed logs for that run. Logs include execution progress, timing, and error details to help you debug issues. You can also view materialization logs from the [Models](https://app.posthog.com/models) page by expanding a run in the **Materialization history** table.
