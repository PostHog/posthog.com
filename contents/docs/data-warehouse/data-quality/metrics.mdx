...
Metric checks run on the metric's schedule. See [triggers and schedules](/docs/data-warehouse/data-quality/triggers) to change the interval or pause automatic runs.
