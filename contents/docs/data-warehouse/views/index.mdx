...
Organize views into folders to keep them manageable. When saving a view, select a folder from the dropdown or create a new one. Drag and drop views between folders in the sidebar to reorganize them.
