...
Organize your views into folders when you have many of them. Folders appear in the SQL editor sidebar alongside your saved views.

To create a folder:

1. Go to the [SQL editor](https://app.posthog.com/sql).
2. In the sidebar, click **New folder**.
3. Enter a name for the folder.

When creating a view, you can choose which folder to save it to. Drag and drop existing views between folders to reorganize them.
