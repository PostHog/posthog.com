...
You can organize views into directed acyclic graphs (DAGs) to manage dependencies between your data models. A DAG is a structure where views depend on other views without circular dependencies – each view builds on data from earlier views in the graph.

DAGs help you:

- Visualize how your views relate to each other
- Understand data lineage – where your data comes from
- Ensure views are processed in the correct order

### Using multiple DAGs

You can create multiple DAGs to organize your data models. This is useful for:

- **Semantic separation by product area** – Keep finance, marketing, and analytics models separate
- **Environment separation** – Separate development, staging, and production models

To manage your DAGs, go to [**Data warehouse**](https://app.posthog.com/data-warehouse) > **Views**.
