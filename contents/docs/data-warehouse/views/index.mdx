...
In the PostHog data warehouse, you can save your most used queries as **views** and reference them in subsequent queries. You can [restrict who queries a view](/docs/settings/warehouse-access-control).
