...
| `view-delete`        | Delete a view (soft delete). Returns blocking view names if the view has dependencies.                     |
| `view-dependencies`  | Get upstream and downstream dependency counts, plus blocking view names for deletion.                      |
