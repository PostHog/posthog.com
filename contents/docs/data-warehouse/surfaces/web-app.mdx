---
title: The data warehouse in the web app
sidebar: Docs
showTitle: true
---
...
{/* TODO: screenshot of the SQL editor with a synced source table expanded in the schema browser */}
...
- **Write SQL with [PostHog AI](/docs/posthog-ai)** – describe the data you want and have the [query written or fixed](/docs/data-warehouse/write-sql-ai) against your real schema. It's an interaction mode inside the web app, not a separate surface.
