---
title: Use the data warehouse over PostHog MCP
sidebar: Docs
showTitle: true
---
...
- [Manage data quality over MCP and SQL](/docs/data-warehouse/data-quality/mcp) to create checks, start runs, and inspect results.
