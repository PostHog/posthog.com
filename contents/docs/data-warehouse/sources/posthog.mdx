...
> **Note:** The `information_schema` tables respect [warehouse access control](/docs/settings/warehouse-access-control). You only see tables and columns you have access to.
