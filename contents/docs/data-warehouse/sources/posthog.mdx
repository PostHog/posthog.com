...
The `system.hog_flows` table contains [workflow](/docs/workflows) definitions created in your project.
...
| `trigger`       | JSON containing the workflow's trigger configuration     |
| `edges`         | JSON containing the workflow's edge connections          |
| `actions`       | JSON containing the workflow's action definitions        |
