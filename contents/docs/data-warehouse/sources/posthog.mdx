...
The `system.data_modeling_views` table contains metadata about data modeling views (saved queries) in your project. These are the views you can [materialize](/docs/data-warehouse/views/materialize) in the data warehouse.
