...
- **Prometheus scraping**: if your services already expose `/metrics` endpoints, deploy the PostHog metrics agent to scrape them and forward to PostHog. No code changes needed.
...
| [Prometheus scraping](/docs/metrics/installation/prometheus) | PostHog metrics agent (Docker)                                    |
