...
> Note: If you generally bundle your web code via Webpack or Rollup or use a framework that does this such as Next.js we would highly recommend 
...
From [PostHog recordings](https://app.posthog.com/recordings) open the `Configuration` and enable the "V2" recorder. We are slowly rolling this out to everyone as it fixes a lot of issues regarding things like ShadowDOM elements and more. For some web frameworks the results are immediatley much better.
