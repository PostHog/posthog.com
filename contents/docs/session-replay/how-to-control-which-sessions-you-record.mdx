...
You can opt to only start recordings once your user emits a particular event. After the event is captured, the recording continues even after they leave the matching page.  
