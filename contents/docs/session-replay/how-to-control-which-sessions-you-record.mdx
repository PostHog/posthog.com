...
2. Visit your replay config page at [US Cloud](https://us.posthog.com/settings/project-replay#replay-ingestion) or [EU Cloud](https://eu.posthog.com/settings/project-replay#replay-ingestion).
