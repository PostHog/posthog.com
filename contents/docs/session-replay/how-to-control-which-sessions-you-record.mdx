...
You can opt to only start recordings once your user visits a certain page. After the url matches, the recording will continue even after they have left the matching page.  
