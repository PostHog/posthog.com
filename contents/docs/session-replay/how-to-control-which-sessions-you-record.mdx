...
import ImgFeatureFlagControlLight from '../../images/docs/session-replay/select-replay-control-flag-light-mode.png'
import ImgFeatureFlagControlDark from '../../images/docs/session-replay/select-replay-control-flag-dark-mode.png'
import ImgSampleConfigLight from '../../images/tutorials/limit-session-recordings/sampling-config-light-mode.png'
import ImgSampleConfigDark from '../../images/tutorials/limit-session-recordings/sampling-config-dark-mode.png'
import ImgMinDurationLight from '../../images/tutorials/limit-session-recordings/min-duration-light-mode.png'
import ImgMinDurationDark from '../../images/tutorials/limit-session-recordings/min-duration-dark-mode.png'
