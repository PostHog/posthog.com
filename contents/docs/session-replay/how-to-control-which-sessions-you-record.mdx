...
# Available on plans released Jan 2024

We're currently testing these new controls and will release them more widely once those tests are complete. [Contact support to request access to these plans.](https://us.posthog.com/project/2#panel=support%3Asupport%3Asession_replay)
