...
> Note: For mobile replay controls, see [iOS](/docs/session-replay/privacy#handling-sensitive-third-party-screens), and [Android](/docs/session-replay/privacy?tab=iOS#handling-sensitive-third-party-screens) privacy controls section. Support for this method in React Native and Flutter is planned — track progress [here](https://github.com/PostHog/posthog-js/issues/2169).
