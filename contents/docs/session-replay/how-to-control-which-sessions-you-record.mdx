...
<CalloutBox icon="IconInfo" title="Sampling is shared across all platforms" type="fyi">

The sampling rate is configured on the **Web** tab in your [replay ingestion settings](https://us.posthog.com/replay/settings#selectedSetting=replay-triggers) and applies to all platforms including Android, iOS, and React Native. Mobile SDKs respect this setting automatically.
