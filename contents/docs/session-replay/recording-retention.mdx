...
When you change the retention period, the new setting only applies to recordings that start from that point forwards. Existing recordings keep their original retention period.
