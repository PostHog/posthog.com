...
We automatically scrub some sensitive information from network headers, but your request or response payloads could contain sensitive data, you should provide a function to mask the captured data when you initialise PostHog.
