...
As inputs are highly likely to contain sensitive text such as emails or passwords, **we mask these by default**. You can set this explictly to false to enable the recording of inputs.
