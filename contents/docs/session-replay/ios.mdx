...
#### URLSession - async/await methods

In iOS, PostHog automatically captures network logs by using method swizzling on [URLSession](https://developer.apple.com/documentation/foundation/urlsession) methods, which allows for the out-of-the-box collection of network data.
