...
Just click the **+ Add to collection** button next to the **Share** button on a replay, search or create a new collection, and then select it. You can then go to the [collection page](https://us.posthog.com/replay/playlists), find that collection, and share the link to anyone with access to your PostHog project.
