...
The below steps outline how you can use the API to share replays:
...
2. Once you have the `session_id` in your backend, enable sharing for that recording using the API and creating an access token.
...
3. If your replays look incorrect or buggy, be sure to read our [troubleshooting docs on how to debug this](/docs/session-replay/troubleshooting#replay-of-recording-looks-incorrect--buggy).```
