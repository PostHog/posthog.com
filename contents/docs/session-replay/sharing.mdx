...
export const shareReplayLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/session-replay/share-replay-light-mode.mp4"
export const shareReplayDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/session-replay/share-replay-dark-mode.mp4"
