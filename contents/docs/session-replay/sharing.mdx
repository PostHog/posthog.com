...
This enables you to share the replay directly in two different ways:
...
To require a password for a public replay link, turn on **Password protect** in the share modal. See [password protecting a shared link](/docs/product-analytics/sharing#password-protecting-a-shared-link) for how it works.
