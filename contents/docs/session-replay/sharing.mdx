...
When viewing any recording you can press `Share` and from their you can configure the recording for **external sharing**. There are some configuration options for the iframe as well as the ability to specify that it should start at a particular timestamp.
