...
This enables you to share the replay directly in two ways:
...
To create issues in Linear, GitHub, GitLab, or Jira from a replay, use the [integrations](/docs/session-replay/integrations) feature instead.
