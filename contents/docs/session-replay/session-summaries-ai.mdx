...
To configure product context, click **Add product context** next to the "Use AI to summarize this session" button in the session replay player. This opens a drawer where you can describe your product in up to 10,000 characters.
