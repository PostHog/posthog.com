...
```ios_swift
// Before presenting a payment screen
PostHogSDK.shared.stopSessionRecording()

// Present your payment screen
presentPaymentScreen()

// When payment sheet is dismissed, resume recording
PostHogSDK.shared.startSessionRecording()
```

> **Important:** Be aware that some recordings might still capture sensitive content if the recording isn't stopped in time. Consider implementing these controls as early as possible in your navigation flow.
