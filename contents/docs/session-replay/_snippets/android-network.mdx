...
> **Note:** You can also toggle network recording remotely from your [Session Replay project settings](https://app.posthog.com/settings/project-replay#replay-network) with Android SDK version 3.32.0 or higher.