...
The same interceptor can also add PostHog tracing headers to matching hosts. See the [Android tracing headers docs](/docs/libraries/android#tracing-headers) for setup.
