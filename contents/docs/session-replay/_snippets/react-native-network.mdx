...
> **Note:** You can also toggle network recording remotely from your [Session Replay project settings](https://app.posthog.com/settings/project-replay#replay-network) with React Native SDK version 4.35.0 or higher.