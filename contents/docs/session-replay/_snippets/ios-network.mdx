...
> **Note:** You can also toggle network recording remotely from your [Session Replay project settings](https://app.posthog.com/settings/project-replay#replay-network) with iOS SDK version 3.41.1 or higher.