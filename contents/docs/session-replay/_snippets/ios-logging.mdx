...
config.sessionReplayConfig.captureLogs = true // Capture logs. Default is false.

PostHogSDK.shared.setup(config)
```

> **Note:** You can also toggle this remotely from your [Session Replay project settings](https://app.posthog.com/settings/project-replay#replay-log-capture) with iOS SDK version 3.41.1 or higher.
