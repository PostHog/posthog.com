...
See [network performance](/docs/session-replay/network-recording#ios) for more information.

## Masking and redacting

See [privacy controls](/docs/session-replay/privacy#ios) for more information.