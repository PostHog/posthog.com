...
export const EnableSessionReplayDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/session-replay/enable-session-replay-in-project-settings-dark-mode.png"
export const EnableSessionReplayLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/session-replay/enable-session-replay-in-project-settings-light-mode.png"
...
> 🚧 **NOTE:** Mobile recording is currently **only available on Android** and is considered `beta`. Check out the [mobile recording page](/docs/session-replay/mobile).
