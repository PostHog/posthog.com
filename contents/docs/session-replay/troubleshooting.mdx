...
| `disabled`  | Recording is turned off – either in [your project replay settings](https://us.posthog.com/settings/project-replay) or via SDK config at runtime. |
...
| `null` / `false` | `disabled`            | any                                                                 | Replay is off, either in [project settings](https://us.posthog.com/settings/project-replay) or via SDK config like `disable_session_recording: true`.        |
