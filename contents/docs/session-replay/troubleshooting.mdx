...
In your [project replay settings](https://us.posthog.com/settings/project-replay#replay), there's a section for 'Authorized domains for replay'. This is the list of domains where posthog will capture recordings. You should make sure it's not too restrictive.
