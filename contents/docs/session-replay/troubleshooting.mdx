...
Product analytics, feature flags, surveys, and error tracking all work. Each SDK sends data to PostHog over an outbound HTTPS connection from the user's browser, so PostHog does not need to reach your app. Your users only need to reach PostHog.
