...
- **[Summarize a recording with Replay Vision](/docs/replay-vision/scanner-types#summarizer)** – have Replay Vision watch a recording and write up what the user did.
