...
- [How to send a slack notification when there's a recording to watch](/tutorials/session-recordings-in-slack)
...
- [How to set up session replays in Electron](/tutorials/electron-analytics)
- [How to set up session replays in Framer](/tutorials/framer-analytics)
- [How to set up session replays in iOS](/tutorials/ios-session-replay)
- [How to set up session replays in Webflow](/tutorials/webflow)
- [How to set up session replays in Squarespace](/tutorials/squarespace-analytics)
