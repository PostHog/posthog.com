...
5. [Limit your product analytics usage to `identify()` calls and `$pageview` events](docs/session-replay/troubleshooting#unable-to-filter-by-user-or-page-properties) to reduce the costs while maintaining useful filtering options.