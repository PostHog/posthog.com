...
>
  ...
  <AuthAwareOSButton variant="primary" to="https://app.posthog.com/signup" authenticatedTo="/docs/session-replay/installation" external={true}>
    Install PostHog SDK
  </AuthAwareOSButton>
...
<QuestLogItem 
  ...
  subtitle="Connect with product data"
  icon="IconLogomark"
>
...
<div className="flex flex-wrap gap-2">
  ...
  <OSButton variant="secondary" asLink to="/talk-to-a-human" external={true}>
    Talk to a human
  </OSButton>
</div>
