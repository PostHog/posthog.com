...
> **Note:** Any individual recording you want to preserve can be downloaded by click "Export to file" in the more options menu in the bottom right of a recording. Downloaded recordings can then be imported back into PostHog for future playback, even if the original recording has expired.
