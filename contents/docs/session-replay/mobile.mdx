...
> 🚧 **NOTE:** Mobile Recording is currently **only available on iOS** and is considered `alpha`. We are keen to gather as much feedback as possible so if you try this out please let us know and reach out in our [Slack Community](/slack) to share your experience with it.
