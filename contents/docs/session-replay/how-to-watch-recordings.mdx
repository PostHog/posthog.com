...
This will then be accessible to anyone in your project via the **Shared filters** tab and new replays will automatically be added to it. You can also apply saved filters by clicking **Add filter** – they appear as a searchable option alongside other filter types.
