...
After you've created a saved filter, you can edit it without recreating it:

- **Rename a filter** - Click the pencil icon next to the filter name to edit it inline.
- **Change an event filter** - Click an event filter, then click **Change event** to select a different event or action.
