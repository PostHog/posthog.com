...
2. Share the private link to the recording, create a public link, or [create linked issues](/docs/session-replay/integrations) in tools like Linear, GitHub, GitLab, or Jira
