...
<<<<<<< HEAD
12. Take a screenshot by pressing **S** or clicking the **screenshot** button
||||||| a0e8350e9
...
4. Switch time display between "relative" (seconds in recording), UTC, or project timezone
