...
3. Add comments by pressing **C** or clicking the **Comment** button to share your thoughts with your team. You can also add emojis to the timeline to highlight specific parts.

4. Enter cinema and fullscreen mode to remove the UI elements and focus on the recording.
