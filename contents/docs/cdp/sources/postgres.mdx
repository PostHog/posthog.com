...
- **Query directly** – Queries your Postgres database in real-time. Data stays in your database and is queried live from the [SQL editor](/docs/data-warehouse/sql). Direct query sources can't be joined with PostHog data.
