...
We recommend starting from the default [HTTP incoming webhook template](/docs/cdp/sources/incoming-webhooks). For most use cases, you can transform the incoming webhook to the required properties simply using our [Hog templating language](/docs/hog).
