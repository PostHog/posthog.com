...
You can sync data from LinkedIn Ads reports by configuring it as a source in PostHog. The supported reports that can be synced include Account, Campaigns, Campaign Stats, Campaign Groups, Campaign Groups Stats, Creatives, and Creative Stats, as described here:
...
- [Creatives](https://learn.microsoft.com/en-us/linkedin/marketing/integrations/ads/account-structure/create-and-manage-creatives?view=li-lms-2025-08&tabs=http#search-for-creatives): Ad objects (LinkedIn calls individual ads "Creatives")
