...
If you add new tables to your source database, click **Pull new schemas** in the **Schemas** tab to sync them without waiting for the next scheduled sync. A notification shows how many schemas were added or removed.

### Sync now

Click **Sync now** in the **Schemas** tab to sync all enabled schemas at once. A confirmation dialog appears before syncing starts, and new sync jobs appear in the **Syncs** tab.

Use this to refresh your data immediately instead of waiting for the next scheduled sync.
