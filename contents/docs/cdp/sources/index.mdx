...
Once the first incremental sync completes, the primary key columns are locked and can't be changed. To modify them, delete the synced data first or switch to a different sync method like append or full table.
