...
The anchor time is stored in UTC. When your project timezone is set to UTC or GMT, the UI displays "(UTC)" next to the anchor time label. For other project timezones, a toggle lets you view and set the anchor time in either UTC or your project timezone.
