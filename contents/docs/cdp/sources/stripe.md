...
If you only take one thing from this page: connect with a restricted API key (with **Write** on **Webhook endpoints**) or OAuth and turn on webhook syncing as soon as your source is created.
