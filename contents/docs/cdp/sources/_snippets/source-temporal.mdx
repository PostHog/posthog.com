...
The Temporal.io source supports resumable imports for full-refresh syncs. If an import is interrupted, it automatically resumes from where it left off instead of restarting from the beginning. This is useful when syncing large amounts of workflow data.
