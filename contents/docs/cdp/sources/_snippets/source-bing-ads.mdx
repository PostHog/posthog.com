You can sync data from Bing Ads reports by configuring it as a source in PostHog. The supported reports that can be synced include Campaigns, Campaign Performance Report, Ad Group Performance Report, and Ad Performance Report, as described here:

- [Campaigns](https://learn.microsoft.com/en-us/advertising/guides/campaign-management)
...
- Your account ID from the [Bing Ads interface](https://ui.ads.microsoft.com/) > Settings > Account Settings > The account ID will be visible below the Account ID item.
...
Connect PostHog to your Bing Ads account using a Microsoft account. The Microsoft account must have permission to access data.
