...
8. You will be redirected to a screen for releasing a new version of your app. Here, you need to:
  ...
  3. Click **Release** and fill in the option release details.
...
1. Go to the [Data pipelines page](https://us.posthog.com/pipeline/sources), and select the **Sources** tab.
2. Click the **+ New source** button and select Shopify by clicking the **+ Create** button.
3. Fill in your Shopify `Store ID` and the `Client ID` and `Secret` from above.
...
The data warehouse then starts syncing your Shopify data. You can see details and progress in the [sources tab](https://us.posthog.com/pipeline/sources).
