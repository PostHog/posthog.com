...
1. Go to the [data pipelines page](/pipeline/sources), and select the **Sources** tab.
...
You can see details and progress in the data pipelines [sources tab](/pipeline/sources).
