...
- Your account ID from the [ads manager](https://ads.tiktok.com/i18n/dashboard) > in the top right it's your account > open the dropdown > check you ad account id or check the dashboard url, e.g `https://ads.tiktok.com/i18n/dashboard?aadvid=ID_HERE`

![Location of the Tiktok account ID](https://res.cloudinary.com/dmukukwp6/image/upload/w_500,c_limit,q_auto,f_auto/Screenshot_2025_09_30_at_11_25_16_AM_ab70c4f7c4.png)

## Configuring PostHog

Connect PostHog to your Tiktok Ads account using a Tiktok account. The Tiktok account must have permission to access data.
