...
A new delay is drawn for every run, meaning some runs start immediately while others may wait up to the full upper limit. For example, a daily batch export configured to start at midnight may begin anywhere between 00:00 and 00:20.
