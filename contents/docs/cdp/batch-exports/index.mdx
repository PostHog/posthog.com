...
If you need to export data programmatically without setting up a recurring schedule, use the [file download API](/docs/cdp/batch-exports/file-download-api). This API lets you trigger batch exports on demand and download the resulting files directly – useful for integrating batch exports into your own data pipelines or downloading data for specific date ranges when you need it.
