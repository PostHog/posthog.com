...
5. From the *Region* dropdown, select one of the GCS regions: "GCP — US Central (Iowa)" or "GCP — Europe (Netherlands)".
6. Finally, set the *Endpoint URL* configuration to: `https://storage.googleapis.com`.
