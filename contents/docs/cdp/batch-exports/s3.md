...
6. Fill in the remaining [configuration details](#s3-configuration).
...
- **Endpoint URL:** The endpoint URL for your storage provider (e.g., `https://<ACCOUNT_ID>.r2.cloudflarestorage.com` for Cloudflare R2 or `https://storage.googleapis.com` for GCS). This is set when you create the connection, and can't be changed from the export's configuration form afterwards.
