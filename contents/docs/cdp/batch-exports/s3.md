...
* **Connection:** An integration that stores your credentials (Access Key ID and Secret Access Key). Click **Configure new AWS S3 connection** (or **Configure new S3-compatible connection** for non-AWS providers) to create one. Credentials are stored encrypted and can be reused across multiple exports.
