...
In addition, depending on any delays in sending or ingesting data, the last few batch export runs created by a backfill may have data that overlaps with the first few regularly scheduled batch export runs.
