...
If your webhook endpoint is behind a firewall or web application firewall (WAF), it may block requests from PostHog. Add these IP addresses to your allowlist so PostHog can deliver events to your endpoint.

<OutboundIPsInline />

These are public, stable IPs used by PostHog's data pipeline.
