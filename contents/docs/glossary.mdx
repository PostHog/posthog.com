...
#### Issues
What we use to log bugs, discuss ideas and make decisions on Github. Issues are better than a [community question](/questions), but worse than a [pull request](/manual/glossary#pull-request). 
