...
Background research is deep, so it can take up to fifteen minutes. If you've just connected a [source](/docs/start-here/inbox/sources), check which case applies.
