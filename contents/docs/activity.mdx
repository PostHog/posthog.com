...
5. **Sessions:** Shows a list of ongoing [sessions](/docs/data/sessions) with customizable columns. This view displays active user sessions currently happening on your site or app.
