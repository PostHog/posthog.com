...
4. **Live:** Shows a live feed of events as they are captured as well as the number of currently active users. This can be filtered by event type or event properties (exact match), or paused.
