...
The MCP server calls `feature-flag-get-all` with `active: "STALE"` and returns the results. This works in any MCP client like Claude Code, Cursor, Windsurf, VS Code, and others. See [Manage flags with MCP](/docs/feature-flags/surfaces/mcp).
