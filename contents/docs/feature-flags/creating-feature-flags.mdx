...
You can delete feature flags that are linked to [experiments](/docs/experiments), as long as the experiment isn't currently running. Draft, stopped, and completed experiments don't block flag deletion.

When you delete a flag linked to an experiment:
