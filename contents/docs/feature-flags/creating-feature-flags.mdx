...
To create a new feature flag, navigate to the [feature flags tab](https://app.posthog.com/feature_flags) in PostHog and click the **New feature flag** button. A dropdown menu will appear where you can select the type of flag you want to create – boolean, multivariate, or remote config. You can also create an experiment directly from this menu or ask AI for help.

After selecting a flag type, you'll see a form where you can complete the details of your new flag:
