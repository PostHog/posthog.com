...
- If you capture [person profiles](/docs/data/persons), you can target based on [person properties](/docs/product-analytics/person-properties) and [cohorts](/docs/data/cohorts).
