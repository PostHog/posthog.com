...
To create a new feature flag, navigate to the [feature flags tab](https://app.posthog.com/feature_flags) in PostHog and click the **New** button. This opens a dropdown menu with options to create different flag types:
...
Selecting an option pre-configures the form for that flag type. You can also click the main button to create a flag and select the type in the form.
