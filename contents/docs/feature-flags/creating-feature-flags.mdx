...
If you are capturing [person profiles](/docs/data/persons), you can create conditions based on [user properties](/docs/product-analytics/user-properties), [group properties](/docs/product-analytics/group-analytics#how-to-set-group-properties), or [cohorts](/docs/data/cohorts).
