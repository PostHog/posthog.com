...
1. `required` [Create a new feature flag](#step-1-create-a-new-feature-flag-required)
2. `required` [The key you use in your code to evaluate the feature flag](#step-2-feature-flag-key-and-description-required)
3. `required` [The type of feature flag – boolean, multivariate, or remote config](#step-3-feature-flag-type-required)
4. `optional` [Additional feature flag behaviors](#step-4-feature-flag-behavior-optional)
5. `optional` [Evaluation runtime and environments](#step-5-evaluation-runtime-and-environments-optional)

## Step 1. Create a new feature flag (required)

To create a new feature flag, navigate to the [feature flags tab](https://app.posthog.com/feature_flags) in your PostHog app and click the **Create feature flag** button to create a new flag.
...
## Step 4. Feature flag behavior (optional)
