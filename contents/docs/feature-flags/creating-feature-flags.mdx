...
- If you capture [person profiles](/docs/data/persons), you can target based on [user properties](/docs/product-analytics/user-properties) and [cohorts](/docs/data/cohorts).
