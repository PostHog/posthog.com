...
## 2. Feature flag key and description
...
You can control where your feature flags are evaluated using the **tags (evaluation environments)** and **evaluation runtime** sections of the form. You can find a detailed explanation of how evaluation environments work in the [evaluation environments documentation](docs/feature-flags/evaluation-environments).

### Tags (evaluation environments)
...
<CalloutBox icon="IconWarning" title="Important: Evaluation environment tag behaviour" type="action">
...
You don't need a tag for your first feature flag, but we recommend reading the [evaluation environments documentation](docs/feature-flags/evaluation-environments) in detail before using it in production.
