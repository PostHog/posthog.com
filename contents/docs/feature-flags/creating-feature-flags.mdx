...
| 2 | [The key you use in your code to evaluate the feature flag](#step-2-feature-flag-key-and-description-required) | Required |
| 3 | [The type of feature flag – boolean, multivariate, or remote config](#step-3-feature-flag-type-required) | Required |
| 4 | [Additional feature flag behaviors](#step-4-feature-flag-behavior-optional) | Optional |
| 5 | [Evaluation runtime and environments](#step-5-evaluation-runtime-and-environments-optional) | Optional |
