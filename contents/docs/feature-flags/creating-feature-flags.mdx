...
> **Note:** This feature requires `person_profiles: 'always'` and calling `posthog.identify` from the Web SDK to function as expected. [Learn more about anonymous vs identified events here](/docs/data/anonymous-vs-identified-events).
