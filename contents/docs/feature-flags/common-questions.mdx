...
## How are flags rolled out? Are they deterministic?

For a specific feature flag, a user who falls under a percentage rollout will always remain in that same percentage so you don't have to worry about users flip flopping.
