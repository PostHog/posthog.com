...
We make a request to get feature flags everytime the posthog SDK is initialised, whenever user identity changes, or whenever you set new properties on the person.
