...
## Copying scheduled changes to other projects

When [copying feature flags to other projects](/docs/feature-flags/multi-project-feature-flags), you can also copy pending scheduled changes. Check the "Copy schedules" option to include any unexecuted scheduled changes with the copied flag. Completed or already-executed schedules are not copied.