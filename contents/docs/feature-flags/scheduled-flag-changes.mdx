...
When copying a feature flag to another project, you can also copy any pending scheduled changes. Only unexecuted (pending) schedules are copied – completed schedules are not included.

See [multi-project feature flags](/docs/feature-flags/multi-project-feature-flags) for instructions on copying flags across projects.