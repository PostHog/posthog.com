...
When [copying a feature flag to another project](/docs/feature-flags/multi-project-feature-flags), you can also copy any pending scheduled changes. This enables you to replicate your entire release schedule across projects – for example, when promoting a flag from staging to production.