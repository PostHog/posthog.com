...
flowchart TD
    ...
    db -- "flag definitions, person properties, group properties, cohort memberships" --> api
...
flowchart TD
    ...
    api -- "flag definitions (every 30s)" --> sdk
    app -- "personProperties, groupProperties" --> sdk
