...
> **Note:** This restriction **does not apply** to v7.13.1 and above of our [Python](/docs/libraries/python) SDK, which can evaluate mixed-targeting flags locally when you provide both `person_properties` and `groups` / `group_properties`.
