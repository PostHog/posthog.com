...
> **Note:** Do not use local evaluation in an edge / lambda environment, as this can raise your bill drastically. It's best to use regular flag evaluation instead.
