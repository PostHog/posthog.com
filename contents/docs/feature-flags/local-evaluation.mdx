...
To enable local evaluation of feature flags that depend on dynamic [cohorts](/docs/data/cohorts), we translate the cohort definition into person properties.
