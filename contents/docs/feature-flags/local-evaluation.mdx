...
> **Note:** Do not use local evaluation in edge/lambda environments and stateless PHP applications, as per-request initialization causes performance issues and inflated billing. Use regular flag evaluation instead.
