...
Evaluating feature flags requires making a request to PostHog. However, you can improve performance by evaluating a flag locally instead – without having to make a request to PostHog.
