...
Posthog-js 1.55 exposes `getEarlyAccessFeatures` and `updateEarlyAccessFeatureEnrollment`, which enable you to wrap your own experience around early access features.