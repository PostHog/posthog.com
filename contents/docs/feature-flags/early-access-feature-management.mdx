...
We've prebuilt a web script that adds an early access feature modal to your site. 
...
2. Search for [Early Access Features App](https://app.posthog.com/web-scripts) in [**Web scripts**](https://app.posthog.com/web-scripts).
...
For a sample implementation, see the [public beta tutorial here](/tutorials/public-beta-program#creating-a-beta-opt-in-page) or [the web script code here](https://github.com/PostHog/early-access-features-app/blob/main/site.ts).
