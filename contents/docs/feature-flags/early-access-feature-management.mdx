...
| **Concept** | No | Users can opt in to register interest, but the feature flag is **not** enabled for them. Use this for roadmap items where you want to gauge demand before building. |
