...
2. Search for [Early Access Features App](https://app.posthog.com/pipeline/new/site-app?search=Early%20Access) in the [Site Apps](https://app.posthog.com/project/apps) tab.
