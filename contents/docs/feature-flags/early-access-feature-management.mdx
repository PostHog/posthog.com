...
We've prebuilt a site app that adds a user early access feature modal to your site. To use it:
...
4. If you did set a `data-attr` selector, add a component with that selector into your app. For example, if you set your selector to `#beta-button`, you need to add an element like `<button id="beta-button">Public Betas</button>`.
