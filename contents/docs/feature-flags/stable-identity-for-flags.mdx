...
Feature flags are [pure functions](/docs/feature-flags/production-ready) – same inputs, same outputs. The most common way to break that contract is to change the `distinct_id` between evaluations, which happens naturally when a user transitions from anonymous to identified.
...
- [Production-ready feature flags](/docs/feature-flags/production-ready) – the pure function model that explains why identity matters for flags
