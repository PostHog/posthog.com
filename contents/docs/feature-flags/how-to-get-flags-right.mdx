...
- [Unexpected results are almost always input problems](#unexpected-results-are-almost-always-input-problems) – evaluate a flag a million times with the same inputs, get the same result a million times. If the result changed, an input changed.
