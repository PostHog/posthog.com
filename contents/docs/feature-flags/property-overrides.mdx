...
1. [Create a feature flag in PostHog](/docs/feature-flags/creating-feature-flags)
2. Add a filter condition using `$app_version` with a [semver operator](/docs/feature-flags/creating-feature-flags#semantic-version-semver-targeting) – for example, `$app_version >= (semver) 2.0.0`
