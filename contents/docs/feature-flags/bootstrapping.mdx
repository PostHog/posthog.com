...
Since there is a delay between initializing PostHog and fetching feature flags, feature flags are not always available immediately. This can be detrimental if you want to do something like redirecting to a different page based on a feature flag.
