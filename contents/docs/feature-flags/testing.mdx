...
## Method 1: Assign an optional override

You can assign a user a specific flag value by **adding an optional override** to your [release conditions](/docs/feature-flags/creating-feature-flags#release-conditions). For example, you can create an override to assign a user a specific flag value if their email is your own (or someone in your team). 
