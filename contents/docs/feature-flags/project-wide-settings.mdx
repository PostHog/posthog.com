...
When enabled, all new feature flags and experiments will have persistence enabled by default. This ensures consistent user experiences across authentication steps where users might have different properties before and after login.

> **Note:** Modifying this setting will only affect **new** feature flags and experiments. Existing flags and experiments retain their current persistence settings.
