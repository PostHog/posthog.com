...
Evaluation contexts are currently in alpha release and require (at least) the <b>boost add-on</b> for the resource tagging feature to function correctly. This feature may not be available in your PostHog instance yet. Contact support if you'd like early access to this feature.

</CalloutBox>

<FeatureAvailability availability={_frontmatter.availability.features.evaluationContexts} />
