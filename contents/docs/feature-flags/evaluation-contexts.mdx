...
5. **Update SDKs gradually**: Roll out [SDK changes](/docs/sdk-health) with `evaluation_contexts` per context
...
| [React Native](/docs/libraries/react-native/) | 4.21.0+ | 4.7.2+ |
