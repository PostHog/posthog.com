...
>
  ...
  > **Frontend, mobile, or CLI app?** Use a [client-side SDK](/docs/libraries) or the public [`/flags` endpoint](/docs/api/flags) with your public [project token](/docs/feature-flags/installation#where-to-find-your-project-token). Save [local evaluation](/docs/feature-flags/local-evaluation) and the secret feature flags secure API key for server-side code only.
