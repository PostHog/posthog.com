...
>
  ...
  - View all experiments using a specific flag from the **Experiments** tab on the flag's detail page
  - Create a draft experiment directly from a multivariate flag using the quick create card on the **Experiments** tab
