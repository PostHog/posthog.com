...
4. (Optional) Check **Copy schedules** to include any pending [scheduled changes](/docs/feature-flags/scheduled-flag-changes) with the flag. This option shows the number of pending schedules (e.g., "3 pending") or "None available" if the flag has no pending schedules.
