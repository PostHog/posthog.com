...
- [React Native (version 3.5.0+)](/docs/libraries/react-native/config#evaluation_environments)
- [Node.js (version 4.3.0+)](/docs/libraries/node/config#evaluation_environments)
- [Android (version 3.10.0+)](/docs/libraries/android#evaluation_environments)
- [iOS (version 3.16.0+)](/docs/libraries/ios#evaluation_environments)
