...
| `SITE_URL` - should be an absolute URL and include the protocol (e.g. `https://app.posthog.com`)            | Principal/canonical URL of your PostHog instance. **Required for emails and webhooks to work properly.** We currently do not support subfolders in this URL. | `http://localhost:8000`
