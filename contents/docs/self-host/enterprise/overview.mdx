...
- Deploy PostHog using Kubernetes on your own cloud
    - This requires knowledge of Kubernetes and your engineering team's time for deployment and ongoing maintenance. We are happy to provide reasonable [support](/docs/self-host/enterprise/support.md).
    - [Enterprise deployment](/docs/self-host/enterprise/overview.mdx) contains the information you need to get set up - we recommend you get a license key first.
