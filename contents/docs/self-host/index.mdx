...
> **This page covers our open-source Docker compose deployment**, which is available under a MIT license, [without guarantee](/docs/self-host/open-source/disclaimer). We have [sunset our paid Kubernetes deployment](/blog/sunsetting-helm-support-posthog) and no longer offer support for Kuberenetes deployments.
...
If your server is struggling, you can either increase your instance size or move to [PostHog Cloud](/docs/migrate/migrate-between-posthog-instances) for a hands-off experience
