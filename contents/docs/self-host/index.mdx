...
We're exploring a new version for our self-hosting deployment via a TUI binary. This hasn't been extensively tested at the moment, and we might change/remove it without notice.
