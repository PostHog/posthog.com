...
> **This page covers our open-source Docker compose deployment**, which is available under a MIT license, [without guarantee](/docs/self-host/open-source/disclaimer). We have [sunset our paid Kubernetes deployment](/blog/sunsetting-helm-support-posthog) and no longer offer support for Kubernetes deployments.
