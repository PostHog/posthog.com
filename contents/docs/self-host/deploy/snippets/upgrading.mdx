...
> Note: Make sure you are not in a folder that contains another folder with the name `posthog`. The upgrade command may fail after unintentionally reading through it.