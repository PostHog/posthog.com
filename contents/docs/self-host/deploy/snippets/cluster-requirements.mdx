...
* Kuberenetes nodes:
    - ensure your cluster has enough resources available (we suggest a total minimum of 4 vcpu & 8GB of memory)
    - ensure your nodes can run x86-64/amd64 architecture workloads. ARM is currently not supported
