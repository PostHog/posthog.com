...
-   You have deployed a Linux Ubuntu Virtual Machine.
    -   A $10/month (2GB RAM) droplet on DigitalOcean can handle approximately 100k events spread over a month
...
-   to [PostHog Cloud](/docs/runbook/migrate/migrate-between-cloud-and-self-hosted) for hands-off experience
-   to [a bigger self-hosted instance](/docs/runbook/migrate/migrate-to-another-self-hosted-instance)
