...
Warning: the 1-click is broken on DigitalOcean, follow the [manual install instructions](https://posthog.com/docs/self-host/deploy/digital-ocean#manual-install).
