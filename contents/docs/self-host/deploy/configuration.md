...
- Set `.Values.clickhouseOperator.useNodeSelector: true` in your `values.yaml`. You can find more information about optional settings like that [here](https://github.com/PostHog/charts-clickhouse/blob/main/charts/posthog/values.yaml#L29) and also more about `nodeSelectors` [here](https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#nodeselector)
