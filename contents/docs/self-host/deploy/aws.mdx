...
First, we need to set up a Kubernetes cluster (see the official AWS [documentation](https://docs.aws.amazon.com/eks/latest/userguide/getting-started-eksctl.html) for more info). Note that AWS defaults to non-expandable volumes, to get an expandable volume see TODO.
