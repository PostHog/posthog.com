...
For troubleshooting your own problems the [troubleshooting guide](/docs/self-host/deploy/troubleshooting) and [runbooks](/docs/self-host/deploy/troubleshooting) will likely be useful.
...
-   Upgrade to PostHog Enterprise
    -   [Book a call](/demo) or send us an email at [hey@posthog.com](mailto:hey@posthog.com)
