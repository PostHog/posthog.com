...
-   to [PostHog Cloud](/docs/migrate/migrate-between-posthog-instances) for hands-off experience
-   to [a bigger self-hosted instance](/docs/migrate/migrate-between-posthog-instances)
