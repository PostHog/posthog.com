...
You can self-host PostHog the open source version in weird and wonderful ways such as [monitor a home IoT system in your basement](https://gist.github.com/mariusandra/d8add5fc7f32bedeae45d9ce8eb75b35).
