...
- Your old and new instances should both be running **the exact same version of PostHog**, with a minimum version of `1.29.0`
## Approach
...
2. Visit the 'Plugins' page on the new instance and click on the 'Advanced' tab.
