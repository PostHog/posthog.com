...
<blockquote>
  <p class="text-black/70 dark:text-white/90"><span className="text-xl">👋</span> <strong>Welcome!</strong> This guide will get you set up with PostHog for your web app and backend.</p>
</blockquote>
