...
To join an opt-in beta you just need to head to the [feature previews menu in-app](http://us.posthog.com/home#panel=feature-previews). It's worth noting that feature previews are on a per-user basis, and will not apply to your entire organization.
