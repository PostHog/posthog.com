...
You can follow along with [the latest betas and updates on our changelog](/changelog). If you're interested in joining an opt-in beta, [head to the feature previews menu in-app](http://app.posthog.com/home#panel=feature-previews).
...
To join an opt-in beta you just need to head to the [feature previews menu in-app](http://app.posthog.com/home#panel=feature-previews).
