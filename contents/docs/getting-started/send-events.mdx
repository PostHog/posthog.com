...
While combining these two events using [Actions](/data/actions) to fix this drift is possible, manually tracking these high-value actions with custom events is far more reliable.
