...
> **Tip**: Autocapture sends lots of events. We provide a generous free tier but as you scale you might switch to mainly using [custom events](#3-capture-custom-events-client) on the areas of the product that are more stable and [tune autocapture](/docs/sdks/js#tuning-autocapture) to your needs.

## 1. Setup autocapture <Badge>Client</Badge>
...
## 2. Capture custom events <Badge>Client</Badge>
...
## 3. Capture backend events <Badge>Optional</Badge> <Badge>Server</Badge>
