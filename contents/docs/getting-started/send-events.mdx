...
<details>
  ...
  If you have a [single-page app](/tutorials/single-page-app-pageviews), you'll need to manually capture pageviews and pageleaves as PostHog only sends them once – i.e. when your app loads and when they leave.
</details>
