...
It's a priority for us that events are fully processed and saved as soon as possible. Typically the events will be usable in queries within a couple of minutes.
