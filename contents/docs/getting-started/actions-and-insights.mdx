...
![form with the field 'Link taget equals' and 'Text equals' set to '/sign-up' and 'Sign up' respectively](./images/match-group.png)
...
In this guide we'll be covering both Trends and Funnels, which are the two most-core insight types and generally are the ones you'll be reaching for the most when you have a question.

## 3. Filtering events in our insight

## 4. Creating a new funnel
