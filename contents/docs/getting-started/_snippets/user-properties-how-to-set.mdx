...
User property values can be strings, booleans, numbers, objects, or arrays.  For objects and arrays, you can use [HogQL](/docs/product-analytics/hogql) to access nested properties in the PostHog app.
