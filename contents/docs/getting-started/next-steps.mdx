...
You'll likely want to [filter out events from internal users](/tutorials/filter-internal-users) if you do this.

## 4. Watch your first session replay
...
## 6. Import revenue and customer data into our data warehouse
...
## 7. Figure out what to track in PostHog
