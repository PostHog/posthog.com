...
- **[Terraform provider](/docs/product-analytics/dashboards#managing-dashboards-with-terraform)** - Manage dashboards, insights, and other PostHog resources as infrastructure-as-code.
