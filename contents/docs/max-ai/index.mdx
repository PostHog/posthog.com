...
If an org admin has previously approved AI features, but you'd prefer them disabled, you can disable Max and all AI functionality in your organization settings. To do this:
