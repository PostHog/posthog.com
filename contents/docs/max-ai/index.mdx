...
There isn't a toggle to _hide_ AI feature altogether, but if you're worried about accidental opt-ins – only org admins can approve AI features in the organization.

If an org admin has previously approved AI features, but you'd prefer them disabled (and are an org admin too), you can disable Max and all AI functionality in your organization settings. To do this:
