...
You can pop Max open wherever you are in PostHog! Just click on "Max" in the top right corner of the app. Then get to chatting.
...
- Create [feature flags](/docs/feature-flags), [experiments](/docs/experiments) or [surveys](/docs/surveys)
...
You can always edit Max's memory in the PostHog's settings.
