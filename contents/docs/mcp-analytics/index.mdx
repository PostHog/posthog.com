...
<SurfaceCard icon="IconPlug" color="purple" title="PostHog MCP" url="/docs/mcp-analytics/surfaces/mcp" cta="Query tool usage">
Query sessions, tool stats, failures, and intent clusters from any MCP client.
</SurfaceCard>

<SurfaceCard icon="IconCode" color="orange" title="PostHog Desktop" badge="Beta" url="/docs/mcp-analytics/surfaces/desktop" cta="Review reports">
