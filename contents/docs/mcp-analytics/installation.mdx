...
The rest of this section covers the TypeScript SDK. **Using Python?** See [Python](#python) below — stateless works out of the box on FastMCP, with no `enableJsonResponse` caveat.
