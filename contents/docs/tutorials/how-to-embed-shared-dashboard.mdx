...
[Dashboards](/docs/user-guides/dashboards) let you bring together a number of charts and Insights into a single view. Dashboards are available to anyone with access to the Project that they are part of. However, you may want to share a Dashboard with other people who do not have a PostHog login. In these situations you can [share a link to the Dashboard](/docs/user-guides/dashboards#send-or-share-a-dashboard) or you could decide to embed the Dashboard within a publicly accessable web page.
