...
sidebar: Docs
showTitle: true
featuredImage: ../../images/tutorials/banners/nextjs-supabase-transparent.png
author: ['leggetter']
topics:
    - funnels
    - user paths
...
![Signup Funnel conversion with PostHog](../../images/tutorials/nextjs-supabase-transparent.png)
