...
1. Have added the [PostHog snippet](/docs/libraries/js) to your website. Alternatively, you can also be using our [API](/docs/api/overview) or [Python integration](/docs/libraries/python), which have support for feature flags. However, please note that the examples in this tutorial will be written in JavaScript.
...
This snippet refers to our [JavaScript Integration](/docs/libraries/js), which is also what we will be using for this tutorial. However, you can also use feature flags via our [API](/docs/api/overview) as well as other libraries, such as our [Python Integration](/docs/libraries/python) (we're working to add this functionality to as many of our libraries as possible). 
