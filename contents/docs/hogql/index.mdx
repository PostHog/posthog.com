...
[SQL insights](/docs/product-analytics/sql) enable you to directly query your data with SQL commands like `SELECT`, `FROM`, `JOIN`, `WHERE`, `GROUP BY` along with many of ClickHouse SQL's function. This enables more complex and customizable queries and results than other insights.
