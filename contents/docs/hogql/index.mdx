...
[HogQL expressions](/docs/hogql/expressions) enable you to directly access, filter, and breakdown your data using SQL. They can be used wherever event filters can including dashboards, trends, funnels, and the activity tab.
...
The [activity](https://app.posthog.com/events) tab replaces the "Live Events" tab in PostHog. It provides more functionality including date filtering, event counts, HogQL queries, [aggregations](#supported-aggregations) and column configuration.
