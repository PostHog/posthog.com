...
<CalloutBox icon="IconInfo" title="Filters required on replay home page" type="fyi">

On the replay home page, you must apply at least one filter before the **Summarize these recordings** button becomes available. Saved filters and collections can be summarized without additional filtering since they already represent curated views.
