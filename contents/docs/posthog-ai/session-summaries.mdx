...
When summarizing multiple sessions, PostHog AI shows a progress widget so you can track what's happening:

- The current step in the process (like "Watching sessions...")
- A progress bar showing overall completion
- Status for each session – a checkmark when complete, a spinner when processing, plus the person and session timestamp
- An ETA countdown during the watching phase based on how long your sessions are
