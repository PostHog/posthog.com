...
You can pop PostHog AI open wherever you are in PostHog! Click the [PostHog AI](https://app.posthog.com/#panel=max) button in the top-right corner of the app to open the chat.
...
<Caption>
Click the PostHog AI button in the top-right corner to open the chat
</Caption>
