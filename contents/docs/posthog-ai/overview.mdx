...
You can also type a question in the [command palette](/docs/cmd-k) (`Cmd` + `K` on Mac, `Ctrl` + `K` on Windows/Linux) – **Ask PostHog AI** appears as the first result and pressing `Enter` sends your query directly to PostHog AI.
