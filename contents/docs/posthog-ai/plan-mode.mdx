...
title: Plan mode
---
<CalloutBox icon="IconFlask" title="Plan mode is in closed beta" type="action">
...
- **Create plan notebooks** - PostHog AI creates plan notebooks that are initially transient (visible only in the conversation). Click **Create notebook** to save it to your project, making it accessible at a permanent URL. Once saved, any updates to the notebook are automatically synced.
