...
<Caption>Select data points to include as context</Caption>
...
| `/remember` | Saves your text input to [memory](/docs/posthog-ai/edit-memory). Returns an error if adding the text would exceed the 10,000 character memory limit. |
