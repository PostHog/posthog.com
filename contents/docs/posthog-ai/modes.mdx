...
The agent can switch modes in three ways:
...
3. **URL-based switching** - You can set the mode via [URL parameters](/docs/posthog-ai/platform-and-chat-ui#deep-linking-with-url-parameters) when opening Max AI (e.g., `#panel=max:mode=sql`).
