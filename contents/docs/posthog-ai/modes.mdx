...
Modes are specialized configurations that determine what tools and capabilities PostHog AI can use. When you ask a question, the agent selects the most appropriate mode based on your request, or you can be in a specific mode based on the page you're viewing.

Key characteristics:
- Each mode has access to mode-specific tools designed for that type of analysis
- All modes share common tools like data schema reading and search
- The agent can switch between modes automatically based on your needs
- Context and conversation history are preserved when switching modes
...
A mode for investigating error tracking issues.
