...
<CalloutBox type="caution" title="HIPAA compliance">

PostHog AI is not HIPAA-compliant and is not intended for processing Protected Health Information (PHI). Any [Business Associate Agreement (BAA)](/docs/privacy/hipaa-compliance) you may have with PostHog does not apply to PostHog AI features. You are responsible for ensuring your use complies with applicable laws and regulations.
