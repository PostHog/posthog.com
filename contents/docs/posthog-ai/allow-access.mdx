...
Because PostHog AI features use third-party LLM providers, we require organizations to explicitly opt in with admin approval. In most cases this is just a formality, but we've made it explicit as we take data governance seriously.
