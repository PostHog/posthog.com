...
You can pop PostHog AI open wherever you are in PostHog. Click on the [PostHog AI](https://app.posthog.com/#panel=max) button in the top-right corner of the app to open the chat.
...
<ProductScreenshot
    ...
    alt="Open PostHog AI from the top-right corner"
    classes="rounded max-h-[480px]"
/>

<Caption>
PostHog AI chat is always available from the top-right corner
</Caption>
