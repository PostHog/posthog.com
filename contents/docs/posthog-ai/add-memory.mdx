...
To get started, we recommend running the `/init` command in the PostHog AI chat. PostHog AI will ask you a few baseline questions to learn more about your product and company and then save it to memory. 
