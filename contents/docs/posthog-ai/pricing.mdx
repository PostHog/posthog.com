...
- [AI summaries in subscriptions](/docs/product-analytics/subscriptions#ai-summaries)
...
When you hit your credit limit, AI features pause until your credits reset at the next billing period. For [subscriptions with AI summaries](/docs/product-analytics/subscriptions#when-ai-credits-run-out), scheduled deliveries are skipped and automatically resume when credits are available.
