...
PostHog AI runs on third-party LLM providers (Anthropic, OpenAI, and Alphabet), so the environmental footprint of running PostHog AI largely tracks the sustainability commitments of those providers rather than PostHog's own infrastructure.
