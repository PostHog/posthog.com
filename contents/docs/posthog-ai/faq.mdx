...
PostHog AI can also read saved insights and dashboards, but only those you have [viewer access](/docs/settings/access-control) to. This is consistent with the permissions enforced by the main PostHog interface and API.
