...
With [admin permissions](/docs/settings/access-control) for your organization, you can disable PostHog AI and all AI data analysis in your [organization settings](http://app.posthog.com/settings/organization-details#organization-ai-consent).
