...
Think of it as onboarding for your new robot product analyst. 

<OSButton variant="primary" asLink to="/docs/posthog-ai/add-memory">
Add memory
</OSButton>
...
PostHog AI is now ready to answer product questions and complete tasks for you. It works best if you already  have some data and implemented at least one PostHog product like product analytics, session replays, feature flags, or error tracking.
...
The chat is one way of using PostHog AI. Across the platform, look for the AI icon <span className="inline-block"><IconSparkles className="h-4 w-4" /></span> to see where PostHog AI is also available to perform intelligent work.
