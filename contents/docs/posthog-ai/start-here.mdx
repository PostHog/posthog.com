...
The chat is one way of using PostHog AI. Across the platform, look for the AI icon <span className="inline-block"><IconSparkles className="h-4 w-4" /></span> to see where PostHog AI is available to perform intelligent work.
