...
import {IconGraph, IconPieChart,IconRewindPlay, IconDatabase, IconToggle, IconFlask, IconWarning, IconMessage, IconPlug, IconLogomark, IconBook, IconLlmAnalytics} from '@posthog/icons'
...
## <span className="inline-block"><IconLlmAnalytics className="w-6 h-6 -mb-1 text-fuchsia-dark" /></span> AI Observability
...
<<<<<<< HEAD
## <span className="inline-block"><IconGraph className="w-6 h-6 -mb-1 text-seagreen" /></span> Marketing analytics

- [`Diagnose my marketing analytics setup`](https://app.posthog.com/#panel=max:!Diagnose%20my%20marketing%20analytics%20setup)
- [`Why are events showing as non-integrated?`](https://app.posthog.com/#panel=max:!Why%20are%20events%20showing%20as%20non-integrated?)
- [`Suggest custom_source_mappings for unmatched UTM values`](https://app.posthog.com/#panel=max:!Suggest%20custom_source_mappings%20for%20unmatched%20UTM%20values)
- [`Which custom events would make good conversion goals?`](https://app.posthog.com/#panel=max:!Which%20custom%20events%20would%20make%20good%20conversion%20goals?)
