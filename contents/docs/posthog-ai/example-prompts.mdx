...
- [`Analyze user paths to identify where people drop off after signup`](https://app.posthog.com/#panel=max:!Analyze%20user%20paths%20to%20identify%20where%20people%20drop%20off%20after%20signup)
