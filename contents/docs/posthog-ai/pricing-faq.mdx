...
Each time you interact with an AI-powered feature — like asking PostHog to write SQL, summarize data, or analyze sessions — credits are used based on the effort required to complete your request.
...
- **Default billing limit:** PostHog sets a default $250 billing limit so you don't accidentially rack up costs without a ceiling 
