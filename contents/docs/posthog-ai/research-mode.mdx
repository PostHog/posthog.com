...
Research mode is a powerful workflow for in-depth data analysis. It uses Claude Sonnet 4.6 during the planning phase for efficient plan creation, then switches to Claude Opus 4.6 with extended thinking capabilities for the research execution phase to tackle complex, multi-faceted research projects that require deep investigation and synthesis.
...
| Model | Claude Sonnet | Claude Sonnet 4.6 (planning) / Opus 4.6 (research) |
