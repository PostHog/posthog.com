...
Memory has a maximum size of 10,000 characters. When memory exceeds 5,000 characters, PostHog AI only sees the first and last 2,500 characters – the middle is truncated.

For best results, keep the most important information at the beginning or end of your memory.
