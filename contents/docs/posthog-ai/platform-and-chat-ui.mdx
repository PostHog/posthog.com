...
PostHog AI powers all AI features within the [PostHog app](https://app.posthog.com). It is an agentic system and intelligence layer that sits on top of the PostHog platform. As a result, there are multiple ways of working with PostHog AI.
...
When logged in, the PostHog AI chat is always available in the right-hand sidebar of the PostHog app. You can open it at anytime by clicking the PostHog AI icon.
...
These touchpoints or shortcuts enable you to trigger PostHog AI directly from the PostHog UI.
...
PostHog AI is also accessible when logged out of the app and on the website, [posthog.com](/). However, in this mode, it's limited to only search and answer questions about PostHog's documentation.
