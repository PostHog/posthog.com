...
The in-app chat supports conversation history and features like [context, commands, memory](/docs/posthog-ai/context-and-commands), and [deep research (beta)](/docs/posthog-ai/deep-research).
