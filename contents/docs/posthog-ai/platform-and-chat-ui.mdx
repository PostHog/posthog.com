...
<Caption>The PostHog AI chat is always available in the sidebar</Caption>
...
<Caption>PostHog AI can be accessed throughout the platform UI</Caption>
...
<Caption>You can chat with PostHog AI about documentation when logged out</Caption>

## Notebooks

PostHog AI is available inline within [notebooks](/docs/notebooks). You can ask questions, get analysis help, and generate content directly in your notebook.

To use inline AI in a notebook:

1. Type `/` and select **Ask AI**, or click the **+** icon on an empty line and select **Ask AI**.
2. Enter your prompt and press **Enter** to submit.
3. The AI response appears inline as markdown content.

You can also highlight text in your notebook and click the <span className="inline-block"><IconSparkles className="h-4 w-4" /></span> **Ask AI** button in the formatting toolbar to ask about or edit the selected content.

A follow-up prompt appears after each response, so you can continue the conversation without leaving your notebook. While PostHog AI is working, a presence cursor shows where content is being generated.
