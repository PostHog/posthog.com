...
When logged in, the PostHog AI chat is always available in the PostHog app. You can open it at any time by clicking the PostHog AI button (with the <span className="inline-block"><IconSparkles className="h-4 w-4" /></span> icon) in the top-right corner, or via the context panel.
...
<Caption>
The PostHog AI chat is always available via the PostHog AI button or context panel
</Caption>
