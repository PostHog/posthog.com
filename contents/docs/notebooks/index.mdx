...
Add experiments to your notebook using the `/experiment` slash command. This opens a modal where you can search and select from your existing experiments.

The modal shows each experiment's name, status, creator, and creation date. Experiments already in your notebook appear highlighted in green. Click an experiment to add it, or click again to remove it.

Once added, you can view the experiment's configuration, results, and related insights directly in your notebook.
