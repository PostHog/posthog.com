...
You can add [Mermaid](https://mermaid.js.org/) diagrams to your notebooks using fenced code blocks. Mermaid lets you create flowcharts, sequence diagrams, class diagrams, and more using text-based syntax.

To add a mermaid diagram, create a fenced code block with the `mermaid` language identifier:
...
Diagrams render in view mode (read-only). When editing, you see the raw source which you can modify directly. If the mermaid syntax is invalid, the original source is shown with an error message instead of the diagram.
