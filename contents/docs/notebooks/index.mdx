...
You can access a notebook via the context panel (click the panel icon in the top-right corner), from the [Notebooks tab](https://app.posthog.com/notebooks), or by clicking and dragging a link anywhere in PostHog.
