...
export const popoverLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/popover-light-mode.mp4"
export const popoverDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/popover-dark-mode.mp4"
export const switchLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/switch-light-mode.mp4"
export const switchDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/switch-dark-mode.mp4"
export const slashLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/slash-light-mode.mp4"
export const slashDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/slash-dark-mode.mp4"
export const plusLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/plus-light-mode.mp4"
export const plusDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/plus-dark-mode.mp4"
export const dragLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/drag-light-mode.mp4"
export const dragDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/drag-dark-mode.mp4"
export const insightsLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/insights-light-mode.mp4"
export const insightsDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/insights-dark-mode.mp4"
export const eventsLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/notebooks/events-light-mode.png"
export const eventsDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/notebooks/events-dark-mode.png"
export const playlistLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/playlist-light-mode.mp4"
export const playlistDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/playlist-dark-mode.mp4"
export const replayLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/replay-light-mode.mp4"
export const replayDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/notebooks/replay-dark-mode.mp4"
export const flagLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/notebooks/flag-light-mode.png"
export const flagDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/notebooks/flag-dark-mode.png"
export const surveyLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/notebooks/survey-light-mode.png"
export const surveyDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/notebooks/survey-dark-mode.png"
