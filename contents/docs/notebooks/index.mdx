...
1. **Slash commands.** Within a notebook, type `/` and a menu will pop up with options for you. For example, `/trend` creates a trend insight and `/ai` opens an inline AI prompt.
...
You can interact with [PostHog AI](/docs/posthog-ai) directly within your notebooks using inline AI prompts. This lets you ask questions, get analysis help, and generate content without leaving your notebook.

To add an inline AI prompt:

1. Type `/ai` or click the **+** icon and select **Ask AI**.
2. Type your question or request.
3. Press **Enter** to submit.

PostHog AI responds directly in your notebook as markdown. After each response, a follow-up prompt appears so you can continue the conversation.

You can also highlight existing content in your notebook and click the **Ask AI** button in the formatting toolbar to ask questions about or modify your selection.

While PostHog AI is responding, an AI presence cursor shows where it's working in your notebook.
