...
No. Although other people can see and edit your notebooks, they can't edit them at the same time.

If a conflict occurs while you're editing, PostHog displays a conflict resolution modal with a side-by-side preview of the last saved version and your unsaved changes. From there, you can either discard your changes and reload the latest version, or copy your unsaved work to a new notebook so nothing is lost.
