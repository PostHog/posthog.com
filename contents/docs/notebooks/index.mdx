...
### Session replays and saved filters

You can add both individual replays and filtered recordings (via saved filters) of replays to notebooks. 

Within saved filters in notebooks, you can see new replays, update the filter such as countries or URLs, and pin replays to a collection.
