...
<HiddenSection headingType='h2' title='Using virtualenv' defaultIsOpen={true}>
...
> **Note:** Developing with Docker may be very slow. If you're planning on doing more than a few simple changes we'd recommend you use virtual env.
