...
export const comingSoon = { color: "yellow", tooltip: "Coming soon" }
export const inDevelopment = { color: "red", tooltip: "In development" }
...
<ProductList
    ...
    products={[
        ...
        { handle: "feature_flags", indicator: inDevelopment },
        { handle: "experiments", indicator: inDevelopment },
        { handle: "llm_analytics", indicator: comingSoon },
        { handle: "logs", indicator: comingSoon },
    ]}
/>
