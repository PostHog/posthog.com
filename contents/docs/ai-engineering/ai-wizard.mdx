...
When it's done, your project is instrumented with: 
...
7. Generates **insights** and **dashboards** within the PostHog app
7. Optionally installs the [PostHog MCP server](/docs/model-context-protocol) for your AI agent
