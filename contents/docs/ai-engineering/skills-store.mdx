...
6. Optionally add bundled files (you can drag and drop files, click **Upload files** to select from your file system, or click **Add file** to create one manually — files must be text and under 1 MB), `allowed_tools`, `license`, `compatibility`, or metadata
