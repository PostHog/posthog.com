...
| [Agent skills](/docs/model-context-protocol#prompts-and-resources) | Curated instructions that help AI agents perform PostHog-specific tasks. Distributed via the MCP server or installed directly. | 🎯 | <Link to="https://github.com/PostHog/posthog/tree/master/products/posthog_ai/skills" external>Code</Link> |
