...
<<<<<<< HEAD
| [CLI API](/docs/model-context-protocol/cli-api) | Access PostHog's API tools from bash with progressive schema discovery – ideal for coding agents. | 🖥️ | <Link to="https://github.com/PostHog/posthog/tree/master/services/agent-cli" external>Code</Link> |
...
| [LLM analytics](/docs/llm-analytics) | Track and analyze the usage of LLMs in your applications, including token usage, latency, and cost. | 📊 | <Link to="https://github.com/PostHog/posthog/tree/master/products/llm_analytics" external>Code</Link> |
=======
| [AI Observability](/docs/ai-observability) | Track and analyze the usage of LLMs in your applications, including token usage, latency, and cost. | 📊 | <Link to="https://github.com/PostHog/posthog/tree/master/products/llm_analytics" external>Code</Link> |
>>>>>>> master
