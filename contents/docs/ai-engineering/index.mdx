...
| [Skills](/docs/skills) | Store and share reusable agent skills with your team – centrally managed, versioned, and available in any MCP-connected agent. | 🎓 | <Link to="https://github.com/PostHog/posthog/tree/master/products/skills" external>Code</Link> |
