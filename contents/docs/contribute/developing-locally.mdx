...
docker compose -f docker-compose.ch.arm64.yml pull zookeeper kafka clickhouse db redis
docker compose -f docker-compose.ch.arm64.yml up zookeeper kafka clickhouse db redis
