...
Broadcasts in PostHog allow you to send one-time messages to a specific audience. Unlike campaigns which can be triggered by events or scheduled, broadcasts are sent immediately to all users who match your targeting criteria at the time of sending.
