...
You can use AI to generate titles and descriptions for your tour steps. PostHog analyzes your tour's structure – including element context and screenshots – and generates relevant content for each step.

To use AI generation, your organization admin must first approve AI data processing in your organization settings.

> **Note:** AI content generation is only available on PostHog Cloud.
