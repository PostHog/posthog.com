...
When you're done, click **Save** to publish your changes or **Cancel** to discard the draft. When ready, set a start date in the [targeting settings](/docs/product-tours/targeting) to launch.
