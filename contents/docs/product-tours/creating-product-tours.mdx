...
- **Submit button text** – Text shown on the submit button (open text questions only). Defaults to "Submit".
- **Back button text** – Text shown on the back button. Defaults to "Back".

Both are translatable via the [Translations panel](/docs/product-tours/localization).
