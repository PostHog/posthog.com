...
When you open the toolbar, you'll see a modal asking if you want to enable session replay. If you opt in, PostHog records your DOM interactions while you build the tour – not your screen or camera. This helps PostHog understand how users build product tours, enabling us to improve the feature.

The recording respects any `.ph-no-capture` privacy markers on your site. All inputs are masked by default.

## Record your session (optional)

When you open the toolbar, you'll see a modal asking if you want to enable session replay. If you opt in, PostHog records your DOM interactions while you build the tour – not your screen or camera. This is useful for reviewing your tour-building process or sharing with teammates.
