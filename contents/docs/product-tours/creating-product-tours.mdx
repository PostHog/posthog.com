...
The main PostHog app provides a unified WYSIWYG editor for editing all tour steps. The editor shows your styling in real-time so you can see exactly how your tour will look.
