...
After defining your tour structure in the toolbar, edit step content in the main PostHog app. The rich text editor supports formatting like bold, italic, underline, lists, and text alignment (left, center, right), as well as images and embedded content.
