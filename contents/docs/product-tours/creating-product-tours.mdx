...
The toolbar includes a lightweight editor for basic formatting (including text alignment), lists, and images. For more control, edit your tour in the main PostHog app.
