...
The toolbar includes a rich text editor with formatting options including bold, italic, underline, lists, links, and images. You can also set text alignment (left, center, or right) for headings and paragraphs. For more control, edit your tour in the main PostHog app.
