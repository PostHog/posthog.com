...
3. Set the **Data freshness** – this controls how often materialized results refresh:
   - **15 minutes** – updates every 15 minutes
   - **30 minutes** – updates every 30 minutes
   - **1 hour** – updates every hour
   - **6 hours** – updates four times a day
   - **12 hours** – updates twice a day
   - **24 hours** (default) – updates once per day
   - **7 days** – updates once per week
