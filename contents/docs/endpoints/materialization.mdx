...
- **You're running an older version** - Only the latest version is materialized (see [Versioning](/docs/endpoints/versioning))
...
3. If you pass parameters or request an older version, PostHog always executes directly
