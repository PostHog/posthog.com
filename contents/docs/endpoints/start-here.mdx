...
2. **Your personal API key**: With the required `endpoint:read` scope. Create one in [your user settings](https://us.posthog.com/settings/user-api-keys#personal-api-keys)
