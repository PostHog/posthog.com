...
SQL-based endpoints use SQL queries written in the [SQL editor](/docs/data-warehouse/sql). When creating or editing a SQL-based endpoint, the full SQL editor is embedded directly in the endpoint page with support for [variables](/docs/data-warehouse/sql/variables), visualizations, and AI assistance.
