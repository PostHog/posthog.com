...
Choose a data freshness setting that balances how current your data needs to be with cost:

| Data freshness | Best for                                            |
| -------------- | --------------------------------------------------- |
| 15-30 minutes  | High-traffic endpoints where near-real-time matters |
| 1-6 hours      | Most customer-facing dashboards                     |
| 12-24 hours    | Standard daily reporting                            |
...
### Choosing the right data freshness

- **15-30 minutes**: Data that changes frequently but doesn't need to be real-time
- **1-6 hours**: Dashboards and reports viewed periodically
- **12-24 hours**: Standard daily metrics
- **7 days**: Historical data or slowly-changing metrics

Longer data freshness intervals reduce costs but data may be less current.
