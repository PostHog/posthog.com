...
2. Optionally add tags to categorize and organize your endpoint
3. Create the endpoint

</Tab.Panel>
<Tab.Panel>

1. In the SQL editor, click **Save as endpoint** in the top right:
<ProductScreenshot
  imageLight="https://res.cloudinary.com/dmukukwp6/image/upload/w_1600,c_limit,q_auto,f_auto/save_as_endpoint_f0ab0165f0.png"
  imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/w_1600,c_limit,q_auto,f_auto/save_as_endpoint_dark_3b6737f5db.png"
...
2. Give your endpoint a descriptive name and optionally a description
  - **Recommended** - `daily_active_users`, `account_users_activity`, `signup_funnel`
  - **Avoid** - `endpoint1`, `test`, `query`
3. Optionally add tags to categorize and organize your endpoint
