...
1. Give your endpoint a descriptive name and optionally a description
  ...
  - **Avoid** - `endpoint1`, `test`, `query`
   ...
   Names must start with a letter and can only contain letters, numbers, hyphens, and underscores. Max length is 128 characters.

   If you enter a friendly name like "My Daily Users", it's converted to a slug like `my-daily-users`. You'll see a preview before creating the endpoint.
