...
1. Open the [SQL editor](https://app.posthog.com/sql) and write your query
2. Click the **Save as** dropdown in the header and select **Save as endpoint**
3. Give your endpoint a descriptive name and optionally a description
  - **Recommended** - `daily_active_users`, `account_users_activity`, `signup_funnel`
  - **Avoid** - `endpoint1`, `test`, `query`
...
1. Go to the [Endpoints page](https://app.posthog.com/endpoints) and click **New endpoint** > **SQL-based endpoint**
2. Write your SQL query in the embedded SQL editor
3. Give your endpoint a descriptive name and optionally a description
4. Create the endpoint
