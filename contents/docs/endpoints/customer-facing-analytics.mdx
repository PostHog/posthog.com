...
<CalloutBox icon="IconLightBulb" type="info" title="Choose your project setup first">

This guide stores all customer data in one project. If you identify users, make each distinct ID unique to the customer to prevent person profiles from merging. See [project setup for embedded analytics](/docs/data/embedded-analytics-projects) for details.

</CalloutBox>

<ProductScreenshot
  imageLight="https://res.cloudinary.com/dmukukwp6/image/upload/w_1000,c_limit,q_auto,f_auto/pasted_image_2026_02_09_T10_05_55_325_Z_015ac1dc57.png"
  imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/w_1000,c_limit,q_auto,f_auto/pasted_image_2026_02_09_T10_05_16_736_Z_2d8553ca7b.png"
...
Before starting, make sure [a PostHog SDK is installed](/docs/getting-started/install) in your app.
