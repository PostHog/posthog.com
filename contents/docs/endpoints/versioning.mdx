...
- **Gradual rollouts** - Test a new query version before fully switching over. (Tip: you can use [feature flags](/docs/feature-flags) to roll out a new version to a subset of your users)
...
<CalloutBox icon="IconInfo" type="fyi" title="Deactivating a version vs. an endpoint">
