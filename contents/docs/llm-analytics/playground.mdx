...
- **Bring your own key (BYOK)** — When you add your own API keys (OpenAI, Azure OpenAI, Anthropic, Google, OpenRouter, Fireworks, etc.), the playground lists all models available through those providers with no PostHog rate limits.
