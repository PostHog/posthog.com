...
1. Navigate to [**LLM Observability** > **Playground**](https://app.posthog.com/llm-analytics/playground)
2. Choose a model from the model picker
3. Write a system prompt and add messages
4. Click **Run**

The playground works out of the box with PostHog-provided trial models — no setup required. To use your own API keys for higher rate limits and access to more models, add them in [**Settings** > **LLM Observability**](https://app.posthog.com/settings/environment-llm-analytics#llm-analytics-byok).
