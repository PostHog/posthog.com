...
Add user and assistant messages to build a conversation. Each message has a role (`user` or `assistant`) and content. Click **Add message** to append new messages and use the role toggle to switch between roles.
