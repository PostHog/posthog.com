...
import AlphaCallout from "./_snippets/alpha.mdx"
...
Evaluations use OpenAI to run the LLM judge. Your first 100 evaluation runs are on us so you can try the feature right away. After that, add your own OpenAI API key in [project settings](https://us.posthog.com/llm-analytics/settings) to keep running evaluations.
