...
Test your evaluation prompt in the playground before saving.

1. Open an LLM-as-a-judge evaluation
2. Click **Open in Playground**

This loads the prompt and model configuration. Click the save icon next to the system prompt to save your changes or create a new evaluation.
