...
<<<<<<< HEAD
| **Cooldown**          | 1 hour        | Minimum time between count-triggered reports (configurable 1-24 hours) |
||||||| 28b441ebc
...
<<<<<<< HEAD
- Set the minimum hours between reports (1-24 hours) to control how often reports can be generated
||||||| 28b441ebc
=======
