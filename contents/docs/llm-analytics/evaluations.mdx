...
Click **Generate with AI** next to the description field to have PostHog summarize what your evaluation checks for. This works for both LLM judge and code-based evaluations.

The generated description is based on:
- The evaluation name
- The judge prompt (for LLM judge evaluations)
- The Hog source code (for code-based evaluations)
- Whether the evaluation allows N/A results

You need at least a name or prompt/source code before generating a description. If you already have a description, the button changes to **Regenerate with AI** so you can update it after making changes.

> **Note:** Your organization must have AI data processing approved to use this feature. Contact your organization admin if you see a permission error.
