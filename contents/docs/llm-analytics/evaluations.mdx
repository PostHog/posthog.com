...
4. Configure the evaluation:
   ...
   - **Property filters** (optional): Filter by event properties (model, environment, cost) or person properties (email domain, user role) to narrow which generations to evaluate
