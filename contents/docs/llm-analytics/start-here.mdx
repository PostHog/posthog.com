...
<OSButton variant="primary" asLink={true} to="/docs/llm-analytics/installation">
Install PostHog SDK
</OSButton>
...
<OSButton variant="primary" asLink={true} to="/docs/llm-analytics/generations">
...
/>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/llm-analytics/dashboard">
