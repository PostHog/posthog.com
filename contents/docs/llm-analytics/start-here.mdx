...
>
  ...
  PostHog's LLM analytics is built to be cost-effective. With a generous free tier and transparent usage-based pricing, more than 90% of companies use PostHog completely for free. 
  
  LLM analytics events priced the same as regular PostHog data events, making it roughly **10x cheaper** than other LLM analytics tools.
