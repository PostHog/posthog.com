...
- export reviews for external analysis or reporting
...
Click the **Export** button next to the review count to export your trace reviews. Exports respect any active search or scorer filters. Two export methods are available:

- **File download** - Export as CSV or XLSX. Use this for large datasets.
- **Copy to clipboard** - Copy as CSV, JSON, or TSV for quick use. Limited to 5,000 rows.

For datasets larger than 5,000 rows, use the file download option.
