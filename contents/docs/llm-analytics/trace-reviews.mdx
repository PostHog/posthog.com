...
Trace Reviews are the manual review workflow in [LLM Observability](/docs/llm-analytics). They let your team inspect individual [traces](/docs/llm-analytics/traces), apply structured scores, add reasoning, and work through pending traces in queues.
