...
- **Event filters** – Property filters to scope which traces or generations are included. You can filter by event properties, event metadata, person properties, and [cohorts](/docs/data/cohorts). Leave empty to include all.
