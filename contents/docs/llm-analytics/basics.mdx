...
Want to see these concepts applied in real projects? Check out our [demos and example projects](/docs/llm-analytics/demos) or [browse LLM analytics side projects](/side-projects?tag=llm-analytics) built by the PostHog team.
