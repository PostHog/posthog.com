...
Custom properties in LLM Observability enable you to add metadata to your [AI generations](/docs/llm-analytics/generations), making it easier to filter, analyze, and understand your LLM usage patterns. 

This guide shows you how to set custom properties using PostHog's LLM Observability SDKs and leverage them for better observability. For specific integration patterns, see our guides on [linking to session replay](/docs/llm-analytics/link-session-replay) and [linking to error tracking](/docs/llm-analytics/link-error-tracking).
