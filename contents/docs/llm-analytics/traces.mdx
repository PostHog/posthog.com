...
## Opening traces in the playground

Click **Open in Playground** on a trace to load its prompt and model configuration into the [playground](/docs/llm-analytics/playground). This lets you experiment with variations of the original request – testing different prompts, models, or parameters without modifying your production code.
