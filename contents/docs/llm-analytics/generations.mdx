...
## Testing variations in the playground

Click **Open in Playground** on a conversation display to load the generation's input into the [playground](/docs/llm-analytics/playground). From there, you can test variations of the original request with different prompts, models, or parameters.
