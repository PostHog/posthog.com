...
You can test prompts in the playground before using them in production code.

1. Open a prompt from **LLM analytics** > **Prompts**
2. Click **Open in Playground**
3. Configure your model and temperature settings
4. Add test messages and run the request

The playground stays linked to the prompt, so you can iterate on the system prompt and save changes back as a new version.
