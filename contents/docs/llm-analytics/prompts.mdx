...
For prompts with markdown headings, a collapsible **Prompt outline** appears above the rendered content. The outline shows all headings in the prompt with their count. Click any heading in the outline to smoothly scroll to that section in the prompt.
