...
<CalloutBox icon="IconInfo" title="Summarization is in alpha" type="fyi">

Summarization is currently in alpha. To enable it, [opt-in from your feature previews menu](https://app.posthog.com/settings/user-feature-previews#llm-analytics-summarization). We'd love to [hear your feedback](https://app.posthog.com/llm-analytics#panel=support%3Afeedback%3A%3Alow%3Atrue) as we develop this feature.
