...
| `$conversation_message_sent`            | Team member sent a message on a ticket     | `message_id`, `message_content`, `author_type`, `author_id`, `customer_name`, `customer_email`, `customer_distinct_id` |
