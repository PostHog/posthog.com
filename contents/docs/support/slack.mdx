...
4. Select one or more **support channels** – messages posted in any of them automatically become tickets
...
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| **Support channels** | Every top-level message in any of these channels becomes a ticket. Thread replies sync as ticket messages. Make sure the SupportHog bot is invited to every selected channel. | –          |
...
When you click the channel selector, PostHog lists all public and private channels the SupportHog bot has access to. Select the channels you want to use as your dedicated support inboxes. You can add up to 50 channels.
...
Any top-level message in any of your configured support channels automatically creates a new ticket. Thread replies on that message sync as ticket messages.
...
- New messages in any configured support channel create tickets
