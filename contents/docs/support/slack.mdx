...
- Team members are automatically recognized when their Slack email matches their PostHog account — their messages appear as team replies, not customer messages
