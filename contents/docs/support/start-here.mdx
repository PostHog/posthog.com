...
Connect your email to turn incoming emails into support tickets. PostHog gives you a unique forwarding address — set up forwarding in your email provider and emails automatically become tickets.

How to connect:

1. Go to **Support** > **Settings** > **Email channel**
2. Enter the email address customers contact you at (e.g. `support@company.com`) and a display name
3. Click **Connect email**
4. Copy the forwarding address PostHog generates
5. Set up a forwarding rule in your email provider to forward incoming emails to that address

Replies on tickets in PostHog are threaded back to the original email conversation.
