...
Connect Microsoft Teams to turn channel messages into support tickets. The **SupportHog** bot enables two-way sync – messages in Teams create tickets, and your replies in PostHog are posted back to the Teams thread.

You can add up to 25 Teams channels per project (one channel per Teams group).

<OSButton variant="primary" asLink to="/docs/support/teams">
