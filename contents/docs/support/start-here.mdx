...
Connect your Microsoft Teams workspace to turn Teams messages into support tickets. The **SupportHog** bot enables two-way sync – messages in Teams create tickets, and your replies in PostHog are posted back to the Teams thread.

Two ways to create tickets from Teams:
