...
| **Tags** | Custom labels for categorizing tickets |
...
Tags help you categorize tickets by issue type, feature request, or any category that makes sense for your team. Tags are shared across the project — any tag used on one ticket is available on all tickets.

### Adding tags to a ticket

1. Open a ticket
2. In the sidebar, find the **Tags** section
3. Click to add existing tags or create new ones
...
Use the tags filter in the ticket list to show only tickets with specific tags. You can filter by multiple tags at once.
