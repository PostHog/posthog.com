...
A collapsible panel showing all changes made to the ticket:
- Status changes
- Priority changes
- Assignee changes
- SLA due date updates
- Tag additions and removals

Each entry shows who made the change and when. Useful for tracking how a ticket evolved or seeing what actions were already taken.
