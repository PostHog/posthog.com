...
| **Channel detail** | How the ticket was created within the channel (e.g., `slack_channel_message`, `slack_bot_mention`, `slack_emoji_reaction`, `widget_embedded`, `widget_api`). Only populated for Slack and widget channels. |
