...
|-------------|-------------|
| **Customer** | Messages sent by the end user via the widget or email |
...
For **widget** conversations, "Read" means the customer viewed the message in the chat widget. For **email** conversations, "Sent" confirms the email was successfully delivered via SMTP. Read tracking is not available for email messages.
...
The main conversation with the customer. Send replies here – they'll appear in the customer's widget or be sent as an email, depending on the ticket's channel.
