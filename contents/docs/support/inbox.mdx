...
The Support inbox is where your team views and responds to customer conversations. You can also [create outbound tickets](/docs/support/email#creating-outbound-tickets) to proactively reach out to customers via email. Each ticket includes rich context from PostHog to help you understand and resolve issues quickly.
...
| **Channel**           | Source channel: `widget`, `slack`, `email`, or `github`. Outbound tickets created via **Compose ticket** use the `email` channel. |
