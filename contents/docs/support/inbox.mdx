...
| **AI** | AI-generated suggestions created via **AI Suggest** |
...
AI suggestions generate draft replies based on conversation history, session events, and exceptions to help you respond faster.

<CalloutBox icon="IconFlask" title="AI suggestions is in early access" type="info">

AI suggestions requires the `product-support-ai-suggestion` feature flag. Contact us to request access.
...
1. Open a ticket
2. Click **AI Suggest**
3. Review and edit the suggestion
4. Send to the customer

Suggestions appear as private messages – customers won't see them until you send.
