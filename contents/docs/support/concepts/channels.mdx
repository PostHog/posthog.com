...
Channels are your support context. In [Self-driving](/docs/self-driving) terms, the conversations they bring in are a signal source: recurring issues across your tickets become reports and, when there's a code fix, pull requests.
