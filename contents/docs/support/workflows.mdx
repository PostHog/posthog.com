...
All events include these base properties: `ticket_id`, `ticket_number`, `channel_source`, `channel_detail`, `status`, and `priority`.
...
| `channel_detail` | string or null | How the ticket was created: `slack_channel_message`, `slack_bot_mention`, `slack_emoji_reaction`, `widget_embedded`, or `widget_api` |
...
event.properties.channel_detail = "slack_channel_message"
