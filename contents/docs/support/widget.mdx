...
When a ticket is opened from the widget, any email communication is sent from your team's [primary email address](/docs/support/email#primary-email-address). You can change which address is primary in your [email channel settings](/docs/support/email).
