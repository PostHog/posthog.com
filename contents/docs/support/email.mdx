...
- Any CC recipients on the email are stored on the ticket and included in future replies
...
- Any CC recipients from the original email are included in the reply
...
- CC recipients, if any were on the original email
