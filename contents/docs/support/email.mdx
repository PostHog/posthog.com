...
### Creating outbound tickets

You can create new tickets to proactively reach out to customers via email – without waiting for them to contact you first.

1. Go to **Support > Tickets**
2. Click **Compose ticket**
3. Select the email address to send from (must have a verified domain)
4. Enter the recipient's email address
5. Add a subject line (optional) and compose your message
6. Click **Send**

This creates a new ticket and sends the initial email to the customer. Any replies from the customer are added to the same ticket thread.

<CalloutBox icon="IconInfo" title="Requirements" type="fyi">

To create outbound tickets, your email channel must be enabled and you need at least one email address with a verified domain configured.
