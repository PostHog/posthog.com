...
The email channel lets customers reach you by email. Incoming emails turn into support tickets in PostHog. Your replies go back as emails, so the whole conversation stays threaded in both places.

- **Email to PostHog** – Incoming emails get forwarded to PostHog as support tickets.
...
3. Enter the email customers will contact you at, like `support@company.com`, and a display name.
...
5. Add the SPF and DKIM DNS records shown to your domain – this lets PostHog send replies on your behalf.
