...
1. **contains:** The screen name contains the specified string. This is the default matching method.

2. **matches exactly:** The screen name matches the specified value exactly.

3. **matches regex:** The screen name matches a regex pattern, useful for screens with dynamic names like `Profile_123`.
