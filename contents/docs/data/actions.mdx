...
Actions are a collection of event types and filters that represent a single behavior or collection. They are created out of a combination of autocapture events, custom events, or pageviews along with filters. They can then be analyzed in [insights](/docs/product-analytics/insights) and [dashboards](/docs/product-analytics/dashboards).
