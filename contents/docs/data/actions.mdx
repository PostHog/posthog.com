...
You can create and view actions by going to "Data Management" in the left-hand navigation sidebar, and then click on the ["Actions" tab](https://app.posthog.com/data-management/actions).
...
2. Using the [PostHog Toolbar](/docs/product-analytics/toolbar) to tag the elements that are relevant. We have a step-by-step tutorial on [creating actions using the toolbar](/tutorials/toolbar#using-inspect-and-creating-actions).
