...
You can create new actions by:

1. Clicking **New action** in **Data Management** > [**Actions**](https://app.posthog.com/data-management/actions).
...
3. Clicking the **more** menu (three dots) on an autocapture event in the [events table](https://app.posthog.com/events) and selecting **Save as action** – this lets you name and save the action without leaving the page.
