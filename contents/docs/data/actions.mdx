...
## Copying actions to another project

If your organization has multiple projects, you can copy an action to another project. To do so:

1. Go to the action's edit page in [Data Management](https://app.posthog.com/data-management/actions).
2. Click the **Copy to another project** button in the side panel.
