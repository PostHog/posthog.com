...
Actions are a collection of events fitting event types and filters that represent a single behavior. They are created out of a combination of autocapture events, custom events, or pageviews along with filters. They can then be analyzed in [insights](/docs/product-analytics/insights), [dashboards](/docs/product-analytics/dashboards), and more.
