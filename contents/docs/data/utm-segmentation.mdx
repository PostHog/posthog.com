...
availability:
  ...
  enterprise: full
---
export const propertiesLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/utm-segmentation/properties-light-mode.png"
export const propertiesDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/utm-segmentation/properties-dark-mode.png"
export const filtersLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/utm-segmentation/filters-light-mode.png"
export const filtersDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/utm-segmentation/filters-dark-mode.png"
export const breakdownLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/utm-segmentation/breakdown-light-mode.png"
export const breakdownDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/utm-segmentation/breakdown-dark-mode.png"
