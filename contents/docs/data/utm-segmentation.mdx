...
> **Note: ** Along with being set on events, UTM properties are also added to the person profile of the user who sent the event if events are captured with [person profiles](/docs/data/persons).
