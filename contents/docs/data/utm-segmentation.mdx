...
PostHog automatically captures any UTM parameters that are present when a user visits your website. These parameters will then be set as properties in three places in PostHog.

1. As properties on the event
2. As **latest** and **initial** properties on the person
