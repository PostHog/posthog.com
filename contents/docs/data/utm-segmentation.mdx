...
![Sample UTM properties](../../images/docs/user-guides/utm-segmentation/properties.png)
...
posthog.init('<ph_project_api_key>', {
    custom_utm_params: ["my_custom_utm_source"]
})
...
![Filtering UTM properties](../../images/docs/user-guides/utm-segmentation/filters.png)
...
![Breakdown by UTM Source](../../images/docs/user-guides/utm-segmentation/breakdown.png)
