...
You can define your own custom channel types in [your project settings](https://us.posthog.com/settings/project-web-analytics). Your custom channel types will take priority over the default channel types.
