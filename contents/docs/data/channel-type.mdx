...
export const ImgCustomChannelLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/custom_channel_types_light_mode_8d1d5820c0.png";
export const ImgCustomChannelDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/custom_channel_types_dark_mode_dbc68eddcb.png";
...
| AI               | A link from an AI assistant, e.g. ChatGPT, Claude, Gemini, Perplexity, or Copilot. |
...
<ProductScreenshot imageLight={ImgCustomChannelLight} imageDark={ImgCustomChannelDark} />

You can define your own custom channel types in [your project settings](https://app.posthog.com/settings/project-web-analytics) under **Web analytics**. Your custom channel types will take priority over the default channel types.
...
| AI               | `utm_source` matches our list of AI sources (e.g. `chatgpt`, `claude`, `gemini`, `perplexity`, `copilot`)                                                                                                              |
| AI               | `referring_domain` matches our list of AI sources (e.g. `chatgpt.com`, `claude.ai`, `perplexity.ai`, `gemini.google.com`)                                                                                              |
