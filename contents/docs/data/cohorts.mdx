...
From the initial setup, [PostHog is tracking various events](/docs/data/autocapture) from all users. However, you may want to differentiate between traffic from your team and traffic from your users.
