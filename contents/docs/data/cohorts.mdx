...
> **Note:** Cohorts rely on [user properties] so you will need to capture events with [person profiles](/docs/data/persons) to create and use them. 
...
[Person profiles](/docs/data/persons) are required for creating cohorts. Once you've captured some person profiles, there are two ways to create a new cohort:
