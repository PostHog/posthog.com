...
## Copying cohorts to another project

If your organization has multiple projects, you can copy a cohort to another project.

To do this:

1. Navigate to the cohort you want to copy.
2. In the side panel, click **Copy to another project**.
