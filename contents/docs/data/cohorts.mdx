...
**Step 1:** Go to [insights](https://app.posthog.com/insights) and open any insight. Click on any data point to view the [persons](/docs/data/persons) represented in the underlying data.
