...
Your list of cohorts are accessible from the [People](https://us.posthog.com/persons) page.
...
Once you've captured some person profiles, there are two ways to create a new cohort:
