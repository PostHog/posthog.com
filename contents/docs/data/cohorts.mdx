...
> **Note:** Cohorts rely on [person properties](/docs/product-analytics/person-properties), so you need to capture events with [person profiles](/docs/data/persons/#people-and-person-profiles) to create and use them. 
