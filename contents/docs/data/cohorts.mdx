...
Filter by metadata about the person record, such as when they were first seen. Find these options under **Person metadata** in the filter dropdown.

| **Criteria**   | **Example**                                           |
| -------------- | ----------------------------------------------------- |
| First seen     | First seen `is greater than` "2024-01-01"             |

Use this to create cohorts based on when PostHog first observed a person, without setting a custom property.
