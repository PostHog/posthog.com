...
export const durationFilterLight = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/docs/user-guides/sessions/duration-filter-light-mode.png"
export const durationFilterDark = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/docs/user-guides/sessions/duration-filter-dark-mode.png"
...
export const durationBreakdownLight = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/docs/user-guides/sessions/duration-breakdown-light-mode.png"
export const durationBreakdownDark = "https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/images/docs/user-guides/sessions/duration-breakdown-dark-mode.png"
