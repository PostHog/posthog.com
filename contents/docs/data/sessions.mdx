...
| `$session_entry_url`   | URL captured at the start of the session and remains constant throughout    |
| `$session_entry_host`  | Host captured at the start of the session and remains constant throughout   |
| `$session_entry_pathname` | Pathname captured at the start of the session and remains constant throughout |
| `$session_entry_referrer` | Referrer captured at the start of the session and remains constant throughout |
