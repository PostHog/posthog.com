...
export const uniqueSessionLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/sessions/unique-sessions-light-mode.png"
export const uniqueSessionDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/sessions/unique-sessions-dark-mode.png"
export const sessionFormulaLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/sessions/session-formula-light-mode.png"
export const sessionFormulaDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/sessions/session-formula-dark-mode.png"
export const durationFilterLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/sessions/duration-filter-light-mode.png"
export const durationFilterDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/sessions/duration-filter-dark-mode.png"
export const medianDurationLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/sessions/median-duration-light-mode.png"
export const medianDurationDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/sessions/median-duration-dark-mode.png"
export const durationBreakdownLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/sessions/duration-breakdown-light-mode.png"
export const durationBreakdownDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/sessions/duration-breakdown-dark-mode.png"
