...
export const personProfileLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/data/people/person-profile-light-mode.png"
export const personProfileDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/data/people/person-profile-dark-mode.png"
