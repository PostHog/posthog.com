...
import personProfileLight from '../../images/docs/data/people/people-profile-light-mode.png'
import personProfileDark from '../../images/docs/data/people/people-profile-dark-mode.png'
