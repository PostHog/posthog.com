...
For backward compatibility, PostHog captures identified events by default. To change this in the [JavaScript Web SDK](/docs/libraries/js), change the `person_profiles` [config](/docs/libraries/js#config) option:
