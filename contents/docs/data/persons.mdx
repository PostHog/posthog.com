...
> **Note:** The **Last seen** column is temporarily behind a feature flag while we resolve an issue with it interfering with data exports. To re-enable it, go to your [project settings](https://us.posthog.com/settings/project) and enable **Person Last Seen At** under **Extra settings**. We're working on restoring it as a default.
