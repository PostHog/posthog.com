...
### Historical person properties

You can retrieve person properties as they existed at any point in time using the `GET /api/person/properties_at_time/` endpoint. This is useful for debugging, auditing, or understanding how a person's properties changed over time.

See [person properties](/docs/product-analytics/person-properties#how-to-retrieve-historical-person-properties) for details.
