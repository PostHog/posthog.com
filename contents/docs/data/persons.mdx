...
import personProfileLight from '../../images/docs/data/people/person-profile-light-mode.png'
import personProfileDark from '../../images/docs/data/people/person-profile-dark-mode.png'
