...
You can access the data warehouse beta by opting in via the early access menu in PostHog. 

Simply log in to PostHog and click the profile icon in the top right. From here, select 'Enable beta features' and enable the beta directly.
