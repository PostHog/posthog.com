...
PostHog's e-commerce spec helps define the journey for a customer as they browse your store, click on promotions, view products, add those products to a cart, and complete a purchase.
...
posthog.capture('Product Reviewed', {
  ...
  review_body: 'They're shipping things, like, almost every day. That's so great.',
  rating: '5'
});
```
