...
To see your live events table, click [Events](https://app.posthog.com/events) on the left sidebar. Here you will see a live feed of Events as they are happening.
...
Most users of PostHog will want to combine their backend data, such as user information, with the frontend actions of those users in their UI. There are three ways of passing data to PostHog:
