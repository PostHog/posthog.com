...
1. **Verified.** Adds a checkmark next to the event definition wherever it is in PostHog.
2. **Visible (default).** The standard visibility for events, nothing special.
