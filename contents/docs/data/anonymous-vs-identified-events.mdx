...
Depending on what you're trying to vizualize, you may be able to use some of the properties on the events to acheive a similar outcome i.e. Looking at the referring domain on the first ever pageview for each user.
