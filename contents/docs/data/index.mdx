...
PostHog has many tools to manage all your data. These tools can be found in the [data management](https://us.posthog.com/data-management/events) and [people](https://us.posthog.com/persons) tabs.
...
The database tab shows a list of the tables in your PostHog instance. You can then query the supported tables using [SQL](/docs/sql).
