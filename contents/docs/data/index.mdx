...
export const definitionCardLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/features/data-management/definition-card-edit-light-mode.png"
export const definitionCardDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/features/data-management/definition-card-edit-dark-mode.png"
export const warningsLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/features/data-management/warnings-light-mode.png"
export const warningsDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/features/data-management/warnings-dark-mode.png"

You can manage all your PostHog data in the [data management](https://us.posthog.com/data-management/events) and [people](https://us.posthog.com/persons) tabs.
...
The [Events tab](https://app.posthog.com/data-management/events) contains a list of all the events captured into your PostHog instance. They are sortable by name, last seen, and type (custom vs default).
