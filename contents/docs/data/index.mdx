...
Below are the different types of data you'll come across in your PostHog instance, which you can manage using the [Data Management](https://us.posthog.com/data-management/events) tab. 
