...
The `name` field allows you to analyze query patterns by their assigned names. Here are some useful queries:

**Daily query volume by request name:**
...
**Most common request names by time period:**
...
**Request performance trends over time:**
...
**Identify problematic request names:**
