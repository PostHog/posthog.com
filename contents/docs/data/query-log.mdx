...
| `cpu_microseconds` | Integer | CPU time consumed |
...
You can do something similar to track S3 operations and data transfer:
...
## Query log and it's relationship to internal tables
