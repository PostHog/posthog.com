...
If you're running campaigns or tracking users across different websites (for example, a marketing site at `marketing.com` and an app at `app.com`), you'll need to ensure proper attribution setup beyond the cross-domain tracking mentioned above.
