...
> **Note:** if you use Ahrefs you need to switch to use the "Desktop" user agent. In other modes the user agent used doesn't contain something that will match to block their crawl from analytics
