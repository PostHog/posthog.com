...
2. The user clicks a link to your site. At this point a new session will be started and the referrer will be `google.com`.
3. The user walks away from their computer, and is inactive long enough for the session to expire (30 minutes by default).
4. User comes back to their computer, goes to the already-open browser tab with your site, and clicks an internal link. A new session will be started, and the referrer will be your own site.
...
If these two sessions are genuinely different periods of activity, then this is known as a legitimate self-referral.
