...
PostHog AI can diagnose common Web Analytics setup issues, like partial [reverse proxy](/docs/advanced/proxy) coverage across your domains. Open PostHog AI from the Web Analytics page and ask questions like "Is my web analytics set up correctly?" or "Why are my pageviews low?"
