...
2. **PostHog conversion goals** - Conversions you define in PostHog using events, actions, or data warehouse tables. These use PostHog's tracking and your custom attribution rules.
...
**General notes:** The docs are not very specifs on the fields, so I put the ad group docs where there are examples of the fields.
**Required tables:** `campaigns` and `campaign_report`
