...
The columns shown depend on which **drill-down level** you select (Channel, Source, or Campaign):

**Channel level**

| Column | Description |
|--------|-------------|
| `Channel` | Channel type classification derived from the ad source (e.g., Paid Search, Organic Social, Direct). |

**Source level**

| Column | Description |
|--------|-------------|
| `Source` | Normalized source name from the ad platform (e.g., `google`, `meta`, `linkedin`). |
