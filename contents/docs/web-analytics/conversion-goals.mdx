...
Adding a conversion goal adds the following metrics to the web analytics dashboard:
...
Once you set up your conversion goal, what else is there to do other than improve it? Here are some recommendations on how:
