...
## Drilling down into segments

The breakdown cards on the Live dashboard (countries, cities, browsers, devices) let you see who's visiting right now within each segment. Click any row in a breakdown card, or click a country on the world map, to open a drawer showing:

- **Identified visitors** – users with a person profile, including their name, email, and when they were last seen
- **Anonymous visitors** – a count of cookieless visitors who don't have a linked profile

The drawer updates in real time. A notification appears when new visitors join the segment, and you can refresh to see the latest list.

This is useful when you want to understand who exactly is landing on your site from a specific country, browser, or device type – especially during a launch or campaign.
