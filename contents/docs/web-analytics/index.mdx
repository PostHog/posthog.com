...
Web analytics works without capturing [person profiles](/docs/data/persons). This means if you are primarily using PostHog for web analytics, it can be significantly cheaper for you. To do this, set your [JavaScript Web](/docs/libraries/js) `person_profiles` config option to `identified_only` or `never` like this:
