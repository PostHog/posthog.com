...
export const webAnalyticsLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/web-analytics/web-analytics-light-mode.png"
export const webAnalyticsDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/web-analytics/web-analytics-dark-mode.png"
export const webAnalyticsVideoLight = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/web-analytics/web-analytics-light-mode.mp4"
export const webAnalyticsVideoDark = "https://res.cloudinary.com/dmukukwp6/video/upload/v1710055416/posthog.com/contents/images/docs/web-analytics/web-analytics-dark-mode.mp4"
