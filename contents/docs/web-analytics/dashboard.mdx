...
The AI summary panel at the top of the Analytics tab gives you a quick overview of your web traffic for the selected time range. Click **Generate AI summary** to create a 4-6 bullet point summary highlighting notable changes – like traffic spikes, drops, or anomalies.

Once generated, you can see when the summary was created and copy it to your clipboard. Summaries are cached to save time: live date ranges (ending at or after "now") cache for 1 hour, while closed past ranges cache for 24 hours.

The summary respects any filters you've applied to the dashboard, including property filters and conversion goals.
