...
Focus mode hides tiles you don't need, showing only data relevant to your current analysis. Choose from nine analytical concerns, and the dashboard displays the related tiles.

To use focus mode:

1. Go to **View** in the menu bar and click **Focus mode settings...**
2. Select the concerns you want to focus on
3. Click **Save and apply**

| Concern | What it shows |
|---------|---------------|
| Traffic & visitors | Overview stats and trend graphs |
| Where visitors come from | Traffic sources |
| Pages they land on and leave from | Paths |
| Where in the world | Geography |
| Devices and browsers | Device breakdown |
| Whether they come back | Retention |
| Goals & conversions | Conversion goals |
| Engagement & session replay | Active hours and session replay |
| Errors & frustration | Error tracking and frustrating pages |

The Overview tile always remains visible.

To restore all tiles, go to **View** > **Exit focus mode**. Your selections persist across sessions, so you can re-enter focus mode from **View** > **Enter focus mode** without reconfiguring.

## Filtering your dashboard

Like other dashboards in PostHog, the web analytics dashboard is filterable. This means you can filter for data with certain event or person property values. Options include browser, path name, device type, country, and UTMs. Click **Add filter** next to the date range at the top of the dashboard.
