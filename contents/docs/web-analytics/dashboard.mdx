...
To get an idea of where users are visiting your site from, you can see top referrers, [channels](/docs/data/channel-type), and [UTMs](/docs/data/utm-segmentation). You can view referrers by domain (e.g., `google.com`) or by full URL (e.g., `google.com/search`). The full URL option strips query parameters but keeps the path, helping you identify specific pages or posts driving traffic to your site.
