...
The world map shows where your users are located. Click on a country to zoom in and view a regions map with state or province-level breakdowns. You can also switch between views to show top countries, regions (like California, England, or Ontario), cities, timezones, or languages.
