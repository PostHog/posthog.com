...
The [live dashboard](https://app.posthog.com/web/live) also includes a real-time world map. Countries light up as visitors arrive, with a heat effect that fades over time to highlight recent activity. Hover over any country to see its name, visitor count, and share of total traffic.
