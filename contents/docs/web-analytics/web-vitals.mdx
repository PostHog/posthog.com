...
If you're concerned about the cost of `$web_vitals` events, you can enable [sampling](/docs/libraries/js/usage#amending-or-sampling-events) for `$web_vitals` events.
