...
Alternatively, if you're inside web analytics, you can also toggle to the web vitals view by clicking the toggle in the top right.
...
You can look at our Web vitals capturing code in here: [web-vitals/index.ts](https://github.com/PostHog/posthog-js/blob/main/src/extensions/web-vitals/index.ts).
