...
The simplest way to add marketing data is to [add a Google Ads source](https://us.posthog.com/project/2/pipeline/new/source?kind=googleads) by following [this guide](/docs/cdp/sources/google-ads).
...
Please refer to the [data warehouse](/data-warehouse) for more information on configuring external data sources.
