...
> **Note:** At least one data source must be configured to use Marketing Analytics. If no sources are configured, an error banner will appear in the settings prompting you to add a data source.
