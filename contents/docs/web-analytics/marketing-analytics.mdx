...
> **Note:** If you haven't configured any data sources, you'll see an error banner prompting you to add at least one native integration or connect a data warehouse source.
