...
PostHog converts currency values for the entire team to the base currency you set in [your project settings](https://us.posthog.com/settings/project#base-currency) before displaying them. If we can't properly detect your currency from the source data, we'll assume it's in this currency as well.
