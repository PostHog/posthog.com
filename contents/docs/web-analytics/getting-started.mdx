...
UTM paramaters are another way to get information about where people are coming from. By providing some structured values at the end of our URLs, we can segment visitors into groups.
...
You can click the **Add conversion goal** button at the top of the web analytics dashbaord, and check out our detailed guide on how to set up [conversion goals](/docs/web-analytics/conversion-goals).
