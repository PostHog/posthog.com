...
To get started with [web analytics](/web-analytics), [install PostHog](/docs/getting-started/install) and you'll automatically collect data based on traffic to your app or website.

Web analytics provides you with a simple [dashboard](/docs/web-analytics/dashboard). If you're new to marketing and analytics, this is a gentle introduction.
