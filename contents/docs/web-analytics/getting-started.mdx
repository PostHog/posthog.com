...
- **Visitors and pageviews, and sessions:** How many people are coming to your website? How many pages do they visit? 
...
You can adjust all the data on your web analytics dashboard to view last 24 hours, the last 7 days, the year-to-date, or any other custom time range. 
...
You can drill down into specific pages and event properties using the **+ Add filter**.
