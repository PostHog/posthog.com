...
It's easy to get up and running with [web analytics](/web-analytics). After you [install PostHog](/docs/getting-started/install), you'll automatically start collecting data based on traffic to your app or website.

Web analytics provides you with a simple [dashboard](/docs/web-analytics/dashboard). If you're new to marketing and analytics, this doc is intended as a gentle introduction.
