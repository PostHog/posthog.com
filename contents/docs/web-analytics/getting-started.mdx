...
It's easy to get up and running with [Web analytics](/web-analytics). All you need to do is [install PostHog](/docs/getting-started/install) and you're all set to collect data based on traffic to your application or website.
...
This post is a gentle introduction to getting started with web analytics, with some practical examples of how it can help you achieve your goals.

## What are we looking at?

The core idea of web analytics is that you can gather insights based on traffic and usage data.
