...
- If a scheduled check falls during quiet hours, it runs after the window ends. Automatic schedules add a short delay to spread checks out, while staying outside blocked windows.
