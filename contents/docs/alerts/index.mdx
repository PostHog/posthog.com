...
5. Pick which 'series' you want to alert on. These are the different events/values you're plotting in the insight. 
    For example, an insight might have multiple series like `A - Pageviews` (total count of page views for a URL) and `B - Signups` (count of users who signed up on the page). 
    You can pick either `A` or `B`, which will determine if the alert gets checked against the value for `A` (total page views) or `B` (signups).
<ProductScreenshot
    imageLight="https://res.cloudinary.com/dmukukwp6/image/upload/series_picker_aa01668862.png" 
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/series_picker_aa01668862.png"
    alt="series picker" 
    classes="rounded"
/>


6. Select the alert type. You can choose:
...
<ProductScreenshot
    ...
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/alert_type_picker_18909b0b33.png"
...
<ProductScreenshot
    ...
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/percentage_threshold_1940ead9e6.png"
...
<ProductScreenshot
    ...
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/filled_alert_627158e6bb.png"
    alt="filled alert" 
    classes="rounded"
/>
...
<ProductScreenshot
    ...
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/insight_alerts_5k_daef47ade1.png"
    alt="insight alerts" 
    classes="rounded"
/>
...
<ProductScreenshot
    ...
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/all_alerts_d92386e45a.png"
    alt="all alerts" 
    classes="rounded"
/>
...
<ProductScreenshot
    ...
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/relative_alert_picker_fa04215397.png"
...
<ProductScreenshot
    ...
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/breakdown_alert_7bd87114cb.png"
