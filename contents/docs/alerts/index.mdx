...
Since alerts work on [trends](/docs/product-analytics/trends) and [SQL (HogQL)](/docs/sql) insights, you can monitor nearly any metric you track in PostHog. Common use cases include:
