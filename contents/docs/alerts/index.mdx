...
9. Select how often you want the alert to be checked (every 15 minutes, every hour, every day, every week, or every month). The 15-minute interval requires a [platform add-on](/platform-packages).
