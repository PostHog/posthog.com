...
10. Pick who should be notified when the alert is triggered. Subscribed users automatically receive in-app notifications when the alert fires. You can also add email recipients, Slack channels, Discord webhooks, or webhook URLs directly in the alert form.
...
4. For webhook notifications:
   - Enter the webhook URL where you want alerts sent.

5. Click **Add notification** to add the destination.

6. Click **Create alert** or **Save** to apply your changes.
