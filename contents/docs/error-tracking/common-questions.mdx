...
1. Use the [SDK Doctor](/docs/sdk-doctor) to verify your SDKs are updated to the latest verison
...
4. Wait a few minutes and check [Error Tracking in the PostHog app](https://app.posthog.com/error_tracking) before assuming it's broken

## Source maps not resolving

If stack traces show minified code instead of original source:

1. Verify source maps are uploaded to the correct project by navigating to [Error Tracking](https://app.posthog.com/error_tracking) and selecting **Configure** > **Symbol sets**
