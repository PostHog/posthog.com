...
<CalloutBox icon="IconInfo" title="Quick connect links" type="fyi">

You can also connect integrations directly from their dedicated pages:
...
These are shareable links useful for onboarding new team members.
