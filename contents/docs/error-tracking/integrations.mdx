...
The same GitHub App powers Self-driving, PostHog Desktop, and the data warehouse GitHub source. See the [GitHub integration](/docs/libraries/github) page for how installations, repository access, and disconnecting work.
