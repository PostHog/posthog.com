...
The same GitHub App powers Self-driving, PostHog Desktop, and the data warehouse GitHub source. See the [GitHub integration](/docs/integrations/github) page for how installations, repository access, and disconnecting work.
...
3. [Create external issues](/docs/error-tracking/assigning-issues#create-external-issues) from the UI, API, or [MCP](/docs/error-tracking/surfaces/mcp)
