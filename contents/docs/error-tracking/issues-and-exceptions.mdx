...
- [Mark the issue as active, suppressed, or resolved](/docs/error-tracking/managing-issues#update-issue-status)
- [Assign the issue to a team member or role](/docs/error-tracking/assigning-issues)
- [Connect the issue to an external tracking system like GitHub issues or Linear](/docs/error-tracking/integrations)
- [View session replays to help root cause the issue](/docs/error-tracking/managing-issues#watch-session-replays)
...
2. Match [custom grouping rules](/docs/error-tracking/grouping-issues#option-1-custom-grouping-rule) defined in PostHog
