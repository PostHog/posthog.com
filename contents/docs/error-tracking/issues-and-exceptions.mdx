...
You can customize issue grouping logic by labeling exceptions with a [custom fingerprint](/docs/error-tracking/grouping-issues#option-2-client-side-fingerprint), [custom grouping rules](/docs/error-tracking/grouping-issues#option-1-custom-grouping-rule), or by [merging issues](/docs/error-tracking/grouping-issues).
