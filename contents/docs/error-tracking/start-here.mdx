...
Connect with the PostHog MCP server to enable autonomous debugging with AI agents. You can also copy our [premade AI prompts](/docs/error-tracking/surfaces/fix-with-ai) which include full stack traces and curated instructions for the AI to follow.
