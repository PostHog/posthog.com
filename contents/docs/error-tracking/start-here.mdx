...
>
  ...
  The second step is to upload symbols to get accurate, readable stack traces for your captured exceptions. This helps you quickly identify and debug issues by showing you the original code context where the error occurred.
  ...
  <OSButton variant="primary" asLink to="/docs/error-tracking/upload-symbols">
    Upload symbols
  </OSButton>
