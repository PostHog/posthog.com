...
Connect with the PostHog MCP server to enable autonomous debugging with AI agents. Or copy our pre-made AI prompts which include full stack traces and curated instructions for the AI to follow.
