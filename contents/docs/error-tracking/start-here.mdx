...
<<<<<<< HEAD
Use the PostHog MCP server to enable autonomous debugging with AI agents. Or copy our pre-made AI prompts which include full stack traces and curated instructions for the AI to follow.
=======
Connect the PostHog MCP server to enable autonomous debugging with AI agents. Or copy our pre-made AI prompts which include full stack traces and curated instructions for the AI to follow.
>>>>>>> 5e37a80e9 (AI content for error tracking)
