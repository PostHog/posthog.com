...
>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/error-tracking/installation">
    Install PostHog SDK
  </OSButton>
...
>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/error-tracking/upload-source-maps">
    Upload source maps
  </OSButton>
...
/>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/error-tracking/issues">
    Learn about issues
  </OSButton>
...
<OSButton variant="primary" asLink={true} to="/docs/error-tracking/debugging-with-mcp">
  Explore AI features
</OSButton>
