...
Want to assign issues to a **team** rather than an individual teammate? You can create a role [your project settings](https://us.posthog.com/settings/organization-roles) under **Error tracking**.
