...
- Resolve issues that are fixed, if they reoccur, the issue will be reopened.
- Suppress issues that you choose to not action on. Typically, this is used for issues that are deemed noisy or not actionable.
