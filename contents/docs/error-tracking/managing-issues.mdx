...
All issues are marked **Active** by default, you can mark them as **resolved** or **suppressed** to reflect the current state of the issue. These labels are mainly used to communicate amoungst your team. Typically, you resolve issues that are fixed, and suppress issues that you choose to not action on.
