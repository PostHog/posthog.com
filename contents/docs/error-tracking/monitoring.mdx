...
The most basic is assigning an error to teammate. To do this, select the profile icon under **assignee** and search for your teammate you want to assign it to, and select them. You can click this again to unassign them. 
