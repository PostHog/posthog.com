...
This guide covers how to find the most relevant, urgent, and impactful issues in your error tracking using the [issues page](https://us.posthog.com/error_tracking).

## Monitoring issues

When you're monitoring issues in your proejct, there are generally two common workflows:
...
Sorting by **last seen** and **occurences** are great ways to get a general sense of issues in your project. Sorting by **users** and **sessions** is great to find the most impactful issues if you're using other [filters](#finding-specific-issues) to narrow down your results.
...
Search results are matched based on [properties of exceptions](TODO) grouped into the issues. For example, if you search for "TypeError", we show you all issues where *any* exception grouped into the issue has a type of "TypeError".
