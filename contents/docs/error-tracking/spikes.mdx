...
On an issue's detail page, spikes appear as highlighted bars in the volume chart. Click any spike bar to see more details in a popover:

- **Zoomed chart** - A 120-minute window centered on the spike, showing exactly when the spike started and ended
- **Occurrences** - The number of exceptions during the spike
- **Baseline** - The expected exception rate based on historical data
- **Exceeded by** - How many times the spike exceeded the baseline (e.g., 3.2x)
