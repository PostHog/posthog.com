### Setting up Angular exception autocapture
...
You will need to override Angular's default ErrorHandler provider:
...
class PostHogErrorHandler implements ErrorHandler, OnDestroy {
...
Then, in your `src/app/app.module.ts`, import the `providePostHogErrorHandler` function and add it to the providers array:
