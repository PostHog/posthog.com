...
Lastly, you will neeed to capture exceptions in the `handleError` callback in your client-side hooks file.
...
Server-side you will also need to implement the `handleError` callback.
