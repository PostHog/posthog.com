...
#### 6. Delete sourcemaps (recommended)

You might want to prevent sourcemaps from being publicly accessible after uploading them to PostHog.

```bash
rm -rf ./path/to/assets/**/*.map
```
