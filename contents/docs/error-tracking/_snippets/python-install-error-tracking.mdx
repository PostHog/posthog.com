...
import PythonFlaskExceptionAutocapture from '../docs/error-tracking/_snippets/python-flask-exception-autocapture.mdx'
import PythonFastAPIExceptionAutocapture from '../docs/error-tracking/_snippets/python-flask-exception-autocapture.mdx'
...
You can find a full example of all of this in our [Python error tracking tutorial](/tutorials/python-error-tracking).