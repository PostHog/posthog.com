...
We also recommend setting up and using [contexts](/docs/libraries/python#contexts) so that exceptions automatically include distinct IDs, session IDs, and other properties you can set up with tags.
...
import PythonDjangoExceptionAutocapture from './python-django-exception-autocapture.mdx'
