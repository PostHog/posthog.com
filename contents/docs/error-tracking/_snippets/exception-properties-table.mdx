...
|-----------|------|-------------|
| `$exception_list` | List | A list of exceptions that occurred, some times contains multiple exceptions that occurred together. Contains the following properties: |
