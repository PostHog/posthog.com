...
You must also ensure that the modified asset bundles uploaded to PostHog are the ones your site serves. If you serve a copy of the bundled assets as they were prior to running `posthog-cli sourcemap upload`, we won't be able to use the uploaded sourcemap to unminify or demangle your stack traces.