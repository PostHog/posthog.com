...
Hono uses [`app.onError`](https://hono.dev/docs/api/exception#handling-httpexception) to handle uncaught exceptions. You can take advantage of this for [Error tracking](/docs/error-tracking). Remember to **export** your [project API key](https://us.posthog.com/settings/project#variables) as an environment variable.
