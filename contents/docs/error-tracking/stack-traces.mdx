...
<ProductScreenshot
    imageLight="https://res.cloudinary.com/dmukukwp6/image/upload/w_1600,c_limit/release_light_d5955d3b5e.png"
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/w_1600,c_limit/release_dark_67fed14b12.png"
...
Each stack frame can link to the matching file and line in your GitHub or GitLab repository. Open the frame menu and select **Open in GitHub** or **Open in GitLab**.

<ProductScreenshot
    imageLight="https://res.cloudinary.com/dmukukwp6/image/upload/Clean_Shot_2025_11_20_at_14_37_09_2x_2ff2e56430.png"
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/Clean_Shot_2025_11_20_at_14_37_09_2x_2ff2e56430.png"
    alt="Stacktrace with GitLab source link"
    classes="rounded"
/>

PostHog matches the paths in your uploaded source map against the repository tree at the release commit, which tells packages apart in a monorepo where the same relative path exists more than once. The repository and commit come from the [release](/docs/error-tracking/releases) of the exception event, and the link opens the file at that commit. An event without a release, or with a release that has no repository information, gets no source links.

Private repositories need the [GitHub or GitLab integration](/docs/error-tracking/integrations).
...
<ProductScreenshot
    imageLight="https://res.cloudinary.com/dmukukwp6/image/upload/pasted_image_2026_06_24_T10_21_36_407_Z_ef88a3ff5a.png"
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/pasted_image_2026_06_24_T10_21_10_637_Z_166d49f692.png"
