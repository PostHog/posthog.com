...
When viewing stack traces in PostHog, you can click directly through to the relevant code in your GitHub or GitLab repository. Each stack frame includes a **View commit** button that links to the exact file and line where the error occurred.
...
<ProductScreenshot
    ...
    alt="Stack trace with source linking buttons"
    classes="rounded"
/>
