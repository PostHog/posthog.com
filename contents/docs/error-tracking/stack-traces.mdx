...
If your source maps are not publicly hosted, you will need to upload them during your build process to see unminified code in your stack traces, you can either use the `@posthog/nextjs` package or the `posthog-cli` to handle this process.
