...
Click the **Test rule** button to see how many exceptions your grouping rule would match. The test shows:

- Number of matching exceptions in the last 7 days (expandable to 30 or 90 days)
- Number of issues those exceptions would be grouped into
- Links to view the matching exceptions and issues

Use this to verify your rule matches the expected exceptions before saving.
