...
Alternatively, set the `POSTHOG_CLI_DOTENV_FILE` environment variable to the path of your dotenv file. This is useful in environments where you control the environment but not the command line, such as an Xcode build phase.
