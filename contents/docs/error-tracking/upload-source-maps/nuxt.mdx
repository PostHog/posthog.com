...
import WizardCallout from './_snippets/wizard-callout.mdx'
...
No manual configuration is needed – follow the [Nuxt Error Tracking installation guide](/docs/error-tracking/installation/nuxt-3-7) to set up the module, and source maps are automatically generated and uploaded when you build your project.
