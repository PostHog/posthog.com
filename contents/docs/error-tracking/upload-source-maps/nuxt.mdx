...
> **Note:** If you're using Nuxt 3.7 or above, we recommend using the `@posthog/nuxt` module which handles sourcemap generation and upload automatically. See the [Nuxt error tracking installation guide](/docs/error-tracking/installation/nuxt) for setup instructions.

The following instructions are for Nuxt 3.6 and below using the PostHog CLI.
