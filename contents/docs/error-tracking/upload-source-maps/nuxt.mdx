...
No manual configuration is needed - simply follow the [Nuxt error tracking installation guide](/docs/error-tracking/installation/nuxt) to set up the module, and sourcemaps will be automatically generated and uploaded when you build your project.
