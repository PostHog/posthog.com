...
AI agents using the [PostHog MCP server](/docs/model-context-protocol) can create external references with the `error-tracking-external-references-create` tool. See the [MCP debugging guide](/docs/error-tracking/surfaces/mcp) for more.
