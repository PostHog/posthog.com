...
First, set up an [integration](/docs/error-tracking/integrations) with your tracking system. Then, from an issue's details page, click **+ Create issue** under **External references**.
