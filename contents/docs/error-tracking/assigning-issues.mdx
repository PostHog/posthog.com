...
Click **Test rule** to check how many exceptions your rule matches. The test shows:

- The number of matching exceptions in the last 7 days (expandable to 30 or 90 days)
- The number of issues those exceptions belong to
