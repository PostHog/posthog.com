...
Alternatively, you can create alerts from [error tracking settings](https://app.posthog.com/settings/environment-error-tracking#error-tracking-alerting). Click **Alerting** to see a list of existing alerts, then click **New notification** to create a new one.
