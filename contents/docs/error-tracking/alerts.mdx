...
You can filter an alert based on the properties of an issue.
You might find this useful to notify the Slack channel of a team when they have been auto assigned an issue using [auto assignment rules](/docs/error-tracking/managing-issues#auto-assignment-rules).
