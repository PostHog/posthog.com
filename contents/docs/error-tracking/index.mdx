...
Exceptions are grouped by type. Aggregated counts and sparklines provide an indication of the serverity of each group. Search makes it easy to find exceptions containing specific text, and filters allow you to see which exceptions affect certain users.
