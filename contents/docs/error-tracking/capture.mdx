...
You can also override the [fingerprint](/docs/error-tracking/fingerprints) to [group](/docs/error-tracking/issues-and-exceptions#how-exceptions-are-grouped-into-issues) exceptions together at capture time.
