...
When capturing exceptions manually, passing `properties` to the capture exception method will override the default properties. This is just like any other event in PostHog.
