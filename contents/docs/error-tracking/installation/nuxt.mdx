...
export default defineNuxtConfig({
  ...
  posthogConfig: {
    ...
    sourcemaps: {
      enabled: true,
      projectId: '<ph_project_id>', // Your project ID from PostHog settings https://app.posthog.com/settings/project#variables
...
> **Note:** Your Personal API Key will require `organization:read` and `error_tracking:write` scopes.
