...
**✅ Checkpoint** – Before proceeding, confirm that you can capture events with PostHog using `client.capture('test_event')`.
...
<Step title="Configuring exception autocapture" subtitle="Your goal in this step: Enable automatic exception tracking for your Node.js application." badge="required">
...
<Step title="Manually capturing exceptions" subtitle="Your goal in this step: Manually capture exceptions in your Node.js application." badge="optional">
