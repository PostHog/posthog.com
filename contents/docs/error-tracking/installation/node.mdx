...
> **Note:** A minimum SDK version of v4.5.2 is required, but we recommend [keeping up with the latest SDK version](/docs/sdk-doctor) to ensure you have all of error tracking's features.
...
<StepUploadSymbols urlPath="node" framework="Node.js" />
