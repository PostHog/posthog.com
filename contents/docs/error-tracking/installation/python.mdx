...
**✅ Checkpoint** – Before proceeding, enable debug and call `posthog.capture('test_event')` to make sure you can capture events.
...
**✅ Checkpoint** – Before proceeding, confirm that exceptions are being properly captured by the framework.
...
**✅ Checkpoint** – Before proceeding, confirm that you can successfully capture exceptions.
