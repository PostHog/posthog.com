...
A minimum SDK version of [3.24.0](https://github.com/PostHog/posthog-android/releases/tag/android-v3.24.0) is required, but we recommend [keeping up to date with the latest version](/docs/sdk-doctor) to ensure you have all of error tracking's features.
