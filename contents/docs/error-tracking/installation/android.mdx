...
We're actively working on adding support for these features.
...
A minimum SDK version of [3.24.0](https://github.com/PostHog/posthog-android/releases/tag/android-v3.24.0) is required, but we recommend keeping up to date with the latest version to ensure you have all of error tracking's features.
...
<Step title="Set up exception autocapture" badge="optional">
