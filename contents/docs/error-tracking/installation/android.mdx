...
> **Note:** We currently don't support demangling stacktraces of minified builds ([isMinifyEnabled=true](https://developer.android.com/topic/performance/app-optimization/enable-app-optimization)). We're actively working on adding support for it.
...
> **Note:** A minimum SDK version of [3.24.0](https://github.com/PostHog/posthog-android/releases/tag/android-v3.24.0) is required, but we recommend [keeping up to date with the latest version](/docs/sdk-doctor) to ensure you have all of error tracking's features.
