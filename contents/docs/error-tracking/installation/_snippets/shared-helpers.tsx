 ...
 */
export const addNextStepsStep = (steps: StepDefinition[], platformSlug?: string): StepDefinition[] => {
            ...
            content: (
                <>
                    ...
                    <CallToAction
                        className="my-2"
                        size="sm"
                        to={`/docs/error-tracking/upload-source-maps${platformSlug ? `/${platformSlug}` : ''}`}
                        external={true}
                    >
                        Upload source maps
                    </CallToAction>
