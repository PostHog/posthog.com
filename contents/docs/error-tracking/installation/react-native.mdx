...
<CalloutBox icon="IconInfo" title="Hermes engine only" type="fyi">

React Native error tracking is supported only when the app is compiled with the [Hermes engine](https://reactnative.dev/docs/hermes) enabled.
