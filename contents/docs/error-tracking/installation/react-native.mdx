...
A minimum SDK version of [4.12.0](https://github.com/PostHog/posthog-js/releases/tag/posthog-react-native@4.12.0) is required, but we recommend [keeping up with the latest SDK version](/docs/sdk-doctor) to ensure you have all of error tracking's features.
