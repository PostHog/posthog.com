...
<Step title="Setting up exception autocapture" subtitle="Your goal in this step: Enable automatic exception tracking for your web application." badge="required">
...
Before proceeding, confirm that exceptions are being automatically captured in PostHog.
...
<Step title="Manually capturing exceptions" subtitle="Your goal in this step: Manually capture exceptions in your web application." badge="optional">
...
<Step checkpoint title="Verify manual exception capture" subtitle="Confirm manual exception capture is working">

Before proceeding, confirm that manual exception capture is working.
...
1. [Upload source maps](/docs/error-tracking/upload-source-maps/web) – Required for accurate stack traces if you serve minified bundles.
