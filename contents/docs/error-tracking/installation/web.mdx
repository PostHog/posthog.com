...
<Step title="Option 1: Add the JavaScript snippet to your HTML" subtitle="Recommended" badge="recommended" titleSize="h3">

<JsSnippet />

</Step> 

<Step title="Option 2: Install via package manager" titleSize="h3">
