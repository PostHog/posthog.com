...
<Step checkpoint title="Verify error boundary capture" subtitle="Confirm exceptions are being properly captured by the error boundary">

Before proceeding, confirm that exceptions are being properly captured by the error boundary.
