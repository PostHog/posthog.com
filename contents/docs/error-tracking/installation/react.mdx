...
> **Note:** A minimum SDK version of v1.207.8 is required, but we recommend [keeping up with the latest SDK version](/docs/sdk-doctor) to ensure you have all of error tracking's features.
...
<StepUploadSymbols urlPath="react" framework="React" />
