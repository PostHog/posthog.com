...
A minimum SDK version of [5.9.0](https://github.com/PostHog/posthog-flutter/releases/tag/5.9.0) is required, but we recommend [keeping up with the latest SDK version](/docs/sdk-doctor) to ensure you have all of error tracking's features.
