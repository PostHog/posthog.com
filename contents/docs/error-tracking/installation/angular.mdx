...
Before proceeding, confirm that you can [capture events](/docs/libraries/angular#capture-custom-events) with PostHog.
...
1. [Upload source maps](/docs/error-tracking/upload-source-maps/angular) – Required for accurate stack traces if you serve minified bundles.
