...
showStepsToc: true
platformImageUrl: https://res.cloudinary.com/dmukukwp6/image/upload/posthog.com/contents/docs/integrate/frameworks/angular.svg
---
...
<StepUploadSymbols urlPath="angular" framework="Angular" />
