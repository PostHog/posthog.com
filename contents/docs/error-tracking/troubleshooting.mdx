...
2. Verify **exception capture** is enabled in the [**Configuration** tab](https://us.posthog.com/error_tracking) in Error Tracking
...
1. Verify source maps are uploaded to the correct project by navigating to [Error Tracking](https://us.posthog.com/error_tracking) and selecting the **Configuration** tab > **Symbol sets**. You'll also see warnings for missing symbol sets
