...
4. Download and inspect uploaded symbol sets to verify their contents match your build artifacts. Click the download button on any uploaded symbol set in the [Symbol Sets configuration](https://app.posthog.com/error_tracking/configuration#selectedSetting=error-tracking-symbol-sets), or use the CLI:
