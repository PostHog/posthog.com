...
- **Traces or generations captured** – Set up LLM event capture using the [installation guide](/docs/llm-observability/installation).
- **AI data processing enabled** – Your organization must have AI data processing consent enabled, the same requirement as [trace summarization](/docs/llm-observability/summarization).
...
Clusters automatically group similar LLM [traces](/docs/llm-observability/traces) or [generations](/docs/llm-observability/generations) together, helping you discover patterns in how users interact with your LLM features without reading every conversation.
...
Enabled clustering jobs run automatically during the next scheduled cycle — no manual intervention needed beyond having [traces captured](/docs/llm-observability/installation).

## Viewing clusters

Navigate to **LLM Observability** > **Clusters** to see the overview.
