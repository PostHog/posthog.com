...
Custom properties in LLM Observability enable you to add metadata to your [AI generations](/docs/llm-observability/generations), making it easier to filter, analyze, and understand your LLM usage patterns. 

This guide shows you how to set custom properties using PostHog's LLM Observability SDKs and leverage them for better observability. For specific integration patterns, see our guides on [linking to session replay](/docs/llm-observability/link-session-replay) and [linking to error tracking](/docs/llm-observability/link-error-tracking).

## Why use custom properties?

Custom properties help you:
- **Filter [traces](/docs/llm-observability/traces)** by specific criteria (e.g., subscription tier, feature flags, account settings)
- **Track prompt versions** to measure improvements over time
- **Link backend LLM events** to [session replays](/docs/llm-observability/link-session-replay) and [error tracking](/docs/llm-observability/link-error-tracking)
- **Group related [generations](/docs/llm-observability/generations)** by custom business logic (e.g, sessions, conversations, tenants )
...
Once you've set custom properties, they appear in the PostHog LLM Observability dashboard where you can:
