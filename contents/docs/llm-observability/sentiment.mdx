...
Sentiment classification is currently in beta. We'd love to [hear your feedback](https://app.posthog.com/llm-observability#panel=support%3Afeedback%3Allm-observability%3Alow%3Atrue) as we develop this feature.

</CalloutBox>

Sentiment classification automatically labels user messages in your LLM [traces](/docs/llm-observability/traces) and [generations](/docs/llm-observability/generations) as **positive**, **neutral**, or **negative**. This helps you understand how users feel during conversations with your AI features without reading every message.
...
The **Sentiment** tab in LLM Observability provides a dedicated card-based interface for browsing user messages by sentiment.
...
- **LLM events captured** – Set up event capture using the [installation guide](/docs/llm-observability/installation).
