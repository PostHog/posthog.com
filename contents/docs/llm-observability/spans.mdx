...
While [generations](/docs/llm-observability/generations) capture LLM interactions and [traces](/docs/llm-observability/traces) group related operations, spans track atomic operations that make up your workflow:
