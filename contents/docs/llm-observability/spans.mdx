...
Spans are units of work within an LLM [trace](/docs/llm-observability/traces). These are events that represent individual operations and discrete durations within your LLM application, like function calls, vector searches, or data retrieval steps, providing granular visibility into the execution flow. 
...
- **[Generations](/docs/llm-observability/generations)** - LLM calls and interactions
...
For technical implementation details, see [manual capture](/docs/llm-observability/installation/manual-capture).
