...
Trace summarization uses AI to generate human-readable summaries of your LLM [traces](/docs/llm-observability/traces) and events. This helps you quickly understand complex multi-step AI interactions without reading through raw inputs and outputs.
