...
3. View user feedback per-trace within LLM Observability, or view all feedback within [Surveys](https://app.posthog.com/surveys).
...
On any top-level [trace](/docs/llm-observability/traces) (or pseudo-trace) event, navigate to the **Feedback** tab to create a survey.
...
For the quickest setup in React apps, [use the `useThumbSurvey` hook to wire up your survey](/docs/llm-observability/user-feedback/use-thumb-survey).

If you need more flexibility, or are not building a React app, see [manual feedback event capture](/docs/llm-observability/user-feedback/manual-event-capture).

## Viewing survey responses

You can view survey responses per-trace within LLM Observability, or per-survey within Surveys.
...
You can also view all responses in a table, and quickly link to the related trace by clicking the LLM Observability icon:
