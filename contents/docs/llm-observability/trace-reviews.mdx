...
Trace Reviews are the manual review workflow in [LLM Observability](/docs/llm-observability). They let your team inspect individual [traces](/docs/llm-observability/traces), apply structured scores, add reasoning, and work through pending traces in queues.
...
Reviews are also a practical way to find gaps in your [evaluations](/docs/llm-observability/evaluations). Manual review helps you spot failure modes you have not encoded yet, so you can turn them into better automated checks later.

## How Reviews work

The **Reviews** area in LLM Observability has three parts:
...
1. Create a queue in **LLM Observability** > **Reviews** > **Queues**
...
1. Open a trace in [Traces](/docs/llm-observability/traces) or from a review queue
2. Click **Review**
...
Trace Reviews and [evaluations](/docs/llm-observability/evaluations) solve different problems:
