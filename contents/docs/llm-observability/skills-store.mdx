...
- A PostHog account with LLM Observability enabled
...
1. Navigate to **LLM Observability** > **Skills**
2. Click **New skill**
...
- Check the changelog at contents/docs/llm-observability/changelog.mdx
