...
The [LLM Observability dashboard](https://app.posthog.com/llm-observability) provides an overview of your LLM usage and performance. Out of the box, it includes insights on:
...
1. Head to the [LLM Observability dashboard](https://app.posthog.com/llm-observability)
...
To dive into specific generation events, click on the [generations](https://app.posthog.com/llm-observability/generations), [traces](https://app.posthog.com/llm-observability/traces), or [sentiment](https://app.posthog.com/llm-observability/sentiment) tabs to explore your LLM data.
