---
title: AWS Bedrock LLM Observability installation
...
tableOfContents: [
    ...
    {
        url: 'instrument-bedrock-calls',
        value: 'Instrument Bedrock calls',
        depth: 1,
    },
    {
...
Source: https://github.com/PostHog/posthog/blob/master/docs/onboarding/llm-observability/aws-bedrock.tsx
See the docs runbook for more info: https://posthog.com/handbook/docs-and-wizard/onboarding-docs
-->

import { AWSBedrockInstallation } from 'onboarding/llm-observability/aws-bedrock.tsx'
...
<OnboardingContentWrapper snippets={{ NotableGenerationProperties }}>
    <AWSBedrockInstallation modifySteps={addNextStepsStep} />
