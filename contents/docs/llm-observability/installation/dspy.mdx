---
title: DSPy LLM Observability installation
platformLogo: dspy
showStepsToc: true
tableOfContents: [
    {
...
Source: https://github.com/PostHog/posthog/blob/master/docs/onboarding/llm-observability/dspy.tsx
See the docs runbook for more info: https://posthog.com/handbook/docs-and-wizard/onboarding-docs
-->

import { DSPyInstallation } from 'onboarding/llm-observability/dspy.tsx'
