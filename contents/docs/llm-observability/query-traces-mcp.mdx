...
The [PostHog MCP server](/docs/model-context-protocol) lets your AI coding agent query [LLM traces](/docs/llm-observability) directly from your code editor. Check costs, monitor errors, and analyze model performance – without switching to the PostHog app.
