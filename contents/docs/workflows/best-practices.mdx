...
Periodically review the **Metrics** tab in the workflow builder. The overview shows workflow-level summary metrics – started, in progress, completed, and emails sent. Select an individual email action to see email-specific metrics – sent, delivered, opened, clicked, bounced, blocked, and marked as spam.
