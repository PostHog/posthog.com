...
Clean up unused/outdated workflows to reduce unnecessary triggers and costs. Archive workflows you no longer need, then bulk delete them from the archived tab by selecting multiple workflows and clicking **Delete selected**.
...
When a workflow becomes obsolete (e.g. onboarding process changed, or a campaign ended), archive or delete it to avoid accidental triggering and reduce maintenance burden. To clean up many workflows at once, archive them and use the bulk delete option in the **Archived** tab to select and delete multiple workflows simultaneously.
