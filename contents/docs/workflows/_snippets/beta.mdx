...
Workflows is currently in early beta. While in beta, workflows is free to use. See the overview page for the [proposed pricing model](/docs/messaging/overview#pricing).
