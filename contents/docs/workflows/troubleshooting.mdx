...
## Recipient stopped receiving emails?

If a recipient experiences a hard bounce (a permanent delivery failure, such as an invalid email address), PostHog automatically opts them out of future emails. This prevents repeated delivery attempts to addresses that can't receive mail and helps maintain your sender reputation.

If you believe a recipient was incorrectly opted out, check your opt-out list and remove them to re-enable email delivery.
