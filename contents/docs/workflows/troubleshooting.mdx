...
Validation errors occur when you try to enable or publish a workflow, not during auto-save. Workflows auto-save as drafts, so incomplete configurations are preserved automatically.
