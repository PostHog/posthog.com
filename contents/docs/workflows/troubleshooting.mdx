...
Ensure SPF/DKIM/DMARC records are properly configured in your domain host. DMARC is now included in the DNS records that PostHog provides during email channel setup, though it will show as pending since automatic verification is not available.
