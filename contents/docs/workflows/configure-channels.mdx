...
<CalloutBox icon="IconInfo" title="Push sends count toward destinations" type="fyi">

Push is available in every project. Each send counts toward your workflows destinations usage and quota, the same as a webhook or other destination step. To send feedback, [reach out in-app](https://app.posthog.com/#panel=support%3Afeedback%3A%3Alow%3Atrue).
</CalloutBox>
