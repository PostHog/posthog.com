...
- Use variables like `{{ person.name }}` to personalize your message. See the [template builder](/docs/workflows/template-builder) documentation for more information on available variables.
