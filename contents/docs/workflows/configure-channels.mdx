...
Each sender address is a separate channel, and only a sender that exists in the project shows in the **From** dropdown of an email step in the [workflow builder](/docs/workflows/workflow-builder). To add another sender later, use the **Channels** tab again. The **Settings** > **Integrations** page shows the senders that exist and lets you remove them, but you cannot add a sender there.
