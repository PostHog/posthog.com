...
You can use it to send **[drip campaigns](/docs/workflows/email-drip-campaign), transactional messages, or announcements** directly from the Workflow Builder.
...
<<<<<<< HEAD
> Twilio support is coming soon. If there are other channels you'd like to see supported, please [let us know](https://app.posthog.com/workflows/campaigns#panel=support).
=======
...
<<<<<<< HEAD
> Webhook support is coming soon. If there are other channels you'd like to see supported, please [let us know](https://app.posthog.com/workflows/campaigns#panel=support).
=======
