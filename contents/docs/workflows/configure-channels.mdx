...
Each sender address is a separate channel. You can add more senders later from the **Channels** tab, or in **Settings** > **Environment** > **Integrations**, which lists every email sender in the project. Only a sender that you add here shows in the **From** dropdown of an email step in the [workflow builder](/docs/workflows/workflow-builder).
...
| Issue | Solution |
| --- | --- |
| No address in the **From** dropdown? | The step can only use a sender that exists in the project. Add one on the [**Channels** tab](https://app.posthog.com/workflows/channels), or in **Settings** > **Environment** > **Integrations**, then select it in the step. |
