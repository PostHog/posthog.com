...
To improve deliverability and stay out of spam folders, verify your domain.

1. After adding your email address, PostHog shows DNS records for **SPF**, **DKIM**, and **DMARC**.
2. Add these to your domain host (e.g., Cloudflare, GoDaddy).
...
| Spam folder issues? | Ensure SPF, DKIM, and DMARC records are valid. |
