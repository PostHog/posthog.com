...
You can stage changes to an enabled workflow as a draft and publish them when you're ready. Nothing below happens until you publish. Each publish is recorded in the workflow's **History** tab, where you can see what changed and restore an earlier version.
