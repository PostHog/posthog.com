...
- In the **Metrics** tab, you should see a line chart showing the number of **succeeded** and **triggered** messages. This shows production workflow activity only – test sends from the workflow builder are excluded.
