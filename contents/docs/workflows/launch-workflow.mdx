...
<CalloutBox type="fyi" title="Auto-save">

Workflows auto-save as drafts after 5 seconds of inactivity. Validation is only enforced when you click **Enable**, not on save.
