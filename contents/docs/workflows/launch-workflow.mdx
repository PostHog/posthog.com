...
- In the **Metrics** tab, you should see charts showing triggered workflow runs and message delivery.
...
For email dispatches, the **Metrics** tab shows these email-specific metrics:

| Metric | Description |
|--------|-------------|
| **Sent** | Emails successfully handed off to the email provider |
| **Delivered** | Emails confirmed delivered to the recipient's inbox by their mail server |
| **Opened** | Emails the recipient opened |
