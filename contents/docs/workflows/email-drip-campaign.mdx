...
- **Max time to wait for condition**: The maximum time to wait before the workflow continues if the condition is not met. For this example, we'll wait 1 day.
...
<ProductScreenshot
    ...
    classes="rounded"
    alt="Complete drip campaign workflow"
/>
