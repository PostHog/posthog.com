...
<OSButton variant="primary" asLink={true} to="/docs/workflows/launch-workflow">
...
<OSButton variant="primary" asLink={true} to="/docs/workflows/workflow-builder">
...
<OSButton variant="primary" asLink={true} to="/docs/workflows/configure-channels">
...
<OSButton variant="primary" asLink={true} to="https://app.posthog.com/workflows/new/workflow" external>
