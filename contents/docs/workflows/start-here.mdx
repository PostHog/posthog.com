...
<CallToAction type="primary" to="/docs/workflows/workflow-builder">
...
<CallToAction type="primary" to="/docs/workflows/configure-channels">
...
<<<<<<< HEAD
<CallToAction type="primary" to="https://app.posthog.com/workflows/campaigns/new/overview">
=======
<CallToAction type="primary" to="https://app.posthog.com/workflows/new/workflow">
