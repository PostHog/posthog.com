...
If you use an AI coding assistant like Cursor or Claude, you can create email templates directly from your editor using the [PostHog MCP server](/docs/model-context-protocol).
...
See the [MCP use cases](/docs/model-context-protocol/use-cases) for more examples, or the [tools reference](/docs/model-context-protocol/tools) for the full list of email template tools.
