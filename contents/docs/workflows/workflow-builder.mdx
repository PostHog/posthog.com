...
| Update ticket        | Change a ticket's status, priority, or assignee         | Status: `new`, `open`, `pending`, `on_hold`, `resolved`. Priority: `low`, `medium`, `high`, `critical`. Assignee: user or role |
