...
| `$conversation_ticket_status_changed`   | Ticket status was updated                  | `old_status`, `new_status`, `actor_type`, `actor_id`, `actor_email`                     |
| `$conversation_ticket_priority_changed` | Ticket priority was updated                | `old_priority`, `new_priority`, `actor_type`, `actor_id`, `actor_email`                 |
| `$conversation_ticket_assigned`         | Ticket was assigned to a team member or AI | `assignee_type`, `assignee_id`, `actor_type`, `actor_id`, `actor_email`                 |
| `$conversation_message_sent`            | Team member sent a message on a ticket     | `message_id`, `message_content`, `author_type`, `actor_type`, `actor_id`, `actor_email` |
...
All events include the following base properties: `ticket_id`, `ticket_number`, `channel_source`, `status`, and `priority`. Staff and system actions also include `actor_type`, `actor_id`, and `actor_email` to identify who performed the action.
