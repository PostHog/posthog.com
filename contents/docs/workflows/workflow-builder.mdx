...
Archived workflows appear in the **Archived workflows** section at the bottom of the workflows list. This section is collapsed by default – expand it to view them.

### Bulk deleting archived workflows

To permanently delete multiple archived workflows:

1. Expand the **Archived workflows** section
2. Select workflows using the checkboxes, or click **Select all**
3. Click **Delete selected (N)**
4. Confirm the deletion

Only archived workflows can be bulk deleted. Draft and enabled workflows must be archived first.
