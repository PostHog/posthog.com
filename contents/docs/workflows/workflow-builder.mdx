...
The workflow editor saves your changes automatically as you work. After a few seconds of inactivity, your workflow saves in the background. A "Last saved" indicator in the tab bar shows when your workflow was last saved.

Auto-save is enabled by default for draft workflows. You can toggle it on or off using the **Auto-save** switch in the tab bar. Active workflows always require an explicit save to prevent unintended changes to live behavior.

Auto-save only works on existing workflows. You must save a new workflow manually at least once before auto-save takes effect. Schedule changes are excluded from auto-save and require a manual save.

If you navigate away with unsaved changes, PostHog saves them automatically so you don't lose your work.
