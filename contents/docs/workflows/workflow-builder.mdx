...
| `$conversation_ticket_status_changed`   | Ticket status was updated                  | `old_status`, `new_status`, `customer_name`, `customer_email`, `customer_distinct_id`     |
| `$conversation_ticket_priority_changed` | Ticket priority was updated                | `old_priority`, `new_priority`, `customer_name`, `customer_email`, `customer_distinct_id` |
| `$conversation_ticket_assigned`         | Ticket was assigned to a team member or AI | `assignee_type`, `assignee_id`, `customer_name`, `customer_email`, `customer_distinct_id` |
