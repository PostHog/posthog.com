...
Workflows have three states: **draft**, **enabled**, and **archived**.
...
| Archived | An inactive workflow removed from the main list. Archived workflows can be restored or permanently deleted. |
...
Only archived workflows can be permanently deleted. You can delete them in two ways:

- **Single delete** – Click the **More** menu on an archived workflow row and select **Delete**.
- **Bulk delete** – Select multiple archived workflows using the checkboxes, then click **Delete selected (N)** to remove them all at once. Use the **Select all** checkbox at the top of the table to select every archived workflow.
