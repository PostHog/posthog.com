...
The workflow editor auto-saves your changes as you edit. A **Saving…** indicator appears while changes are being saved, followed by a **Last saved** timestamp showing when the workflow was last saved. This prevents you from losing work if you navigate away without manually saving.

Auto-save applies to existing workflows only. New workflows need to be saved manually the first time. You can still click the **Save** button at any time to save explicitly.
