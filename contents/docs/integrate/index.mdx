...
> **Note: ** The following information only covers how to bring in _new_ events. If you have a data warehouse or database with _past_ events, see [this guide](/docs/integrate/ingest-historic-data) on importing historical data.
