...
Open a [support request](https://us.posthog.com/#panel=support%3Asupport%3Alogin%3A%3Atrue) in the app, choosing **Authentication** as the topic, if you need a higher limit for production use. If you don't have a PostHog account to sign in with, [reach out to us](/talk-to-a-human) instead.
