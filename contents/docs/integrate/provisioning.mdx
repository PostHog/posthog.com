...
3. **Generate a keypair and publish the public half** at a `jwks_uri`, if you are a confidential client. See [authenticating with a private key](#authenticating-with-a-private-key).
