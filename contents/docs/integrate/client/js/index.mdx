...
You can configure autocapture using the allowlists.
...
posthog.init('sTMFPsFhdP1Ssg',
    {
        ...
        autocapture: {
                event_allowlist: ['click'], // elements from this array ['click', 'change', 'submit']
                url_allowlist: ['*/docs/*'], // strings or RegExps
...
The allowlists only change autocapture, they won't change the data collected by session recordings.
