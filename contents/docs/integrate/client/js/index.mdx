...
| `sanitize_properties`<br/><br/>**Type:** Function<br/>**Default:** `null`                                                                                                                       | A function that allows you to sanitize the properties that get sent. Example: `sanitize_properties: function(properties, event_name) { delete properties['$current_url']; return properties}` |
