...
import JSInstall from './js/snippets/install.mdx'
...
import JSAutoCapture from './js/snippets/autocapture.mdx'
import JSCaptureIgnoreElements from './js/snippets/capture-ignore-elements.mdx'
...
import JSCapture from './js/snippets/capture.mdx'
...
import JSIdentify from './js/snippets/identify.mdx'
