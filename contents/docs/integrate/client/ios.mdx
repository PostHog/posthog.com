...
import IOSInstall from './ios/snippets/install.mdx'
import IOSConfigure from './ios/snippets/configure.mdx'
import IOSIdentify from './ios/snippets/identify.mdx'
import IOSCapture from './ios/snippets/capture.mdx'
