...
import AndroidInstall from './android/snippets/install.mdx'
import AndroidConfigure from './android/snippets/configure.mdx'
import AndroidIdentify from './android/snippets/identify.mdx'
import AndroidCapture from './android/snippets/capture.mdx'
