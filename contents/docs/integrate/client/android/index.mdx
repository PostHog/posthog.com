...
<p className="mb-0 md:mr-4" style={{lineHeight: '1.5'}}>
This is the official <strong>PostHog library for Android</strong> to capture and send events to any PostHog instance (including posthog.com).
</p>
<CallToAction icon="none" href="https://github.com/PostHog/posthog-android" className="whitespace-nowrap">
Browse on GitHub
</CallToAction>
</div>

<!-- <VisitLibrary name="Android" to="https://github.com/PostHog/posthog-android" official="official" /> -->

This is the official Android library to capture and send events to any PostHog instance (including posthog.com).

It uses an internal queue to make calls fast and non-blocking. It also batches requests and flushes asynchronously, 
