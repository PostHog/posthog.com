...
A user must be able to request that their data be removed from PostHog. How you faciliate that request is up to you. For example, you could accept requests via email or form submission.
