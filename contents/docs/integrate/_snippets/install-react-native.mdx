...
export function MyApp() {
    return (
        <PostHogProvider apiKey="<ph_project_api_key>" options={{
            ...
            host: '<ph_client_api_host>', // TIP: host is optional if you use https://app.posthog.com
        }}>
            <MyComponent />
        </PostHogProvider>
    )
...
export const posthog = await PostHog.initAsync("<ph_project_api_key>", {
    ...
    host?: string = "<ph_client_api_host>", // TIP: host is optional if you use https://app.posthog.com
