...
```ts
export const posthog = new PostHog("<ph_project_api_key>", {
    /** PostHog API host (usually 'https://us.i.posthog.com' by default or 'https://eu.i.posthog.com') */
    host?: string, // TIP: host is optional if you use https://us.i.posthog.com
