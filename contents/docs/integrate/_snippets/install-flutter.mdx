...
For Web, add your `Web snippet` (which you can find in [your project settings](https://app.posthog.com/settings/project#snippet)) in the `<header>` of your `web/index.html` file:
