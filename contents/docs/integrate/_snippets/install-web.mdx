...
The `defaults` is a version number for a configuration snapshot used as defaults to initialize PostHog. The version number is a date, such as `2025-05-24`. This default is overriden when you explicitly set a value for any of the options.
