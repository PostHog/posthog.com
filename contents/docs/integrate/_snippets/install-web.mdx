...
You can also pin the snippet to a specific version of `posthog-js` in your [project settings](https://app.posthog.com/settings/environment#js-snippet-version). Accepted formats are major (`1`), minor (`1.358`), or exact (`1.358.0`). The default is `1`, which always serves the latest v1.x release.
