...
<details>
  ...
  If you need ES5 support for older browsers, replace `/static/array.js` in the snippet with `/static/array.full.es5.js`. Note that Internet Explorer 11 is not a supported browser.
</details>
