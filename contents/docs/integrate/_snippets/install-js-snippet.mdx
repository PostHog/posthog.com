...
<details>
  ...
  If you’re working with AI code editors (like Lovable, Bolt.new, Replit, and others), it’s easy to install PostHog. Just give it this prompt: `npx --yes @posthog/wizard@latest --signup`
