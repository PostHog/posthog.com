...
<h3 class="flex items-center">
    Quick start: JavaScript snippet <span class="inline-block border border-blue rounded-sm px-1 py-0.5 text-xs text-blue uppercase font-semibold ml-2">Recommended</span>
</h3>
