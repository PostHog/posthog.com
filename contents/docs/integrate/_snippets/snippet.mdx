...
> **Integrated the snippet?** Here are some ideas for [what to do after you've installed PostHog](/tutorials/next-steps-after-installing), from setting up event capture to building your first dashboard.
