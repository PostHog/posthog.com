...
3. Give your key a label – this is just for you, usually to describe the key's purpose. Optionally, click **Add description** to add more detail about where and how the key is used.
