...
posthog = Posthog('<ph_project_api_key>', host='<ph_instance_address>', personal_api_key='<ph_personal_api_key>') # TIP: The personal API key is necessary only if you want to use local evaluation of feature flags.
```
