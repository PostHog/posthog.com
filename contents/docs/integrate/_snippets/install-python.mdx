...
Version `6.x` of the PostHog Python SDK introduces a new [contexts](/docs/libraries/python#contexts) and breaking changes. If you're upgrading from `5.x` to `6.x`, read the [migration guide](/tutorials/python-v6-migration) first to learn more.
