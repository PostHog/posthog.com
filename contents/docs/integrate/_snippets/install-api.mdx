Personal API keys enable full access to your account, just like e-mail address and password. You can create any number of them and each one can be invalidated individually. This makes for greater control for you and improved security of stored data.
...
#### How to use the personal API key
...
For PostHog Cloud US, use `app.posthog.com` as the host. For PostHog Cloud EU, use `eu.posthog.com`.