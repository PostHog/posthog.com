...
This is an optional library you can install if you're working with Python. 

<CallToAction icon="none" href="https://github.com/PostHog/posthog-python" className="mb-4">
    Browse library (Python)
</CallToAction>
