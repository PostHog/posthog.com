...
import CohortExpansionSnippet from './snippets/cohort-expansion'
...
Feature flags can be returned with matching payloads which are JSONType (string, number, boolean, dictionary, array) values. 
