...
If you're working with Node.js, the official `posthog-node` library is the simple way to integrate your software with PostHog.

<CallToAction icon="none" href="https://github.com/PostHog/posthog-node" className="mb-4">
    Browse library (Node.js)
</CallToAction>
