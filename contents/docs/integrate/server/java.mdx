...
See the [com.posthog.java](https://search.maven.org/artifact/com.posthog.java/posthog) in the Maven Central Repository. Click on the latest version shows you options for adding dependencies for other build systems.
