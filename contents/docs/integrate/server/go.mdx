...
This is the official PostHog Go library to capture and send events to any PostHog instance (including posthog.com).

<CallToAction icon="none" href="https://github.com/PostHog/posthog-go" className="mb-4">
    Browse library (Go)
</CallToAction>
