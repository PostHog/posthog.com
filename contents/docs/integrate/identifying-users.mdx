...
The main issue that we consistently see from our clients is using non-unique distinct IDs to identify their users. This usually happens because of one of 2 key reasons:
