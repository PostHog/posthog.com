...
- `POSTHOG_PROJECT_API_KEY` - Your [project API key](/docs/getting-started/api-keys), used to initialize the PostHog SDK
...
No. The integration creates a new organization. Existing PostHog organizations cannot be migrated to Vercel billing.
