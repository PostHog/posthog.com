...
/_import { Tabs } from 'antd'
export const TabPane = Tabs.TabPane_/
...
["JavaScript", <JSInstall />],
["Android", <><AndroidInstall /><AndroidConfigure /></>],
["iOS", <><IOSInstall /><IOSConfigure /></>],
["Flutter", <><FlutterPackage /><FlutterInstall /></>],
["React Native", <><ReactNativeInstall /><ReactNativeConfigure /></>],
]} />
...
<CodeSnippets snippets={[
["JavaScript", <JSCapture />],
["Android", <><AndroidCapture /><p>For more information see the <a href="/docs/integrate/client/android#capture">Android capture docs</a>.</p></>],
["iOS", <><IOSCapture /><p>For more information see the <a href="/docs/integrate/client/ios#capture">iOS capture docs</a>.</p></>],
["Flutter", <>
...
<CodeSnippets snippets={[
["JavaScript", <JSIdentify />],
["Android", <AndroidIdentify />],
["iOS", <IOSIdentify />],
["Flutter", <p>See the <a href="/docs/integrate/client/flutter">Flutter library docs</a> for more information.</p>],
["React Native", <ReactNativeIdentify />],
]} />
