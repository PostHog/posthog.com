...
Then, every screen needs to be wrapped with this provider if you want to capture touches or use the hook `usePostHog()` 
...
#### Manually captuing screen capture events
