...
By default, the JavaScript SDK requests every eligible feature flag for the current user. If this page or SDK instance only needs a subset, pass `flag_keys` when initializing PostHog:
