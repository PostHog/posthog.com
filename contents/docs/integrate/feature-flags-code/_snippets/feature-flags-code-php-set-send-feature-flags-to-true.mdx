...
As of version 6.2.0, `send_feature_flags` can also accept an array for more granular control:

```php
PostHog::capture(array(
  'distinctId' => 'distinct_id_of_your_user',
  'event' => 'event_name',
  'send_feature_flags' => array(
    'only_evaluate_locally' => true,
    'person_properties' => array('plan' => 'premium'),
    'group_properties' => array('org' => array('tier' => 'enterprise'))
  )
));
```
