...
- Analyze retention for groups of users, such as all users in the same organization, company, or account. This [requires group analytics](/docs/product-analytics/group-analytics) and it's useful if your customers are companies where there are many users, but not all of them are active.
