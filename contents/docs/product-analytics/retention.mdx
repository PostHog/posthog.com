...
availability:
  ...
  enterprise: full
---
export const retentionTableLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/retention-table-light-mode.png"
export const retentionTableDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/retention-table-dark-mode.png"
