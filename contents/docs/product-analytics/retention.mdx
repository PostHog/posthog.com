...
By default, retention charts display all available retention periods (e.g., Week 1, Week 2, Week 3, Week 4...). You can select specific periods to display in the chart, which helps reduce visual clutter and focus on the periods that matter most for your analysis.
...
To select specific periods, click on the retention table columns you want to display. The chart will update to show only the selected periods, making it easier to focus on the data that matters most for your analysis. Note that period selection is not available for shared insights or embedded retention charts.
