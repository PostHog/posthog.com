...
Retention insights support both [events](/docs/data/events) and [actions](/docs/data/actions). You can also use [data warehouse](/docs/data-warehouse/insights#retention-insights) tables for the start event, return event, or both. Breakdowns and recurring interval retention aren't supported with data warehouse tables.
