...
Starting in PostHog, you can add the PostHog Slack app to your workspace in the subscription set up modal or in [your project settings](https://us.posthog.com/settings/project#integration-slack).
...
After installing the app, head back to PostHog and add a new subscription. In any dashboard or insight, by clicking the top right menu and click **Subscribe**, then **Add subscription**.
