...
AI summaries also consume [AI credits](/docs/posthog-ai/pricing). If your organization exceeds its AI credit limit:

- You can't enable AI summaries on new or existing subscriptions until you increase your limit.
- Existing subscriptions with AI summaries still deliver, but without the summary. Your report includes a notice explaining why and a link to billing settings.
