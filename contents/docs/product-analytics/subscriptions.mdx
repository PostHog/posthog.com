...
Free plans can create up to five subscriptions. Paid plans have no subscription limit.

When you've reached the limit, the create form is replaced with a prompt to upgrade your plan. Viewing and editing existing subscriptions is never blocked – only creating additional subscriptions past the cap.

Deleting a subscription frees its slot. Restoring a previously deleted subscription counts against the limit again.
