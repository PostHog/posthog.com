...
If your team has [PostHog AI memory](/docs/posthog-ai/edit-memory) configured, AI summaries automatically use that context – including saved facts about your company, product, users, and goals.

For example, if your memory includes your company name, product name, or key metrics, the AI references them in your summaries instead of using generic descriptions.

To configure memory, run the `/init` command in PostHog AI or edit memory directly in **Settings** > **AI**.
