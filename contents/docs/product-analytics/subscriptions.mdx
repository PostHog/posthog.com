...
If you have multiple Slack workspaces connected to PostHog, select which Slack connection to use for this subscription. The channel picker appears after you select a connection.

Select any channel the app has access to and set a frequency. **Private channels** are only listed if you have already added PostHog to the relevant channel.
