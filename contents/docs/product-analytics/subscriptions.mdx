...
## Preview your subscription

When configuring a subscription for an insight, you can preview what the exported image will look like before saving. Click **Generate preview** at the bottom of the subscription configuration form to generate a preview of the insight export.

This is helpful for verifying that all breakdown values, chart elements, and data are visible in the exported image.

> **Note:** Preview is only available for insight subscriptions, not dashboard subscriptions.
