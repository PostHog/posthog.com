...
If you have multiple Slack integrations (e.g., connected to different workspaces), select which connection to use first. The channel picker appears after you select a connection. Switching connections clears your channel selection since channels are workspace-specific.
