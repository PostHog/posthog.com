...
Use [Funnels](/docs/user-guides/funnels) to understand how conversion between steps, identify possible causes of success or failure, and track how conversion changes over time.
...
![create an insight](../../images/docs/product-analytics/creating-an-insight.mp4)
