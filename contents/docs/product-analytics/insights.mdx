...
To create a new insight, navigate to the [product analytics tab](https://us.posthog.com/insights) and click `New`. You can also select the type of insight you'd like to create from the dropdown.
