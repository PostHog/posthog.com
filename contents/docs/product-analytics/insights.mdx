...
[Trends](/docs/user-guides/trends) enable you to track how metrics change over time and use formulas to create custom metrics.
...
Use [Funnels](/docs/user-guides/funnels) to understand how often people convert between steps, identify possible causes of success or failure, and track how conversion changes over time.
...
[Retention](/docs/user-guides/retention) insights enable you to see how often users return and compare retention for different cohorts.
...
[Lifecycle](/docs/user-guides/lifecycle) insighs are helpful for checking your product's health by breaking users down by new, returning, resurrecting, and dormant.
...
Use [SQL](/docs/product-analytics/hogql#sql-insights) insights to create custom tables based on your data using SQL.
