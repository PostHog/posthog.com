...
Click the sparkle icon next to an insight's name to generate a name and description using AI. PostHog analyzes the insight's query and generates both a concise name and plain-language description, then saves them automatically.

> **Note:** AI-generated metadata requires [AI data processing approval](/docs/posthog-ai/allow-access) from your organization.
