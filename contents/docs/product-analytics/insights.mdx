...
If your organization has multiple projects, you can copy an insight to another project. To do this:

1. Open a saved insight.
2. Click **Copy to another project** in the side panel.
3. Select the destination project.

This is useful when you've built an insight in one project and want to reuse it elsewhere without recreating it from scratch.
