...
export const sentAMessageLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/sent-a-message-lifecycle-light-mode.png";
export const sentAMessageDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/sent-a-message-lifecycle-dark-mode.png";
export const lifecycleFiltersLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/lifecycle-filters-light-mode.png";
export const lifecycleFiltersDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/lifecycle-filters-dark-mode.png";
export const timeControlLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/time-control-light-mode.png";
export const timeControlDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/time-control-dark-mode.png";
export const chartLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/lifecycle-chart-light-mode.png";
export const chartDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/lifecycle-chart-dark-mode.png";
export const showValuesLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/show-values-light-mode.png";
export const showValuesDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/show-values-dark-mode.png";
export const detailLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/detail-light-mode.png";
export const detailDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/detail-dark-mode.png";
export const viewSessionLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/view-session-reply-light-mode.png";
export const viewSessionDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/product-analytics/view-session-reply-dark-mode.png";
...
To start, you need to select an event or action that represents lifecycle activity. It is likely something users do repeatedly like a pageview, logging into your app, or performing a key action. For example, in a messaging product, you might consider someone active if they've sent a message within the interval.
...
<ProductScreenshot
  imageLight={
    "https://res.cloudinary.com/dmukukwp6/image/upload/v1718625075/posthog.com/contents/Screenshot_2024-06-17_at_1.49.16_PM.png"
  }
  imageDark={
    "https://res.cloudinary.com/dmukukwp6/image/upload/v1718625075/posthog.com/contents/Screenshot_2024-06-17_at_1.49.26_PM.png"
  }
  classes="rounded"
...
You can also click on the **Options** button and select **Show values on series** to display values on the chart for more details:
...
To see the relative breakdown of each status within a time interval, enable **Show percentages on series** in the **Options** popover. When combined with **Show values on series**, each segment label displays both the count and its share of the band total – e.g. `580 (42%)`. You can also enable percentages on their own to show only the percentage – e.g. `42%`.
