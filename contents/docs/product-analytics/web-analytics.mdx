...
Web analytics enables you to easily track and monitor the many of the most important metrics for your website. 
...
<ComparisonTable column1="Web analytics" column2="Product analytics">
  ...
  <ComparisonRow column1={"Small teams, marketers"} column2={"Engineering, product, data teams"} feature="Users" />
