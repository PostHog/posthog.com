...
<CalloutBox icon="IconInfo" title="Plan availability" type="fyi">

On the free plan, you can set a starting point for your path analysis. Setting an ending point, using wildcard groups, and other advanced options require a [paid plan](/pricing).
