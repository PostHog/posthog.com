...
availability:
  ...
  features:
    ...
    advancedOptions:
      ...
      enterprise: true
---
import switchingTypeLight from '../../images/docs/user-guides/paths/switching-type-light-mode.png'
import switchingTypeDark from '../../images/docs/user-guides/paths/switching-type-dark-mode.png'
import exampleLight from '../../images/docs/user-guides/paths/example-light-mode.png'
import exampleDark from '../../images/docs/user-guides/paths/example-dark-mode.png'
import twoStepLight from '../../images/docs/user-guides/paths/2-step-light-mode.png'
import twoStepDark from '../../images/docs/user-guides/paths/2-step-dark-mode.png'
import threeStepLight from '../../images/docs/user-guides/paths/3-step-light-mode.png'
import threeStepDark from '../../images/docs/user-guides/paths/3-step-dark-mode.png'
import dropoffLight from '../../images/docs/user-guides/paths/dropoff-light-mode.png'
import dropoffDark from '../../images/docs/user-guides/paths/dropoff-dark-mode.png'
import usersLight from '../../images/docs/user-guides/paths/users-light-mode.png'
import usersDark from '../../images/docs/user-guides/paths/users-dark-mode.png'
import exclusionslight from '../../images/docs/user-guides/paths/exclusions-light-mode.png'
import exclusionsDark from '../../images/docs/user-guides/paths/exclusions-dark-mode.png'
import pathLight from '../../images/docs/user-guides/paths/path-cleaning-light-mode.png'
import pathDark from '../../images/docs/user-guides/paths/path-cleaning-dark-mode.png'
