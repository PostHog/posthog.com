...
The PostHog Terraform Provider and in-app export features are currently in beta. To enable the "Manage with Terraform" button, opt in for `Infrastructure as Code for Analytics` via [Feature Previews](https://app.posthog.com/settings/user-feature-previews) in your settings.
