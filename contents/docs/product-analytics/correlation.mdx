...
![Correlation analysis](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/funnels/funnel-correlation-analysis.png)

## Using correlation analysis

Suppose we have a funnel and we want to optimize it. The first thing we might want to do is identify if there is anything special about user that make them more or less likely to convert. When we capture person profiles, we can use correlation analysis to automatically identify which user properties are significant:

![Person property correlations](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/funnels/funnel-correlation-user-properties.png)
...
![Event property correlations](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/funnels/funnel-correlation-event-properties.png)
...
![Breakdown by country](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/funnels/funnel-correlation-analysis-country.png)
