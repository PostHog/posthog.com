...
The generated file only includes:

- **Verified events** – Events you've marked as verified in [Data Management](/docs/data/events#managing-event-definitions)
- **Events with schemas** – Events that have property groups attached

This keeps ad-hoc and test events out of your typed definitions. If an event is missing from your generated file, verify it or attach a schema.
