...
![Creating a property group](https://res.cloudinary.com/dmukukwp6/image/upload/w_1600,c_limit,q_auto,f_auto/create_property_group_476e273705.png)
...
> **Note:** Event names cannot be changed after creation, so choose carefully.
...
Once you've created property groups and events (or if you already have events from captured data), attach property groups to your events:
...
![Event schema with property group](https://res.cloudinary.com/dmukukwp6/image/upload/w_1600,c_limit,q_auto,f_auto/event_schema_with_property_group_93d0971ebf.png)
...
> **Note:** TypeScript is currently the only supported language for schema generation.
