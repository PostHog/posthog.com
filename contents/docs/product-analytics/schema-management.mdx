...
> **Note:** The type safety aspect of schema management is currently experimental and the API may change. The `exp` prefix will be removed once the feature is stable.
