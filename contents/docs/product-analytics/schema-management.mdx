...
<CalloutBox icon="IconInfo" title="Already have events?" type="fyi">

    If you already have events from captured data and want to add schemas to them, you can skip ahead to this section.

</CalloutBox>

Once you've created property groups and events, attach property groups to your events:
