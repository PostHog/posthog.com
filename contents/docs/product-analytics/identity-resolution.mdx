...
|---|---|---|
| **Feature flags** | Different values before and after login | [Hash input changed](/docs/feature-flags/production-ready#resolve-identity-before-evaluating-flags) |
...
- [Production-ready feature flags](/docs/feature-flags/production-ready) – why identity matters for flags and experiments (the pure function model)
