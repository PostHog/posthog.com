...
4. Wait 1 hour and check if the event is still not visible in PostHog. Also make sure your cloud is not experiencing an [active incident](https://status.posthog.com) as that could cause an ingestion lag.
