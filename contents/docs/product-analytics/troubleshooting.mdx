...
If no events are *not* visible in webhook.site, that means you have misconfigured your PostHog library. Consult our [installation guide](/docs/product-analytics/installation) for how to initialize PostHog.
...
2. Send your event as a cURL request directly
