...
PostHog can be adblocked, even locally. This prevents requests from being sent from your app to PostHog. To limit the impact of adblockers, [set up a reverse proxy](/docs/advanced/proxy]. 
