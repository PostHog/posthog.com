...
It's not possible to rename events in PostHog. Instead, you should use [actions](add link) to xyz. This [tutorial](/tutorials/how-to-rename-events) covers this in detail.
