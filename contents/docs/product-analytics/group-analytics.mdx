...
import viewGroupLight from 'user-guides/group-analytics/view-groups-light-mode.png'
import viewGroupDark from 'user-guides/group-analytics/view-groups-dark-mode.png'
...
import groupsInFeatureLight from '../../images/docs/user-guides/group-analytics/groups-in-feature-flags-light-mode.png'
import groupsInFeatureDark from '../../images/docs/user-guides/group-analytics/groups-in-feature-flags-dark-mode.png'
