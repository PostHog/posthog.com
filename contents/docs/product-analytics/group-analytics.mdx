...
<CalloutBox icon="IconWarning" title="Important billing information" type="caution">
...
- **Billing starts** when you enable group analytics from your [billing page](https://us.posthog.com/organization/billing), not when you add group analytics code to your application.
- **All identified events count** toward your group analytics usage once subscribed, regardless of whether they have group properties.
