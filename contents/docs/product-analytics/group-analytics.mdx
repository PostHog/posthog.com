...
This is also how you separate data by tenant in a multi-tenant app – use a group type rather than a project per customer. See [multi-tenant apps](/docs/product-analytics/multi-tenant-apps) for an end-to-end guide.
