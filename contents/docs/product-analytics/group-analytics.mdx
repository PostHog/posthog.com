...
To do this, [create a feature flag](/docs/feature-flags/creating-feature-flags) as you normally would, and select the group type you wish to "Match by", using the drop down in the "Release conditions" section:
