...
import viewGroupLight from '../../images/docs/user-guides/group-analytics/view-groups-light-mode.png'
import viewGroupDark from '../../images/docs/user-guides/group-analytics/view-groups-dark-mode.png'
import relatedLight from '../../images/docs/user-guides/group-analytics/related-people-and-groups-light-mode.png'
import relatedDark from '../../images/docs/user-guides/group-analytics/related-people-and-groups-dark-mode.png'
import groupInsightsLight from '../../images/docs/user-guides/group-analytics/group-insights-light-mode.png'
import groupInsightsDark from '../../images/docs/user-guides/group-analytics/group-insights-dark-mode.png'
import funnelsGroupAggregationLight from '../../images/docs/user-guides/group-analytics/funnels-group-aggregation-light-mode.png'
import funnelsGroupAggregationDark from '../../images/docs/user-guides/group-analytics/funnels-group-aggregation-dark-mode.png'
import groupsInFeatureLight from '../../images/docs/user-guides/group-analytics/groups-in-feature-flags-light-mode.mp4'
import groupsInFeatureDark from '../../images/docs/user-guides/group-analytics/groups-in-feature-flags-dark-mode.mp4'
import groupsProjectSettingLight from '../../images/docs/user-guides/group-analytics/groups-project-settings-light-mode.png'
import groupsProjectSettingDark from '../../images/docs/user-guides/group-analytics/groups-project-settings-dark-mode.png'
