...
This is also how you separate data by tenant in a multi-tenant app – use a group type rather than a project per customer. See [multi-tenant and B2B SaaS setup](/docs/product-analytics/multi-tenant-saas) for an end-to-end guide.
