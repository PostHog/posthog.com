...
The **Calendar heatmap** feature displays a heatmap showing either the number of **unique users** or **total events** for **any selected event**, broken down by hour of the day and day of the week.
