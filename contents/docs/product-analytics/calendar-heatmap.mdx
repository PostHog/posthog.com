...
> **Important:** This feature is currently an opt-in beta. You can enable it on the [feature previews settings page](https://app.posthog.com/#panel=feature-previews%3Acalendar-heatmap-insight).
