...
Text cards use a rich text editor with three tabs:

- **Write** – A visual editor with formatting options for headings, bold, italic, underline, strikethrough, inline code, code blocks, blockquotes, lists, and links. You can also add images and emojis.
- **Preview** – See how your text card will look on the dashboard.
- **Markdown** – View or edit the raw markdown directly.

In the **Write** tab, you can also:

- **Select text** to open a floating toolbar with formatting options
- **Type `/`** to open a menu for quickly inserting headings, formatting, and other elements

You can drag and drop images into text cards and resize them within the editor. Text cards have a 4,000 character limit.

Use text cards to annotate your dashboard with context for other users. For more in-depth analysis, we recommend [creating a notebook](/docs/notebooks).
