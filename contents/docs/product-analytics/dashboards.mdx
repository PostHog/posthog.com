...
- **Show legend** / **Hide legend** – Toggle the chart legend on or off. Available for Trends, Stickiness, and Lifecycle insights. For Trends insights, you can also configure the legend position (right, bottom, top, or left) in the insight's display options.
