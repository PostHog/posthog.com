...
> **Important:** Insights can appear on multiple dashboards at the same time, so you don't have to create multiple copies of the same insight. Changes to the insight will be reflected in all the dashboards it's used in.
