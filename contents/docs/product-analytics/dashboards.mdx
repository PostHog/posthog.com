...
-   With the [Teams add-on](/pricing), you can configure sharing to only give edit access to certain members within a project. Dashboards can be shared either by members with administrator privileges or by the dashboard creator.
