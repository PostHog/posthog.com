...
Dashboard widgets are an early access feature. Subscribe on the [early access feature page](https://app.posthog.com/early_access_features/default/249) to enable widgets for your organization.
