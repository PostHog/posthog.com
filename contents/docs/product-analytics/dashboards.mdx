...
You can update tags across multiple dashboards at once from the list view:

1. Go to the [dashboards list](https://app.posthog.com/dashboards).
2. Select the dashboards you want to update using the checkboxes.
3. Click **Update tags** in the toolbar that appears.
4. Choose whether to **Add**, **Remove**, or **Replace all** tags on the selected dashboards.
5. Enter the tags and click the confirm button to apply.

> **Note:** Bulk tag updates require editor access to the selected dashboards. Dashboards you don't have editor access to can't be selected.
