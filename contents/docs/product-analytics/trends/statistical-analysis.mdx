...
A <Link to='https://en.wikipedia.org/wiki/Confidence_interval' external>confidence interval</Link> is a range of values that likely contains the true value of a metric.
