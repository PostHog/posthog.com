...
Breakdowns only support a single property at a time, unless you use SQL. To breakdown by the combination of browser and operating system, for example, you can use the following expression:
