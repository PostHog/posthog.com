...
export const breakdownLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/trends/breakdown-by-light-mode.png";
export const breakdownDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/trends/breakdown-by-dark-mode.png";
export const breakdownGraphLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/trends/breakdown-graph-light-mode.png";
export const breakdownGraphDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/trends/breakdown-graph-dark-mode.png";
export const breakdownBarsLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/trends/breakdown-bars-light-mode.png";
export const breakdownBarsDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/trends/breakdown-bars-dark-mode.png";
export const breakdownIntoBinsLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/trends/breakdown-into-bins-light-mode.png";
export const breakdownIntoBinsDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/user-guides/trends/breakdown-into-bins-dark-mode.png";
...
When viewing breakdowns in a total value bar chart, each breakdown value displays as a separate bar by default. Enable **Stack breakdown values** in the display settings to combine them into stacked bars grouped by series. This is particularly useful with [formulas](/docs/product-analytics/trends/formulas).
Trends insights support up to 3 breakdowns at a time. Other insight types support a single breakdown (funnels support a single cohort breakdown). When you reach the limit, the **+ Breakdown** button becomes disabled with a tooltip explaining why. If you need more flexibility, you can use [SQL insights](/docs/sql) which don't have this limitation.

To breakdown by the combination of browser and operating system, for example, you can use the following SQL expression:
