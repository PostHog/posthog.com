...
- What's the difference between a power user and a non-power user?
...
You can also create your own aggregation using SQL. See the [HogQL docs](/docs/hogql) for more on this feature and [supported HogQL expressions](/docs/hogql/expressions).