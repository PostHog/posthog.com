...
For user identification to work, you must be capturing person profiles. If set your `person_profile` config option is set to `identified_only`, PostHog only captures person profiles once you call one of the following functions or methods:
