...
When a user logs out, you should [call reset](/docs/product-analytics/identify/reset) to prevent future events on the device from getting accidentally grouped with that user.
