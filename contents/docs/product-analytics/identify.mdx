...
import mergeRestrictionsLight from '../../images/docs/data/identify/merge-restrictions-tooltip-light-mode.png'
import mergeRestrictionsDark from '../../images/docs/data/identify/merge-restrictions-tooltip-light-mode.png'
import splitUsersLight from '../../images/docs/data/identify/how-to-split-users-light-mode.mp4'
import splitUsersDark from '../../images/docs/data/identify/how-to-split-users-dark-mode.mp4'
