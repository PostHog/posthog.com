...
If you use our JavaScript libraries and enable heatmap autocapture in your [project settings](https://app.posthog.com/settings/environment-heatmaps#heatmaps), we can capture general clicks, mouse movements, and scrolling to create [heatmaps](/docs/toolbar/heatmaps). No additional events are created.
...
You can collect dead clicks with the Web SDK by enabling them in [your project settings](https://app.posthog.com/settings/environment-autocapture#dead-clicks-autocapture). 
