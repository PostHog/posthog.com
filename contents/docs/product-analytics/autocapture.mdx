...
export const ImgClipboardAuocaptureLight = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/autocapture/clipboard-activity-light.png"
export const ImgClipboardAuocaptureDark = "https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/autocapture/clipboard-activity-dark.png"
