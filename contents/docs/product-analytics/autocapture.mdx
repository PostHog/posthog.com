...
You can also disable autocapture in your [project settings](https://app.posthog.com/project/settings).

The two settings to enable or disable autocapture interacting can make it tricky to be sure what combination of settings you want.

When client side is turned off `autocapture: false in the config`, then autocapture is always off.

When client side is opted in, autocapture is only on, if the project settings also enable autocapture.

| SDK Enabled | Project Settings enabled | Autocapture is enabled? |
| :---: | :----: | :----: |
| true   |   true    |     true |
| true   |   false    |     false |
| false   |   true    |     false |
