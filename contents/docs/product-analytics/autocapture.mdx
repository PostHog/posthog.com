...
When client side is disabled `autocapture: false in the config`, then autocapture is always off.

When client side is opted in, autocapture is only on, if the project settings do not opt out.

| SDK Enabled | Project Settings opted out | Autocapture is enabled? |
| :---: | :----: | :----: |
| true   |   true    |     false |
| true   |   false    |     true |
| false   |   true    |     false |
