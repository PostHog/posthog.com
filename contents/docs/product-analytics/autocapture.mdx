...
Autocapture is available by for our [JavaScript Web](/docs/libraries/js), [React](/docs/libraries/react), [React Native](/docs/libraries/react-native) and  [iOS](/docs/libraries/ios) SDKs and is **disabled by default**. 
