...
Autocapture is available by for our [JavaScript Web](/docs/libraries/js), [React](/docs/libraries/react), and [React Native](/docs/libraries/react-native) SDKs and is **enabled by default**. 

Autocapture is also available for our [iOS SDK](/docs/libraries/ios), but it is **disabled by default** as an experimental feature.
