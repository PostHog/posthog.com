...
> **Note:** The PostHog heatmap captures dead clicks for free. Collecting just the coordinates of dead clicks to display in heatmaps. Enabling autocapture of dead clicks here enables deeper analysis and is priced as a normal product analytics event. 
