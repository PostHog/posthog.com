...
To create a custom color theme in PostHog, open the "Data color" settings. Click "Add theme", give it a name, and customize the colors to match your preferred palette. Click "Save" to create the theme.
...
### Setting a custom theme override for a single insight (advanced)
...
Colors that aren't assigned, are getting the color they would regularly (in order). 
