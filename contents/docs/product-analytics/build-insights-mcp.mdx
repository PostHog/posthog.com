...
Actors tools let your agent drill into a specific data point from any insight and list the individual persons behind it – who converted, dropped off, retained, and so on.

| Tool                      | Description                                                                                                                                                                                                                                                                                          |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `query-trends-actors`     | List persons behind a trends data point.                                                                                                                                                                                                                                                             |
| `query-funnel-actors`     | List persons who converted through or dropped off at a funnel step. Supports two modes: **step mode** (positive `funnelStep` = converted, negative = dropped off, 1-based) and **trends-dropoff mode** (`funnelTrendsDropOff` + `funnelTrendsEntrancePeriodStart` for funnel-trends visualizations). |
