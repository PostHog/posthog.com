...
| `dashboard-create-text-tile` | Add a text tile (markdown) for section headings, dividers, or annotations. |
| `dashboard-update-text-tile` | Update an existing text tile's content, layout, or color. |
