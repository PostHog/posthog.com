...
> **Note:** See our docs on [person profiles](/docs/data/persons) for more information on the differences between anonymous and identified events.
...
import HowToCaptureAnonymousEvents from './_snippets/how-to-capture-anonymous-events-web.mdx'
