...
You can sanitize properties on the client side by setting the `sanitize_properties` [config](/docs/libraries/js#config) option. This is a function that enables to modify the properties before they are sent to PostHog. For example:
