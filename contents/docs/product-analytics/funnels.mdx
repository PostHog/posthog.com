...
- **Historical trends** – shows you how your conversion rate has changed over time. Useful for understanding how changes, fixes, and new features have affected your funnel success rate. The date represents the conversion rate for all users who entered the funnel on that date.
