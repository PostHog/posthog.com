...
When breaking down funnels by, it's possible that the same properties don't exist on every event. For example, if you want to break down by `browser` on a funnel thats contains both of frontend and backend events.
