...
Using the side menu, navigate to **Insights**, click the dropdown on the **New insight** button, and then select **Funnel**. This will present you with a blank funnel screen.

![Blank funnel screen](../../images/docs/user-guides/funnels/new-funnel.mp4)
...
A more advanced approach is to use [feature flags](/docs/feature-flags) to run a simple A/B test. You can create a feature flag and assign 50% of people to the test group and 50% to the control group.
