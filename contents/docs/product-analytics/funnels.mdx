...
availability:
    ...
    features:
        correlation:
            ...
            enterprise: true
---
import newFunnelLight from '../../images/docs/user-guides/funnels/new-funnel-light-mode.mp4'
import newFunnelDark from '../../images/docs/user-guides/funnels/new-funnel-dark-mode.mp4'
import funnelStepsLight from '../../images/docs/user-guides/funnels/funnel-steps-light-mode.png'
import funnelStepsDark from '../../images/docs/user-guides/funnels/funnel-steps-dark-mode.png'
import globalFiltersLight from '../../images/docs/user-guides/funnels/global-filters-light-mode.png'
import globalFiltersDark from '../../images/docs/user-guides/funnels/global-filters-dark-mode.png'
import setFunnelTimeRangeLight from '../../images/docs/user-guides/funnels/set-funnel-time-range-light-mode.png'
import setFunnelTimeRangeDark from '../../images/docs/user-guides/funnels/set-funnel-time-range-dark-mode.png'
import saveAFunnelLight from '../../images/docs/user-guides/funnels/save-a-funnel-light-mode.mp4'
import saveAFunnelDark from '../../images/docs/user-guides/funnels/save-a-funnel-dark-mode.mp4'
import personsModalLight from '../../images/docs/user-guides/funnels/persons-modal-light-mode.png'
import personsModalDark from '../../images/docs/user-guides/funnels/persons-modal-dark-mode.png'
import identifyingLight from '../../images/docs/user-guides/funnels/identifying-drop-offs-light-mode.png'
import identifyingDark from '../../images/docs/user-guides/funnels/identifying-drop-offs-dark-mode.png'
import switchToRelativeLight from '../../images/docs/user-guides/funnels/switch-to-relative-drop-off-light-mode.png'
import switchToRelativeDark from '../../images/docs/user-guides/funnels/switch-to-relative-drop-off-dark-mode.png'
import averageTimeToConvertLight from '../../images/docs/user-guides/funnels/average-time-to-convert-light-mode.png'
import averageTimeToConvertDark from '../../images/docs/user-guides/funnels/average-time-to-convert-dark-mode.png'
import distributionHistogramLight from '../../images/docs/user-guides/funnels/distribution-histogram-time-to-convert-light-mode.png'
import distributionHistogramDark from '../../images/docs/user-guides/funnels/distribution-histogram-time-to-convert-dark-mode.png'
import granularConversionLight from '../../images/docs/user-guides/funnels/granular-conversion-time-distribution-light-mode.png'
import granularConversionDark from '../../images/docs/user-guides/funnels/granular-conversion-time-distribution-dark-mode.png'
import breakdownByOSLight from '../../images/docs/user-guides/funnels/breakdown-by-operating-system-light-mode.png'
import breakdownByOSDark from '../../images/docs/user-guides/funnels/breakdown-by-operating-system-dark-mode.png'
import funnelStepBreakdownLight from '../../images/docs/user-guides/funnels/funnel-steps-breakdown-light-mode.png'
import funnelStepBreakdownDark from '../../images/docs/user-guides/funnels/funnel-steps-breakdown-dark-mode.png'
import converstionOverTimeLight from '../../images/docs/user-guides/funnels/conversion-over-time-using-trends-light-mode.png'
import converstionOverTimeDark from '../../images/docs/user-guides/funnels/conversion-over-time-using-trends-dark-mode.png'
...
A fast way to get a feel for whether or not a step has high friction is to look at the average time to convert. Steps with a long time to convert are likely much harder than steps with a short time to convert. Click on 
