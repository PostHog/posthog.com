...
Using the side menu, navigate to the **Product Analytics** tab where you'll be able to see a list of all your saved insights. You can then create a new trends insight by clicking on the New insight button in the top right. By default, new insights will default to Trends.
...
If you ever want to go back and modify a trend, you can do so by clicking on its name in the 'Product Analytics' tab, and then clicking the 'Edit' button in the top right.
