...
Now that you've created a Trends insight, the next thing is select the events you would like to see. Click the dropdown to the right of the <div class="inline-flex items-center justify-center rounded-full border-2 font-semibold" style="width: 20px; height: 20px; border-color: rgb(29, 74, 255); color: rgb(29, 74, 255); background-color: rgba(29, 74, 255, 0.15);">A</div> icon.
