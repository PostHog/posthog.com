...
title: Trends
related:
    - ../../tutorials/how-to-segment-users.md
...
Trends are a type of [Insight](/docs/product-analytics/insights) that allow you to plot data from people, events, and properties.
