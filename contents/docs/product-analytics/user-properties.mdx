...
Using user properties requires capturing [person profiles](/docs/data/persons).
...
## How to view the person profile and user properties

To view the person profile and user properties for a particular user, go to [Persons & Groups](https://app.posthog.com/persons) in the PostHog app. Then, click on any person in the list to view their properties. 
