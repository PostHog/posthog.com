...
At the cutting edge, this might mean building multimodal RAG pipelines and productionizing fine-tuned models at scale. But in our opinion, it also encompasses the practical work of tinkering with prompts, coding with agents, or installing MCPs, anything that helps developers leverage AI to build great products.
...
PostHog is all the dev tools you need in one. When you add AI on top of that, and with enough data, your product should be able to build itself. 

That's our long-term vision for AI at PostHog. We call it *product autonomy*.
...
| [AI wizard](/docs/ai-platform/ai-wizard) | Magically add PostHog to your codebase with a single CLI command using AI. | 🧙 | <Link to="https://github.com/PostHog/wizard" external>Code</Link> |
...
| [Markdown and llms.txt](/docs/ai-platform/markdown-llms-txt) | Feed your AI agents more context. All of our docs pages are available in raw Markdown. | 📚 | <Link to="https://posthog.com/llms.txt" external>Code</Link> |
...
- [How we caught our AI agent embezzling tokens](/blog/optimizing-agent-cost)
- [What the AI Wizard taught us about LLM code generation at scale](/blog/correct-llm-code-generation)
- [8 learnings from 1 year of agents – PostHog AI](/blog/8-learnings-from-1-year-of-agents-posthog-ai)
