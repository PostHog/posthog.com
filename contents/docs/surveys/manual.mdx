...
Right now we only support one page open feedback and external link type surveys, so be sure to follow the syntax above to use our built in results functionality for API surveys. We'll be adding more types soon!
