...
2. You must have the `opt_in_site_apps` option enabled in your PostHog initialization code and be on posthog-js version 1.67.1+ or the latest JavaScript HTML snippet.
