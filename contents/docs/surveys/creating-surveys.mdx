...
2. **API:** Implement your own survey UI and use PostHog for handling logic and events.

### Question type

PostHog supports a number of different questions types. All survey types are available for both popover and API display modes.

Below is a table showing the different questions types:
...
This specifies the conditions a user must meet in order to be shown the survey. The user must meet **ALL** of the conditions you set to be eligible.
...
Once you've set up your survey, click "Save as draft" to save your survey. Then, when you're ready to launch, click the "Launch" button.
