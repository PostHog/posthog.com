...
This specifies the conditions a user must meet to be shown the survey. A user must meet **ALL** the conditions to be eligible. **It is not available for hosted surveys, as those are accessed via an external link.**
...
**Display conditions are not available for hosted surveys**. For now, any user who visits the link will be shown the survey, as long as they are launched and still collecting responses.
