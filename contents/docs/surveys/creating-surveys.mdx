...
#### Adding metadata to hosted survey responses
When directing users to a hosted survey, you can attach contextual metadata using URL parameters. These parameters are automatically captured as event properties on the survey sent event.
```
