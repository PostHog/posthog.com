...
You can also select from [a variety of pre-built templates](/templates?filter=type&value=survey). 
...
- **User/group properties:** If you are capturing [person profiles](/docs/data/persons), you can target a survey to users who have a specific [user](/docs/product-analytics/user-properties) or [group property](/docs/product-analytics/group-analytics#how-to-set-group-properties). For example, you can target a survey to users who have a property `is_paying=true`.

- **Wait period**: Hide surveys from users who have seen a survey in the last X days.

![Survey targeting options](https://res.cloudinary.com/dmukukwp6/image/upload/v1710125843/posthog.com/contents/images/docs/surveys/targeting-options-light-mode.png)
