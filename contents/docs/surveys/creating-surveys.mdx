...
The "Automatically submit on selection" toggle is available in both the in-app survey editor and the hosted survey editor for rating and single-choice questions (without an open-ended option).
