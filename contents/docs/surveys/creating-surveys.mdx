...
When directing users to a hosted survey, you can add event propertie using URL parameters. These parameters are automatically captured on the survey sent event.
