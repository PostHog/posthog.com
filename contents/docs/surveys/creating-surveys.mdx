...
- **Events:** If you are emitting [custom events](https://posthog.com/docs/getting-started/send-events) from your application, you can target a survey to users who cause the event to be captured on the client. This feature only works for Surveys of type "Popover".

- **Actions:** If you have any [actions created](https://posthog.com/docs/data/actions) in your project, you can target a survey to users whose activity can be classified by the action. This feature only works for Surveys of type "Popover".

<ProductScreenshot
    imageLight="https://res.cloudinary.com/dmukukwp6/image/upload/survey_conditions_light_7497613100.png"
    imageDark="https://res.cloudinary.com/dmukukwp6/image/upload/survey_conditions_dark_9a3b1950e5.png"
    alt="Targeting" 
    classes="rounded"
/>
