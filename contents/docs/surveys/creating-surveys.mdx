...
There are several ways to create surveys with PostHog AI:

-   **Surveys empty state** – If you don't have any surveys yet, the empty state includes an AI prompt input where you can describe what you want to learn from your users.
-   **Survey creation wizard** – When creating a new survey, the template selection step includes an AI prompt input at the bottom. Describe your survey and click **Create with AI**.
-   **PostHog AI side panel** – Click **PostHog AI** in the top right corner of the PostHog app and describe what kind of survey you want to create.
