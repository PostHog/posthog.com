...
import surveyInsightsLight from '../../images/docs/surveys/survey-insights-light-mode.mp4'
import surveyInsightsDark from '../../images/docs/surveys/survey-insights-dark-mode.mp4'
import surveyResultsLight from '../../images/docs/surveys/survey-results-sample-light-mode.png'
import surveyResultsDark from '../../images/docs/surveys/survey-results-sample-dark-mode.png'
