...
import targetingLight from '../../images/docs/surveys/targeting-options-light-mode.png'
import targetingDark from '../../images/docs/surveys/targeting-options-dark-mode.png'
