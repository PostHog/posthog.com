---
title: Use Surveys over PostHog MCP
sidebar: Docs
showTitle: true
---
...
You can also [configure it manually](/docs/model-context-protocol#get-started-in-30-seconds). Reading surveys needs the `survey:read` scope; creating, editing, launching, and stopping them needs `survey:write`.
