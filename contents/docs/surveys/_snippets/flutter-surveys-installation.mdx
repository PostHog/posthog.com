...
> **Important:** For Flutter Web, surveys are powered by the JavaScript Web SDK, so any Flutter-specific survey configuration will be ignored. Please refer to the [Web installation guide](/docs/surveys/installation?tab=Web) for proper setup.
...
- On Web, surveys are powered by the [JavaScript Web SDK](/docs/surveys/installation?tab=Web).
