...
Using it requires PostHog's Flutter SDK version >= 5.7.0, but it's recommended to always use [the latest version](/docs/sdk-doctor).
...
- Requires PostHog Flutter SDK version >= 5.7.0
