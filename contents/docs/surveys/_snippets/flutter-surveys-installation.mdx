...
> 🚧 **Note:** Mobile surveys for Flutter is currently in **beta**. We'd love to hear your feedback on betas via the [in-app support panel](https://us.posthog.com#panel=support%3Afeedback%3Asurveys%3Alow%3Atrue) or one of our other [support options](/docs/support-options).

Using it requires PostHog's Flutter SDK version >= 5.4.1, but it's recommended to always use [the latest version](/docs/sdk-doctor).
