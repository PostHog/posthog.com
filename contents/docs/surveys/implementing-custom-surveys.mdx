...
For collecting thumbs up/down feedback on AI responses and linking feedback to LLM traces, see [Collecting feedback](/docs/llm-analytics/collecting-feedback) in the LLM Analytics docs.
