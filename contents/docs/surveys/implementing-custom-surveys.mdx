...
> **Note:** This is **not required** for [popover surveys](/docs/surveys/creating-surveys#presentation).

If you're using PostHog's [survey API](/docs/surveys/creating-surveys#presentation) to create a custom survey UI, there are 2 steps to integrating with PostHog:
