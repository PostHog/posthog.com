  ...
  return (
    <div className="App">
      ...
      <div className="survey-controls">
        <button onClick={handleForceShowSurvey}>Force Show Survey</button>
      </div>
    </div>
  );
}
...
function App() {
  ...
  return (
    <div className="App">
      <h1>Survey Tutorial with PostHog</h1>
      <div className="survey-controls">
        <button onClick={handleShowPrefilled}>Show Pre-filled Survey</button>
      </div>
    </div>
  );
}
...
function App() {
  ...
  return (
    <div className="App">
      <h1>Survey Tutorial with PostHog</h1>
      <div className="survey-controls">
        <button onClick={handleForceShowInlineSurvey}>Force Show Inline Survey</button>
      </div>
...
function App() {
  ...
  return (
    <div className="App">
      <h1>Survey Tutorial with PostHog</h1>
      <div className="survey-controls">
        <button onClick={handleRenderSurvey}>Render Survey</button>
      </div>
      <div id="survey-container">
        <p>Survey will render here</p>
      </div>
...
The `appearance` object includes the following optional fields for multi-question surveys:

- **`allowGoBack`** - When `true`, displays a back button allowing users to navigate to previous questions
- **`backButtonText`** - Custom text for the back button (defaults to "Back")

The `translations` object can contain localized versions of translatable text keyed by language code, including `submitButtonText` and `backButtonText`.
