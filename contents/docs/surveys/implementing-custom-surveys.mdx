...
If you have a survey with multiple questions, you can capture the responses to each question using both ID-based and index-based properties for backwards compatability:
