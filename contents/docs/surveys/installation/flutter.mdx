...
Using it requires PostHog's Flutter SDK version >= 5.8.0, but version 5.14.0 or later is recommended for the latest survey customization features. See [the latest version](/docs/sdk-doctor).
