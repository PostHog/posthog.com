...
It can be useful to receive notifications whenever a user responds to your survey. For example, messages containing their response can be sent to [Slack](/tutorials/slack-surveys), Discord, or Teams. 
