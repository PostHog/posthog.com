...
Currently [we do not support dynamic cohorts in flags](/docs/data/cohorts#can-you-use-a-dynamic-behavioral-cohort-as-a-feature-flag-target) which is why you might see an error if setting a person property that contains a dynamic cohort in your survey.

Dynamic cohorts aren't supported yet, upvote this [issue](https://github.com/PostHog/posthog/issues/19031) if that would be useful for you.
