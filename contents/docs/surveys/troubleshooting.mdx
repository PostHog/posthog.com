...
Whenever someone responds to or dismisses a survey, we add a user property (if person profiles are enabled). For now, you can use this property to exclude users from targeting by adding these properties to your existing conditions, like so:
