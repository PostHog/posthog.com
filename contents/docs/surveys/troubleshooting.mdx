...
Whenever someone responds to or dismisses a survey, we add a person property (if you are capturing person profiles). For now, you can use this property to exclude users from targeting by adding these properties to your existing conditions, like so:

![Survey user targeting](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/images/docs/surveys/user-targeting.png)
