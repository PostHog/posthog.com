...
For each event in the [configuration page](https://posthog.com/docs/customer-analytics/configure-your-dashboard), there's a sparkle button right beside the event name. Clicking the button will pre-fill PostHog AI with a prompt to identify that specific event.
