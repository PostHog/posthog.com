...
<!--TODO: Maybe add a screenshot highlighting the b2c/b2b button?-->
...
[Product analytics](/docs/product-analytics) is for understanding user behavior in aggregate—funnels, trends, retention across your user base.

Customer Analytics is for understanding individual customers: their activity, engagement, and context. It's designed for when you need to know "who are my best customers?" or "what's going on with this specific account?"
