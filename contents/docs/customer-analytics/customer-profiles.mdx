...
Accessing customers from insights and other products will also land in their profile page.
...
The journey node displays a flow diagram with your funnel steps:

- **Completed steps** show green checkmarks
- **Incomplete steps** show X icons
- **Optional steps** appear with dashed lines and an "(optional)" label
...
This helps you see where a customer dropped off in your conversion flow, or confirm they completed key milestones like signing up, activating, or upgrading.
