...
You can switch between different journeys using the dropdown selector in the node. If no journeys are configured, click **Configure journeys** to set them up. See [how to create customer journeys](/docs/customer-analytics/create-customer-journeys) for a step-by-step guide.
