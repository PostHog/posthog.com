...
If you already have captured events, you can use [PostHog AI](https://posthog.com/docs/customer-analytics-configure-dashboard-with-ai) to help you figure out what events to use.
