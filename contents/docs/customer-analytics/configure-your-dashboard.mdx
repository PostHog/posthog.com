...
If you already have captured events, you can use [PostHog AI](/docs/posthog-ai/overview) to help you figure out what events to use.
...
Click on any customer in the dashboard to open their [customer profile](/docs/customer-analytics/customer-profiles), where you can see their full activity history, errors, and support tickets.
