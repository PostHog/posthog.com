...
If you haven't set up group types yet, [multi-tenant apps](/docs/product-analytics/multi-tenant-apps) covers how to model your customer accounts so they show up here.
