...
<CalloutBox icon="IconInfo" title="Want to create a new journey?" type="fyi">
    See <a href="/docs/customer-analytics/create-customer-journeys">Create customer journeys</a> for step-by-step instructions.
</CalloutBox>
