...
[Customer profiles](/docs/customer-analytics/customer-profiles) consolidate everything about a customer in one place: their events, [errors](/docs/error-tracking), [LLM traces](/docs/llm-analytics), and support tickets.
