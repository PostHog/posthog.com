...
- Use [PostHog AI](https://posthog.com/docs/customer-analytics/configure-dashboard-with-ai) to help you find the events
...
[Create usage metrics](https://posthog.com/docs/customer-analytics/create-usage-metrics) to track custom activity for each interaction they have with your product. These appear on customer profiles and help you identify power users and churn risks.
...
[Customer profiles](https://posthog.com/docs/customer-analytics/customer-profiles) consolidate everything about a customer in one place: their events, [errors](/docs/error-tracking), [LLM traces](/docs/ai-engineering/observability), and support tickets.
