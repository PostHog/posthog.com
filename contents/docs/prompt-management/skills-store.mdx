...
When someone visits this URL, the file viewer automatically expands, loads the file content, and scrolls it into view. The `file` parameter takes the exact path shown in the skill's file list.
