...
- **Want to be notified?** Add a [scout](/docs/replay-vision/scouts) that writes a scheduled digest of a scanner's findings, or an [alert](/docs/replay-vision/alerts) that fires when a condition is met – both can post to Slack or a webhook.
