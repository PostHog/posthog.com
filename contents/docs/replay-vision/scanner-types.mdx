...
<CalloutBox icon="IconInfo" title="Replay Vision is in closed beta" type="warning">

Replay Vision is in closed beta and not yet available to everyone. <a href="/replay-vision">Join the waitlist</a> to get access.
