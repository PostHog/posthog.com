...
Reach for a **scanner alert** when you want the finding itself, with links straight to the matching sessions. Reach for an **insight alert** when you want a threshold on a metric derived from observations, combined with other data in PostHog's [SQL](/docs/product-analytics/sql).
