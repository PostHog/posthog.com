...
{/* SCREENSHOT: bulk-scan-recordings – the recordings list with three recordings selected, the selection menu open, "Scan these recordings" hovered with the scanner submenu expanded. */}
