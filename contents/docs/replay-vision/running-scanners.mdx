...
> **Tip:** When you first create a scanner, the observations table is empty until the first background sweep runs. If you want immediate results, use the **Scan a recording now** link in the empty state to jump to the [on-demand tab](#on-demand-on-recordings-you-pick) and trigger a scan manually.
