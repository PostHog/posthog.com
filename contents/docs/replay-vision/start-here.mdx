...
Once it finishes, the observation shows up on the scanner's **Observations** tab and as a notification on the replay you scanned. Open it to see the structured result.
...
- A **true/false verdict** with a confidence score.
...
You'll see a count over time of sessions the scanner flagged. From here you can chart it, drop it on a dashboard, or wire an alert. See [querying observations](/docs/replay-vision/querying-observations) for more patterns.
