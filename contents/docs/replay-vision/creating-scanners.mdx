...
2. [Run it on-demand](/docs/replay-vision/running-scanners#on-demand-on-a-single-recording) against 5–10 recordings you already understand.
...
Inside the scanner editor, you can ask [PostHog AI](/docs/posthog-ai) to draft a prompt by describing what you want in natural language. PostHog AI picks a scanner type, drafts the prompt, and fills it into the form for you to edit.

{/* SCREENSHOT: posthog-ai-prompt-drafter — scanner editor with the PostHog AI chat panel open; user has typed "find sessions where someone tries to use a coupon code and it fails" and PostHog AI has drafted a monitor prompt and filled it into the form. */}
...
- **Monitor** – choose whether the model can return `inconclusive` instead of being forced to pick yes/no.
