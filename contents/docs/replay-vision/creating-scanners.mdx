...
The scanner editor shows a **per-month estimate** of how many observations the scanner will produce, based on your project's recent recording volume, the filters you've set, and the sampling rate. Use this to size the scanner against your [quota](/docs/replay-vision/quota-and-limits) _before_ saving.
...
Findings are emitted as signals to the [self-driving inbox](/docs/start-here/inbox/sources), where Responder agents can pick them up, research the issue against your codebase and product data, and potentially open a PR.
