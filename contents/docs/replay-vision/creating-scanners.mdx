...
A prompt usually needs a few rounds before it returns what you want. Post yours in the [PostHog Discord](https://discord.gg/posthog) to get a second opinion, and to see the prompts other teams run.
