...
Findings are emitted as signals to [PostHog Code Inbox](/docs/posthog-code/inbox/sources), where Responder agents can pick them up, research the issue against your codebase and product data, and potentially open a PR.
