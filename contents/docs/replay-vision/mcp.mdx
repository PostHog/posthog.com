...
- `vision-scanners-prompt-suggestions-dismiss` – dismiss it without changing the scanner.

### Scouts and alerts

[Scouts](/docs/replay-vision/scouts) and [alerts](/docs/replay-vision/alerts) are managed in the app, on a scanner's **Scouts** and **Alerts** tabs – there are no MCP tools for them yet.
