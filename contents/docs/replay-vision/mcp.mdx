...
- `vision-scanners-impact-retrieve` – get how many sessions and users a scanner's findings affected over a trailing window.
- `vision-scanners-affected-cohort-create` – save those affected users as a static cohort, usable in funnels, surveys, experiments, and more.
