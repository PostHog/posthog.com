...
The [inbox](/docs/self-driving/inbox) is the autopilot version of PostHog Code. Connect signal sources like Error Tracking, Support tickets, Session Replay, GitHub issues, or Linear issues.
