...
PostHog Desktop can reason with product data while it works. As you write code or stage a diff, the [enricher](/docs/posthog-code/posthog-integration#enricher) detects PostHog SDK calls and pulls live data from your project.
