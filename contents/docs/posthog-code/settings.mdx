...
Control how PostHog Code alerts you when an agent finishes or needs input. Options include desktop notifications, dock badge, dock bounce, and a completion sound. Pick from 11 sounds and adjust the volume with an inline test button.

For push notifications on cloud runs, install the PostHog Code mobile app. You'll get notified when tasks finish, fail, get cancelled, or need input.
