...
Set a team-level default Slack channel where all Inbox notifications get posted. When an issue arrives, the relevant Slack user is tagged in the channel. Per-user notification settings still apply alongside the team channel.
