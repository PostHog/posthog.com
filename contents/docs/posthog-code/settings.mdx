...
Connect GitHub and toggle which data sources feed your [Inbox](/docs/posthog-code/inbox). The agent automatically starts tasks assigned to you at any priority level.
