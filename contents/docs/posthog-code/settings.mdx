...
Connect GitHub, toggle which data sources feed your [inbox](/docs/start-here/inbox), and set a priority threshold (P0 through P4) that controls when the agent auto-starts tasks assigned to you.
