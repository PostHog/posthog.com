...
Inbox uses signal sources to find work worth investigating. A signal can be a production error, a support conversation, a session replay pattern, a log alert state change, a Replay Vision scanner finding, or an issue from an external tracker.
