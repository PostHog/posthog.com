...
Repo-bound tasks – anything that opens a PR – require your personal GitHub integration. This ensures the agent opens pull requests under your identity, not the PostHog app's.

If you haven't connected your personal GitHub, the bot posts a message with a **Connect GitHub** button linking to your integration settings. Connect it, then mention the bot again to continue.

Tasks that don't touch a repo (like answering analytics questions or chatting) work without a personal GitHub connection.
...
<<<<<<< HEAD
If you send a follow-up mention without naming a repo (like "should be there now" after connecting GitHub), the bot checks the last 10 thread messages to find the repo you mentioned earlier. You don't need to repeat the repo name every time.
