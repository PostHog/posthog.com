...
Slack tasks consume [AI credits](/docs/posthog-ai/pricing) like other AI features. Every organization gets a monthly free tier, and you can track usage on the [billing page](https://app.posthog.com/organization/billing/usage).

If you exceed your AI credit quota, the bot won't start new tasks or accept follow-ups until you add credits. You'll see a message in the thread directing you to the billing page.
