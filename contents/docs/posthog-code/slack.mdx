...
When a mention comes in, the bot checks routing rules first and only opens the repo picker if no rule matches.

## Multi-project workspaces

If your Slack workspace is connected to multiple PostHog projects, mentions route to whichever project you've set as your default. The first time you mention the bot in a multi-project workspace without a default set, it lists the connected projects and asks you to pick one.

| Command | What it does |
|---|---|
| `@PostHog project` | Show which PostHog project your mentions route to |
| `@PostHog project <id>` | Set your default project (the bot remembers this choice) |

Your default is personal — each Slack user can route their mentions to a different project.
