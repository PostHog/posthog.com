...
Head to [PostHog Code → Slack integration](https://app.posthog.com/settings/project-posthog-code) in your project settings and click **Add to Slack**. Approve the requested scopes - you'll need to be a project admin to install.

<ProductScreenshot
    imageLight="TODO: upload screenshot of the Slack integration panel in project settings with the Add to Slack button"
    classes="rounded"
    alt="Adding the PostHog Slack app to a project from the Slack integration settings"
/>
...
PRs are authored under your GitHub identity, not the bot's, which means each teammate who wants to ship code needs to connect their own GitHub account once. Open your [user settings](https://app.posthog.com/settings/user#integrations) and connect GitHub.

<ProductScreenshot
    imageLight="TODO: upload screenshot of the personal GitHub integration in user settings with the Connect button"
    classes="rounded"
    alt="Connecting a personal GitHub integration from user settings"
/>
