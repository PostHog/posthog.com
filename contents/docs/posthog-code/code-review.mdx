...
To send a batch of comments to the agent, check **Add to review** before submitting each one, then **Send to agent** when you're ready. This will combine all your feedback into a single agent prompt.
