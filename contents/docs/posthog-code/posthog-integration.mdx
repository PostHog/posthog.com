...
PostHog Desktop ships a curated set of [skills](/docs/posthog-code/skills) that the agent loads automatically. They update independently of the desktop app, so you get new skills without waiting for a release.
