...
<CalloutBox icon="IconInfo" title="Quick connect link" type="fyi">

You can also connect Slack directly using the dedicated [Slack integration page](https://app.posthog.com/integrations/slack) – useful for sharing with teammates or during onboarding.
