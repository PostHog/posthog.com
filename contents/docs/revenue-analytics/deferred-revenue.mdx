...
This means future revenue is included when you query a date range that extends into the future, showing all of the revenue that will be recognized over time.
