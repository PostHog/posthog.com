...
You can query these views anywhere you work with data in PostHog, including the [SQL editor](/docs/data-warehouse/query) and [product analytics insights](/docs/product-analytics/insights).
...
The `revenue_item` view is a table containing the list of all revenue items you have in your sources. It applies [deferred revenue](/docs/revenue-analytics/deferred-revenue) and [currency conversion](/docs/revenue-analytics/common-questions#how-do-you-convert-revenue-in-different-currencies) to the data automatically.

This data is inferred both from your events and data warehouse sources. For data warehouse sources, we consider all of your invoices plus all of your invoiceless charges. You can omit invoiceless charges in the [settings](/docs/revenue-analytics/payment-platforms).
