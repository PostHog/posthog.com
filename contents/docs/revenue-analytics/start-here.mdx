...
>
  ...
  <OSButton variant="primary" asLink to="/docs/revenue-analytics/capture-revenue-events">
    Capture revenue events
  </OSButton>
...
>
  ...
  <OSButton variant="primary" asLink to="https://app.posthog.com/data-management/revenue" external>
...
<QuestLogItem
    title="Explore your revenue"
    subtitle="Recommended"
    icon="IconGraph"
>

  Once you've configured your revenue data source, your [revenue metrics](/docs/revenue-analytics/revenue-metrics) are available across PostHog. Query them in [product analytics insights](/docs/product-analytics/insights) and the [SQL editor](/docs/data-warehouse/query) using [managed views](/docs/revenue-analytics/managed-views), or ask [PostHog AI](/docs/revenue-analytics/analyze-revenue-ai) to build the analysis you need.

  <OSButton variant="primary" asLink to="/docs/revenue-analytics/managed-views">
    Explore managed views
  </OSButton>
...
>
  ...
  <OSButton variant="primary" asLink to="/docs/revenue-analytics/connect-to-customers">
...
>
  ...
  <OSButton variant="primary" asLink to="/docs/revenue-analytics/payment-platforms">
