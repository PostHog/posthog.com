...
>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/revenue-analytics/capture-revenue-events">
    Capture revenue events
  </OSButton>
...
>
  ...
  <OSButton variant="primary" asLink={true} to="https://app.posthog.com/data-management/revenue" external>
...
>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/revenue-analytics/dashboard">
...
>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/revenue-analytics/connect-to-customers">
...
>
  ...
  <OSButton variant="primary" asLink={true} to="/docs/revenue-analytics/payment-platforms">
