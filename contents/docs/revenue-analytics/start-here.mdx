...
Once you've configured your revenue data source, you can analyze your revenue in several ways:

- Use the `$virt_revenue` and `$virt_mrr` properties on persons and groups in [product analytics insights](/docs/product-analytics/insights)
- Query [managed views](/docs/revenue-analytics/managed-views) in the [SQL editor](/docs/data-warehouse/query)
- View revenue data directly on [person](/docs/data/persons) and [group](/docs/data/groups) profiles

<OSButton variant="primary" asLink to="/docs/revenue-analytics/managed-views">
  Learn about managed views
</OSButton>
