...
<iframe
    width="560"
    height="315"
    src="https://www.youtube.com/embed/XUKQvXrE96k"
    frameborder="0"
...
<center>
    <img
        src={shareDashboardAnimation}
        style={{ borderRadius: '10px', boxShadow: 'rgba(0, 0, 0, 0.35) 0px 20px 20px', marginBottom: '60px' }}
        alt="Send or share Dashboard"
    />
</center>
