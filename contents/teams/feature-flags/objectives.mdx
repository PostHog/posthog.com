...
What we will ship:
* **HyperCache + `/local_evaluation`** – Finish implementation of `/local_evaluation` powered by HyperCache <TeamMember name="Phil Haack" photo />
...
### Objective 3: UI/UX improvements (Shared goal for the whole team)
Motivation: Fix known UI issues and identify future improvements through systematic user research.

What we will ship:
* **Known issue fixes** – Address existing backlog of cohort UI bugs & UX issues
...
### Objective 4: Java SDK <TeamMember name="Dustin Byrne" photo />
Motivation: Support Java developers with an officially-supported SDK, expanding PostHog's reach to Java-based applications and teams.

What we will ship:
* **Java SDK** – Ship initial version and iterate on customer feedback

### Objective 5: SDK standardization <TeamMember name="Dustin Byrne" photo />
