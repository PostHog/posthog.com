...
- Own conversion from PostHog.com visits to the signup page. The <SmallTeam slug="growth" /> owns everything from the signup page onward, and its suggestions and requests here get more weight than requests from other teams.
