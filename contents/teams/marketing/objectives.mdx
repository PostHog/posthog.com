...
- [Docs that spark joy](#docs-that-spark-joy-andy)
- [Drive word of mouth through improving support](#drive-word-of-mouth-through-improving-support-joe)
- [Supporting CS in their sales-led activities](#supporting-cs-in-their-sales-led-activities-joe)
- [Become default analytics tool for new AI startups](#become-default-analytics-tool-for-new-ai-startups-lior)
- [Finish alternatives guides](#finish-alternatives-guides-andy)
- [Scale newsletter](#scale-newsletter-james)
- [Level up branding](#level-up-branding-lottie)
- [Ship awesome technical blogs](#ship-awesome-technical-blogs-ian)
- []
