...
- **Rationale:** We've built a successful newsletter, but we need to aim higher. We want to ship more ambitious and original articles. Our ultimate long-term goal is people should talk about Product for Engineers is the same, or similar, terms as Lenny's Newsletter. A "default" newsletter that is synonmous with quality.

- **Owned by:** Andy, Ian, and Lior

- **What we're shipping:**
  - Bar raising issues of the newsletter
  - Working toward a higher frequency of issues
  - Potentially new newsletter formats
  - Andy attempting to become a LinkedIn influencer #thoughtleader
