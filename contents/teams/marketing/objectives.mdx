...
-   **Things we could do:** Ship the essential content, guides, migration docs, website stuff, and other activties like events that will make the necessary hype.
...
-   **Planning issue:** [Track the cross-sell planning issue](https://github.com/PostHog/meta/issues/377)
