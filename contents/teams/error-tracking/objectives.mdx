...
#### Go all in on AI <TeamMember name="David Newell" />
* Implement issue autofixing
  ...
  * Build terminal based experience within the CLI
    ...
    * Test generation to prevent regressions
* Add exception capture auto instrumentation to the wizard
* Intergrations to capture exceptions for popular LLM / agent tools (e.g. Langchain)

#### Ship mobile error tracking
* [Sequencing TBD]
...
#### Research deep dive on customers <TeamMember name="Cory Slater" />
...
* Level up Node SDK (add contexts & tagging, $session_id propegation)
