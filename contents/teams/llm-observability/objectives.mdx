...
#### Goal 1: Agent-first LLM Observability

*Description*: Make LLM Observability usable directly from agents and developer workflows, not just through the product UI.

*What we will ship*:
- **MCP tools and skills** - expose core LLM Observability workflows through MCP tools and reusable skills
- **Agent-first guides** - documentation and examples for using LLM Observability without relying on the UI
- **PostHog AI integration** - bring LLM Observability capabilities directly into PostHog AI workflows
- **Agentic search** - help agents search traces and related context more effectively

#### Goal 2: Proactive LLM Observability

*Description*: Turn LLM Observability into a proactive system that surfaces issues, insights, and next steps instead of acting only as a passive dashboard.

*What we will ship*:
- **Signals integration** - emit strong LLM Observability signals into Signals pipeline for the self-driving PostHog by default
...
*Description*: Improve the connections between LLM Observability features and strengthen how LLM Observability works with the rest of PostHog.

*What we will ship*:
- **Prompts and experiments integration** - tighter connections between prompt workflows and experimentation
- **Cross-product workflows** - better glue between LLM Observability and the rest of PostHog
- **Feature discoverability** - make it easier for users to find related LLM Observability capabilities and sub-products

#### Goal 5: Reliability and performance

*Description*: Continue improving the speed, resilience, and overall quality of LLM Observability, with a particular focus on trace-heavy workflows.

*What we will ship*:
- **Trace and platform improvements** - ongoing improvements to the speed, resilience, and overall quality of core LLM Observability workflows
