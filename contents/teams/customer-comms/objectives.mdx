...
- **What we'll ship:** MaxAI v2, handbook definitions (incl. definitions of what we don't support), Zendesk improvements ([domain problem](https://github.com/PostHog/meta/issues/201), team tracking, [bounced emails](https://github.com/PostHog/company-internal/issues/1324) etc).
