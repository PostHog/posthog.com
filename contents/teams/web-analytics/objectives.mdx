...
* Finish building **cookieless prototype** (Robbie)
...
* **Define more sophisticated success metrics** to better understand how much our users value the product (Anna)
...
* The web analytics dashboard for www.posthog.com is publicly shared as a **demo on the web analytics product page**
