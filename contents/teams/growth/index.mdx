...
- Signup
  - Everything from the moment someone lands on the signup page
  - Signup flows from any surface other than PostHog.com (e.g. partner integrations, agents)
  - Conversion from PostHog.com visits to the signup page is owned by the <SmallTeam slug="website" />. We make suggestions and requests there, and they'll generally get more weight than requests from other teams.
- Activation
