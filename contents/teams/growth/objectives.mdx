...
- Work with <SmallTeam slug="platform-ux" /> to improve the sidebar experience for long-term onboarding (activation for our other products).
...
<TeamMember name="Matt Brooker" photo /> will be working on integrations with external partners to drive growth. We already have an MCP and Array but we don't closely integrate with partners.
