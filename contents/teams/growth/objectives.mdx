...
- Project homepage for a more intuitive and less overwhelming onboarding experience
- Add more products to the setup wizard
- Connecting Postgres / Stripe / Hubspot during onboarding
	- Integrate with major db providers (e.g. Supabase)
- Side quests:
