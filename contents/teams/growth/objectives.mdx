...
2. DeskHog
    - Keep using DeskHog development to learn about the agent coding frontier, around one or two afternoons a week
    - Get first batch of hardware into the hands of our most passionate users
