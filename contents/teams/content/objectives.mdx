...
* Audit and refresh most popular comparisons to ensure accuracy, consistency, developer-first positioning, LLM readability, etc.  
...
**Motivation:** Right now, performance data is scattered and often looked at in isolation. We want to introduce a structured monthly content performance review to give the team clearer visibility across products, spot trends, and use those insights to guide planning, prioritization,
...
- Migrate to Beehiiv and set up better onboarding flow, analytics, referrals, better integrated in [posthog.com](http://posthog.com) and other nice features
...
**Owner:** [Ian Vanagas](mailto:ian@posthog.com)
...
**Motivation:** Same reasons as before
...
* Jobs \+ website code to automatically keep references up to date.  
* Selectors to view references by version. This is important in the future for big organizations that are slow to upgrade.
...
**Motivation:** LLM based tools need these. Big companies looking to lock in, will want to use these. They don’t need to be pretty, but they can’t be wrong.
...
* They’re inconsistent. The information should be generally the exact same. You should be able to start in onboarding, move to docs, and then to wizard and see the same general instructions/approach. This builds trust and makes installation easier to follow.  
  ...
  * They lack clear checkpoints. No self-checking mechanisms that help readers/users/LLMs understand if they’re succeeding.
...
**Owner: [Edwin Lim](mailto:edwin@posthog.com)** 
...
<details>
<summary>10x docs contributors</summary> 

**Owner: Edwin Lim

**Motivation**: Take two. At PostHog, everybody writes documentation. So let's equip everyone with the templates, tools, and criteria to 10x their output alongside ours.

**What we'll ship:** 

* Partner with DevEx team on their POC for “mini-monorepo”.   
* An updated docs handbook with templates, tools, and style guide criteria for writing PostHog documentation  
* A set of LLM prompts to help quickly generate docs drafts
...
<details>
  <summary>Update all existing product docs to new format and structure</summary>

**Owner: Edwin Lim, [Vincent Ge], [Danilo Campos]

**Motivation**: Ugh… it’s a hassle, but the product docs should be somewhat consistent. Otherwise we run the risk of product docs drifting apart, especially after another quarter of engineers pushing and shipping. 

**What we’ll ship:** 

* Let’s keep it light and focus on rearranging content with minor rewriting  
* New sidebar structure: Overview, Getting started, Concepts, Guides, AI, and Resources  
* Start here page for each product  
* Overview page for each product

**We'll know we're successful when**:

* People agree the docs look more consistent and organized   
* Product teams are writing within the bounds of the new docs structure
...
<details>
  <summary>Shoot a "season" of YouTube videos</summary>

**Owner:** Alex & Andy

**Motivation:** We want to create PostHog superfans by shipping a bunch of fun, brand building YouTube formats as a season of videos over the course of a month of two, so we can test a bunch of different ideas at once. They'll be shot in a studio over the course of a few days for efficiency.

**What we'll ship:**

* The first ever episode of State of the Hog with James and Tim, which we'll repeat annually.  
* Three episodes of the Hackathon documentary \+ the final cut  
* Dictator or Tech Bro  
* More YouTubey content ideas with James and Tim TBD  
* Social clips and cuts for all assets

**We'll know we're successful when:** 

* We learn what formats work and which ones don't  
* We see growing engagement \+ channel subs with videos as we release more of them  
...
* Writing all product docs for all product teams. It’s not practical or efficient, we do better if we help with planning, reviewing, and organizing new docs instead \+ providing assets for making docs writing easier for them.  
