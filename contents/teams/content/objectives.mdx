...
* Enough assets to have a weekly release cadence for a period of 12 weeks. This release window will encompass things already in the edit (Hackathon); changelogs; and new content that we aim to film as much as possible in a single shooting block, that then get edited & released.
