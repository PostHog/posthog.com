...
- Integrating modeling into the PostHog MCP
  ...
  - It's not the top priority because we believe that source control and testing will act as solid guard rails for reigning in agents that will model on behlaf of customers in the near future; so, we will ship those first and then MCP and agentic stuff as a fast follow
