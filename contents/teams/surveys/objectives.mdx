...
We've started and nearly finished a couple of features our customers requested, but they are not [GA](https://en.wikipedia.org/wiki/Software_release_life_cycle#General_availability_(GA)) yet, the goal is to finish them up, gather feedback and put them in from of customers.
...
- [Partial Responses](https://github.com/PostHog/posthog/issues/19300)
    - There are Draft PRs
- [Survey Actions](https://github.com/PostHog/posthog/pull/23613)
    - Currently under a feature flag
