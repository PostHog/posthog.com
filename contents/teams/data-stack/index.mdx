...
-   Primary Personas:
    -   **Data/Analytics Engineer**
        ...
        -   They want flexibility and control of every part of the stack to ensure current reporting downstream. 
    -   **Data Analysts/Product Managers** (technical type)
        ...
        -   Data analysts and product managers are the power-users of data modeling and BI. They have the desire and the time to go significantly deeper into the data.
-   Limited focus:
    -   Product engineer
