### Improve support processes and consistently hit 90% SLA attainment (Abigail)
...
### Improve prompting in Inkeep Max (Steven)
...
### Deflect more tickets using Max AI (Ben)
...
### Improve how we search and retrieve information from internal knowledge sources (Haynes)
...
### Create SDK example apps which can be used internally by the support team (Joshua)
...
### Better analytics on tickets (Luke)
- **Rationale:** A better understanding of where what themes are coming up in tickets will allow us to understand what changes need to be made and the areas/products they need to be made in.
