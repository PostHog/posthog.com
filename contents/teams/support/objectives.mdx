...
- **What we'll ship:** A way for customers to be able to view their tickets from within the support sidebar. They should be able to see the status of the ticket, respond to the ticket directly within the sidebar, and link out to the Zendesk help center. We will get this live behind a feature flag and roll it out to customers who are keepn to test out this feature. 
- **We'll know we're successful when:** Some customers are able to reliably view the status of their tickets and respond from the sidebar.

### Develop a framework for how support apps and tools are deployed
- **Owner:** <TeamMember name="Ben Lea" photo />
- **Rationale:** Havinng a known and consistent way of deploying our support apps makes us more efficient in the development of our tooling.
- **What we'll ship:** Consider what the best approach is for deploying our support tooling and support apps. We'll come up with a framework for how we think this should be done and test it out on at least one of our apps.
- **We'll know we're successful when:** We have a clear and understood way forward for how we'd like to deploy our support apps.
...
### Explore how we can leverage PostHog AI
- **Owner:** <TeamMember name="Joshua Ordehi" photo />
- **Rationale:** Improving PostHog AI to keep up to date with the latest changes in the product helps improve PostHog AI's answers and in turn should reduce the support load.
- **What we'll ship:** Consider and design how, without updating the docs, PostHog AI can have up to date knowledge about a product's features and how it works.
- **We'll know we're successful when:** We have a POC for one product and where the knowledge of the AI is updated when the team ships a new feature / changes a feature.
