...
## What the heck is the Vibes Team?!

The Vibes Team is responsible for making PostHog _not_ feel like every other tech company. We primarily work on PostHog.com (design, copy, overall UX architecture, and development), but also try to inspire the rest of the team to think outside the box to avoid default tech company mediocrity. We also jump around in the product a bit (as time allows) to 10x parts of the experience as time allows.
...
- [#team-vibes](https://posthog.slack.com/archives/C01V9AT7DK4)
