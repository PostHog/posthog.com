...
> Who: <TeamMember name="Raúl Negrón-Otero" photo />, <TeamMember name="Georges-Antoine Assi" photo />
...
### Local stack and dev experience

> Who: <TeamMember name="Georges-Antoine Assi" photo />
...
> Who: <TeamMember name="Julian Bez" photo />, <TeamMember name="Raúl Negrón-Otero" photo />
...
> Who: <TeamMember name="Raúl Negrón-Otero" photo />
