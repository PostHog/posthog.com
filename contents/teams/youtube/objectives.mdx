...
3. **We are a benchmark.** People love what we do. They want to copy what we do. We are proud of our work. People cite our video as an example how to do video right.
...
- **What we'll ship:** 
	...
	- Focus on PostHog Code (general availability), LLM Analytics, Observability Stack (Replay, Error Tracking, Logs), but could also include 
...
- **What we'll ship:** 
	...
	- 2-3 different styles of video we cant test
...
### Ship more product engineer handbook chapters
- **Owner:** Andy
- **Motivation:** Now we've got the skeleton of the handbook live, I want to build this out so it feels more comprehensive and less of an MVP.
- **What we'll ship:** 
	- Chapters on ideal customer profiles and finding product-market fit
	- Newsletters and videos to go with those chapters
	- Additional chapters based on existing content
	- Polishing up presentation of the hanndbook so it feels less like an MVP
- **We'll know we're successful when:**