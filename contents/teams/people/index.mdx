...
| UK payroll                  	   |  Tara   	|
| Deel payroll                     	|  Tara   	|
| UK benefits & pension            	|  Tara  	|
| US benefits & 401k               	|  Carol  	|
| Onboarding & contracts           	|  Carol   	|
| State registrations              	|  Carol  	|
| System automations               	|  Tara  	|
| People systems                   	|  Carol 	|
| Total Rewards                   	|  Fraser 	|
| Performance Enablement           	|  Tara   	|
| Grievance & disciplinary process 	|  Fraser 	|
| Termination & offboarding       	|  Tara   	|
| Access & permissions governance  	|  Tara  	|
| Compliance Correspondence        	|  Carol  	|
| Insurance & Risk renewals      	|  Carol  	|
| Vendor Management               	|  Tara  	|

| **Culture**                   	   |  Owner  	|
|----------------------------------	|:-------:	|
| Swag & Merch                   	|  Kendal 	|
| Culture campaigns & recognition  	|  Kendal 	|
| Global Offsites                  	|  Kendal 	|
| Engagement surveys             	|  Kendal 	|
| DE&I initiatives                 	|  Kendal 	|
| Vendor Management               	|  Kendal 	|
| Budget Management               	|  Kendal 	|
...
Where "Ops" is mentioned this is shared responsibility of Ops Managers.
...
- UK contracts are currently done manually in Google Drive, with payroll also being run manually - our accountants load up payments in Revolut for us to approve every month. All templates are stored in the _ Legal Docs [CONFIDENTIAL]_ shared Google Drive, in the _Team_ folder. 
