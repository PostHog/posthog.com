...
description: Makers everywhere get better at building products because of PostHog
sidebar: Handbook
showTitle: true
hideAnchor: false
...
-   Conversion optimization - the <SmallTeam slug="growth" /> is monitoring how particular KPIs are doing, trying to come up with experiments, shipping features to try and improve these
