...
#### Goal 2: Prompt Management

*Description*: Complete the prompt management feature, allowing teams to manage, version, and optimize their prompts directly in PostHog.

*What we will ship*:
- **Prompts** to GA

#### Goal 3: Feature GA Releases
...
*Description*: Release our semantic clustering feature to help teams discover patterns and group similar LLM outputs automatically.

*What we will ship*:
- **Clustering** to GA - automatic grouping of similar traces and outputs

#### Goal 7: PostHog AI Integration
...
#### Goal 8: Agents Support

*Description*: Add first-class support for AI agents, enabling teams to track and analyze agentic workflows.

*What we will ship*:
- **Agents exploration** - research and design how to best support agent tracking
- **Agents implementation** - build core agent tracking functionality

#### Goal 9: Docs, Onboarding & Wizard
