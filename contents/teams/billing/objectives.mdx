...
9. **Launch an engineering-led outbound motion for high signal leads (lead: <TeamMember name="Abhischek Thottakara" />)**\
    Source and curate datasets of Entities (Company) and Contacts (Person) for: 
    - Job Switchers of existing PostHog organizations
    - LinkedIn engagers of PostHog posts
    - Brand mentions of PostHog or PostHog Competitors
    - Investigate source for product analytics stack of companies using PostHog competitors
