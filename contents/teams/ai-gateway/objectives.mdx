...
*What we will ship*:
- **100% internal traffic** – route <SmallTeam slug="posthog-ai" />, <SmallTeam slug="surfaces" />, <SmallTeam slug="agents" />, and the <SmallTeam slug="ai-observability" /> Playground through the gateway and switch off the old one
...
*Description*: Generalize our authentication and attribution solutions for <SmallTeam slug="surfaces" />, <SmallTeam slug="agents" />, and external customers.
