...
- **Goal:** Teams given access to beta can self-serve Ducklings end to end — provisioning, event data bootstrapping, and external source connector data landing in the warehouse
- **What we'll ship:**
