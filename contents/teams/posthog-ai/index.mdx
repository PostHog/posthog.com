...
To do this, we start engineers out in the PostHog AI team. They will ship whatever the current roadmap is.
...
Then the PostHog AI Team will send one of their engineers out to the other small team for one or several sprints, pairing with someone on the other team.
