...
Our other small teams will always want to make their products work well with MaxAI's interface.

To do this, we start engineers out in the MaxAI team. They will ship whatever the current roadmap is.
...
Then the MaxAI team will send one of their engineers out to the other small team for one or several sprints, pairing with someone on the other team.
...
Over time, this team should maintain a feature ownership table.

ie:

Michael -> product analytics + warehouse
Georgiy -> session replay
