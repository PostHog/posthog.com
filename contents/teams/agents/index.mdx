...
- **Agent builder** – a smooth, end-to-end experience for creating agents from wherever people already work (their CLI, the PostHog app, Slack, MCP, PostHog Desktop)
