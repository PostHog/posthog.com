...
- **Core modules** - auth, rate limiting, routing, cost, quota, dispatch, and the post-call recording path into LLM Observability
...
#### Goal 4: Land gateway calls in LLM Observability
...
#### Goal 5: Take ownership of the LLM Observability Playground

*Description*: Pick up the [LLM Observability Playground](/docs/llm-observability/playground) from <SmallTeam slug="llm-observability" /> and keep it moving as gateway capabilities grow.
