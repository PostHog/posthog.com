...
### Tool and automation consolidation <TeamMember name="Phil DelGobbo" photo />
We have lots of effective tools, alerts and processes designed across our team. Some of these are hiding in different channels, communicated ineffectively, and only being leveraged by a few team members. We should establish the key tools we want to use, and consolidate them into a single area for future team members to have a starting point.

**We'll know we're successful when**: we have a single, maintained, handbook page with key tools and automations
