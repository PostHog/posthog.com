...
We're called Words & Pictures, but that's not all we do. We think in animations, emails, events, songs, videos, vibes, and more. There's no such thing as "just a writer" or "just a designer", and everyone's feedback is valued equally on all projects.
  
### 3. We're not an 'ideas' team

You know the type of 'Ideas' person who comes up with big ideas but doesn't do anything with them, or tries to get someone else to do it? Yeah, we hate people like that too. We ship things and, whereever possible, we ship them all by ourselves. 
