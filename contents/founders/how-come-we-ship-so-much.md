...
When we started, we felt the best engineers would eventually quit if they felt dictated by product designers. [Product engineers](/product-engineer-handbook/what-is-a-product-engineer) need autonomy and freedom to enjoy their work.
...
The concept internally is a "[product engineer](/product-engineer-handbook/what-is-a-product-engineer)" – i.e. an [engineer who is product-minded and autonomous](/blog/product-engineer-vs-software-engineer), rather than mindlessly filing tickets.
