...
featuredImage: ../images/apps/variance.png
<<<<<<<< HEAD:contents/pipelines/variance-connector/index.mdx
documentation: /docs/pipelines/variance-connector
========
documentation: /docs/cdp/variance-connector
>>>>>>>> master:contents/cdp/variance-connector/index.mdx
thumbnail: ../thumbnails/variance.png
filters: {
    type: ["data-out"],
