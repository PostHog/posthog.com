...
title: Avo Inspector
featuredImage: 
<<<<<<<< HEAD:contents/pipelines/avo-inspector/index.mdx
documentation: /docs/pipelines/avo-inspector
========
documentation: /docs/cdp/avo-inspector
>>>>>>>> master:contents/cdp/avo-inspector/index.mdx
thumbnail: ../thumbnails/avo-logo.png
filters: {
    type: ["data-out"],
...
<TutorialsSlider topic="avo-inspector" />
