...
featuredImage: 
<<<<<<<< HEAD:contents/pipelines/customer-io/index.mdx
documentation: /docs/pipelines/customer-io
========
documentation: /docs/cdp/customer-io
>>>>>>>> master:contents/cdp/customer-io/index.mdx
thumbnail: ../thumbnails/customerio-connector.png
filters: {
    type: ["data-out"],
    maintainer: official
}
