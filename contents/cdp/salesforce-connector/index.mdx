...
<<<<<<<< HEAD:contents/pipelines/salesforce-connector/index.mdx
documentation: /docs/pipelines/salesforce-connector
========
documentation: /docs/cdp/salesforce-connector
>>>>>>>> master:contents/cdp/salesforce-connector/index.mdx
thumbnail: ../thumbnails/salesforce.svg
filters: {
    type: ["data-out"],
