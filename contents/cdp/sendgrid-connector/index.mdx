...
featuredImage: 
<<<<<<<< HEAD:contents/pipelines/sendgrid-connector/index.mdx
documentation: /docs/pipelines/sendgrid-connector
========
documentation: /docs/cdp/sendgrid-connector
>>>>>>>> master:contents/cdp/sendgrid-connector/index.mdx
thumbnail: ../thumbnails/sendgrid-connector.png
filters: {
    type: ["data-out"],
    maintainer: official
}
