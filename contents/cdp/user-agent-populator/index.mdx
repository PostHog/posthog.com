...
featuredImage:
<<<<<<<< HEAD:contents/pipelines/user-agent-populator/index.mdx
documentation: /docs/pipelines/user-agent-populator
========
documentation: /docs/cdp/user-agent-populator
>>>>>>>> master:contents/cdp/user-agent-populator/index.mdx
