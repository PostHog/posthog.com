...
featuredImage: 
<<<<<<<< HEAD:contents/pipelines/intercom/index.mdx
documentation: /docs/pipelines/intercom
========
documentation: /docs/cdp/intercom
>>>>>>>> master:contents/cdp/intercom/index.mdx
thumbnail: ../thumbnails/intercom.png
filters: {
    type: ["data-out"],
    maintainer: official
}
