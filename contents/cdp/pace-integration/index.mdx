...
featuredImage: 
<<<<<<<< HEAD:contents/pipelines/pace-integration/index.mdx
documentation: /docs/pipelines/pace-integration
========
documentation: /docs/cdp/pace-integration
>>>>>>>> master:contents/cdp/pace-integration/index.mdx
thumbnail: ../thumbnails/pace-integration.png
filters: {
    type: ["data-out"],
...
<TutorialsSlider topic="pace-integration" />
