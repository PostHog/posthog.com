...
For most companies, we recommend creating **three projects**: production, staging, and development. This way you can test out analytics in development and staging environments, while keeping that test data separate from production.
