...
These can be changed under organization settings -> role based access tab. You can set organizational defaults to just "view only" and restrict edit access
to certain features.
...
For even more granularity, you may set only certain individual resources to be editable by certain roles. You can set these
