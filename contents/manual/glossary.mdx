...
import InternalTerm from '../images/logos/gloss_hog.png'

PostHog is an incredibly broad platform, with many distinct features and tools. As a result, it's hugely powerful -- but can be overwhelming if you're new to product analytics. So, we've created a glossary to explain many of the most common terms and acronyms. If a term is specific to PostHog then it's marked with a Professor [Hedgehog](/manual/glossary#hedgehog) <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} /> to help reduce confusion. 

## A

#### Action <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Alias <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Annotation <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### App <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### App chain <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Contributor <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Event <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Formula <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Heatmap <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Insights <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
> We couldn't think of anything which begins with an J. If you can think of something which should go here, let us know by [making a GitHub issue](https://github.com/PostHog) or [sending us a Slack](/slack)!
...
#### Multivariate test
An [A/B test](/manual/glossary#a/b-test) which runs with more than two possible variants. You can run multivariate tests in PostHog using the [experimentation suite](/manual/experiments).
...
#### New user <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Path <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Persons <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Retention <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Returning user <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Resurrecting user <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Stickiness <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Toolbar <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
#### Trend <img src={InternalTerm} alt="Internal Term" style={{ width: 25 }} />
...
> We couldn't think of anything which begins with an Z. If you can think of something which should go here, let us know by [making a GitHub issue](https://github.com/PostHog) or [sending us a Slack](/slack)!
