...
> 🚧 **Data Management is currently in beta**. If you have any feedback, please <a href="/questions" target="_blank">reach out</a>.
...
Tags and descriptions can additionally be added to events after they are created. This makes using them in insights much easier, especially as the number of distict event types grows.
