...
On enterprise plans, you can further configure sharing to only give access to certain members within a project. Dashboards can be shared either by members with administrator priviledges, or by the dashboard creator.
