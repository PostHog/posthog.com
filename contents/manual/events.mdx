...
PostHog can capture all front-end events automatically using a small [JavaScript snippet](/docs/integrate). This means you do not need to add tracking to individual buttons, or parts of your product to get started at analyzing user behavior.
...
For example, with a notifications bell:

![a notification bell showing 1 unread notification](/images/manual/events/notification-bell.png)
