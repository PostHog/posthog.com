...
Groups are a feature within PostHog which enable you to aggregate events by an entity other than a user - such as a company, or project. 

In a sense, groups allow entities such as companies or projects to 'send' events in the same way that users can.

Groups can be used to represent almost anything, including organizations, companies, devices, posts, projects, and much more.
...
Before we start learning how to use groups, it's best to get some intuition on how they behave within PostHog.
