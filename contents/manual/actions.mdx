...
> Looking for a tutorial about how to use Actions? Check out our [guide to event tracking](/docs/tutorials/event-tracking-guide#sorting-through-your-events-with-actions).
