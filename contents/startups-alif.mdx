  ...
  <div class="max-w-screen-lg mx-auto font-bold">
    ...
    <blockquote class="text-2xl text-primary dark:text-primary-dark m-0 quote md:text-[32px] md:leading-tight">
      <span class="leading-tight">
        "Users stated preferences are often quite different from their revealed preferences. That's why we partner with PostHog: <span class="text-red">to give our startups deeper insights into which features are stickiest and which disrupt user flows</span>.”
      </span>
    ...
    <div class="flex justify-center">
      <ul class="m-0 p-0 list-none inline-grid sm:grid-cols-3 lg:grid-cols-3 justify-evenly relative text-center sm:text-left">
        <li class="relative md:max-w-md py-4 md:py-8 pl-4 pr-2 md:px-12 lg:px-8">
          ...
          <p class="m-0 text-[15px]">Pry used session replays to <a href="/customers/pry">increase new sign-ups by 30%</a>. Then they were acquired by Brex!</p>
        </li>
        <li class="relative md:max-w-md py-4 md:py-8 pl-4 pr-2 md:px-12 lg:px-8">
          ...
          <p class="m-0 text-[15px]">AssemblyAI <a href="/customers/assemblyai">switched from Mixpanel to PostHog</a> and hasn't looked back since.</p>
        </li>
        <li class="relative md:max-w-md py-4 md:py-8 pl-4 pr-2 md:px-12 lg:px-8">
