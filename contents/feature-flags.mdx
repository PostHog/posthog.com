...
productSections: [
  ...
  [
    {
      ...
      content: "Allow users to sign up to a feature waitlist to register interest.",
      align: 'center',
    },
    {
      image: ./images/products/feature-flags/release-conditions.png
      ...
      features: [
        {
            ...
            description:
                'Use release conditions to choose who gets access to a feature, e.g. targeting by user ID, email address or cohort.',
        },
      ]
    },
    {
  ...
  [

    {
      ...
      content: "Let users opt in and opt out of Beta features. Create your own custom UX so users can enable a new feature from anywhere in your product.",
      align: 'center',
    },
    {
      image: ./images/products/feature-flags/multivariate.png
...
productTestimonial: {
    "author": {
        ...
        "image": "/images/customers/joe.jpg",
        "company": { "name": "Mention Me", "image": "/images/customers/mention-me/logo.svg"}
    },
