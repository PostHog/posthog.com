...
#### Can I use PostHog Wizard if I already use PostHog?

Yes! It's perfect for trying new PostHog products. You can ask PostHog Wizard to run on any specific PostHog product like this:

<pre>
npx @posthog/wizard --llm-analytics
npx @posthog/wizard --logs
</pre>
