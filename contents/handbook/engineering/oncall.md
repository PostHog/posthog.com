...
A chunk of our high-frequency alerts have runbooks attached, most of which live [on the runbooks site](http://runbooks/). The runbook should tell you what to look at and easy fixes if there are any. Every alert also has a link to the grafana graph that triggered the alert.
