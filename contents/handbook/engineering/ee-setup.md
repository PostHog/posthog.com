...
### Option A (Recommended). Docker-based.
...
### Option B. Running Backend in Docker and Frontend locally
...
### Option C. Running Python + Webpack locally
...
### Option D. Running everything but ClickHouse locally
...
### Option E. Running ClickHouse, Kafka and Zookeeper on a Cloud Server
