...
However after testing we encountered several fundamental make this feature unusable in our case until the feature is improved. They are detailed in the issues here:
