...
We don't fully understand why our ClickHouse gets sometimes overloaded. We extensively use query's `SETTING`: `log_comment` to put JSON with bunch of metadata inside it. 
