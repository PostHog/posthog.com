...
Now, ClickHouse would generate one **partition** per 10 years of data, allowing to skip reading even the primary index
...
[this issue](https://github.com/PostHog/posthog/issues/10616) for benchmarks.
