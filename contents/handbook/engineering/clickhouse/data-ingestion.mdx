...
- [ClickHouse's not so secret weapon... Materialized Views](https://posthog.com/blog/clickhouse-vs-postgres#clickhouses-not-so-secret-weapon-materialized-views)
...
](/handbook/engineering/clickhouse/working-with-json)