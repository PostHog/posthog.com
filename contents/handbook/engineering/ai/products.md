...
Right now we're focused on dogfooding — getting the <SmallTeam slug="posthog-desktop" /> to build everything using PostHog Code itself. This lets us refine product quality and identify friction fast.
