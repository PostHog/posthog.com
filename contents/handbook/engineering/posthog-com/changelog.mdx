...
The <SmallTeam slug="brand" /> has created an image generator that takes the information from the changelog entry and creates a square image for sharing on social media. [Read the blog post](/blog/changelog-image-generator) to learn how it works.
