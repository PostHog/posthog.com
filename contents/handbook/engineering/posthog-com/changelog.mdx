...
The [changelog](/changelog) publishing process is run by the <SmallTeam slug="wizard-and-docs" />.
...
<CalloutBox type="fyi" title="Publishing process">

For more details on the publishing process, check out the [How to publish changelog](/handbook/wizard-and-docs/how-to-publish-changelog) handbook page by the <SmallTeam slug="wizard-and-docs" />.
...
The <SmallTeam slug="website" /> has created an image generator that takes the information from the changelog entry and creates a square image for sharing on social media. [Read the blog post](/blog/changelog-image-generator) to learn how it works.
