...
The [changelog](/changelog) publishing process is run by the <SmallTeam slug="docs-wizard" />.
...
For more details on the publishing process, check out the [How to publish changelog](/handbook/docs-and-wizard/changelog) handbook page by the <SmallTeam slug="docs-wizard" />.
