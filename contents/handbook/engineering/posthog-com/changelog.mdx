...
For more details on the publishing process, check out the [How to publish changelog](/handbook/wizard-and-docs/changelog) handbook page by the <SmallTeam slug="wizard-and-docs" />.
