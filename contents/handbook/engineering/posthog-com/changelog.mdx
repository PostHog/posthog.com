...
The [changelog](/changelog) is run by the [Brand & Vibes](/teams/brand) Team.
...
The [Brand & Vibes](/teams/brand) team has created an image generator that takes the information from the changelog entry and creates a square image for sharing on social media. [Read the blog post](/blog/changelog-image-generator) to learn how it works.
