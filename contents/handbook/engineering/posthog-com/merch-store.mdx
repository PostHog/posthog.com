...
We don't include these by default as sourcing the products from Shopify takes an absurd amount of time. Ask the <SmallTeam slug="brand" /> if you need these values.
