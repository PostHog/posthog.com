...
There are a few options for embedding videos, and the [style guide](/handbook/content/posthog-style-guide#adding-media) can help you decide which to use.

### Product videos

Th `<ProductVideo />` component works the same as product screenshots (above) for videos [uploaded to Cloudinary](/handbook/content/posthog-style-guide#adding-media) but supports light and dark videos. It's best for short videos.
