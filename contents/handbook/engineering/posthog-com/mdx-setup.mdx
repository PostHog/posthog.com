...
> Currently, almost every component on the site is available automatically. This will eventually change because it causes some performance issues. For now, if you need a reference for which components you should be using in your MDX, check out our [MDX components handbook page](/handbook/engineering/posthog-com/markdown).
