...
-   Log in to posthog.com
-   Visit posthog.com/roadmap
-   Click the **+** button at the top of the window

![plus button at top](https://res.cloudinary.com/dmukukwp6/image/upload/w_1600,c_limit,q_auto,f_auto/Clean_Shot_2025_10_06_at_10_35_24_2x_c59b4ef7e6.png)
...
Used to show album art for roadmap items under the “In progress” section. Images should be square, at least 200 x 200 pixels, and not contain any borders or shadows. Images are optional. If you need a new image, [request it through the normal process](/handbook/brand/art-requests).
...
Only appears when editing an existing roadmap item. See the [notifying roadmap subscribers section](#notifying-roadmap-subscribers) for more info on how to use this feature.

## Notifying roadmap subscribers

-   Visit the item in the roadmap
