...
Visit [the roadmap](/roadmap) and click the _Add a feature_ button (available to the PostHog team only)
...
#### Image
Used to show album art for roadmap items under the “In progress” section. Images should be square, at least 200 x 200 pixels, and not contain any borders or shadows. Images are optional. If you need a new image, [request it through the normal process](/handbook/words-and-pictures/art-requests). 
