...
PostHog.com is built and maintained in-house by the <SmallTeam slug="website" />. You've probably never seen a Gatsby.js site like this before. <TeamMember name="Eli Kinsey" photo /> is the mastermind behind how the site is structured.
