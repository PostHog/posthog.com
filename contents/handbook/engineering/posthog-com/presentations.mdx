...
In the above example, it uses the "[`home`](https://github.com/PostHog/posthog.com/blob/6b6eae68e9d5b8665b082d7809edfe645db4215f/src/hooks/productData/llm_analytics.tsx#L64)" screenshot from the `ai_observability` product:
...
```
/ai-observability?thumbnails=false&notes=false&form=true
```
