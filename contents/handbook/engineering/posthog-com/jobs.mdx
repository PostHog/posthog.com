...
#### Benefits
This section appears on all job postings. The data in this section can be updated in the [Careers benefits component](https://github.com/PostHog/posthog.com/blob/master/src/components/Careers/Benefits/index.tsx).
