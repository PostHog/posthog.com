...
See the <SmallTeam slug="brand" /> [small team page](/teams/brand) as an example of how it will look.
...
This requires coordination with the <SmallTeam slug="brand" /> team, as updating team names involves changing slugs which will break builds if not done in the correct order. Ask in <PrivateLink url="https://posthog.slack.com/archives/C08UABF7PB7">#posthogdotcom</PrivateLink> team for help.
