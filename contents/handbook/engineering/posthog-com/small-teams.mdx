...
1. Add the [placeholder crest](https://www.figma.com/design/QCYxjm4wVVVvs6UA27xRmz/Website-art?node-id=2043-2&t=aO62tCO12PoIZMt9-1) with the new team's name on it
1. Go to small team members' profiles, add them to the team, remove from other teams, and assign the tema lead
1. Publish the changes to the team record
...
1. Add the team's name to `src/navs/index.js` under the `companyMenu` section in alphabetical order under the _Engineering_ or _Not engineering_ heading
1. Rebuild the site (after the Strapi configuration) to see the new page
...
1. Add the small team's mission on their page once the site is built
1. Add the team's feature ownership to the [feature list](/handbook/engineering/feature-ownership)
