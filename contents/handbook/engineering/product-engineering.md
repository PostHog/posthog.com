...
* the product improves - we do a better job at building what users want
* we get marketing benefit - the user will be impressed and will tell their friends
* we get more feedback - it teaches people that we listen and that we care 

Ton matters a lot. Whenever you are messaging a user, please consider:

* They're on the internet - you are competing with cat videos. It better be compelling.
* They receive a crap ton of outreach from people - if you send something generic, it will get auto filtered out by their brain.
...
Look for evidence that users have _actually done anything_ about the problems they say they have. People want to be likeable - when you talk to them, this means they'll ofen say they want what you're working on, even if they don't. Lots of features or products are nice to have versus must have. When something is a nice to have, people will act interested but won't get around to actually using it. Ask things like:
