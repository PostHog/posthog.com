...
>4. Can you please share the logs from the affected pods?
>5. Do you have any kind of monitoring configured? (if not, you’ll need to configure this so we can debug in the future - Grafana is enabled by default [here](https://github.com/PostHog/charts-clickhouse/blob/a9df027e32456b5ac3b155515dc2569626632ba7/charts/posthog/Chart.yaml#L56-L60) in the chart)
>6. How many events are in clickhouse, and how many ingested last month?
