...
**Other team members** can answer community questions either:
- Directly on the community platform (if you prefer)
- Through Zendesk (if you have access)
...
- The Website & Docs team can help configure Slack notifications for your team channel
- You can subscribe to specific topics by clicking the bell icon next to the topic's title to receive daily email summaries
- You'll find open threads in your personalized [community dashboard](/community/dashboard) (when signed in)

If you answer a question and it needs follow-up later, tag it with `Internal: follow-up` and the Website & Docs team can make sure there's a resolution.
