...
PostHog community members can earn achievements for various activities. Assigning, revoking, and manually creating new achievements is all handled in [Strapi](https://squeak.posthog.cc/admin).

### Creating a new achievement

1. Login to [Strapi](https://squeak.posthog.cc/admin) (Request an account from [Eli](/community/profiles/3) or [Cory](/community/profiles/2) if you don't already have one)
