...
| LLM Observability | [/docs/llm-observability/changelog](/docs/llm-observability/changelog) |
| Feature Flags | [/docs/feature-flags/changelog](/docs/feature-flags/changelog) |
| ... | ... |

### Option 3: Automated drafting via Slack reaction

The <SmallTeam slug="docs-wizard" /> team uses an automated flow to draft changelog entries directly from Slack.
...
3. The draft opens as a new issue in the <PrivateLink url="https://github.com/PostHog/changelog-drafts">changelog-drafts</PrivateLink> repo.
...
- <PrivateLink url="https://run.relay.app/workflows/cmo3adnn905yn0qm0dotagvof/edit">Relay workflow for automated changelog drafts</PrivateLink>
