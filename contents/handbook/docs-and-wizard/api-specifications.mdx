...
PostHog's API specifications are (mostly) generated automatically from the OpenAPI spec. We have tooling to generate the API specification markdown files from the OpenAPI spec.
