...
Developers love the [wizard](/docs/ai-platform/ai-wizard): it's the fastest way to get a deep, correct integration of PostHog, with none of the hallucinations that come from naive agent-based attempts.
