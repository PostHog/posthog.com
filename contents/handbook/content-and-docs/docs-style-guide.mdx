...
> **Do:** Under **Settings** > **Product analytics** > **Date & time**, under **Time zone**, select your timezone.

> **Don't:** Under **Settings** > **Product analytics** > **Date & time** > **Time zone** > select your timezone.

If the flow is complex, consider [adding a video](#record-video).
