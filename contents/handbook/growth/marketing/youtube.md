...
Although videos were driving X00s of views each (some hit X000s), and we received some positive feedback, we didn't see an increase to signups, traffic, or mentions from the videos. For example, a the video on [why and how we use GitHub as our CMS](https://www.youtube.com/watch?v=Z2-dSM2i2_Y) got 3,000 views in 1 one week, but made no noticable impact on signups.
...
- Lighting is what makes the most difference on video quality.
...
- Only 2.5% of video traffic came from `posthog.com`. 60% was came from YouTube features like search, channel pages, or recommendations.
