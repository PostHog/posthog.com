...
![PostHog webshare pricing experiment](https://res.cloudinary.com/dmukukwp6/image/upload/v1710055416/posthog.com/contents/handbook/images/customers/webshare/webshare-pricing.png)
