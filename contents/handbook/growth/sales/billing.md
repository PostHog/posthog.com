...
1. For annual paid up-front customers, that have not made payment and their due date has passed.  Usually this is 30 days from the contract start date (Net 30) although can differ based on other contracual terms.
...
In either of the above scenarios the account owner as defined in Vitally needs to take action to ensure that payment is made. If you are an AE, remember this also has impact on your commission, as we don't pay out until the customer has paid their invoice.
...
> Make it clear in this outreach that if we don't receive payment in the next 7 calendar days, their user access will be suspended.
