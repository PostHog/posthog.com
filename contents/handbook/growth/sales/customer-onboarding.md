...
Some customers may wish to use MS Teams rather than Slack. With Pylon we can support this, first you will need an MS Teams licence, ask Simon for this. Then, follow the instructions on the link here to get set up - https://docs.usepylon.com/bridges/microsoft-teams/setup.
