...
As a Technical Account Manager, you'll spend as much time managing your existing book of business as you will closing [product-led leads](/handbook/growth/sales/product-led-sales). Your first priority is retaining them - this is counter balanced to an upwards Land, Expand, Retain motion. We have to work twice as hard if we're trying to close new deals and make up for lost customers. You'll typically be assigned a bunch of customers who are paying monthly - this means they could turn off PostHog at any time. 
...
An overview of how to drive expansion with a customer can be found in the [cross-selling](/handbook/growth/cross-selling/how-we-upsell-and-cross-sell) pages. 
