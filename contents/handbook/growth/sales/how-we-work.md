...
As a TAM, we expect you to get in front of customers in person on a regular cadence. As a baseline:

- **Visit local customers (those near you) once a quarter.** If a customer is within easy travelling distance, there's no excuse not to see them regularly.
...
These are minimums, not limits — if it makes sense to see a customer more often, do it. Use your judgement, be sensible with spend, and prioritize the trips that will have the biggest impact on retention and expansion.
