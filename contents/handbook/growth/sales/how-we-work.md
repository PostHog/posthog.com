...
Each TAM manages a book sized by ARR under management: $1.5M to $2M, which usually works out to 12-18 accounts. See [TAM book balance](/handbook/growth/sales/account-allocation#tam-book-balance) for the full composition targets. Additionally, you will manage inbound leads as they are assigned to you in your territory. Staying extremely focused is important.
...
6. Your `AM Managed` book should hold $1.5M-$2M in ARR, usually 12-18 accounts (see [TAM book balance](/handbook/growth/sales/account-allocation#tam-book-balance)). There is some wiggle room here, but well past those bounds you won't be able to give accounts the focus we expect from a TAM, so be prepared to rebalance with your team lead.
