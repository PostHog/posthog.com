...
If a customer requests to use a non-PostHog drafted contract for DPA, MSA, Order Form or BAA generally we avoid doing this as it adds too much risk for us. We usually would not even consider this for deals not above $100k or for extremely blue chip companies like Apple etc. It is best to manage this expectation early and just avoid entertaining the idea with customers as soon as possible. An exception to this rule is for NDAs usually we are totally fine to sign a companies NDA. 
