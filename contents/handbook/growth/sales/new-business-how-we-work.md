...
If a new customer needs a migration or a first implementation, consider offering a [forward deployed engineering (FDE) engagement](/handbook/forward-deployed-engineering/working-with-sales-and-cs#where-fde-fits-in-the-customer-lifecycle) before handover.
