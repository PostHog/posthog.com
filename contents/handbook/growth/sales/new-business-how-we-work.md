...
- Our [forward deployed engineering (FDE) team](/handbook/forward-deployed-engineering/overview) can build custom requests with the customer, run migrations, set up their instrumentation, and more. These engagements are usually paid and scoped to the customer's specific needs. See [how to get an FDE involved](/handbook/forward-deployed-engineering/how-to-get-fde-involved).
