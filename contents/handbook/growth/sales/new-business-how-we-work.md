...
- Our [Forward Deployed Engineering (FDE) team](/handbook/forward-deployed-engineering/working-with-sales-and-cs#where-fde-fits-in-the-customer-lifecycle) can help customers build out custom requests, run managed migrations, setup their instrumentation and more. These engagements are billed and there to cater customer specific requests.
