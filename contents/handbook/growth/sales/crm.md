...
We use [Clearbit](https://clearbit.com/) to enhance our contact information as they are created and then compute a score out of 25 in [HubSpot](https://app.hubspot.com/property-settings/6958578/properties?action=edit&property=hubspotscore&search=score&type=0-1) based on the following parameters:
...
| Customer type  | B2B                                                                                                              | 5     |
|                | B2C                                                                                                              | 2     |
| Country        | Not in target country list                                                                                       | -7    |

We also sync the HubSpot score back into PostHog as the `hubspot_score` person property using the [HubSpot App](https://posthog.com/apps/hubspot-connector).
