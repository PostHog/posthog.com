...
PostHog is a broad product suite with [common combinations](/handbook/growth/sales/expansion-and-retention#how-to-run-a-cross-sell-process) depending on the use case. Discovery can help us provide customers with a better experience by understanding their specific needs so we can:
...
- Zoom / Phone
- Email
- [Shared Slack channel](/handbook/growth/sales/slack-channels)
...
[Demoing PostHog](/handbook/growth/sales/new-sales#3-initial-demo) is an important part of our sales process and how we first introduce PostHog to customers. It brings immediate value to a call, is consistent with other messaging and builds credibility with technical folks. 
...
- Demo of Experiments: _Showing Experiment dashboard_
  - Questions: "How are you currently cross-reference test results with other user-behavior data?"
...
- **Requesting a BAA/DPA** - We built both a BAA and DPA generator where customers can self-serve. If a customer wants to [vary any terms](/handbook/growth/sales/contract-rules#varying-terms), we can review changes if the contract is above <$20k/year
...
- **Need self-hosted** - PostHog's [self-hosted](/docs/self-host/open-source/disclaimer) open-source deployment is made for hobbyists and since we're a small team, we can only provide limited support for it
...
- [Overview](/handbook/growth/sales/overview)
