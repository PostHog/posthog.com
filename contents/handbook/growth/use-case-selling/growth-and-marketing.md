...
- **[Customer Analytics](/docs/customer-analytics)** – Customer profiles, journeys, and usage metrics, with a B2B mode. Where Product Analytics answers "what did users do," this answers "how is this account doing" – the view a growth team at a B2B company actually needs for expansion and churn plays.
