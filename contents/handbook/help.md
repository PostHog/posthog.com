...
## Lore of PostHog / in jokes

A beginner's guide to the Slack emoji and various anecdotes you'll see and hear about.

* :yakko-internet: Yakko always had bad internet when demoing. _Always_.
* Jams wore a skin tight green all-body suit for months to improve his zoom background game without us realizing.
* :ben-peace: Ben has the same pose in 90% of PostHog photos. It's a reference to a meme.
* :hype-X: / :X-hype: where X is a team member. Used in times of extremely impressive performance, unless used sarcastically.
...
* :spark_joy: / :does_not_spark_joy: a reference to [Marie Kondo's book](https://konmari.com/marie-kondo-rules-of-tidying-sparks-joy/) on tidying your house, generally used to describe things that are particularly good or bad from a user's perspective
* :eu-thumbsup: we once made [isgoogleanalyticsillegal.com](https://www.isgoogleanalyticsillegal.com/) when there were privacy rulings about Google Analytics. We put it on HN, got the top of the front page and it was our biggest _ever_ day of signups at the time. The website was supposed to be tongue in cheek but the internet took it seriously. The person in the emoji is Ursula von der Leyen who introduced the GDPR legislation.
