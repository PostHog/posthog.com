...
> This guide explains how to onboard a new product manager at PostHog.
>
> If you're looking for what the role involves day to day, see [What product managers do at PostHog](/handbook/product/product-manager-role).

## People relevant in a new PM's onboarding
...
- [First 6 months success criteria](#first-6-months-success-criteria)
- [Onboarding week schedule](#onboarding-week-schedule)

In addition to the two artifacts above, there are a couple of other items to set up, including:
- Invite PM to relevant Slack channels (#pm, team channels, ...)
- Invite PM to PM brownbag, PM standup, PM book club & the PM Google group
- Add the PM to the [PM sprint planning](https://github.com/PostHog/company-internal/blob/master/.github/ISSUE_TEMPLATE/new-pm-sprint.md) and [monthly growth review](https://github.com/PostHog/requests-for-comments-internal/blob/main/.github/ISSUE_TEMPLATE/growth-review-summary-template.md) templates
...
This section covers *how* the onboarding buddy supports the new PM through this period. For the *goals* we set over the same window, see [First 6 months success criteria](#first-6-months-success-criteria).
