...
2. Show examples in real context
...
This means we should include details beyond references and technical implementations. We should share examples, use cases, and the reasons **why** they should use a product or feature. 
