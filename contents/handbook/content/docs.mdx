...
const posthog = require('posthog-node') // TIP: 
...
The in-context example is longer but more useful. It shows how PostHog fits into application logic, which helps developers understand *when* and *how* to use it. Concerns about length can be addressed with UI features like syntax highlighting, collapsible code blocks, and inline comments to keep code scannable.
