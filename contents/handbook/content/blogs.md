...
- **Add internal links.** Run the `/suggest-links` command in the posthog.com repo. The [SEO guide](/handbook/content/seo-guide) covers how many to add and what anchor text to use.
