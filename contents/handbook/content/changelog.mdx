...
The content team (specifically, <TeamMember name="Edwin Lim" photo /> and <TeamMember name="Vincent Ge"  photo />) writes changelog entries on a weekly basis and publishes them at the end of a week on the [changelog](/changelog) page.

Changelog videos are produced by <TeamMember name="Jordo Dibb" photo /> on a **bi-weekly** basis.
...
| Day | Task |
|-----|------|
| Monday - Wednesday | Write up <PrivateLink url="https://drive.google.com/drive/folders/1l5qWyMkm2EhwO1WXUL2UVgILqz3N6NPq?usp=drive_link">changelog entries</PrivateLink> that should be added to the website over the _past week_. With help from the video team, decide which of those entries are video worthy. |
| Thursday/Friday | Update PostHog's [changelog page](/changelog) with new entries. |
| Thursday/Friday | Capture necessary screen recordings of that week's video entries and upload them <PrivateLink url="https://drive.google.com/drive/folders/1tYiRQMFIXZy7Lx3DcekB74PL6rezZFCt?usp=drive_link">for Jordo</PrivateLink>. |
