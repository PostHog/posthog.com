...
<CalloutBox icon="IconWarning" title="Keep it simple" type="caution">

Decision trees can easily grow far too complex, so keep your logic minimal. Aim for 2-3 questions max with 5-6 options per question. If you need more, consider restructuring your content instead. A complicated decision tree is worse than a simple list.
...
-   `buttonText`: optional, defaults to "Follow the guide"
...
For a full working example, see `contents/docs/advanced/proxy/_snippets/proxy-decision-tree.tsx`.
