...
1. We are not an analytics platform or tool. Although we started with analytics, we have grown well beyond this. We're not a product analytics or session replay tool either. Nor a "product improvement platform."
