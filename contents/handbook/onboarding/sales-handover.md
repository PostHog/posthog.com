...
- If you reach out to a high spender (+$1000), add a Vitally task to see if the first bill came through. If it did, we could pass them on to Sales faster, without having to circle back to the account before the second bill comes up. We currently have a [playbook](https://posthog.vitally-eu.io/settings/playbooks/4937c8d2-94d8-4622-85ee-9104aaa19e27) running that automates task creation. 
