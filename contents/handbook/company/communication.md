...
1. Discussion in GitHub issues or pull requests is preferred over everything else. If you need a response urgently, you can Slack someone with a link to your comment on an issue or pull request, asking them to respond there. However, be aware that they still may not see it straight away (and that's OK in our book). _That said, casual conversations in Slack are completely normal and encouraged — it’s our main space for day-to-day, informal communication._
