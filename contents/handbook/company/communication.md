...
3. Share the RFC:
    ...
    - The importand thing is not to get the RFC approved, but to get the right people involved and commenting. That means you might need to chase them to make sure it happens - tag the people, present at all hands, use offsites or other sync time - **it's your responsibility to nudge the relevant people for their input**
