...
For extra convenience, you can also add this search as a 'search engine' in Chrome. That way you can type in `gh <tab>` and instantly find anything. To do that, follow these steps:
