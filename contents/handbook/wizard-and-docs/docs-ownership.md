...
- Reviewing and merging [docs PRs generated by Inkeep](/handbook/wizard-and-docs/content-writer-agent) when your monorepo PRs are merged
...
The <SmallTeam slug="wizard-and-docs" /> is responsible for improving the docs. This means:
...
1. Reading our goals on the <SmallTeam slug="wizard-and-docs" /> page
...
### I'm really busy, can the <SmallTeam slug="wizard-and-docs" /> team write docs for me?
