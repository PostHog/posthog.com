...
See the [onboarding docs handbook](/handbook/wizard-and-docs/onboarding-docs) for full details on how to create or migrate installation guides to the shared rendering architecture.
