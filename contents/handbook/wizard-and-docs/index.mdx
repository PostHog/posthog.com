...
The <SmallTeam slug="wizard-and-docs" /> focuses on delivering a delightful developer experience, maintaining a well-organized knowledge base, and writing documentation that is a genuine pleasure to read for both humans and robots.
...
Writing is something we love to do here at PostHog. The principles of PostHog [writing](/handbook/content/writing-for-posthog) and [marketing](/handbook/marketing#marketing-values) all still apply here.
...
The [docs style guide](/handbook/wizard-and-docs/docs-style-guide) is a key reference we'll continue to update with examples and best practices.
