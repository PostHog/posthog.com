...
We sponsored a variety of newsletters to drive subscriptions for our newsletter, [build mode](/handbook/content-and-docs/newsletter), but have put that on pause as we revaluate the quality of the subscriptions we're getting.
