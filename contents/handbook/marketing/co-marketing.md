...
**When to level up:**
Most integrations stop here. But if there's genuine product synergy where both tools are better together, then it's worth doing more:

- A practical tutorial like [this one](/tutorials/supabase-query)
- A video walkthrough if the workflow is complex
- A blog article or other co-authored content

Like all PostHog marketing, co-marketing should be useful to the reader. A super simple way to signal compatibility without being promotional is to casually reference partner companies in docs and editorial.
...
We do this out of goodwill anyway in blog posts like [this](/blog/startup-ops-toolkit). It helps readers and costs us nothing.
...
## PostHog customers
If a customer is a logo we’d proudly show on the site, represents [who we build for](/handbook/who-we-build-for), and is getting real value from PostHog, then a [case study](/handbook/marketing/customer-case-studies) usually makes sense.
...
Social media co-marketing for case studies naturally follows since most companies are excited to have their story featured.
...
If we're signing anything with legal commitments, that needs to go via [Hector](/community/profiles/33607) in <PrivateLink url="https://posthog.slack.com/archives/C08MYQX74KH">#legal</PrivateLink>. If it's an informal exchange of perks, you can usually just coordinate directly with the partner company.
...
- Add the offer to relevant emails and onboarding flows
...
Joe maintains a <PrivateLink url="https://docs.google.com/spreadsheets/d/1LSk0J6TWgioHlReyMj9otbQRkx8rSQYUO8yJqpv0pwM/edit?usp=sharing">#spreadsheet</PrivateLink> with most of our current partnerships. This also includes partnerships with VCs and PE firms. For the most part these do not require co-marketing.
...
Virtual events can also work for co-marketing, we just try to avoid boring ones. For example, we participated in ElevenLab’s [Worldwide Hackathon](https://elevenlabs.io/blog/announcing-the-winners-of-the-elevenlabs-worldwide-hackathon), which was rad.
...
A good example is the limited edition [t-shirts](https://posthog.com/merch?product=supabase-x-posthog-t-shirt) we did with [Supabase](https://supabase.com/), which was way more fun than a press release.

If you think a merch collab makes sense for a co-sponsored event, use the [art request template](/handbook/brand/art-requests).
