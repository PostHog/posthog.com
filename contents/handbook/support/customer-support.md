...
Within Zendesk, we will futher prioritize tickets based on their selected severty. If you come across a ticket that doesn't have the severity set appropriately [according to our severity level guidelines](/docs/support-options#severity-levels), then you should update the ticket with the appropriate severity level.
