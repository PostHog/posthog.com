...
> Before taking any deletion action, they should ensure that they are no longer sending the sensitive data to us either by [redacting information client-side](/docs/libraries/js/usage#redacting-information-in-events) or setting up a [CDP transformation](/docs/cdp/transformations/filter-properties).  If they don't do this first they will continue to send us the sensitive data even after deletion is actioned.
