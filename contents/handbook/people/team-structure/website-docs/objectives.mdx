...
* **Rationale**:
    * posthog.com is now regularly references as a gold standard website, like Stripe (!). We should go from 'great' to 'exceptional' to get more word of mouth growth and to double down on brand.
