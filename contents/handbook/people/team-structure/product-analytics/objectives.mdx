...
TODO, but leading up to all the reasons we want universal search, including solving new issues
[like this one](https://github.com/PostHog/posthog/issues/11913).
