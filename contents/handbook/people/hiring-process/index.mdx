...
Our [recruitment strategy](/founders/early-stage-startup-hiring-strategy) is to run:
...
[‘You're the driver’](/handbook/values#youre-the-driver) is one of our values here at PostHog. We think carefully about each new role and the complexity it introduces to the organization. We also have an extremely high bar for the people we do hire!
...
If the candidate is unable to accept payment for the SuperDay, we will donate by default to [Django Girls Foundation](https://djangogirls.org/en/donate/donate/). Payment and donation for SuperDays are expected to process every Wednesday so it'll depend on what day your SuperDay falls on. Either way, please feel free to flag your talent partner if you don't see the payment deposit within one week of your SuperDay. 
