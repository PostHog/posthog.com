...
We can also increase benchmark levels when we are making a deliberate attempt to raise the bar in terms of hiring, this means that when a benchmark is increased, it's not unusual for your level and step to come down, this can still mean a payrise, just not at the same % increase as the benchmark increase. 
...
Any increases will be communicated by the relevant Blitzscale team member, as they are the only people responsible for communicating pay rises, as compensation is not a [manager's responsibility](/handbook/company/management) at PostHog.  If you need to talk to someone about your compensation or how the calculator works, you should ask the relevant member of the exec team in the first instance. 

You will only hear from them if there has been a change in your pay, not if it is staying the same. 

If you recently accepted an offer at PostHog and the benchmark has been changed your pay will be updated at the next pay review cycle, this is because your offer was made at the level & step of the previous benchmark and the blitzscale team will need to review where you sit on the new benchmark. 
