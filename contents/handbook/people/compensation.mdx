...
Because the engineering market is very competitive, and we think there is a 10x difference between an average and a top engineer, we pay near the top of market, which we define as being around the 90th percentile. For other roles we still try to pay towards the top of market, which we define as 50th percentile + 20%.
...
If PostHog decides to end your contract after the first 3 months of employment have been completed (6 months for sales roles), we will offer you a total of 4 months of base salary (inclusive of any statutory notice periods, as may be required by law), subject to you signing a post-termination certificate or similar document or release in favor of PostHog. For employees based in Germany that have passed their 6 month probationary period, we will follow statutory notice and severance requirements that align with legal obligations and market-standard best practices.  It is possible that we will ask you to stop working immediately, make you a payment in lieu of notice, or agree to have you on some sort of "garden leave" or similar structure, depending on jurisdictional best practices and the specific terms of your contract. If the decision to leave is yours, then we generally just require 1 month of notice, though this may vary depending on jurisdictions and statutory minimums as well as any specific provisions in your contract.
