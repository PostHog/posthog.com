...
If PostHog decides to end your contract after the first 3 months of employment have been completed (6 months for sales roles or German employees), we will offer you a total of 4 months of base salary (inclusive of any statutory notice periods, as may be required by law), subject to you signing a post-termination certificate or similar document or release in favor of PostHog. It is possible that we will ask you to stop working immediately, make you a payment in lieu of notice, or agree to have you on some sort of "garden leave" or similar structure, depending on jurisdictional best practices and the specific terms of your contract. If the decision to leave is yours, then we generally just require 1 month of notice, though this may vary depending on jurisdictions and statutory minimums as well as any specific provisions in your contract.
