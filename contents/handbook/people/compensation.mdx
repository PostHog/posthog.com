...
- For creative roles where we believe there is an outsize (10x or more) difference between average and top talent in output, we pay at the top of market in order to attract top talent. We define as being around the 90th percentile.
- For other roles where we don't think the difference is as large, we pay around the 50th percentile.
