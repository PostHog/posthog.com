...
- Senior: owns and drives large projects or a whole product (perhaps as team lead), decides what needs to happen and does everything necessary to get that done
