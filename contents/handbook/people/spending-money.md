...
## Guiding principles
We have a context-based expense policy [inspired by the book 'No Rules Rules'](https://posthog.com/handbook/story#things-that-influenced-us). We're empowering team members to make good decisions while maintaining transparency and accountability.
...
- Company software budget
  - All subscriptions/tools used at a company level - ([Janani](https://posthog.com/community/profiles/34497) should be default admin for all of these, so she can handle receipts etc.
...
- Activities that only some of the team can take part in - see [team activities](#team-activities)
...
- If you're in the same place as other team members, even if you aren't directly working together, PostHog will cover the cost of a dinner or a fun activity - see [team activities](#team-activities) for what counts
...
We cover team activities, and the bar is that a team activity is something _everyone_ on the team can do - not just a select few. It's decided as a team, and everyone can participate.

A few people doing an activity for their individual enjoyment isn't a team activity just because several of them happen to want to go, so that's on you rather than the company. Nothing stops you doing it - just pay for it yourself.

There's no list of qualifying activities here on purpose, because we expect you to use good judgement. If you can't tell, ask [Janani](https://posthog.com/community/profiles/34497) in [#team-people-and-ops](https://posthog.slack.com/archives/C017WDX3BFZ) _before_ you book it, rather than after.
