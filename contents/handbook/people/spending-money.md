...
* For engineering roles, we recommend a Macbook Pro 14-inch M4, with the 12-core CPU, 16-core GPU upgrade and 24Gb of RAM. By default grab the smallest SSD (512gb), but you can upgrade if you need to.
* For all other roles, we currently recommend a Macbook Air with an Apple Silicon processor and 16GB of RAM.
