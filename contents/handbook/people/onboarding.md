...
<table>
  ...
  <tr>
   <td>Add the team member to <a href="https://posthog.charliehr.com/">CharlieHR</a> and ask them to fill in all details, upload relevant docs (e.g. passport scan). Once they are on, manually change their profile so their holiday requests are auto-approved.
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Send team member a copy of this page so they can check everything has been done
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Create GSuite account for the team member
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Add team member to any relevant Google Groups
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Add team member to 1password
   </td>
   <td>All
   </td>
   <td>Charles
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Send team member a link to the <a href="https://posthog.com/handbook">Handbook</a>
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td> Send team member a digital company card
   </td>
   <td>All
   </td>
   <td>Charles/Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Team member to purchase any necessary equipment as per the <a href="https://posthog.com/handbook/people/spending-money">spending money</a> guidelines
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Give them $100 credit to spend on Shopify
   </td>
   <td>All
   </td>
   <td>Charles
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Share the <a href="https://docs.google.com/spreadsheets/d/1k4o4VN5VSsgFZpVYrN28Ib0z_pCJFTJyQdfkZEHhOV0/edit?usp=sharing">Important Company Details</a> sheet with them
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Add team member to the PostHog app
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Send them an invite to <a href="https://app.drata.com/">Drata</a> to do security onboarding and their background check
   </td>
   <td>All
   </td>
   <td>Charles
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Add the team member's details to our hiring plan in Pry 
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Add the team member's share options to Captable.io (if relevant)
   </td>
   <td>All
   </td>
   <td>Charles
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Add team member to the internal company Slack 
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Add them to the virtual-coffee and #wellbeing channel on Slack
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Add them to all relevant <a href="https://github.com/PostHog/company-internal/issues/234">Slack channels</a>
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Add team member to PostHog Users Slack
   </td>
   <td>All
   </td>
   <td>Charles
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Add team member to PostHog organization in GitHub
   </td>
   <td>All
   </td>
   <td>Charles
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Send a copy of their HMRC new starter form on CharlieHR to DRG, and include their salary and if they are full or part time
   </td>
   <td>UK
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Ask if they want to be part of our <a href="https://posthog.com/handbook/people/benefits#private-health-insurance">private healthcare</a> and if they want to contribute our <a href="https://posthog.com/handbook/people/benefits#pension-and-401k-contributions">pensions</a>
   </td>
   <td>UK
   </td>
   <td>Eltje 
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Send the team member the HMRC new starter form, pass it on to DRG once signed for payroll
   </td>
   <td>UK
   </td>
   <td>Eltje
...
<table>
  ...
  <tr>
   <td>Book a weekly 1:1 with the team member
   </td>
   <td>All
   </td>
   <td>Manager
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Send them these instructions on adding the <a href="https://intercom.help/charliehr/en/articles/839648-importing-your-time-off-calendar-to-google-calendar">team time off cal</a> to their Gcal
   </td>
   <td>All
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>For the first week or so, book extra sessions as appropriate to provide extra help
   </td>
   <td>All
   </td>
   <td>Manager
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Schedule a <a href="https://www.gov.uk/guidance/coronavirus-covid-19-right-to-work-checks">right to work</a> check with Eltje
   </td>
   <td>UK
   </td>
   <td>Eltje
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Team members should add themselves to the <a href="https://calendar.google.com/calendar/?cid=Y19tczllaWN1Ym92ZGgxYWhzNmtoY2xpNTQ3b0Bncm91cC5jYWxlbmRhci5nb29nbGUuY29t">customer interviews calendar</a>.
   </td>
   <td>All
   </td>
   <td>Team member
...
<li><code>[ ]</code>
  ...
  <tr>
   <td>Share user interview notes with them, found in <a href="https://docs.google.com/document/d/1762fbEbFOVZUr24jQ3pFFj91ViY72TWrTgD-JxRJ5Tc/edit">this doc</a>. If the person is particularly interested in more historical context, here are the notes from <a href="https://docs.google.com/document/d/1gJlsUDrlW7ur8zT5scqRvXZhapm_0JdvKGiw68Iyx9E/edit">Q4-2020</a>, and <a href="https://docs.google.com/document/d/1vrwn-owF320otkm3oODCFjvqj7gptF6QaFFO6v-_RhY/edit">Q3-2020</a>.
   </td>
   <td>All
   </td>
   <td>Manager
