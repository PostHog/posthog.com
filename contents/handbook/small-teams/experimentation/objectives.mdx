...
- **Key Result:** 80% of external users give the maximum satisfaction score (:heart_eyes: ) for the new correlation features (if deployed)
 ...
 Possible avenues:
- [Cohort correlation](https://github.com/PostHog/posthog/issues/7875). What are property and behavioral similarities between users in this cohort
...
- **Key Result:** Experiments NPS score of 40
...
- [Experiments UX](https://github.com/PostHog/posthog/issues/10426)
