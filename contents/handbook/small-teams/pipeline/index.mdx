...
We run a 30 minute standup on Monday, Wednesdays, and Fridays, and extend the slot if we feel the need to have a longer synchronous discussion about a specific topic. We look at [the Pipeline Team GitHub Board](https://github.com/orgs/PostHog/projects/46/views/1), and we document every standup in [this doc](https://docs.google.com/document/d/1iHeef4lWQ4rSBXmaM6A9_GHmARXax7If4B0duo8gFSE/edit?usp=sharing).
