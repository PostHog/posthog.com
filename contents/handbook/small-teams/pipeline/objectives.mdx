...
- Objective: CDP - Owner @fuziontech
    - Key Result: Rock solid webhooks - Owner @hazzadous
        - Improve quality by removing questionable apps: mark apps that store lots of data in postgres, or are generally lower quality as non-global or disable altogether.
