...
- Make sure PostHog.com sells the vision of PostHog as a company to prospective customers or candidates
...
Our team works in weekly sprints. We run sprints in conjunction with the Marketing team, since we often have projects that overlap. You can find what we're working on in the [company-internal](https://github.com/PostHog/company-internal/issues?q=is%3Aissue+is%3Aopen+%5BSPRINT%5D+Marketing+%2B+Website+%26+Docs%3A) repo (private).
