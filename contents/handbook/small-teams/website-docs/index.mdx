...
- Outline weekly sprint tasks in the joint Marketing/Website & Docs sprint planning sessions
- Keep an eye on the [posthog/posthog.com repo](https://github.com/posthog/posthog.com) for issues
- Maintain a constant iteration process - our work is never "finished"
...
**Important:** We prioritize feedback based on alignment with business goals. _Everyone has feedback about design._ (If feedback is more of a personal opinion than a business-related perspective, we’ll note it, but please don't be offended if your feedback isn't specifically addressed!)
...
* Correcting typos
* Fixing broken links
* Posting an issue about a concern
...
* Posting about a problem in Slack (they can get lost easily!)

In general, with the above, it is more than likely that the team has put considerable thought into them and this all will need explaining to you. In other situations, the above are known to be MVP state thus we are working on completely overhauling something - hence discussing and merging a potential iterative improvement may be as much effort as redoing something entirely.
