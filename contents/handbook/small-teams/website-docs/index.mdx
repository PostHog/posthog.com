...
Because of the volume of content we publish, blog artwork falls into the [Branding board](https://github.com/orgs/PostHog/projects/65/views/2) managed by Lottie.

When [authoring a blog post](/handbook/growth/marketing/blog), add the `Branding` project board so we can create visuals and make sure the post is listed on our [content calendar](https://docs.google.com/spreadsheets/d/1-6QYxi46d5y88BQ8vdGWmgrFZBbCMs1CAIc5JGLuf4Y/edit) with a publish date. [Learn more about our process.](/handbook/growth/marketing/exporting-blog-post-image)
