...
PostHog.com is currently around 80% of its potential. Animation and video are two ways to help get this closer to making the site as awesome as we can make it. Other areas need some refreshes (like the product pages listed above, and updating things like auto-generated open graph image templates).

### Nail the merch store

The merch store experience should be as awesome as the rest of the website. This includes higher quality products and a shopping experience that is more on par with the rest of our brand. This may include going headless with our Shopify store, or switching to another platform that can work with a fulfillment partner.
