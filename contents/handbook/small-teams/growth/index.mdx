...
The most people possible can get value out of PostHog.
...
- Product led growth, including all messaging, emailing and notifications
...
- **Objective 2**: Improve conversion to paid
  - Reasoning: This metric encompasses everything
  - *KR*: Sign up-> paid anything from 1.6% to 5% (3 month average).
    ...
    - Idea: All the docs, tutorials and product material is accessiblea from within the app
