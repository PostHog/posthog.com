...
Last quarter, we launched pricing for surveys and gathered lots of useful feedback. This quarter, we're building out most of the things users have asked for.

We will, in order of priority build:

- Event based targeting for surveys
- Branching logic with multiple questions
- Better result visualisation for NPS/CSAT surveys
