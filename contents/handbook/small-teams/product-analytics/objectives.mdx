...
Dashboards:
- https://metabase.posthog.net/question/492-key-metric-insight-fetch-time-for-top-10-teams
- https://metabase.posthog.net/question/502-key-metric-initial-dashboard-load-time-for-top-10-teams
