...
- Primary Personas:
    - **Product manager** (ex-engineer type)
        - Support the product teams to build the best products. They guide the product roadmap by speaking to customers and diving into the data.
...
We should build for the highest-performing product teams (engineers, PMs, designers) building the most loved products at high-growth startups. The product analytics teams focus specific on product managers (the ex-engineer type) and product-engineers (full-stack engineers skewed towards the frontend) but it should be usable by everyone in the product team.
