* **Objective**:
    * Increase word-of-mouth growth by:
      1. Acting as the newsroom of PostHog to showcase new PostHog features.
...
* **Rationale:**
    ...
    * Paid ads also fall under business-as-usual. We're working towards making paid ad spend as lean as possible, so we can divert budget to other more leveraged activities.
