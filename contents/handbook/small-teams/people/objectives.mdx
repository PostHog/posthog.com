...
* **Key Results:**
    ...
    * Get onto the Data Protection Framework list (Charles)
    * Plan an offsite so good other companies share the video of it online (Kendal)
    * Hire a Pipeline Lead, Growth Engineer & Ops Lead (Coua)
    ...
    * Become sales tax compliant in NY and CA, and prepare for future states (Charles)
* **Rationale:**
