...
#### LLM Observability
1. [Implementing with your LLM SDK](/docs/llm-observability/basics)
    - Privacy options
2. Generations vs traces vs spans vs sessions
3. [LLM Cost Analysis](/docs/llm-observability/calculating-costs)
    - How do we accommodate custom LLM pricing?
4. [Insight analysis](/docs/llm-observability/dashboard)
