---
title: PostHog for Startups x Antler
showTitle: false
showSidebar: true
width: lg
images:
...
<section class="my-24 px-5">
  <div class="max-w-screen-2xl mx-auto">
    ...
    <p class="text-2xl lg:text-3xl m-0 text-center mb-6 sm:mb-16 lg:mb-8">Teams must be less than 3 years old and have less than $5 million in funding to qualify</p>
    <div class="flex justify-center">
      <ul class="m-0 p-0 list-none inline-grid sm:grid-cols-2 lg:grid-cols-4 justify-evenly relative text-center sm:text-left">
        ...
        <li class="relative md:max-w-md py-4 md:py-8 pl-4 pr-2 md:px-12 lg:px-8">
          ...
          <p class="m-0 text-[15px]">Refer a friends' startup and get an extra $10k in credit to split between you.</p>
        </li>
      </ul>
    </div>
  </div>
...
<table className="w-400 mt-4" style="max-width: 1100px; font-size: 15px;">
    ...
    <tbody>
        <tr class="border-b border-light dark:border-dark">
            ...
            <td className="bg-accent dark:bg-accent-dark text-center">&lt;$5m in funding and less than 3 years old</td>
        </tr>
        <tr class="border-b border-light dark:border-dark">
...
<p>Your company needs to be less than 3 years old and have raised less than $5m funding. You need to have signed up any time from Jan 1st 2023 onwards. </p>
</details>
