    ...
    theme: {
        ...
        extend: {
            ...
            backgroundImage: {
                ...
                'cost-analysis':
                    'radial-gradient(ellipse 100% 80% at 85% 15%, rgba(184, 66, 231, 0.69) 0px, transparent 55%), radial-gradient(ellipse 70% 100% at 90% 85%, rgba(55, 148, 255, 0.52) 0px, transparent 65%), radial-gradient(ellipse 60% 80% at 50% 50%, rgba(239, 125, 155, 1) 0px, transparent 70%)',
            ...
            fontFamily: {
                ...
                fancy: ['Zapfino', 'serif'],
                button: ['IBM Plex Sans Variable', 'IBM Plex Sans', 'IBM Plex Sans KR', 'sans-serif'],
                nav: ['IBM Plex Sans Variable', 'IBM Plex Sans', 'IBM Plex Sans KR', 'sans-serif'],
                code: ['Source Code Pro', 'Menlo', 'Consolas', 'monaco', 'monospace'],
                rounded: ['RoundHog', 'IBM Plex Sans KR', 'sans-serif'],
                squeak: ['Squeak', 'IBM Plex Sans KR', 'sans-serif'],
                comic: [
                    'Comic Sans MS',
                    'Comic Sans',
