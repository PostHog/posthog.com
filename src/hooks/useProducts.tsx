...
`}
        ...
        presenterNotes: {
            ...
            'getting-started':
                'Session replay gives you the context behind your metrics. It’s not trying to replace your charts—it’s there to make them actionable. If a number looks off, you can dig in and see what happened. And because it’s part of a single platform, it fits into your workflow instead of adding another tool to maintain. It’s flexible, it scales, and it gives you real visibility without having to guess what your users were doing.',
        },
    },
    {
        Icon: IconToggle,
