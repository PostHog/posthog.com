...
export const posthog_ai = {
    ...
    features: [
        ...
        },
        {
            ...
            headline: 'LLM Observability',
            team: 'llm-observability',
            layout: 'ai',
            icon: <IconLlmAnalytics className="size-5" />,
            color: 'purple',
            description:
                "Why was today's token spend more than your salary? PostHog AI and LLM Observability help keep an eye on your AI.",
            images: [
                {
                    src: 'https://res.cloudinary.com/dmukukwp6/image/upload/llm_cde5a95040.png',
                    alt: 'LLM Observability',
                    className: 'h-80 w-full object-contain @2xl:h-64',
                    // stylize: true,
                    // shadow: true,
                },
