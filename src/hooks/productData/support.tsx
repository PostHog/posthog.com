...
export const support = {
    ...
    useCases: {
        ...
        rows: [
            ...
            [
                'Support Engineers',
                'A daily driver for ticket response, with all the customer context you need in PostHog',
            ],
            ['PMs & designers', 'Get reports of where users hit friction, pulled through the MCP'],
            ['Growth Engineers', 'Investigate how support tickets correlate with other metrics, right from Slack'],
