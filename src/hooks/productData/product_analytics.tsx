...
export const productAnalytics = {
    ...
    seo: {
        ...
        description:
            'Track usage, retention, and feature adoption with Product Analytics. PostHog connects recordings, experiments, feature flags, and more for full product insight.',
