    ...
    return (
        <html {...props.htmlAttributes}>
            <head>
                ...
                {process.env.GATSBY_POSTHOG_API_KEY && process.env.GATSBY_POSTHOG_HOST && (
                    <script
                        dangerouslySetInnerHTML={{
                            ...
                            posthog.init("${process.env.GATSBY_POSTHOG_API_KEY}", {api_host: "${process.env.GATSBY_POSTHOG_HOST}",capture_pageview: false,_capture_metrics: true})
                            `,
                        }}
                    />
                )}
