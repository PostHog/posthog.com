                ...
                {process.env.GATSBY_POSTHOG_API_KEY && process.env.GATSBY_POSTHOG_API_HOST && (
                    <script
                        dangerouslySetInnerHTML={{
                            ...
                            posthog.init("${process.env.GATSBY_POSTHOG_API_KEY}", {api_host: "${process.env.GATSBY_POSTHOG_API_HOST}",capture_pageview: false,_capture_metrics: true,uuid_version:'v7', __preview_measure_pageview_stats: true})
                            `,
                        }}
                    />
                )}
