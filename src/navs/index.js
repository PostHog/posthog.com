    ...
    children: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    name: 'Investigate and analyze data',
                    url: '/docs/posthog-ai/investigate-and-analyze-data',
                    icon: 'IconShield',
                    color: 'red',
                },
                {
                    name: 'Automate developer workflows',
                    url: '/docs/posthog-ai/automate-developer-workflows',
                    icon: 'IconShield',
                    color: 'red',
                },
                {
                ...
                },
                {
                    ...
                    url: '/docs/posthog-ai/security-and-privacy',
                    icon: 'IconShield',
                    color: 'red',
                },
                {
