...
const appSettings: AppSettings = {
    ...
    '/field-guide/foreword': { toolbar: true, hideTitle: true },
    '/field-guide/closing-note': { toolbar: true, hideTitle: true },
    '/field-guide/the-rage-clicker': { toolbar: true, hideTitle: true },
    '/field-guide/the-refreshing-pilgrim': { toolbar: true, hideTitle: true },
    '/field-guide/the-tab-hopper': { toolbar: true, hideTitle: true },
    '/field-guide/the-mid-form-fleer': { toolbar: true, hideTitle: true },
    '/field-guide/the-pricing-page-loiterer': { toolbar: true, hideTitle: true },
    '/field-guide/the-tutorial-skipper': { toolbar: true, hideTitle: true },
    '/field-guide/the-modal-slammer': { toolbar: true, hideTitle: true },
    '/field-guide/the-phantom-returner': { toolbar: true, hideTitle: true },
    '/field-guide/the-dead-end-wanderer': { toolbar: true, hideTitle: true },
    '/field-guide/the-console-opener': { toolbar: true, hideTitle: true },
    '/trash': {
        toolbar: true,
    },
    '/ai': {
