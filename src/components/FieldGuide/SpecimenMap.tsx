...
export default function SpecimenMap(): JSX.Element {
    ...
    return (
        <div ref={rootRef} className="fg-map" data-in-view={inView}>
            ...
            <style>{`
                .fg-map { container-type: inline-size; position: relative; width: 100%; }
