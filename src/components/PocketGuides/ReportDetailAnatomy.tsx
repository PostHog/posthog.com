...
export default function ReportDetailAnatomy({
    ...
    return (
        <AnatomyFrame className="rounded border border-primary bg-primary px-4 py-3.5">
                ...
                <div className="flex min-w-0 items-start gap-2">
                    ...
                    <span className="min-w-0">
                        ...
                        <span className="mt-1 flex flex-wrap items-center gap-2 text-[0.7em] leading-none text-secondary">
                            ...
                            <span className={`${chipClasses} bg-green/10 text-green dark:bg-green/30 dark:text-white`}>
                                {actionability}
                            </span>
