                            ...
                            {features.map(({ title, icon, url }) => {
                                return (
                                    ...
                                    >
                                        <Link
                                            to={url}
                                            className="flex space-x-2 items-center text-base py-2 px-1 my-1 rounded group hover:bg-gray-accent-light transition-all relative active:top-[1px] active:scale-[.99]"
                                        >
