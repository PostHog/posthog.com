...
export const Screenshot = ({ icon, product, slug, order, className = '', children }: ScreenshotProps): JSX.Element => {
    ...
    useEffect(() => {
        const messageHandler = (event) => {
            if (event.data.type === 'session-replay-data' && event.data.ready && replayEvents.length > 0) {
                replayRef.current?.contentWindow?.postMessage(
                    { type: 'session-replay-data', snapshots: replayEvents },
                    '*'
                )
            }
        }
            ...
            <g clipPath="url(#a)">
                ...
                <g filter="url(#c)">
                    <path
                        fill="#ED6A5E"
                        fillRule="evenodd"
                        d="M19 28a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"
                        clipRule="evenodd"
                    />
                </g>
                <path stroke="#CE5347" stroke-width=".5" d="M24.75 22a5.75 5.75 0 1 1-11.5 0 5.75 5.75 0 0 1 11.5 0Z" />
                <g filter="url(#d)">
                    <path
                        fill="#F6BE4F"
                        fillRule="evenodd"
                        d="M39 28a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"
                        clipRule="evenodd"
                    />
                </g>
                <path stroke="#D6A243" stroke-width=".5" d="M44.75 22a5.75 5.75 0 1 1-11.5 0 5.75 5.75 0 0 1 11.5 0Z" />
                <g filter="url(#e)">
                    <path
                        fill="#62C554"
                        fillRule="evenodd"
                        d="M59 28a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"
                        clipRule="evenodd"
                    />
                </g>
                <path stroke="#58A942" stroke-width=".5" d="M64.75 22a5.75 5.75 0 1 1-11.5 0 5.75 5.75 0 0 1 11.5 0Z" />

                {/* active browser tab background */}
                <path
                    fill={isDark ? '#35363A' : '#fff'}
                    fillRule="evenodd"
                ...
                <g mask="url(#g)">
                    <text
                        xmlSpace="preserve"
                        fill={isDark ? '#fff' : '#3D4043'}
                        fontFamily="SF Pro, -apple-system, Inter, BlinkMacSystemFont, system-ui, sans-serif"
                        fontSize="12"
                        letterSpacing="0em"
                        style={{ whiteSpace: 'pre' }}
                    >
                        <tspan x="114" y="29.266">
                            {product} | PostHog
                        </tspan>
                    </text>
                </g>
                ...
                <g fill="#fff" clipPath="url(#h)">
                    <path d="M96.21 25.054a.572.572 0 1 1-1.024-.512.572.572 0 1 1 1.024.512ZM96.21 28.253a.572.572 0 1 1-1.024-.512.572.572 0 1 1 1.024.512Z" />
                    ...
                    <path d="M95.7 23.519v2.302c0 .165.065.323.181.44l3.017 3.016v-2.301a.622.622 0 0 0-.182-.44l-3.017-3.017Z" />
                </g>
                ...
                <text
                    xmlSpace="preserve"
                    fill={isDark ? '#fff' : '#202124'}
                    fontFamily="SF Pro, -apple-system, Inter, BlinkMacSystemFont, system-ui, sans-serif"
                    fontSize="14"
                    letterSpacing="0em"
                    style={{ whiteSpace: 'pre' }}
                >
                    <tspan x="204.48" y="64.977">
                        .posthog.com/{slug}
                    </tspan>
                </text>
                ...
                <text
                    xmlSpace="preserve"
                    fill={isDark ? '#fff' : '#767676'}
                    fontFamily="SF Pro, -apple-system, Inter, BlinkMacSystemFont, system-ui, sans-serif"
                    fontSize="14"
                    letterSpacing="0em"
                    style={{ whiteSpace: 'pre' }}
                >
                    <tspan x="142" y="64.977">
                        https://{region}
                    </tspan>
                </text>
                ...
                <text
                    xmlSpace="preserve"
                    className="fill-dark dark:fill-white opacity-50"
                    fontFamily="SF Pro, -apple-system, Inter, BlinkMacSystemFont, system-ui, sans-serif"
                    fontSize="12"
                    fontWeight="600"
                    letterSpacing="0em"
                ...
                <text
                    xmlSpace="preserve"
                    className="fill-dark dark:fill-white font-bold"
                    fontFamily="MatterVF"
                    fontSize="16"
                    letterSpacing="0em"
                    style={{ whiteSpace: 'pre' }}
                >
                    <tspan x="231" y="125.187">
                        {product}
                    </tspan>
                </text>
                ...
                <rect
                    ...
                    height="10"
                    x="8.75"
                    y={301.5 + navOrderOffset}
                    className="fill-[#E0DDDD] dark:fill-[#2E2F36] stroke-[#ccc] dark:stroke-[#464A55]"
                    stroke-width="1.5"
                    rx="5.25"
                />
                ...
                <rect
                    ...
                    height="31.5"
                    x="8.75"
                    y={275.75 + navOrderOffset}
                    stroke-width="1.5"
                    rx="5.25"
                    className="fill-white dark:fill-accent-dark stroke-border dark:stroke-border-dark"
                />
                ...
                <text
                    ...
                    fontWeight="600"
                    letterSpacing="0em"
                    transform={`translate(40, ${284.5 + navOrderOffset})`}
                    style={{ whiteSpace: 'pre', fontVariationSettings: "'wght' 800" }}
                >
                    <tspan x="0" y="12.498">
                        {product}
                    </tspan>
                ...
                <text
                    xmlSpace="preserve"
                    className="fill-[#121212] dark:fill-primary-dark"
                    fillOpacity=".6"
                    fontFamily="MatterVF"
                    fontSize="14"
                    fontWeight="570"
                    letterSpacing="0em"
                    transform="rotate(90 571.25 692.25)"
                    style={{ whiteSpace: 'pre' }}
                >
                    <tspan x="0" y="12.498">
                        Notebooks
                ...
                <text
                    ...
                    fontWeight="570"
                    letterSpacing="0em"
                    transform="rotate(90 509.75 753.75)"
                    style={{ whiteSpace: 'pre' }}
                >
                    <tspan x="0" y="12.498">
                        Docs
                ...
                <text
                    ...
                    fontWeight="570"
                    letterSpacing="0em"
                    transform="rotate(90 467.25 796.25)"
                    style={{ whiteSpace: 'pre' }}
                >
                    <tspan x="0" y="12.498">
                        Support
