...
export const Screenshot = ({ icon, product, slug, order, className = '' }: ScreenshotProps): JSX.Element => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 1280 736" className={`${className} shadow-xl rounded-md reasonable:max-h-[calc(100vh_-_53px_-_2rem)] mx-auto max-w-7xl border border-transparent dark:border-dark/50`}>
      ...
      <g clipPath="url(#a)">
        ...
        <g mask="url(#g)">
          <text xmlSpace="preserve" fill={isDark ? '#fff' : '#3D4043'} fontFamily="SF Pro, -apple-system, Inter, BlinkMacSystemFont, system-ui, sans-serif" fontSize="12"
        ...
        {/* address bar text */}
        <text xmlSpace="preserve" fill={isDark ? '#fff' : '#202124'} fontFamily="SF Pro, -apple-system, Inter, BlinkMacSystemFont, system-ui, sans-serif" fontSize="14" letterSpacing="0em" style={{ whiteSpace: 'pre' }}><tspan x="204.48" y="64.977">.posthog.com/{slug}</tspan></text>

        {/* protocol */}
        <text xmlSpace="preserve" fill={isDark ? '#fff' : '#767676'} fontFamily="SF Pro, -apple-system, Inter, BlinkMacSystemFont, system-ui, sans-serif" fontSize="14"
        ...
        {/* app header slash */}
        <text xmlSpace="preserve" className="fill-dark dark:fill-white opacity-50" fontFamily="SF Pro, -apple-system, Inter, BlinkMacSystemFont, system-ui, sans-serif" fontSize="12" fontWeight="600" letterSpacing="0em" style={{ whiteSpace: 'pre' }}><tspan x="318.578" y="99.165">/</tspan></text>
        ...
        <text xmlSpace="preserve" className="fill-dark dark:fill-white font-bold" fontFamily="MatterVF" fontSize="16" letterSpacing="0em" style={{ whiteSpace: 'pre' }}><tspan x="231" y="125.187">{product}</tspan></text>
        ...
        {slug === 'surveys' && (
          <g id="survey content frame" style={{ backgroundColor: isDark ? '#202124' : '#fff' }}>
            ...
            <text id="0" fill="black" xmlSpace="preserve" style={{ whiteSpace: 'pre', fontFamily: 'Matter SQ', fontSize: '36', fontWeight: '670', letterSpacing: '0em' }}><tspan x="262" y="209.352">0</tspan></text>
            <text id="responses" opacity="0.75" fill="black" xmlSpace="preserve" style={{ whiteSpace: 'pre', fontFamily: 'Matter SQ', fontSize: '24', fontWeight: '500', letterSpacing: '0em' }}><tspan x="262" y="237.568">responses</tspan></text>
            <g id="progress bar">
        ...
        {/* product label */}
        <text xmlSpace="preserve" className="fill-[#121212] dark:fill-white" fontFamily="MatterVF" fontSize="14"
        ...
        <text xmlSpace="preserve" className="fill-[#121212] dark:fill-primary-dark" fillOpacity=".6" fontFamily="MatterVF"
      ...
      {slug === 'session-replay' && (
        <foreignObject x="215" y="137" width="1017" height="599">
          <iframe width="1017" height="599" src="https://us.posthog.com/embedded/etEPFPwAMY2o4EendRa7aBbl71PgkA?showInspector"></iframe>
        </foreignObject>
      )}
