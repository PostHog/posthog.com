    ...
    if (isThumbnail) {
        return (
            <div className="h-full flex flex-col bg-gradient-to-b from-[#08080A] to-[#737385] text-white">
                ...
                {/* Main content area */}
                <div className={`flex-grow flex gap-8 px-8 pb-8 ${isPortraitMode ? 'flex-col' : 'flex-row'}`}>
                    {/* Static thumbnail on the left */}
                    <div className={`${isPortraitMode ? '' : 'flex-1'} flex flex-col`}>
                    ...
                    <div className={isPortraitMode ? 'w-full' : 'w-80'}>
