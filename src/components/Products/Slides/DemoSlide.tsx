...
export default function DemoSlide({ productHandle, answers = [] }: DemoSlideProps) {
    return (
        <div className="h-full flex flex-col px-8 py-12 bg-gradient-to-b from-[#08080A] to-[#737385] text-white">
            <div>
                ...
                {answers.map((answer, index) => {
                    ...
                    return (
                        <OSButton
                            ...
                            className="flex gap-2 justify-between items-center p-2 border border-input rounded-full text-left w-full active:bg-transparent"
                        >
                            <span className="text-xl text-center italic font-medium w-full pl-7 text-white">
                                {answer.q}
                            </span>
                            <span>
                                <div className="p-2 rounded-full bg-blue">
                                    <IconSend className="size-6 text-white" />
                                </div>
                            </span>
                        </OSButton>
                    )
