...
- **Headshot** – the first speaker's community profile avatar (the hand-drawn portrait) in a white-ringed circle, with a "Featuring:" label, their name in Squeak, and their role in Open Runde. Events without speakers get the default hedgehog artwork instead.
