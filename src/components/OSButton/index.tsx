...
export default function OSButton({
    ...
    const variantClasses = {
        ...
        primary: {
            ...
            child: 'relative flex items-center justify-center w-auto bg-orange text-black hover:text-black dark:text-black dark:hover:text-black no-underline border-button dark:border-button-dark dark:bg-orange rounded-[6px] text-[14px] font-bold px-4 py-1.5 translate-y-[-2px] hover:translate-y-[-4px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px] block active:transition-all active:duration-100 select-none',
        },
        secondary: {
            ...
            child: 'relative flex items-center justify-center w-auto bg-white text-primary hover:text-primary dark:text-primary-dark dark:hover:text-primary-dark no-underline border-button dark:border-orange dark:bg-dark rounded-[6px] text-[14px] font-bold px-4 py-1.5 translate-y-[-2px] hover:translate-y-[-4px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px] block active:transition-all active:duration-100 select-none',
        },
