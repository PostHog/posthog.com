...
export const NewsletterForm = ({
    ...
    const classList = mergeClassList('w-full p-4 relative z-10', className)
                ...
                <div className="flex flex-col">
                    <figure className="shrink-0 grow-0 basis-12 m-0 text-black dark:text-white">
                        <svg
                            ...
                            viewBox="0 0 50 50"
                        >
                            <path d="M41.5 7.5c-3.86 0-7 3.14-7 7s3.14 7 7 7 7-3.14 7-7-3.14-7-7-7Z" fill="#F54E00" />
                    ...
                    <span className="flex flex-col flex-grow leading-tight font-bold text-xl md:text-lg">
