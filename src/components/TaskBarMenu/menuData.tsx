    ...
    const items: any[] = [
        {
            type: 'item',
            label: 'PostHog Web',
            description: 'Everything you need to build, all in one place',
            link: '/self-driving',
        ...
        },
        {
            type: 'item',
            label: 'PostHog Slack',
            description: 'Tag @PostHog in any thread to ship fixes',
            link: '/slack',
        ...
        },
        {
            type: 'item',
            label: 'PostHog MCP',
            description: 'Query your product data in plain English',
            link: '/mcp',
        ...
        },
        {
            ...
            description: 'Collect, store, transform, and query your data',
            link: '/data-stack',
