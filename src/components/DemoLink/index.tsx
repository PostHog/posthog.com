...
export const DemoLink = ({ dark = false, className = '' }: { dark?: boolean; className?: string }): JSX.Element => {
    return dark ? (
        <CallToAction
            type="secondary"
            to="/book-a-demo"
            className={` ${className} text-[15px] group justify-center font-semibold text-white py-2 px-3 rounded-sm hover:text-white hover:bg-white/30 inline-flex space-x-2 items-center relative active:top-[0.5px] active:scale-[.98] !w-full md:!w-44 shadow-xl`}
        >
