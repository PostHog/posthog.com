...
export default function Submenu({ referenceElement, menu, open }) {
    ...
    return (
        <div
            ...
            className={`z-10 lg:pt-[30px] mx-auto w-full max-w-screen-xl border-transparent   lg:block lg:group-focus:visible lg:group-hover:visible lg:invisible opacity-100 lg:group-focus:opacity-100 lg:group-hover:opacity-100 lg:opacity-0  transition-all text-white ${
                open ? 'block' : 'hidden'
            }`}
        >
