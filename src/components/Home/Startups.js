...
export default function Startups() {
    return (
        <section className="overflow-hidden pt-12">
            <div className="max-w-6xl p-8 border border-light dark:border-dark bg-accent dark:bg-accent-dark rounded mb-12 md:mb-16 lg:mb-20 xl:mb-24 mx-4 xl:mx-auto">
