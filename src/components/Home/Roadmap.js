...
const RoadmapItem = ({ children }) => {
  return <li className="list-none m-0 pt-2 px-1 pb-3 text-[15px] text-black/70 w-full font-semibold border-gray-accent-light/50 border-solid border-b last:border-b-0">{children}</li>
}
