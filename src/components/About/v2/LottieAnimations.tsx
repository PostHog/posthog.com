...
export const LottieAnimation = ({ variant, className = '' }: LottieAnimationProps) => {
    ...
    const variants = {
        kendrick: {
            ...
            containerClasses: 'relative -left-4',
            backgroundClasses: 'absolute inset-4 bg-accent rounded-full size-56 mx-auto',
        ...
        different: {
            ...
            backgroundClasses: 'absolute bg-accent inset-4 rounded-full size-60 mx-auto',
