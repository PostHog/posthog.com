    ...
    return (
        ...
        >
            <div className="flex flex-col">
                ...
                {featureName && (
                    <div className="feature-name text-black text-opacity-40 flex items-start gap-2 border-gray-accent-light border-dashed border-l-0 border-r-0 border-t-0 border-b pb-2 mb-8">
                        {featureIcon && (
