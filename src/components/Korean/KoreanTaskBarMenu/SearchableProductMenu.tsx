...
const SearchableProductMenu: React.FC<SearchableProductMenuProps> = ({ products }) => {
    ...
    const hiddenSlugs = [
        ...
        'context-warehouse/reverse-etl-export',
        'context-warehouse/data-modeling',
        'context-warehouse',
    ]
        ...
        <div className="p-1 min-w-[280px] max-w-[320px]">
            ...
            <div className="relative mb-2">
                ...
                <input
                    ref={inputRef}
                    type="text"
                    placeholder={translateKo('Search apps...')}
                    value={searchTerm}
                    ...
                    <>
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="font-medium truncate">
                                            {translateKo(customLabels[product.slug] || product.name)}
                                        </div>
                                        {product.description && (
                                            <div className="text-xs text-muted truncate">
                                                {translateKo(product.description)}
                                            </div>
                                        )}
                                    </div>
                                </Link>
                        ...
                        <div className="border-t border-border mt-2 pt-2">
                            ...
                            >
                                ...
                                {translateKo(`Browse all apps (${APP_COUNT})`)}
                            </Link>
                        </div>
                    </>
                ) : (
