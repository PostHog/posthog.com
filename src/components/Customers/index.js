            ...
            <section className="my-16 md:my-32 px-4">
                <div>
                    <Quote
                        ...
                        quote={
                            <span>
                                “The fact that PostHog is open source is really helpful. The cloud formation templates
                                made deployment easy and{' '}
                                <span className="text-red">we were up and running within a day,</span> but we can also
                                open the codebase and build on it. We’ve iterated an entire stack for ourselves since
                                launch.”
                            </span>
                        }
                    />
