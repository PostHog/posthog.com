    ...
    return (
        <div className="px-4 max-w-7xl mx-auto py-12">
            ...
            >
                ...
                <button className="swiper-button-prev absolute left-0 top-1/2 -translate-y-1/2 hover:scale-[1.01] hover:top-[calc(50%-1px)] active:top-[calc(50%+0.5px)] active:scale-[.99] md:z-30 p-2 xl:p-6 box-border peer">
                ...
                <button className="swiper-button-next absolute right-0 top-1/2 -translate-y-1/2 hover:scale-[1.01] hover:top-[calc(50%-1px)] active:top-[calc(50%+0.5px)] active:scale-[.99] md:z-30 p-2 xl:p-6 box-border peer">
