            ...
            <div className="text-center">
                ...
                <div className="max-w-2xl mx-auto">
                    <p>
                        ...
                        on the pizza is <strike>forbidden</strike> contentious. Choose your team wisely.
                    </p>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10 md:gap-12 pt-6 pb-12">
                <div>
                    <div className="font-bold mb-4 border-b border-light dark:border-dark pb-2 flex gap-2">
                        ...
                        <h3 className="text-[19px] leading-tight m-0 pt-2">
                            Small teams who <span className="text-green">wrongly believe</span> pineapple belongs on
                            pizza
                        </h3>
                    </div>
                ...
                <div>
                    <div className="font-bold mb-4 border-b border-light dark:border-dark pb-2 flex gap-2">
                        ...
                        <h3 className="text-[19px] leading-tight m-0 pt-2">
                            Small teams who <span className="text-red">correctly disagree</span> pineapple belongs on
                            pizza
                        </h3>
                    </div>
