...
import { StickerPineappleYes } from 'components/Stickers/Index'
      ...
      <div className="">
        <div className="text-center">
          ...
          <div className="max-w-2xl mx-auto">
            <p>
              Our small teams meet up in various places around the world. Pizza is often involved. Pineapple on the pizza is optional. Choose your team wisely.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-24 py-6">
          <div>
            <div className="font-bold mb-4 border-b border-light dark:border-light-dark pb-2 flex items-center gap-2">
              <StickerPineappleYes className="inline-block size-10" />
              <h3 className="text-xl m-0">Small teams who <span className="text-green">correctly agree</span> pineapple on pizza</h3>
            </div>
          ...
          <div>
            <h3 className="text-2xl font-bold mb-2">Small teams who <span className="text-red">don't believe</span> pineapple on pizza</h3>
            ...
            <ul>
              {groupedTeams.lessThan50.map(team => {
                ...
                const teamMiniCrest = getImage(teamData.miniCrest)
                return (
                  <li key={team.name} className="flex items-center mb-2">
                    {teamMiniCrest && (
                      <GatsbyImage
                        image={teamMiniCrest}
                        alt={`${team.name} mini crest`}
                    ...
                    <span>{team.name} - {team.pineapplePercentage}%</span>
                  </li>
                )
              })}
            </ul>
        ...
        <div>
          <h3>Teams who are split on pineapple on pizza</h3>
          <ul>
