...
export const OpenRoles = () => {
    return (
        <section id="open-roles" className="@container">
            <h2 className="text-center text-2xl @3xl:text-4xl my-8">Open roles</h2>
            ...
            <div className="not-prose @2xl:columns-2 gap-8 [orphans:3] mb-8">
                ...
                <p>
                    ...
                    decisions, and if the timing isn’t quite right, we’ll do our best to provide insight into a better
                    time to apply.
                </p>
                <p>
                    Regardless of the timing of your application or interest in PostHog, you can go ahead and contribute
                    to one of our{' '}
