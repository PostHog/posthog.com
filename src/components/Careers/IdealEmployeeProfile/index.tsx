  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-8 grid md:grid-cols-2 md:gap-8">
      <div className="">
        ...
        <p className="text-[15px] max-w-md my-4 py-4 border-y md:border-b-0 md:pb-0 md:mb-0 border-light dark:border-dark"><strong>Fun fact:</strong> We have an internal Slack channel called <span className="whitespace-nowrap">#do-more-weird</span> where we discuss crazy ideas that most companies save for April Fool's Day.</p>
      </div>
      <div className="space-y-8 md:space-y-0">
        ...
        <div>
          ...
          <p className="mb-3">We think it's more important to hire exceptional people, then give them autonomy and plenty of context. We're not a fit if management responsibility is what motivates you.</p>

          <p className="text-[15px] text-primary/75 dark:text-primary-dark/75 border border-light dark:border-dark p-2 rounded-md bg-accent dark:bg-accent-dark mb-6">
            <TeamMember name="Thomas Obermüller" photo className="bg-white/50 dark:bg-dark/50" /> was CTO for his previous company of 120 people before joining PostHog as a software engineer on the <Link href="/teams/product-analytics">Product Analytics team</Link>.
          </p>
        </div>

        <div>
          <h3 className="text-lg mb-1">Low egos</h3>
          <p className="mb-3">Fast, scrappy people thrive here. We're informal, we use clear language and get a broad variety of work done fast. We're not a fit if you want process.</p>
          ...
          <p className="text-[15px] text-primary/75 dark:text-primary-dark/75 border border-light dark:border-dark p-2 rounded-md bg-accent dark:bg-accent-dark">
            <TeamMember name="Cameron DeLeone" photo className="bg-white/50 dark:bg-dark/50" /> worked for an $11 billion startup, then was Vice President of a poultry farm before joining PostHog as a CSM.
          </p>
        </div>
      </div>
    </section>
