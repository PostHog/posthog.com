...
export default function FooterCTA() {
    return (
        <div className="flex flex-col lg:flex-row justify-between py-12 px-6 sm:px-12 bg-accent dark:bg-accent-dark border border-light dark:border-dark items-center dark rounded-[10px] mt-12">
            <div>
