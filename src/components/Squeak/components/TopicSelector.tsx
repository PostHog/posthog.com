...
export const TopicSelector = (props: TopicSelectorProps) => {
    ...
    return (
        <Popover className="block relative">
            ...
            <Popover.Panel className="fixed z-50 text-black mb-0 w-64 top-[5vh] h-[90vh] px-4 mt-3 transform sm:px-0 overflow-y-scroll overscroll-contain bg-white dark:bg-gray-accent-dark rounded border border-gray-accent-light/50 dark:border-gray-accent-dark/50 shadow-sm">
