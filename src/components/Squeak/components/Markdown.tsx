...
export const Markdown = ({
    ...
    return (
        <ReactMarkdown
            ...
            className={`flex-1 !text-sm overflow-hidden text-ellipsis mr-1 !pb-0 text-primary/75 dark:text-primary-dark/75 font-normal [&_p:last-child]:mb-0 ${regularText ? '' : 'question-content community-post-markdown'
                }`}
            components={{
                pre: ({ children }) => {
                    return (
