...
export function Footer(): JSX.Element {
    return (
        <footer className="max-w-screen-2xl mx-auto mt-20 pb-9 px-4 leading">
            ...
            <div className="flex py-5 border border-dashed border-gray-accent-light dark:border-gray-accent-dark border-l-0 border-r-0 items-center text-lg max-w-6xl mx-auto">
