    ...
    return (
        <ul className="m-0 p-0 list-none">
            <li className="grid grid-cols-12 pb-1 items-center text-primary/75 dark:text-primary-dark/75 text-sm">
                <div className="col-span-12 md:col-span-8 pl-8">Topic {showAuthor && '/ Author'}</div>
                                      ...
                                      <div className="grid grid-cols-12 items-center">
                                          <div className="col-span-12 md:col-span-8 flex items-center space-x-4">
                                              ...
                                              <div className="w-full">
                                                  ...
                                                  <div className="flex items-center gap-2 text-primary/50 dark:text-primary-dark/50">
                                                      {showTopic && (
                                                          <>
