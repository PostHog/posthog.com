...
export const CloudVsSelfHost = ({ className = '' }) => {
    return (
        <section
            ...
            className={`${className} px-4 box-content grid md:grid-cols-2 grid-cols-1 md: max-w-screen-lg mx-auto relative md:gap-20 text-center font-bold text-almost-black`}
        >
