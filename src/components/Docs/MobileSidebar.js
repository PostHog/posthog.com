...
export default function InternalSidebar({ tableOfContents, mobile = true }) {
    return (
        tableOfContents?.length > 0 && (
            <div className="">
                <p className="bg-accent border-y border-border dark:border-border-dark py-1 px-4 text-sm mt-0 mb-2 font-semibold text-opacity-50 sticky top-[calc(-1rem_-_1px)]">
                    On this page
                </p>
