...
const Founders = () => {
    return (
        <div className="bg-accent dark:bg-accent-dark px-6 py-4 mt-8 md:mt-0 rounded border border-light dark:border-dark">
            ...
            <p className="text-sm">
                We've curated the best advice in all the major disciplines you need
                to build a successful company – and what we've learned from building PostHog to product-market fit and beyond.
            </p>
