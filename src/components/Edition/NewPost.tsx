...
export default function NewPost({ id, onSubmit, ...other }: { id?: number; onSubmit?: () => void }) {
    ...
    return (
        <div className="max-w-screen-2xl mx-auto flex items-start h-full">
            <form onSubmit={handleSubmit} className="max-w-md w-full sticky top-[108px] py-12">
                <CategoryDropdown categories={categories} category={values.category} onChange={handleCategoryChange} />
