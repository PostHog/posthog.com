...
export default function Tags() {
    ...
    return activeMenu?.children?.length > 0 ? (
        <div className="-mx-4 pl-2 pr-4 md:-mx-8 md:pl-4 md:pr-8 2xl:-mx-12 2xl:pl-8 2xl:pr-12 border-y my-4 py-2 overflow-y-hidden overflow-x-auto border-light dark:border-dark">
