        ...
        <>
            <Modal open={modalOpen} setOpen={setModalOpen}>
                ...
                <div
                    ...
                    className="flex items-center justify-center absolute w-full md:h-full p-4 md:pt-4 pt-[300px]"
                >
                    <div className="max-w-[875px] bg-white rounded-md" onClick={(e) => e.stopPropagation()}>
                        <div className="px-8 py-10 flex md:space-x-10 md:flex-row flex-col items-center">
                            <StaticImage
                                className="flex-shrink-0 md:relative absolute top-0"
                                objectFit="contain"
                                width={296}
                            ...
                            <div>
                                <div className="flex space-x-2 sm:space-x-4 items-center">
                                    ...
                                    <h2 className="text-blue m-0 sm:text-3xl text-2xl">Application received!</h2>
                                </div>
                                <p className="text-base mt-4 mb-6 pb-6 border-b border-dashed border-gray-accent-light">
                                ...
                                <div className="flex sm:flex-row flex-col sm:space-x-8 space-y-8 md:space-y-0">
                                    <div>
                                        <h3 className="m-0 text-lg">Can we send you a sticker, on us?</h3>
                                        <p className="m-0 mb-3">
                                            This code is our token of appreciation for taking the time to apply.
                                        </p>
                                        <div className="rounded-md bg-tan border border-dashed border-gray-accent-light py-2 px-3 flex justify-between items-center mb-3 max-w-[230px] w-full">
                                            <p className="font-semibold text-lg m-0">{code}</p>
                                            <button
                                                disabled={copied}
                                                className={`${
                                        ...
                                        <CallToAction external to="https://merch.posthog.com/" size="sm">
                                            Visit merch store
                                        </CallToAction>
                                    </div>
                                    <div className="flex-shrink-0 sm:text-center">
                                        <StaticImage src="./images/sticker.png" width={140} />
                                        <p className="text-sm text-black/50 m-0">Looks great on laptops!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 border-y border-dashed border-gray-accent-light">
                            <Link className="font-bold text-lg px-6 py-5">Install PostHog on a side project</Link>
                            <Link className="font-bold text-lg px-6 py-5">Join our mailing list</Link>
                            <Link className="font-bold text-lg px-6 py-5">Have you starred our repo?</Link>
                        </div>
                        <div className="text-center py-4">
                            <button onClick={() => setModalOpen(false)} className="text-lg font-bold text-red">
