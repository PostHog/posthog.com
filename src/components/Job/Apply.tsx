...
const Form = ({ onSubmit, info, id }: { onSubmit: () => void; info: any; id: string }) => {
    ...
    return (
        <div>
            ...
            <p>Just fill out this painless form and we'll get back to you within a few days. After you submit your application, you will receive an email acknowledging receipt. (If you do not receive this email, you can assume we did not receive your application, sadly - please try submitting it again.) Thanks in advance! </p>
...
export default function Apply({ id, info }: { id: string; info: any }) {
    ...
    return submitted ? (
        ...
        <Form info={info} id={id} onSubmit={handleSubmit} />
    )
}
