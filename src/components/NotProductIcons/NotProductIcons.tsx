    ...
    close: (
        <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-current">
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="m2.21 5.157 2.946-2.946 6.829 6.828c2.295-2.267 4.562-4.562 6.857-6.828.963.992 1.954 1.954 2.946 2.946-2.295 2.267-4.562 4.562-6.857 6.829l6.857 6.857c-.992.963-1.984 1.954-2.946 2.946l-6.857-6.857c-2.267 2.295-4.562 4.562-6.829 6.857-.992-.992-1.955-1.984-2.946-2.946 2.267-2.295 4.562-4.562 6.828-6.857L2.21 5.157Z"
            />
        </svg>
    ),
    department: (
