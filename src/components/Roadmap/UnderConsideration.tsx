...
export function UnderConsideration(props: IRoadmap) {
    ...
    return (
        <li className="sm:flex xl:flex-col space-y-2 sm:space-y-0  first:border-t-0 px-4 py-4 sm:py-2 xl:pb-4 bg-accent dark:bg-accent-dark rounded-sm shadow-xl relative">
