        ...
        <AnimatePresence>
            {visible && (
                <motion.div
                    ...
                    className="hidden sm:flex fixed sm:bottom-[23px] z-[9998] w-full sm:w-[350px] sm:left-[calc(50%_-_175px)] justify-center items-center"
                >
                    <div className="flex space-x-4 bg-red/80 dark:bg-yellow/80 sm:bg-red dark:sm:bg-yellow py-[12px] px-[25px] text-white sm:rounded-full w-full sm:w-auto sm:items-center">
