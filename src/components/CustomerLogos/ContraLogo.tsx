...
interface ContraLogoProps {
    className?: string
}

export default function ContraLogo({ className = '' }: ContraLogoProps) {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 148 28">
