...
- Selecting it clears the query and pins a filter token between the search icon and the input; results are then scoped to that category, and an empty query browses everything in it.
