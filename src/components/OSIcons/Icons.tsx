...
export const IconShop = (props: IconProps) => (
    <BaseIcon viewBox="0 0 24 24" width="100%" height="100%" {...props}>
        <path d="M3 19.25v-8a.75.75 0 0 1 1.5 0v8c0 .138.112.25.25.25h14.5a.25.25 0 0 0 .25-.25v-8a.75.75 0 0 1 1.5 0v8A1.75 1.75 0 0 1 19.25 21H4.75A1.75 1.75 0 0 1 3 19.25Z" /><path d="M19.484 3c.79 0 1.483.53 1.69 1.293l.954 3.528C22.692 9.878 21.216 12 19.064 12a3.192 3.192 0 0 1-2.432-1.096A3.006 3.006 0 0 1 14.315 12c-.935 0-1.758-.43-2.315-1.095A3.006 3.006 0 0 1 9.685 12c-.937 0-1.76-.43-2.318-1.096A3.191 3.191 0 0 1 4.936 12c-2.152 0-3.628-2.122-3.064-4.179l.954-3.528A1.75 1.75 0 0 1 4.516 3h14.968ZM4.516 4.5a.25.25 0 0 0-.242.185l-.955 3.53v.004c-.325 1.18.535 2.281 1.617 2.281.95 0 1.683-.697 1.683-1.661v-.015l.004-.077a.751.751 0 0 1 1.496.086v.01c.002.944.73 1.657 1.566 1.657.836 0 1.565-.715 1.565-1.661v-.01a.75.75 0 0 1 1.5 0v.01c0 .946.729 1.66 1.565 1.661.837 0 1.566-.715 1.566-1.661v-.01a.75.75 0 0 1 1.5 0v.01c0 .964.733 1.66 1.683 1.661 1.082 0 1.942-1.1 1.618-2.281l-.001-.003-.955-3.531a.25.25 0 0 0-.242-.185H4.516Z" />
    </BaseIcon>
)

export const IconSticker = (props: IconProps) => (
    <BaseIcon viewBox="0 0 24 24" width="100%" height="100%" {...props}>
        <path d="M20.5 12c0-.21-.008-.418-.023-.624a.198.198 0 0 0-.062-.122l-7.669-7.669a.199.199 0 0 0-.122-.063A8.5 8.5 0 1 0 20.5 12Zm1.5 0c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2c.246 0 .49.009.732.026.421.03.797.221 1.075.498l7.669 7.67c.277.277.467.653.498 1.074.017.241.026.486.026.732Z" /><path fill="#fff" d="M13.787 3.09c-.484 4.017 3.107 7.607 7.124 7.123l.089.745.09.744c-4.983.6-9.393-3.81-8.792-8.792l1.489.18Z" /><path fill="#fff" d="M19.914 10 18.5 11.414 12.586 5.5 14 4.086 19.914 10Z" />
    </BaseIcon>
)
