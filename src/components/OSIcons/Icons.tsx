...
export const IconLinkedIn = (props: IconProps) => (
    <BaseIcon viewBox="0 0 24 24" width="100%" height="100%" {...props}>
        <path fill="#0A66C2" d="M19.04 19.041h-2.962v-4.64c0-1.107-.02-2.532-1.542-2.532-1.543 0-1.78 1.206-1.78 2.45v4.722H9.794V9.497h2.845v1.305h.04a3.118 3.118 0 0 1 2.807-1.542c3.003 0 3.557 1.976 3.557 4.546l-.001 5.235ZM6.45 8.193a1.72 1.72 0 1 1 0-3.44 1.72 1.72 0 0 1 0 3.44ZM7.93 19.04H4.965V9.497H7.93v9.544Zm12.587-17.04H3.476A1.46 1.46 0 0 0 2 3.443v17.114A1.46 1.46 0 0 0 3.476 22h17.042A1.464 1.464 0 0 0 22 20.557V3.442A1.463 1.463 0 0 0 20.518 2" />
    </BaseIcon>
)

export const IconSubstack = (props: IconProps) => (
    <BaseIcon viewBox="0 0 24 24" width="100%" height="100%" {...props}>
        <path fill="#FF6719" d="M20.632 10.594V22l-8.317-5.501L4 22V10.594h16.632Zm0-2.149H4V6.297h16.632v2.148Zm0-4.297H4V2h16.632v2.148Z" />
    </BaseIcon>
)

export const IconYouTube = (props: IconProps) => (
    <BaseIcon viewBox="0 0 24 24" width="100%" height="100%" {...props}>
        <path fill="#ED1D24" d="M21.582 7.193a2.508 2.508 0 0 0-1.768-1.774C18.254 5 12 5 12 5s-6.254 0-7.814.42c-.86.23-1.538.91-1.768 1.774C2 8.757 2 12.02 2 12.02s0 3.264.418 4.829c.23.863.908 1.543 1.768 1.773 1.56.42 7.814.42 7.814.42s6.254 0 7.814-.42c.86-.23 1.538-.91 1.768-1.773C22 15.285 22 12.02 22 12.02s0-3.264-.418-4.828Z" /><path fill="#fff" d="m9.955 14.985 5.227-2.963-5.227-2.964v5.927Z" />
    </BaseIcon>
)

export const IconInstagram = (props: IconProps) => (
    <BaseIcon viewBox="0 0 24 24" width="100%" height="100%" {...props}>
        <path fill="url(#paint0_linear_1631_225)" d="M18.538 6.662a1.201 1.201 0 1 0-2.402 0 1.201 1.201 0 0 0 2.402 0Z" /><path fill="url(#paint1_linear_1631_225)" d="M20.139 16.04c-.045.976-.208 1.505-.343 1.857a3.09 3.09 0 0 1-.75 1.15c-.349.35-.682.566-1.149.746-.352.138-.883.301-1.859.348-1.054.046-1.366.056-4.04.056-2.67 0-2.985-.01-4.039-.056-.975-.047-1.504-.21-1.856-.348-.47-.18-.8-.396-1.15-.746a3.048 3.048 0 0 1-.749-1.15c-.135-.352-.3-.881-.343-1.857-.051-1.054-.06-1.371-.06-4.039 0-2.673.009-2.988.06-4.042.042-.975.208-1.504.343-1.86.18-.465.397-.797.749-1.147.35-.349.68-.566 1.15-.748.352-.138.881-.299 1.856-.345C9.013 3.812 9.33 3.8 12 3.8c2.673 0 2.985.012 4.04.059.974.046 1.506.207 1.858.345.467.182.8.399 1.148.748.352.35.569.682.75 1.148.136.355.3.884.344 1.86.049 1.053.06 1.368.06 4.041 0 2.668-.011 2.985-.06 4.04Zm1.8-8.163c-.049-1.065-.217-1.793-.466-2.427a4.874 4.874 0 0 0-1.152-1.773 4.917 4.917 0 0 0-1.77-1.153c-.637-.247-1.363-.417-2.429-.463C15.056 2.009 14.716 2 12 2c-2.715 0-3.058.01-4.124.06-1.063.047-1.788.217-2.428.464A4.93 4.93 0 0 0 3.68 3.677 4.914 4.914 0 0 0 2.525 5.45c-.247.634-.415 1.362-.467 2.427C2.012 8.943 2 9.284 2 12.001c0 2.715.012 3.055.058 4.121.052 1.064.22 1.791.467 2.428a4.905 4.905 0 0 0 1.154 1.77 4.929 4.929 0 0 0 1.768 1.155c.64.247 1.365.415 2.428.464C8.941 21.99 9.285 22 12 22c2.717 0 3.057-.012 4.123-.06 1.066-.05 1.792-.218 2.428-.465a4.916 4.916 0 0 0 1.77-1.154 4.866 4.866 0 0 0 1.153-1.77c.25-.638.417-1.365.466-2.429.05-1.066.061-1.406.061-4.12 0-2.718-.012-3.059-.06-4.125Z" /><path fill="url(#paint2_linear_1631_225)" d="M11.999 15.332a3.332 3.332 0 1 1 0-6.666 3.334 3.334 0 1 1 0 6.666Zm0-8.47a5.136 5.136 0 0 0 0 10.272 5.135 5.135 0 1 0 0-10.271Z" /><defs><linearGradient id="paint0_linear_1631_225" x1="2.18" x2="20.334" y1="21.793" y2="3.639" gradientUnits="userSpaceOnUse"><stop stopColor="#FFD521" /><stop offset=".05" stopColor="#FFD521" /><stop offset=".501" stopColor="#F50000" /><stop offset=".95" stopColor="#B900B4" /><stop offset=".95" stopColor="#B900B4" /><stop offset="1" stopColor="#B900B4" /></linearGradient><linearGradient id="paint1_linear_1631_225" x1="2.18" x2="20.349" y1="21.818" y2="3.649" gradientUnits="userSpaceOnUse"><stop stopColor="#FFD521" /><stop offset=".05" stopColor="#FFD521" /><stop offset=".501" stopColor="#F50000" /><stop offset=".95" stopColor="#B900B4" /><stop offset=".95" stopColor="#B900B4" /><stop offset="1" stopColor="#B900B4" /></linearGradient><linearGradient id="paint2_linear_1631_225" x1="2.185" x2="20.349" y1="21.818" y2="3.654" gradientUnits="userSpaceOnUse"><stop stopColor="#FFD521" /><stop offset=".05" stopColor="#FFD521" /><stop offset=".501" stopColor="#F50000" /><stop offset=".95" stopColor="#B900B4" /><stop offset=".95" stopColor="#B900B4" /><stop offset="1" stopColor="#B900B4" /></linearGradient></defs>
    </BaseIcon>
)

export const IconGithub = (props: IconProps) => (
    <BaseIcon viewBox="0 0 24 24" width="100%" height="100%" {...props}>
        <path className="text-[#24292F] group-hover:text-white dark:text-white group-hover:dark:text-[#24292F]" fillRule="evenodd" d="M12.008 2C6.474 2 2 6.583 2 12.254c0 4.532 2.867 8.369 6.843 9.726.498.103.68-.22.68-.492 0-.237-.017-1.052-.017-1.901-2.784.611-3.364-1.222-3.364-1.222-.447-1.189-1.11-1.494-1.11-1.494-.911-.628.067-.628.067-.628 1.01.068 1.54 1.052 1.54 1.052.895 1.562 2.337 1.12 2.917.85.083-.663.348-1.121.63-1.376-2.22-.238-4.557-1.12-4.557-5.059 0-1.12.397-2.037 1.027-2.75-.1-.254-.447-1.307.1-2.716 0 0 .845-.272 2.75 1.052a9.472 9.472 0 0 1 2.502-.34c.845 0 1.707.12 2.502.34 1.906-1.324 2.75-1.052 2.75-1.052.548 1.409.2 2.462.1 2.716.647.713 1.028 1.63 1.028 2.75 0 3.939-2.337 4.804-4.574 5.06.365.322.68.933.68 1.9 0 1.375-.017 2.479-.017 2.818 0 .272.183.595.68.493C19.133 20.622 22 16.786 22 12.253 22.016 6.584 17.526 2 12.008 2Z" clipRule="evenodd" />
    </BaseIcon>
)

export const IconXNotTwitter = (props: IconProps) => (
    <BaseIcon viewBox="0 0 24 24" width="100%" height="100%" {...props}>
        <path className="text-black group-hover:text-white dark:text-white group-hover:dark:text-black" d="M17.743 3h3.052l-6.667 7.64L22 21h-6.185l-4.819-6.28L5.454 21H2.402l7.148-8.16L2 3h6.345l4.378 5.76L17.743 3Zm-1.084 16.16h1.686L7.422 4.72H5.574L16.66 19.16Z" />
    </BaseIcon>
)
