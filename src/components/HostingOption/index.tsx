...
export const HostingOption = ({ handle, name, url }: HostingOptionProps) => {
    return (
        <li className="mr-1 mb-2">
            <a
                href={`${url}`}
                className="flex items-center flex-row py-2 px-3 rounded-full whitespace-nowrap border-white border-2 border-solid border-opacity-10 hover:text-white hover:border-opacity-20"
            >
