...
export const HostingOption = ({ handle, name, url }: HostingOptionProps) => {
    return (
        <li className="mr-1 mb-1">
            <a
                href={`${url}`}
                className="flex items-center flex-row p-2 rounded-full whitespace-nowrap border-white border-2 border-solid border-opacity-10 hover:text-white hover:border-opacity-20"
            >
