        ...
        <div className="">
            ...
            >
                {menu && (
                    ...
                    >
                        <aside
                            className={`lg:sticky reasonable:sticky reasonable:top-[108px] max-h-[calc(100vh_-_108px)] flex-shrink-0 w-full justify-self-end px-4 lg:box-border my-10 lg:my-0 mr-auto overflow-y-auto pt-6 pb-10 bg-light dark:bg-dark ${
                                hideSearch ? 'pt-5' : ''
                            }`}
                        >
                            {/*
