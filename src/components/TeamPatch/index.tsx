                ...
                <g id="marquees - foreground">
                    ...
                    {plaque === 'straight' && (
                        <g id="straight_3">
                            <path
                                ...
                                d="M28.2416 235.772H259.756C261.792 235.772 263.443 237.422 263.443 239.458V276.181C262.137 274.985 260.777 274.098 259.197 273.487C257.132 272.689 254.786 272.399 251.86 272.399H36.4842C32.5414 272.399 28.2354 273.383 24.555 276.382V239.458C24.555 237.422 26.2055 235.772 28.2416 235.772Z"
                                fillOpacity="0.8"
                                strokeWidth="2.4577"
                                className={`fill-${plaqueColor} stroke-${plaqueColor}-dark`}
                            />
                    ...
                    {plaque === 'wavy' && (
                      <>
                        <g id="wavy">
                          <g id="wavy marquee" filter="url(#filter0_b_2806_100)">
                          <path d="M25.5508 205.668C25.5508 204.064 26.6688 202.678 28.2358 202.338L39.4732 199.9C60.8194 195.269 83.0003 196.238 103.8618 202.711V202.711C128.311 210.297 154.587 210.265 179.036 202.679V202.679C199.782 196.242 221.915 195.194 243.167 199.685L255.676 202.329C257.307 202.674 258.475 204.113 258.475 205.781V250.349C258.475 252.525 256.472 254.149 254.343 253.699L243.167 251.337C221.915 246.845 199.782 247.893 179.036 254.331V254.331C154.587 261.917 128.311 261.948 103.8618 254.362V254.362C83.0003 247.889 60.8194 246.921 39.4732 251.552L29.5561 253.703C27.4967 254.15 25.5508 252.581 25.5508 250.473V205.668Z" fill-opacity="0.8"
                          className={`fill-${plaqueColor}`}
                          />
                          <path d="M256.507 205.781V250.349C256.507 251.274 255.655 251.965 254.75 251.773L243.574 249.412C221.992 244.851 199.518 245.915 178.453 252.451C154.382 259.92 128.513 259.951 104.4449 252.483C83.2593 245.909 60.7338 244.926 39.0561 249.629L29.139 251.78C28.3057 251.961 27.5185 251.326 27.5185 250.473V205.668C27.5185 204.99 27.9909 204.404 28.653 204.261L39.8903 201.823C60.9049 197.264 82.7413 198.217 103.2787 204.59C128.109 212.294 154.792 212.262 179.619 204.558C200.045 198.22 221.838 197.189 242.76 201.61L255.269 204.254C255.991 204.406 256.507 205.043 256.507 205.781Z" stroke-width="3.93536"
                          className={`stroke-${plaqueColor}-dark`}
                          />
                          </g>
                        </g>
                    ...
                    {plaque === 'stepped' && (
                      <g id="stepped marquee">
                        ...
                        <g id="Rectangle 218" filter="url(#filter0_b_2806_100)">
                          <rect x="46" y="186" width="186.505" height="51.6023" rx="4.91451"
                            fill-opacity="0.8" />
