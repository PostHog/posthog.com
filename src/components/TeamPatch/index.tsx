    ...
    return (
        ...
        >
            <g id="all variants - slice">
                ...
                <path
                    id="frame"
                    d="M238.29 140.827V303.035H39.7083V140.827C39.7083 85.9905 84.1624 41.5365 138.999 41.5365C193.836 41.5365 238.29 85.9905 238.29 140.827Z"
                    strokeWidth="3.93231"
                />
                ...
                <g id="marquees - foreground">
                    {plaque === 'curved' && (
                        <g id="curved_3">
                            ...
                            >
                                <textPath href="#curved-name" startOffset="26%" textAnchor="middle">
                                    {name}
                                </textPath>
                            </text>
                        </g>
                    ...
                    {plaque === 'wavy' && (
                      <>
                        <g id="wavy">
                          <g id="wavy marquee" filter="url(#filter0_b_2806_100)">
                            <path
                              d="M25.5508 205.668C25.5508 204.064 26.6688 202.678 28.2358 202.338L39.4732 199.9C60.8194 195.269 83.0003 196.238 103.862 202.711V202.711C128.311 210.297 154.587 210.265 179.036 202.679V202.679C199.782 196.242 221.915 195.194 243.167 199.685L255.676 202.329C257.307 202.674 258.475 204.113 258.475 205.781V250.349C258.475 252.525 256.472 254.149 254.343 253.699L243.167 251.337C221.915 246.845 199.782 247.893 179.036 254.331V254.331C154.587 261.917 128.311 261.948 103.862 254.362V254.362C83.0003 247.889 60.8194 246.921 39.4732 251.552L29.5561 253.703C27.4967 254.15 25.5508 252.581 25.5508 250.473V205.668Z"
                             fill-opacity="0.8" className={`fill-team-${color}-plaque-bg stroke-team-${color}-plaque-border`} />
                            <path
                              d="M256.507 205.781V250.349C256.507 251.274 255.655 251.965 254.75 251.773L243.574 249.412C221.992 244.851 199.518 245.915 178.453 252.451C154.382 259.92 128.513 259.951 104.445 252.483C83.2593 245.909 60.7338 244.926 39.0561 249.629L29.139 251.78C28.3057 251.961 27.5185 251.326 27.5185 250.473V205.668C27.5185 204.99 27.9909 204.404 28.653 204.261L39.8903 201.823C60.9049 197.264 82.7413 198.217 103.279 204.59C128.109 212.294 154.792 212.262 179.619 204.558C200.045 198.22 221.838 197.189 242.76 201.61L255.269 204.254C255.991 204.406 256.507 205.043 256.507 205.781Z"
                              stroke-width="3.93536" 
                              className={`fill-team-${color}-plaque-bg stroke-team-${color}-plaque-border`}
                            />
                          </g>
                        </g>
