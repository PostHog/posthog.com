...
export default function TeamPatch({
    ...
    return (
        ...
        >
            <g id="all variants - slice">
                <g id="marquees - background">
                    ...
                    {plaque === 'downward-curve' && (
                        ...
                        <path id="Rectangle 213"
                          ...
                          fill="#FFDBDB" stroke="#1E2F46" stroke-width="3.93037" />
                        <path id="Vector 184"
                ...
                {frame === 'oval' && (
                  ...
                  fill="#E34C6F" stroke="#8C0D3B" stroke-width="3.93037" />
                )}
                <path
                    id="frame"
      ...
      <path
        ...
        stroke="#1E2F46" stroke-width="3.93037" />
    </g>
