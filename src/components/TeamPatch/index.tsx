...
export default function TeamPatch({ name, imageUrl, color, textColor, textShadow, frame, plaque }: TeamPatchProps) {
    return (
        <div className="size-72 mx-auto flex items-end justify-center">
            <div
                className={`relative w-48 h-64 shadow-xl border-4 mx-auto flex items-center justify-center border-team-${color}-border bg-team-${color}-bg ${
                    frame === 'half-round'
            ...
            >
                {plaque === 'straight' && (
                    <>
                        ...
                        />
                        <div
                            className={`banner-text-bg bg-team-${color}-plaque-bg bg-opacity-80 border-2 border-team-${color}-border h-8 rounded-tl rounded-tr absolute bottom-4 -left-4 -right-4 z-20 flex items-center justify-center uppercase text-xl font-bold font-squeak [font-variant:none] text-${
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 970 274" fill="none" className="w-full">
                            ...
                            <text fill="#000">
                                <textPath
                                    ...
                                    textAnchor="middle"
                                    fontSize="96px"
                                    className={`font-squeak [font-variant:none] uppercase fill-${
                                        textColor ? textColor : 'white [text-shadow:0_1px_0_rgba(0,0,0,.5)]'
                                    } ${
                                        textShadow === 'light'
                                            ? '0_1px_0_rgba(255,255,255,.5)'
