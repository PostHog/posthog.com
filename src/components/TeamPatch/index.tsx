        ...
        >
            <g id="all variants - slice">
                <g id="marquees - background">
                    {plaque === 'straight' && (
                        <g id="straight">
                            <rect id="Rectangle 170" x="19.555" y="270.42" width="238.888" height="14.2546" rx="7.12732" fill="#47416C" stroke="black" stroke-width="2.4577" className={`fill-${plaqueColor} stroke-${plaqueColor}-dark`}/>
                        </g>
                    )}
                    {plaque === 'curved' && (
                        <g id="curved">
                    ...
                    {plaque === 'stepped' && (
                      <g id="stepped bg">
                        <rect id="stepped bg_2" x="10.0478" y="242.028" width="258.995" height="47.6707" rx="2.9487"
                          stroke-width="3.9316" 
                          className={`fill-${plaqueColor} stroke-${plaqueColor}-dark`}
                          />
                        <path id="Vector 182"
                ...
                <g id="marquees - solids">
                    ...
                    {plaque === 'straight' && (
                        <g id="straight_2">
                            <path
                                id="solid white background" d="M23.2416 231.772H254.756C256.792 231.772 258.443 233.422 258.443 235.458V276.181C257.137 274.985 255.777 274.098 254.197 273.487C252.132 272.689 249.786 272.399 246.86 272.399H31.4842C27.5414 272.399 23.2354 273.383 19.555 276.382V235.458C19.555 233.422 21.2055 231.772 23.2416 231.772Z"
                                fill="white" 
                                strokeWidth="2.4577" 
                                className={`stroke-${plaqueColor}-dark`}
                            />
                    ...
                    {plaque === 'wavy' && (
                      <>
                        <g id="wavy marquee" filter="url(#filter0_b_2806_100)">
                          <path d="M25.5508 215.668C25.5508 214.064 26.6688 212.678 28.2358 212.338L39.4732 209.9C60.8194 205.269 83.0003 206.238 103.862 212.711V212.711C128.311 220.297 154.587 220.265 179.036 212.679V212.679C199.782 206.242 221.915 205.194 243.167 209.685L255.676 212.329C257.307 212.674 258.475 214.113 258.475 215.781V260.349C258.475 262.525 256.472 264.149 254.343 263.699L243.167 261.337C221.915 256.845 199.782 257.893 179.036 264.331V264.331C154.587 271.917 128.311 271.948 103.862 264.362V264.362C83.0003 257.889 60.8194 256.921 39.4732 261.552L29.5561 263.703C27.4967 264.15 25.5508 262.581 25.5508 260.473V215.668Z" fill="white"/>
                        </g>
                      </>
                    )}
                    {plaque === 'upward-curve' && (
                    ...
                    {plaque === 'downward-curve' && (
                      <g id="downward curve marquee">
                        <path d="M26 264.602C26 268.184 29.7093 270.562 32.9639 269.066L37.3391 267.056C103.36 236.726 179.422 237.177 245.078 268.289L246.453 268.941C249.713 270.485 253.47 268.108 253.47 264.501V227.227C253.47 225.329 252.376 223.6 250.661 222.787L245.078 220.142C179.422 189.03 103.36 188.579 37.3391 218.909L28.862 222.804C27.1178 223.605 26 225.349 26 227.268V264.602Z" fill="#fff"/>
                        <path d="M251.505 264.501V227.227C251.505 226.088 250.849 225.051 249.819 224.563L244.237 221.918C179.105 191.055 103.653 190.607 38.1595 220.695L29.6824 224.59C28.6359 225.07 27.9652 226.117 27.9652 227.268V264.602C27.9652 266.751 30.1907 268.178 32.1435 267.281L36.5187 265.271C103.068 234.697 179.738 235.152 245.92 266.513L247.295 267.165C249.25 268.091 251.505 266.665 251.505 264.501Z" stroke-width="3.93037"
                        className={`stroke-${plaqueColor}-dark`}
                        />
                      </g>
                    )}
                ...
                <g id="marquees - foreground">
                    ...
                    {plaque === 'wavy' && (
                      <>
                        <g id="wavy">
                          <g id="wavy marquee" filter="url(#filter0_b_2806_100)">
                            <path d="M25.5508 215.668C25.5508 214.064 26.6688 212.678 28.2358 212.338L39.4732 209.9C60.8194 205.269 83.0003 206.238 103.8618 212.711V212.711C128.311 220.297 154.587 220.265 179.036 212.679V212.679C199.782 206.242 221.915 205.194 243.167 209.685L255.676 212.329C257.307 212.674 258.475 214.113 258.475 215.781V260.349C258.475 262.525 256.472 264.149 254.343 263.699L243.167 261.337C221.915 256.845 199.782 257.893 179.036 264.331V264.331C154.587 271.917 128.311 271.948 103.8618 264.362V264.362C83.0003 257.889 60.8194 256.921 39.4732 261.552L29.5561 263.703C27.4967 264.15 25.5508 262.581 25.5508 260.473V215.668Z" fill-opacity="0.8"
                            className={`fill-${plaqueColor}`}
                            />
                            <path d="M256.507 215.781V260.349C256.507 261.274 255.655 261.965 254.75 261.773L243.574 259.412C221.992 254.851 199.518 255.915 178.453 262.451C154.382 269.92 128.513 269.951 104.4449 262.483C83.2593 255.909 60.7338 254.926 39.0561 259.629L29.139 261.78C28.3057 261.961 27.5185 261.326 27.5185 260.473V215.668C27.5185 214.99 27.9909 214.404 28.653 214.261L39.8903 211.823C60.9049 207.264 82.7413 208.217 103.2787 214.59C128.109 222.294 154.792 222.262 179.619 214.558C200.045 208.22 221.838 207.189 242.76 211.61L255.269 214.254C255.991 214.406 256.507 215.043 256.507 215.781Z" stroke-width="3.93536"
                            className={`stroke-${plaqueColor}-dark`}
                            />
                          </g>
                        </g>
                    ...
                    {plaque === 'stepped' && (
                      <g id="stepped marquee">
                        <rect id="stepped - mid" x="212.522" y="218.685" width="40.7904" height="47.6707"
                          rx="2.9487" stroke-width="3.9316" 
                             fillOpacity="0.8"
                          className={`fill-${plaqueColor} stroke-${plaqueColor}-dark`}
                        />
                        <rect id="stepped - mid_2" x="26.2588" y="218.685" width="40.5447" height="47.6707"
                          rx="2.9487" stroke-width="3.9316" 
                             fillOpacity="0.8"
                          className={`fill-${plaqueColor} stroke-${plaqueColor}-dark`}
                        />
                        ...
                        <g id="Rectangle 218" filter="url(#filter0_b_2806_100)">
                          <rect x="46" y="196" width="186.505" height="51.6023" rx="4.91451"
                            fill-opacity="0.8" />
                          <rect x="47.9658" y="197.966" width="182.574" height="47.6707" rx="2.9487"
                             stroke-width="3.9316" 
                             fillOpacity="0.8"
                             className={`fill-${plaqueColor} stroke-${plaqueColor}-dark`}
                            />
                    ...
                    {plaque === 'upward-curve' && (
                      <g id="shield marquee_2" filter="url(#filter1_b_2806_100)">
                        ...
                        <path
                          ...
                          className={`stroke-${plaqueColor}-dark`}
                        />
                        <path id="upward-curve-name" d="M32 249.5C32 246.5 97.0179 274.5 140.5 271.5C194 274.5 249 249.5 249 249.5" stroke="none"/>
