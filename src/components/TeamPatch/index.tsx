      ...
      >
        {plaque === 'straight' && (
          <>
            ...
            />
            <div
              className={`banner-text-bg bg-team-${color}-plaque-bg bg-opacity-80 border-2 border-team-${color}-border h-8 rounded-tl rounded-tr absolute bottom-4 -left-4 -right-4 z-20 flex items-center justify-center uppercase ${size === 'lg' ? 'text-xl' : size === 'md' ? 'text-lg' : size === 'sm' ? 'text-sm' : 'text-xl'} font-bold font-squeak [font-variant:none] text-${textColor ? textColor : 'white [text-shadow:0_1px_0_rgba(0,0,0,.5)]'
                } ${textShadow === 'light'
