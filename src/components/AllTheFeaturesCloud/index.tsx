...
export const AllTheFeaturesCloud = () => {
    return (
        <div className="w-11/12 max-w-4xl mx-auto text-center">
            ...
            <div className="bg-deep-blue bg-opacity-20 border border-white border-opacity-10 p-4 px-10 mx-auto mt-4 mb-10 max-w-4xl flex flex-col md:flex-row rounded-lg items-baseline">
