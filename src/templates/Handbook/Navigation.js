...
export default function Navigation({
    ...
    return (
        ...
        >
            <div className="bg-tan dark:bg-almost-black flex mt-4 items-center border-2 border-gray-accent-light dark:border-gray-accent-dark border-dashed border-l-0 border-r-0 ">
                ...
                <ul className="list-none p-0 m-0 hidden md:flex">
                    <li className="py-2 px-3 border-r-2 border-gray-accent-light dark:border-gray-accent-dark border-dashed">
                    ...
                    {breadcrumb &&
                        breadcrumb.map((crumb, index) => {
                            return (
                                <li
                                    key={index}
                                    className="py-2 px-3 border-r-2 border-gray-accent-light dark:border-gray-accent-dark border-dashed"
                                >
                ...
                <div className="py-2 flex-grow border-r-2 border-l-2 border-gray-accent-light dark:border-gray-accent-dark border-dashed">
                ...
                <ul className="list-none p-0 m-0 hidden lg:flex ml-auto">
                    <li className="py-2 px-3">
                        <a
                            className="text-gray hover:text-almost-black dark:hover:text-white flex items-center space-x-1"
                ...
                <div className="ml-auto md:ml-0 py-2 px-3 border-l-2 border-gray-accent-light dark:border-gray-accent-dark border-dashed">
