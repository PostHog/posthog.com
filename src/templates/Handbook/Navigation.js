...
export default function Navigation({
    ...
    return (
        ...
        >
            <div className="bg-tan dark:bg-almost-black flex mt-4 items-center border border-gray-accent-light dark:border-gray-accent-dark border-dashed border-l-0 border-r-0 ">
                ...
                <ul className="list-none p-0 m-0 hidden md:flex">
                    <li className="py-2 px-3 border-r border-gray-accent-light dark:border-gray-accent-dark border-dashed">
                ...
                <div className="py-2 flex-grow border-r border-l border-gray-accent-light dark:border-gray-accent-dark border-dashed">
