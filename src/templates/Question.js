...
const QuestionSidebar = ({ question, location, title, pageViews, categories }) => {
...
export default function Question({
    ...
    return (
        <Layout>
            ...
            />
            <PostLayout article={false} sidebar={<QuestionSidebar question={question} />}>
                <div className="bg-white dark:bg-gray-accent-dark p-5 rounded-md shadow-lg article-content">
