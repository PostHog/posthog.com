...
<html>
  <head>
    ...
    <style>
      ...
      .logo-container > div > span::before {
        content: '';
        position: absolute;
      ...
      .logo-container > div > span::after {
        content: '';
        position: absolute;
        border-left: 1px solid #D0D1C9;
        border-bottom: 1px solid #D0D1C9;
        top: 0;
        height: 100%;
        width: 10px;
  ...
  <body>
    ...
    <div>
        ...
        <div style="padding: 0px 4rem; position: relative;">
                  <svg style="width: 200px; height: auto" viewBox="0 0 251 48" fill="none" xmlns="http://www.w3.org/2000/svg">
