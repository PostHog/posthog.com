    ...
    return (
        <>
            ...
            <div className="flex items-center space-x-2 mb-4">
                ...
                {beta && <span className="text-xs font-semibold px-2 py-0.5 rounded bg-blue/10 text-blue">Beta</span>}
            </div>

            <p>
                Connect {name} to PostHog to sync your data into the PostHog data warehouse for analysis and modeling.
            </p>
            ...
            <ol>
                <li>
                    Go to the <a href="https://us.posthog.com/pipeline/new/source">Data pipeline page</a> in PostHog
                </li>
                <li>
