        ...
        <div className="mx-auto max-w-4xl p-6">
            ...
            <div className="md:grid md:grid-cols-2 md:grid-flow-row-dense auto-rows-min gap-x-16 mt-8 md:mt-16">
                <h2 className="flex items-center space-x-2 col-start-1">
                    <CloudFilled /> <span>Cloud</span>
                </h2>
                <h4 className="col-start-1 mt-2">Just create an account.</h4>
                <p className="col-start-1 mt-6">
                ...
                <h2 className="flex items-center space-x-2 mt-16 md:mt-0">
                    <HddFilled /> <span>Open Source</span>
                </h2>
                <h4 className="mt-2">Host your own instance.</h4>
                <p className="h-16 mt-6">
                    Select this option if you want to install our open source platform on your own infrastructure.
                </p>
                <CallToAction type="primary" width="56" className="h-12" to="/docs/self-host">
                    Self Deploy
                </CallToAction>
            </div>
