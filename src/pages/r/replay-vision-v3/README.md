# Replay Vision comparison, version three

Local route: `/r/replay-vision-v3`. This is a separate comparison proposal requested by Brian. Version two at `/r/replay-vision-v2` and version one at `/r/replay-vision-preview` remain unchanged. The deliberate page snapshot preserves those designs for comparison; shared Editor, CTA, Link, ZoomImage, product metadata, and installation-command components are reused. This branch submits v3 for website review at its preview route. The proposed experiment destination `/r/replay-vision` is not added in this review. No experiment is configured. The page is noindex.
...
Before-and-after SHA-256 hashes of the existing pages:

- v2: `6dd8b0f5ed87f4a77d17620f529f20f8fd8f6d41b131f23e754b3ddcec80d83d`
- v1: `7c04667429c97ab8856bccee21b247ad3521de611d616ab058a2bd73fd965d89`

## Review branch checks

All seven disclosures start closed. A focused browser check verifies their defaults and opening/closing in light and dark mode at widths 640 and 1440. Screenshots are attached to the PR. The development preview runs in the original checkout; this branch is based on the latest upstream master. A production build and the hosted branch preview remain required before merge.
