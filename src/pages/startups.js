...
export function StartupForm({ title, startup = true, subtitle, onSubmit }) {
  return [
    ...
    <Col align="middle" key="startup-form-2">
      <Form
        {...layout}
        name="posthogapplication"
        id="startupapplication"
        method="post"
        onSubmit={onSubmit}
      >
        <Form.Item
        ...
        {startup && (
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: 'Please provide an accelerator program!',
              },
            ]}
          >
            <Input id="accelerator" required />
          </Form.Item>
        )}
        {startup && (
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: 'Please select which deal you would like',
              },
            ]}
          >
            <Input id="deal" required />
          </Form.Item>
        )}
    ...
    <Layout className="index-page">
      ...
      <Row gutter={[16, 8]}>
        <Col span={16} className="gutter-row">
          ...
          <p>
            We are giving early-stage startups PostHog's premium features for
            free for up to 12 months - along with other perks.
          </p>
        </Col>
      </Row>
      <Row gutter={[24, 8]}>
      ...
      <Row gutter={[24, 24]}>
        <Col span={12} className="gutter-row">
          ...
          <p>
            ...
            app, so there's no need to add tracking to every element.
          </p>
          <p>
            Know what every user is doing in your app, view trends and funnels,
      ...
      <Row justify="center">
        <Col xs={24} sm={24} md={8} lg={8} xl={8}>
          <Card
            style={{ maxWidth: 300 }}
            cover={<img alt="Ben Horowitz" src={benHorowitz} />}
          >
            <Meta
              title="Ben Horowitz"
        ...
        <Col xs={24} sm={24} md={8} lg={8} xl={8}>
          <Card
            style={{ maxWidth: 300 }}
            cover={<img alt="Michael Seibel" src={michaelSeibel} />}
          >
            <Meta
        ...
        <Col xs={24} sm={24} md={8} lg={8} xl={8}>
          <Card
            style={{ maxWidth: 300 }}
            cover={<img alt="Paul Graham" src={paulGraham} />}
          >
            <Meta
              title="Paul Graham"
              ...
              <Row gutter={16}>
                <Col span={12}>
                  <Card bordered={false}>
                    ...
                    <li>
                      PostHog will manage your deployment for you, on your
                      infrastructure
                    </li>
                    ...
                    <li>
                      After 12 months, manage it yourself for free, or have the
                      PostHog team continue to support your deployment
                    </li>
                    <p>
                      <Link to="startups#apply_section">
      ...
      <Row justify="center">
        <StartupForm title={'Apply Now'} onSubmit={submitForm}></StartupForm>
      </Row>
      <Row className="gutter-row" justify="center" align="middle">
        <Col span={24} className="gutter-row" justify="center" align="middle">
          <h2 align="middle" className="icons-header header-row">
