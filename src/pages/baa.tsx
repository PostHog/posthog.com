        ...
        >
            ...
            >
                ...
                <p className="text-center">
                    Thanks for submitting your information. If you subscribe to our Scale or Enterprise add-on, we'll
                    get back to you soon to finalize the agreement.
                </p>
                ...
                <div className="md:col-span-3 bg-white text-primary px-4 md:px-8 pt-4 pb-24 border-y md:border-y-0 border-light dark:border-dark md:shadow-xl rounded relative">
                    ...
                    <div className="pt-8">
                        ...
                        <p>
                            ...
                            the Agreement. If you are accepting this BAA in your capacity as an employee, consultant or
