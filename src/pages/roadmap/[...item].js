                ...
                <UserProvider>
                    <div className="border-t border-dashed border-gray-accent-light">
                        ...
                        >
                                ...
                                <FeatureSnapshot
                                    ...
                                    features={[
                                        <>
                                            ...
                                            feature flags and events from any other SaaS product.
                                        </>,
                                        <>
                                            <strong>Context for support teams</strong> know if users are paying
                                            customers, which features they use and product actions they've taken.
                                        </>,
                                        <>
                            ...
                            <h2 className="font-bold text-5xl mb-8 xl:mt-0">How to install</h2>
                            <ol>
                                <li>
                            ...
                            <h2 className="font-bold text-5xl mb-8 xl:mt-0">Feature ideas</h2>
