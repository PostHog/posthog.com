...
const addons = [
    {
        name: "Teams",
        price: 450,
        description: "A smorgasbord of features for teams, plus security and compliance tools to keep large teams happy.",
        features: [
            {
                "group": "Features",
                "items": [
    ...
    },
    {
        name: "Data pipelines",
        price: 300,
        description: "Export your data to your data warehouse.",
        features: [
    ...
    },
    {
        ...
        price: 200,
        description: "Analyze how groups of users behave in your product.",
        features: [
    ...
    },
    {
        ...
        price: 100,
        description: "Get a complete view of your users.",
        features: [
    ...
    return <Layout parent={pricingMenu}>
        <section className="w-11/12 mx-auto px-4 2xl:px-12 py-8">
            ...
            {addons.map((addon, addonIndex) => (
                <div key={addonIndex} className="grid md:grid-cols-12 gap-12 pt-8">
                    <div className="md:col-span-4">
                        <h2>{addon.name}</h2>
                        <p className="text-[15px]">{addon.description}</p>
                        <div className="flex items-baseline">
                            <strong className="text-xl">${addon.price}</strong>
                            <span className="text-[15px] opacity-60">/mo</span>
                        </div>
                    </div>
                    <div className="md:col-span-8">
                        <div className="grid md:grid-cols-2 gap-x-8 gap-y-4">
                            {addon.features.map((featureGroup, groupIndex) => (
