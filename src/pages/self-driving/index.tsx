        ...
        <>
            ...
            <ReaderView leftSidebar={<LeftSidebarContent />} title="self-driving.md" hideTitle>
                <div className="relative z-10">
                    ...
                    <div className="not-prose mb-6 @3xl:mb-10 pt-1 @md/reader-content:pt-2 @lg/reader-content:pt-4 @4xl:pb-6 relative border-b border-primary shadow-xl -mx-4 @md/reader-content-container:-mx-6 @lg/reader-content-container:-mx-8 @xl/reader-content-container:-mx-12 @2xl/reader-content-container:-mx-16 @3xl/reader-content-container:-mx-20 px-4 @md/reader-content-container:px-6 @lg/reader-content-container:px-8 @xl/reader-content-container:px-12 @2xl/reader-content-container:px-16 @3xl/reader-content-container:px-20">
