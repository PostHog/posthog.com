                ...
                <div className="flex flex-col md:items-center md:justify-end md:flex-row-reverse gap-8 md:gap-2">
                    <div className="md:flex-1">
                        <div className="@container">
                            ...
                            <p>
                                Let’s face it, PostHog isn’t successful because we nickel and dime builders with hobby
                                projects. We’re here to grow with you for the long-term.
                            </p>
                            <p>
                                That’s why{' '}
                                <strong>
                            ...
                            <ul>
                                <li>
                                    It’s your first bill of &gt;$1 or usage spiked &gt;200% compared to average use over
                                    the past three months
                                </li>
                                <li>You or your company doesn’t have revenue, or is a hobby project</li>
                            </ul>
                            <p>
                                Just reach out using the in-app Help button and we'll get you sorted out. You may also
                                be interested in{' '}
                            ...
                            <hr className="my-8" />
                            <p className="!text-sm">
                                Please note: this is not an <em>actual insurance policy</em>. We offer this out of the
                                goodness of our hearts and reserve the right to make the final call on any refunds.
                            </p>
