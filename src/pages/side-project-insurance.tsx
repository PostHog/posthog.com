                    ...
                    <div className="flex flex-col md:items-center md:justify-end md:flex-row-reverse gap-8 md:gap-2">
                        <div className="md:flex-1">
                            <div className="@container article-content">
                                ...
                                <p>
                                We often see this happen with a side project that unexpectedly goes viral (like <Link href="https://x.com/jxnlco/status/1777673854770463072" external>this one</Link> or <Link href="https://x.com/gabriel__xyz/status/1876188221983633535" external>this one</Link>).</p> 
                                ...
                                <p>That’s why <strong>if you get hit with an unexpectedly large bill in your first month because of a spike in volume, we'll refund it.</strong>
                                </p>
                                <p>Here’s the criteria:
                                </p>
                                  <ul>

                          <li>It’s your first bill of &gt;$1 or usage spiked &gt;200% compared to average use over the past three months</li>
                          <li>You or your company doesn’t have revenue, or is a hobby project</li>
                          </ul>
                          <p>Just reach out using the in-app Help button and we'll get you sorted out. You may also be interested in <Link href="/docs/billing/estimating-usage-costs#how-to-reduce-your-posthog-costs">ways to reduce your costs</Link> going forward.</p>

                          <p>Keep building amazing things. We can't wait to see what you do next! 💫
                                </p>

                                <hr className="my-8" />
                                <p className="!text-sm">Please note: this is not an <em>actual insurance policy</em>. We offer this out of the goodness of our hearts and reserve the right to make the final call on any refunds.</p>
