...
const PRODUCT_HANDLE = 'raquel_ai'
    ...
    return (
        ...
        >
            ...
            <div className="bg-accent border border-primary max-w-xl mx-auto rounded p-8 text-center">
                <div className="text-2xl font-bold mb-4">Raquel is free during beta.</div>
                <p className="text-xl">
...
export default function RaquelAI(): JSX.Element {
    ...
    const slides = createSlideConfig({
        exclude: ['customers', 'answers', 'comparison-summary', 'feature-comparison', 'docs', 'pairs-with'],
        // custom: [
        //     {
        ...
        content: {
            answersDescription: 'What can Raquel do?',
        },
    })
