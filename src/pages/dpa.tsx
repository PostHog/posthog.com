                        ...
                        <div className="pl-8 pb-2">
                            ...
                            <div className="pl-8 pb-2">
                                ...
                                <p>
                                    ...
                                    model or similar LLMs). Note that the Processor does not use any Company Personal
                                    Data to fine tune, train or develop its AI functionality or models for its own
                                    purposes and does not permit any third parties (including its Subprocessors) to do
                                    so.
                                </p>
                            </div>
