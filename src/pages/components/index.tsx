                ...
                <div className="@container text-primary">
                    <div className="space-y-12">
                        ...
                        <section>
                            ...
                            {/* Native Button Equivalents */}
                            <div className="mb-8">
                                <h3 className="text-xl font-semibold mb-4">Native button equivalents</h3>
                                <p className="text-muted mb-4">
                                    These are regular HTML <code>&lt;button&gt;</code> elements with equivalent OSButton
                                    styling applied. Use these when you need native button behavior without the OSButton
                                    component.
                                </p>
                                <ScrollArea className="h-96">
                                    <table className="w-full border-collapse border border-primary">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td className="border border-primary px-4 py-2 font-mono">default</td>
                                                <td className="border border-primary px-4 py-2">
                                                    Native button with default styling
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-px top-[1px] rounded-[5px] px-1 py-1 text-xs gap-1 rounded-[5px] translate-y-[-1px] hover:translate-y-[-2px] active:-translate-y-px border-[1.5px] -mx-px group-disabled:hover:!translate-y-[-2px] bg-black border-black text-white hover:bg-black/90 active:bg-black/80 justify-center w-auto">
                                                        Native
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[5px] px-1.5 py-1 text-[13px] gap-1 rounded-[5px] translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-3px] bg-black border-black text-white hover:bg-black/90 active:bg-black/80 justify-center w-auto">
                                                        Native
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[6px] px-1.5 py-1 gap-1 rounded-[6px] text-sm translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px] bg-black border-black text-white hover:bg-black/90 active:bg-black/80 justify-center w-auto">
                                                        Native
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[2px] rounded-[6px] px-6 py-3 text-base gap-1.5 rounded-[6px] translate-y-[-2px] hover:translate-y-[-4px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px] bg-black border-black text-white hover:bg-black/90 active:bg-black/80 justify-center w-auto">
                                                        Native
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[2px] rounded-[6px] px-2.5 py-1 @md:px-3 @md:py-1.5 @md:text-[15px] @lg:px-4 @lg:py-2 text-base gap-2 rounded-[6px] translate-y-[-2px] hover:translate-y-[-4px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px] bg-black border-black text-white hover:bg-black/90 active:bg-black/80 justify-center w-auto">
                                                        Native
                                                    </button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td className="border border-primary px-4 py-2 font-mono">primary</td>
                                                <td className="border border-primary px-4 py-2">
                                                    Native button with primary styling
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-px top-[1px] rounded-[5px] bg-button-shadow dark:bg-button-shadow-dark w-auto text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                        <span className="flex items-center justify-center w-auto bg-orange text-black hover:text-black dark:text-black dark:hover:text-black no-underline border-button dark:border-button-dark dark:bg-orange font-bold block active:transition-all active:duration-100 select-none px-1 py-1 text-xs gap-1 rounded-[5px] translate-y-[-1px] hover:translate-y-[-2px] active:-translate-y-px border-[1.5px] -mx-px group-disabled:hover:!translate-y-[-2px]">
                                                            Native
                                                        </span>
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[5px] bg-button-shadow dark:bg-button-shadow-dark w-auto text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                        <span className="flex items-center justify-center w-auto bg-orange text-black hover:text-black dark:text-black dark:hover:text-black no-underline border-button dark:border-button-dark dark:bg-orange font-bold block active:transition-all active:duration-100 select-none px-1.5 py-1 text-[13px] gap-1 rounded-[5px] translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-3px]">
                                                            Native
                                                        </span>
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[6px] bg-button-shadow dark:bg-button-shadow-dark w-auto text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                        <span className="flex items-center justify-center w-auto bg-orange text-black hover:text-black dark:text-black dark:hover:text-black no-underline border-button dark:border-button-dark dark:bg-orange font-bold block active:transition-all active:duration-100 select-none px-1.5 py-1 gap-1 rounded-[6px] text-sm translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px]">
                                                            Native
                                                        </span>
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[2px] rounded-[6px] bg-button-shadow dark:bg-button-shadow-dark w-auto text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                        <span className="flex items-center justify-center w-auto bg-orange text-black hover:text-black dark:text-black dark:hover:text-black no-underline border-button dark:border-button-dark dark:bg-orange font-bold block active:transition-all active:duration-100 select-none px-6 py-3 text-base gap-1.5 rounded-[6px] translate-y-[-2px] hover:translate-y-[-4px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px]">
                                                            Native
                                                        </span>
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[2px] rounded-[6px] bg-button-shadow dark:bg-button-shadow-dark w-auto text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                        <span className="flex items-center justify-center w-auto bg-orange text-black hover:text-black dark:text-black dark:hover:text-black no-underline border-button dark:border-button-dark dark:bg-orange font-bold block active:transition-all active:duration-100 select-none px-2.5 py-1 @md:px-3 @md:py-1.5 @md:text-[15px] @lg:px-4 @lg:py-2 text-base gap-2 rounded-[6px] translate-y-[-2px] hover:translate-y-[-4px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px]">
                                                            Native
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td className="border border-primary px-4 py-2 font-mono">secondary</td>
                                                <td className="border border-primary px-4 py-2">
                                                    Native button with secondary styling
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-px top-[1px] rounded-[5px] bg-orange dark:bg-button-secondary-shadow-dark dark:border-button-secondary-dark w-auto text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                        <span className="flex items-center justify-center w-auto bg-white text-primary hover:text-primary dark:text-primary-dark dark:hover:text-primary-dark no-underline border-button dark:border-orange dark:bg-dark font-bold block active:transition-all active:duration-100 select-none px-1 py-1 text-xs gap-1 rounded-[5px] translate-y-[-1px] hover:translate-y-[-2px] active:-translate-y-px border-[1.5px] -mx-px group-disabled:hover:!translate-y-[-2px]">
                                                            Native
                                                        </span>
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[5px] bg-orange dark:bg-button-secondary-shadow-dark dark:border-button-secondary-dark w-auto text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                        <span className="flex items-center justify-center w-auto bg-white text-primary hover:text-primary dark:text-primary-dark dark:hover:text-primary-dark no-underline border-button dark:border-orange dark:bg-dark font-bold block active:transition-all active:duration-100 select-none px-1.5 py-1 text-[13px] gap-1 rounded-[5px] translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-3px]">
                                                            Native
                                                        </span>
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[6px] bg-orange dark:bg-button-secondary-shadow-dark dark:border-button-secondary-dark w-auto text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                        <span className="flex items-center justify-center w-auto bg-white text-primary hover:text-primary dark:text-primary-dark dark:hover:text-primary-dark no-underline border-button dark:border-orange dark:bg-dark font-bold block active:transition-all active:duration-100 select-none px-1.5 py-1 gap-1 rounded-[6px] text-sm translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px]">
                                                            Native
                                                        </span>
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[2px] rounded-[6px] bg-orange dark:bg-button-secondary-shadow-dark dark:border-button-secondary-dark w-auto text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                        <span className="flex items-center justify-center w-auto bg-white text-primary hover:text-primary dark:text-primary-dark dark:hover:text-primary-dark no-underline border-button dark:border-orange dark:bg-dark font-bold block active:transition-all active:duration-100 select-none px-6 py-3 text-base gap-1.5 rounded-[6px] translate-y-[-2px] hover:translate-y-[-4px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px]">
                                                            Native
                                                        </span>
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[2px] rounded-[6px] bg-orange dark:bg-button-secondary-shadow-dark dark:border-button-secondary-dark w-auto text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                        <span className="flex items-center justify-center w-auto bg-white text-primary hover:text-primary dark:text-primary-dark dark:hover:text-primary-dark no-underline border-button dark:border-orange dark:bg-dark font-bold block active:transition-all active:duration-100 select-none px-2.5 py-1 @md:px-3 @md:py-1.5 @md:text-[15px] @lg:px-4 @lg:py-2 text-base gap-2 rounded-[6px] translate-y-[-2px] hover:translate-y-[-4px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px]">
                                                            Native
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td className="border border-primary px-4 py-2 font-mono">ghost</td>
                                                <td className="border border-primary px-4 py-2">
                                                    Native button with ghost styling
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-px top-[1px] rounded-[5px] px-1 py-1 text-xs gap-1 rounded-[5px] translate-y-[-1px] hover:translate-y-[-2px] active:-translate-y-px border-[1.5px] -mx-px group-disabled:hover:!translate-y-[-2px] bg-transparent border-transparent skin-classic:border-b-3 rounded hover:bg-accent hover:skin-classic:bg-primary skin-classic:hover:border-primary skin-classic:border-transparent active:bg-accent-2/80 focus:border-primary justify-center w-auto">
                                                        Native
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[5px] px-1.5 py-1 text-[13px] gap-1 rounded-[5px] translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-3px] bg-transparent border-transparent skin-classic:border-b-3 rounded hover:bg-accent hover:skin-classic:bg-primary skin-classic:hover:border-primary skin-classic:border-transparent active:bg-accent-2/80 focus:border-primary justify-center w-auto">
                                                        Native
                                                    </button>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                            ...
                            {/* Full Width Native Buttons */}
                            <div className="mb-8">
                                <h3 className="text-xl font-semibold mb-4">Full width native buttons</h3>
                                <p className="text-muted mb-4">
                                    These are full-width native HTML <code>&lt;button&gt;</code> elements with
                                    equivalent OSButton styling. Note the different width handling for primary and
                                    secondary variants.
                                </p>
                                <ScrollArea className="h-96">
                                    <table className="w-full border-collapse border border-primary">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td className="border border-primary px-4 py-2 font-mono">default</td>
                                                <td className="border border-primary px-4 py-2">
                                                    Full-width native button with default styling
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <div className="w-48">
                                                        <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-px top-[1px] rounded-[5px] px-1 py-1 text-xs gap-1 rounded-[5px] translate-y-[-1px] hover:translate-y-[-2px] active:-translate-y-px border-[1.5px] -mx-px group-disabled:hover:!translate-y-[-2px] bg-black border-black text-white hover:bg-black/90 active:bg-black/80 justify-center w-full">
                                                            Full Width
                                                        </button>
                                                    </div>
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <div className="w-48">
                                                        <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[5px] px-1.5 py-1 text-[13px] gap-1 rounded-[5px] translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-3px] bg-black border-black text-white hover:bg-black/90 active:bg-black/80 justify-center w-full">
                                                            Full Width
                                                        </button>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td className="border border-primary px-4 py-2 font-mono">primary</td>
                                                <td className="border border-primary px-4 py-2">
                                                    Full-width native button with primary styling
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <div className="w-48">
                                                        <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-px top-[1px] rounded-[5px] bg-button-shadow dark:bg-button-shadow-dark w-full text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                            <span className="flex items-center justify-center w-full bg-orange text-black hover:text-black dark:text-black dark:hover:text-black no-underline border-button dark:border-button-dark dark:bg-orange font-bold block active:transition-all active:duration-100 select-none px-1 py-1 text-xs gap-1 rounded-[5px] translate-y-[-1px] hover:translate-y-[-2px] active:-translate-y-px border-[1.5px] -mx-px group-disabled:hover:!translate-y-[-2px]">
                                                                Full Width
                                                            </span>
                                                        </button>
                                                    </div>
                                                ...
                                                <td className="border border-primary px-4 py-2">
                                                    <div className="w-48">
                                                        <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[5px] bg-button-shadow dark:bg-button-shadow-dark w-full text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                            <span className="flex items-center justify-center w-full bg-orange text-black hover:text-black dark:text-black dark:hover:text-black no-underline border-button dark:border-button-dark dark:bg-orange font-bold block active:transition-all active:duration-100 select-none px-1.5 py-1 text-[13px] gap-1 rounded-[5px] translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-3px]">
                                                                Full Width
                                                            </span>
                                                        </button>
                                                ...
                                                <td className="border border-primary px-4 py-2">
                                                    <div className="w-48">
                                                        <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[6px] bg-button-shadow dark:bg-button-shadow-dark w-full text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                            <span className="flex items-center justify-center w-full bg-orange text-black hover:text-black dark:text-black dark:hover:text-black no-underline border-button dark:border-button-dark dark:bg-orange font-bold block active:transition-all active:duration-100 select-none px-1.5 py-1 gap-1 rounded-[6px] text-sm translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px]">
                                                                Full Width
                                                            </span>
                                                        </button>
                                                ...
                                                <td className="border border-primary px-4 py-2">
                                                    <div className="w-48">
                                                        <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[2px] rounded-[6px] bg-button-shadow dark:bg-button-shadow-dark w-full text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                            <span className="flex items-center justify-center w-full bg-orange text-black hover:text-black dark:text-black dark:hover:text-black no-underline border-button dark:border-button-dark dark:bg-orange font-bold block active:transition-all active:duration-100 select-none px-6 py-3 text-base gap-1.5 rounded-[6px] translate-y-[-2px] hover:translate-y-[-4px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px]">
                                                                Full Width
                                                            </span>
                                                        </button>
                                            ...
                                            <tr>
                                                <td className="border border-primary px-4 py-2 font-mono">secondary</td>
                                                <td className="border border-primary px-4 py-2">
                                                    Full-width native button with secondary styling
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <div className="w-48">
                                                        <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-px top-[1px] rounded-[5px] bg-orange dark:bg-button-secondary-shadow-dark dark:border-button-secondary-dark w-full text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                            <span className="flex items-center justify-center w-full bg-white text-primary hover:text-primary dark:text-primary-dark dark:hover:text-primary-dark no-underline border-button dark:border-orange dark:bg-dark font-bold block active:transition-all active:duration-100 select-none px-1 py-1 text-xs gap-1 rounded-[5px] translate-y-[-1px] hover:translate-y-[-2px] active:-translate-y-px border-[1.5px] -mx-px group-disabled:hover:!translate-y-[-2px]">
                                                                Full Width
                                                            </span>
                                                        </button>
                                                    </div>
                                                ...
                                                <td className="border border-primary px-4 py-2">
                                                    <div className="w-48">
                                                        <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[5px] bg-orange dark:bg-button-secondary-shadow-dark dark:border-button-secondary-dark w-full text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                            <span className="flex items-center justify-center w-full bg-white text-primary hover:text-primary dark:text-primary-dark dark:hover:text-primary-dark no-underline border-button dark:border-orange dark:bg-dark font-bold block active:transition-all active:duration-100 select-none px-1.5 py-1 text-[13px] gap-1 rounded-[5px] translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-3px]">
                                                                Full Width
                                                            </span>
                                                        </button>
                                                ...
                                                <td className="border border-primary px-4 py-2">
                                                    <div className="w-48">
                                                        <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[3px] rounded-[6px] bg-orange dark:bg-button-secondary-shadow-dark dark:border-button-secondary-dark w-full text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                            <span className="flex items-center justify-center w-full bg-white text-primary hover:text-primary dark:text-primary-dark dark:hover:text-primary-dark no-underline border-button dark:border-orange dark:bg-dark font-bold block active:transition-all active:duration-100 select-none px-1.5 py-1 gap-1 rounded-[6px] text-sm translate-y-[-2px] hover:translate-y-[-3px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px]">
                                                                Full Width
                                                            </span>
                                                        </button>
                                                ...
                                                <td className="border border-primary px-4 py-2">
                                                    <div className="w-48">
                                                        <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-[1.5px] top-[2px] rounded-[6px] bg-orange dark:bg-button-secondary-shadow-dark dark:border-button-secondary-dark w-full text-primary inline-block border-button text-center group disabled:opacity-50 disabled:cursor-not-allowed">
                                                            <span className="flex items-center justify-center w-full bg-white text-primary hover:text-primary dark:text-primary-dark dark:hover:text-primary-dark no-underline border-button dark:border-orange dark:bg-dark font-bold block active:transition-all active:duration-100 select-none px-6 py-3 text-base gap-1.5 rounded-[6px] translate-y-[-2px] hover:translate-y-[-4px] active:translate-y-[-1px] border-[1.5px] mx-[-1.5px] group-disabled:hover:!translate-y-[-2px]">
                                                                Full Width
                                                            </span>
                                                        </button>
                                            ...
                                            <tr>
                                                <td className="border border-primary px-4 py-2 font-mono">ghost</td>
                                                <td className="border border-primary px-4 py-2">
                                                    Full-width native button with ghost styling
                                                </td>
                                                <td className="border border-primary px-4 py-2">
                                                    <div className="w-48">
                                                        <button className="relative inline-flex items-center rounded border text-primary transition-colors transition-[font-size,line-height,padding] transition-50 hover:transition-none disabled:text-muted disabled:cursor-not-allowed disabled:hover:bg-primary disabled:hover:text-muted disabled:hover:border-transparent border-px top-[1px] rounded-[5px] px-1 py-1 text-xs gap-1 rounded-[5px] translate-y-[-1px] hover:translate-y-[-2px] active:-translate-y-px border-[1.5px] -mx-px group-disabled:hover:!translate-y-[-2px] bg-transparent border-transparent skin-classic:border-b-3 rounded hover:bg-accent hover:skin-classic:bg-primary skin-classic:hover:border-primary skin-classic:border-transparent active:bg-accent-2/80 focus:border-primary justify-center w-full">
