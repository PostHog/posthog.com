...
import { productEngineerHandbookSidebar } from '../navs'
import chapters from '../navs/product-engineer-handbook.json'
import Link from 'components/Link'

export const ProductEngineerHandbook: React.FC = () => {
    return (
        <>
            <SEO image="/images/handbook.png" title="Product Engineer Handbook - PostHog" />
            <ReaderView
                title="Product Engineer Handbook"
                hideTitle={true}
                leftSidebar={<TreeMenu items={productEngineerHandbookSidebar} />}
                homeURL="/product-engineer-handbook"
                description="Learn how to become a product engineer"
                proseSize="base"
            >
                <section className="max-w-4xl">
                    <div className="flex flex-col @md:items-center @md:justify-end @md:flex-row-reverse gap-8 @md:gap-2 mb-8">
                        ...
                        <div className="md:flex-1">
                            <h1>Product Engineer Handbook</h1>
                            <p className="text-secondary">
                                Learn how to become a product engineer and build products that users love.
                            </p>
                        </div>
                    </div>
...
export default ProductEngineerHandbook
