        ...
        <>
            ...
            <Editor showFilters title="quick calls script" type="txt" slug="/quick-calls-script">
                <ScrollArea>
                    ...
                    <p>Sorry, this doesn't actually exist because we don't force you to talk to anyone.</p>
                    <p>
                        But you can{' '}
                    ...
                    <p>
                        You may also enjoy{' '}
                        <Link href="/sales" state={{ newWindow: true }}>
                            our in-depth comparison
                        </Link>{' '}
                        of how we do "sales" compared to everybody else.
                    </p>
                </ScrollArea>
            </Editor>
        </>
