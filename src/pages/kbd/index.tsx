            ...
            <div data-scheme="secondary" className="w-full h-full bg-primary text-primary">
                <ScrollArea className="h-full">
                    <div className="p-4 max-w-4xl mx-auto">
                        <CloudinaryImage
                            src="https://res.cloudinary.com/dmukukwp6/image/upload/mind_blown_b40a9d0e47.png"
                            className="float-right -mt-1 ml-2"
                            imgClassName="max-h-[161px]"
                        />
                        <div className="mb-6">
                                        ...
                                        {section.shortcuts.map((shortcut, index) => (
                                            <div key={index} className="flex items-center justify-between">
                                                <div className="flex-1">
                                                    <div className="text-primary">{shortcut.description}</div>
