                    ...
                    ({
                        ...
                        return (
                            <li key={id}>
                                ...
                                <div className="ml-6 [&_p]:leading-normal [&_p]:text-sm [&_img]:rounded">
...
const CommunityNewsLogo = () => {
    return (
        <h1 className="mb-0 tracking-tight uppercase font-bold text-xl @2xl:text-2xl flex justify-center items-start gap-1.5 @2xl:gap-2 mt-1">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 295 34"
                className="w-full @2xl:w-auto @2xl:h-8"
            >
    ...
    return (
        <section className={`@container pt-4 px-6 @7xl:px-5 transition-all mx-auto ${fullWidthContent ? '' : 'max-w-[1400px]'}`}>
            <div data-scheme="primary" className="bg-accent grid grid-cols-2 @3xl:grid-cols-[200px_1fr_200px] mb-4 @7xl:mb-6 mx-auto py-1 @3xl:p-2 items-center">
                ...
                <div className="text-center py-2 @3xl:py-1 order-3 @3xl:order-none col-span-2 @3xl:col-span-1  border-t border-primary @3xl:border-t-0 mt-1 @3xl:mt-0">
                    <CommunityNewsLogo />
                </div>
                <div className=" @3xl:block @3xl:pr-2">
                    <AppStatus />
                </div>
            </div>
        </section>
