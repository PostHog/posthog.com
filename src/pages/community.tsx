                ...
                <div className="order-1 md:order-none md:px-4 md:border-x border-light dark:border-dark">
                    ...
                    >
                        <div className="flex flex-col gap-4">
                            <div>
                                <StaticImage
                                    src="https://res.cloudinary.com/dmukukwp6/image/upload/f_webp,h_2720,w_4836,c_fill,g_auto,q_auto/v1/posthog.com/contents/images/blog/risotto-startup?_a=AXAH4nI0"
                                    alt=""
                                />
                                <div className="text-sm opacity-60 mt-3 mb-1">Inside PostHog</div>
                                <h2 className="mb-2">How Risotto got into Y Combinator and built an AI product</h2>
                                <p>
                                    Each month, we speak to a team enrolled in PostHog for Startups about the way they
                                    work. This time, we spoke to Risotto, an AI-powered IT helpdesk platform, about how
                                    they got into the world’s most successful startup accelerator.
                                </p>
                            </div>

                            <div className="grid grid-cols-2 xl:grid-cols-[1fr_35%] 2xl:grid-cols-[1fr_40%] gap-4 items-center transition-all">
                                <div>
                                    <div className="text-sm opacity-75">Newsletter</div>
                                    <h3 className="text-[17px] xl:text-xl 2xl:text-2xl">
                                        Read this before you pivot your startup
                                    </h3>
                                </div>
                                <div>
                                    <StaticImage
                                        src="https://res.cloudinary.com/dmukukwp6/image/upload/f_webp,h_630,w_1200,c_fill,g_auto,q_auto/v1/posthog.com/contents/images/blog/story-about-pivots?_a=AXAH4nI0"
                                        alt=""
                                    />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 xl:grid-cols-[1fr_35%] 2xl:grid-cols-[1fr_40%] gap-4 items-center transition-all">
                                ...
                                <div>
                                    <StaticImage
                                        src="https://res.cloudinary.com/dmukukwp6/image/upload/f_webp,h_400,w_600,c_fill,g_auto,q_auto/v1/posthog.com/contents/images/blog/misconceptions-about-analytics/analytics?_a=AXAH4nI0"
                                        alt=""
                                    />
                                </div>
                            </div>
