        ...
        <Layout>
            ...
            <Row gutter={[24, 24]}>
                <Col span={24} align="middle">
                    <h1 className="p-title p-text-primary">Product analytics for everyone</h1>
                </Col>
            </Row>
            ...
            <Row gutter={[24, 24]} style={{ marginTop: '32px' }}>
                <Col span={24}>
                    ...
                    <p>
                        Cloud or self-hosted? We'd love to help you find the option that's <b>right for you</b>.
                    </p>
                </Col>
