                            ...
                            <div>
                                <div className="p-main">
                                    ...
                                    <p style={{ maxWidth: '50vw' }}>
                                        ...
                                        that does the legwork for you. Try PostHog for free for 12 months with a volume
                                        of up to 20 million events per month.
                                    </p>
                                    <p>
                        ...
                        <Col md={12} sm={24}>
                            <div className="p-full-height">
                                ...
                                <ul className="p-comparison-list">
                                    ...
                                    <li>
                                        You need dedicated support, and want regular touch points with our team to get
                                        the best value.
                                    </li>
                                    <li>
