    ...
    const integrations = [
        {
            logo: OpenAILogo,
            name: 'OpenAI',
            link: '/docs/llm-observability/installation/openai',
        },
        {
            logo: AnthropicLogo,
            name: 'Anthropic',
            link: '/docs/llm-observability/installation/anthropic',
        },
        {
            logo: GeminiLogo,
            name: 'Google Gemini',
            link: '/docs/llm-observability/installation/google',
        },
        {
            logo: LangChainLogo,
            name: 'LangChain',
            link: '/docs/llm-observability/installation/langchain',
        },
        {
            logo: VercelLogo,
            name: 'Vercel AI SDK',
            link: '/docs/llm-observability/installation/vercel-ai',
        },
        {
            logo: OpenRouterLogo,
            name: 'OpenRouter',
            link: '/docs/llm-observability/installation/openrouter',
        },
        {
            logoLight: LiteLLMLogoLight,
            logoDark: LiteLLMLogoDark,
            name: 'LiteLLM',
            link: '/docs/llm-observability/installation/litellm',
        },
        {
            isManualCapture: true,
            name: '</> Manual Capture',
            link: '/docs/llm-observability/installation/manual-capture',
        },
    ]
            ...
            <div className="flex flex-col @2xl:flex-row @2xl:items-start gap-4 @2xl:gap-6 flex-1 min-h-0">
                ...
                <div className="flex-1 min-h-0">
                    <div data-scheme="secondary" className="bg-primary rounded p-6 h-full flex flex-col min-h-0">
                        ...
                        <Link
                            to="/docs/llm-observability/installation/manual-capture"
    ...
    return (
        ...
        >
            ...
            <p className="mt-4 text-xl text-center">
                Sure you can use LLM Observability solo, but it's better with other PostHog products.
            </p>
...
export default function LLMAnalytics(): JSX.Element {
    ...
    const slides = createSlideConfig({
        ...
        content: {
            ...
            answersHeadline: 'What can LLM Observability help me discover?',
        },
    })
