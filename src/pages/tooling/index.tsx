        ...
        <>
            ...
            <Editor>
                <div className="space-y-6 leading-relaxed">
                    ...
                    {/* Timeline — future: swap images div to a single @2xl:col-span-3 image */}
                    <div className="grid grid-cols-1 @2xl:grid-cols-3 @2xl:gap-x-6">
                        <div className="pb-6 @2xl:pb-0">
                            ...
                            <div className="relative pl-8 @2xl:pl-0 @2xl:pt-4">
                                ...
                                <div className="hidden @2xl:block h-[2px] bg-border top-3 absolute left-1 -right-6 mt-px" />
                                {/* Vertical line (mobile) */}
                                <div className="@2xl:hidden absolute top-6 -bottom-6 left-2 w-px bg-border" />
                                <p className="text-sm font-semibold text-secondary mb-2">1995 - 2020</p>
                                <h3 className="text-lg m-0 mb-1 leading-normal">
                        ...
                        <div className="pb-6 @2xl:pb-0">
                            ...
                            <div className="relative pl-8 @2xl:pl-0 @2xl:pt-4">
                                ...
                                <div className="hidden @2xl:block h-[2px] bg-border top-3 absolute left-1 -right-6 mt-px" />
                                <div className="@2xl:hidden absolute top-6 -bottom-6 left-2 w-px bg-border" />
                                <p className="text-sm font-semibold text-secondary mb-2">2020 - 2024</p>
                                <h3 className="text-lg m-0 mb-1 leading-normal">Multi-product SaaS companies</h3>
                                <p className="m-0">
                        ...
                        <div className="pb-0">
                            ...
                            <div className="relative pl-8 @2xl:pl-0 @2xl:pt-4">
                                ...
                                <p className="text-sm font-semibold text-secondary mb-2">2025 - current</p>
                                <h3 className="text-lg m-0 mb-1 leading-normal">Just write a prompt</h3>
                                <p className="m-0">
