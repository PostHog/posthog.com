      ...
      <div className="indexContainer">
        ...
        <div className="whiteBackground">
          <Row>
            ...
            <Col xs={20} sm={20} md={12} lg={12} xl={12}>
              <p>
                Visualize how users navigate through your app or website, and use metrics to understand what needs
                improvement.
              </p>
            </Col>
          </Row>
          ...
          <Row justify="space-between">
            ...
            <Col xs={20} sm={20} md={8} lg={8} xl={8}>
              ...
              <p className="blueText">
                Continuously release new features without worrying about breaking changes. Test new ideas quickly and
                roll out to 10%, 20% or 100% of your users.
              </p>
            </Col>
          </Row>
        </div>
            ...
            <Col xs={24} sm={24} md={8} lg={8} xl={8}>
              <Row>
                ...
                <Col xs={14} sm={14} md={24} lg={24} xl={24} style={{ padding: '0 6%' }}>
                  ...
                  <p>
                    PostHog can manage your deployment on your infrastructure. All the benefits of self-hosting with the
                    reliability and scalability of the cloud.
                  </p>
                </Col>
              </Row>
              `
        ...
        <Row>
          <Col span={24} className="gutter-row header-row">
            ...
            <p>Version 1.14.0</p>
            <Link to="blog/the-posthog-array-1-14-0">
