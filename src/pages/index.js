            ...
            <div className="indexContainer">
                ...
                <Row align="top" style={{ marginBottom: '12rem' }}>
                    <Col xs={24} sm={18} md={12} lg={12} xl={12} className="gutter-row">
                        <h1 className="largeHeader" align="top">
                            Understand <br className="hiddenHeadBreak" />
                            your users.
                            <br />
                        ...
                        <Link to="/trial">
                            <Button type="primary" size="large" icon="right-circle">
                        ...
                        <p>
                            PostHog provides a full product analytics UX. Analyze trends, funnels, retention and
                            cohorts.
                        </p>
                    </Col>
                    ...
                    <Row justify="space-between">
                        ...
                        <Col xs={17} sm={17} md={8} lg={8} xl={8}>
                            ...
                            <p className="blueText">
                                PostHog autocaptures events and user behavior in your mobile or web app.
                            </p>
                        </Col>
                ...
                <div className="whiteBackground">
                    <Row justify="space-between">
                        ...
                        <Col xs={4} sm={4} md={3} lg={3} xl={3}>
                            <h2 className="redHead numberHead">02</h2>
                        </Col>
                ...
                <div className="blueBackground">
                    <Row justify="space-between">
                        ...
                        <Col xs={18} sm={18} md={9} lg={9} xl={9}>
                            ...
                            <p>
                                Powerful analytics to really understand what your users are doing and how to keep them
                                coming back.
                            </p>
                        </Col>
                ...
                <div className="yellowBackground">
                    <Row justify="space-between">
                        ...
                        <Col xs={0} sm={0} md={1} lg={1} xl={1}></Col>
                        <Col xs={4} sm={4} md={3} lg={3} xl={3}>
                            <h2 style={{ marginTop: '1rem' }} className="redText numberHead">
                                05
                            </h2>
                        </Col>
                        <Col xs={20} sm={20} md={8} lg={8} xl={8}>
                            <h2 style={{ marginTop: '1rem' }} className="blueText">
                            ...
                            <br />
                            <p className="blueText">
                                Continuously release new features without worrying about breaking changes. Test new
                                ideas quickly and roll out to 10%, 20% or 100% of your users.
                            </p>
                        </Col>
                    </Row>
                </div>
                ...
                <div className="whiteBackground">
                    <Row className="gutter-row" justify="center" align="middle">
                        <Col span={24} className="gutter-row" justify="center" align="middle">
                            <h3 align="middle">Designed for your stack</h3>
                        </Col>
                    </Row>
                        ...
                        <Col xs={24} sm={24} md={8} lg={8} xl={8}>
                            <Row>
                                ...
                                <Col xs={14} sm={14} md={24} lg={24} xl={24} style={{ padding: '0 6%' }}>
                                    ...
                                    <p>
                                        PostHog can manage your deployment on your infrastructure. All the benefits of
                                        self-hosting with the reliability and scalability of the cloud.
                                    </p>
                                </Col>
                            </Row>
                            `
                ...
                <Row justify="center">
                    <Col span={24} align="middle">
                        <p>
                            ... or start a <a href="https://app.posthog.com/signup">free trial</a> with PostHog SaaS.
                        </p>
                    </Col>
                </Row>
