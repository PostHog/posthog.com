...
const FeatureFlags: React.FC<FeatureFlagsProps> = ({ data }) => {
    ...
    return (
        <Layout>
            <SEO title="Feature management - Docs - PostHog" />

            <PostLayout title={'Feature management'} menu={docs} hideSurvey hideSidebar>
                <StaticImage
                    alt=""
                    placeholder="none"
                    quality={100}
                ...
                />
                <h1 className="text-4xl mb-2 mt-6">Feature management</h1>
