...
const SessionRecordingComparisonTable = () => {
    return (
        <Section>
...
export const SessionRecordingTestimonial = (): JSX.Element => {
    const testimonial: ITestimonial | undefined = testimonials.find(
...
export const SessionRecordingFeatureGrid = (): JSX.Element => {
    return (
...
export const SessionRecordingMainFeatures = (): JSX.Element => {
    return (
        <>
            <Section border>
            ...
            <Section border>
                <TwoCol className="items-center">
                    <div>
                        ...
                        <p className="mb-2">
                            "The user seemed frustrated. Oh, there was a 5 second API request. That's interesting..."
                        </p>
                        <p className="m-0">
...
export const SessionRecordingPairsWith = (): JSX.Element => {
    return (
...
export default function SessionRecording(): JSX.Element {
    ...
    return (
        <Layout>
            ...
            >
                <SessionRecordingFeatureGrid />
                <SessionRecordingTestimonial />
                <SessionRecordingMainFeatures />
                <SessionRecordingPairsWith />
                <SessionRecordingComparisonTable />
                <Section>
