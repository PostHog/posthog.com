  ...
  <Layout>
    ...
    <Row gutter={[16, 96]}>
      <Col xs={24} sm={24} md={12} lg={12} xl={12}>
        ...
        <p>
          Select this option if you want to quickly try the PostHog features and
          don't want to worry about installing it yourself.
        </p>
        <p>
      ...
      <Col xs={24} sm={24} md={12} lg={12} xl={12}>
        ...
        <p>
          Select this option if you want to install PostHog on your own
          infrastructure.
        </p>
        <p>
